...
local function var_0_23(arg_24_0, arg_24_1, arg_24_2)
	for iter_24_0 in io.lines(arg_24_1) do
		var_0_22(arg_24_0, iter_24_0, iter_24_0 .. arg_24_2)
	end
end
...
local function var_0_24(...)
	...
	while var_25_1 <= #var_25_0 do
		local var_25_6 = var_25_0[var_25_1]

		if type(var_25_6) == "string" and string.sub(var_25_6, 1, 1) == "-" and var_25_6 ~= "-" then
			...
			for iter_25_0 = 2, #var_25_6 do
				local var_25_7 = string.sub(var_25_6, iter_25_0, iter_25_0)

				if var_25_7 == "l" then
					var_25_2 = true
				elseif var_25_7 == "L" then
					var_25_2 = true
					var_25_3 = true
				elseif var_25_7 == "s" then
					var_25_5.strip = true
				elseif var_25_7 == "g" then
					var_25_5.strip = false
				else
					if var_25_0[var_25_1] == nil or iter_25_0 ~= #var_25_6 then
						var_0_3()
					end
					...
					if var_25_7 == "e" then
						...
						var_25_0[1] = var_0_4(loadstring(var_25_0[1]))
					elseif var_25_7 == "n" then
						var_25_5.modname = var_0_12(table.remove(var_25_0, var_25_1))
					elseif var_25_7 == "t" then
						var_25_5.type = var_0_10(table.remove(var_25_0, var_25_1), var_0_7, "file type")
					elseif var_25_7 == "a" then
						var_25_5.arch = var_0_10(table.remove(var_25_0, var_25_1), var_0_8, "architecture")
					elseif var_25_7 == "o" then
						var_25_5.os = var_0_10(table.remove(var_25_0, var_25_1), var_0_9, "OS name")
					elseif var_25_7 == "f" then
						var_25_4 = true
					else
						var_0_3()
					end
	...
	if var_25_4 then
		...
		var_0_23(var_25_5, var_25_0[1], var_25_0[2])
	elseif var_25_2 then
		if #var_25_0 == 0 or #var_25_0 > 2 then
			var_0_3()
		end

		var_0_21(var_25_0[1], var_25_0[2] or "-", var_25_3)
	else
		if #var_25_0 ~= 2 then
			var_0_3()
		end

		var_0_22(var_25_5, var_25_0[1], var_25_0[2])
	end
end
