...
slot0 = class("SeasonSpecialMarketView", BaseView)
...
function slot0.onInitView(slot0)
	...
	slot0._simagebg2 = gohelper.findChildSingleImage(slot0.viewGO, "#go_info/bg/#simage_bg2")
	...
	slot0._btnstart = gohelper.findChildButtonWithAudio(slot0.viewGO, "#go_info/left/#btn_start")
	...
	slot0._gounlock = gohelper.findChild(slot0.viewGO, "#go_info/left/layout/root/mask/#scroll_rewards/Viewport/Content/#go_unlock")
	slot0._gounlocktype1 = gohelper.findChild(slot0.viewGO, "#go_info/left/layout/root/mask/#scroll_rewards/Viewport/Content/#go_unlock/#go_unlocktype1")
	slot0._gounlocktype2 = gohelper.findChild(slot0.viewGO, "#go_info/left/layout/root/mask/#scroll_rewards/Viewport/Content/#go_unlock/#go_unlocktype2")
	slot0._gounlocktype3 = gohelper.findChild(slot0.viewGO, "#go_info/left/layout/root/mask/#scroll_rewards/Viewport/Content/#go_unlock/#go_unlocktype3")
...
function slot0._editableInitView(slot0)
	...
	slot0._simagebg2:LoadImage(ResUrl.getSeasonIcon("full/img_bg3.png"))
...
function slot0._refreshLevel(slot0)
	for slot5 = 1, Activity104Model.instance:getMaxSpecialLayer() do
		if not slot0._showLvItems[slot5] then
			slot0._showLvItems[slot5] = SeasonSpecialMarketShowLevelItem.New()
	...
	slot0._simageleveldecorate:LoadImage(ResUrl.getSeasonMarketIcon(SeasonConfig.instance:getSeasonSpecialCo(ActivityEnum.Activity.Season, slot0._layer).icon))
end

function slot0._refreshInfo(slot0)
	slot1 = SeasonConfig.instance:getSeasonSpecialCo(ActivityEnum.Activity.Season, slot0._layer)
	...
	slot0._simagedecorate2:LoadImage(ResUrl.getSeasonMarketIcon(slot1.icon))
