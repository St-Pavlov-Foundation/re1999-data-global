...
function slot0.updateItem(slot0, slot1, slot2)
	...
	slot1.txtEffectDesc.text = SkillConfig.instance:fmtTagDescColor(luaLang("dungeon_add_rule_target_" .. slot4), string.gsub(slot3.desc, "%【(.-)%】", "<color=#6680bd>[%1]</color>") .. ("\n" .. HeroSkillModel.instance:getEffectTagDescFromDescRecursion(slot3.desc, slot5[1])), slot5[slot4])
