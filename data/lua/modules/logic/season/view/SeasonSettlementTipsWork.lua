-- chunkname: @modules/logic/season/view/SeasonSettlementTipsWork.lua

module("modules.logic.season.view.SeasonSettlementTipsWork", package.seeall)

local SeasonSettlementTipsWork = class("SeasonSettlementTipsWork", BaseWork)

function SeasonSettlementTipsWork:onStart(context)
...
function SeasonSettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function SeasonSettlementTipsWork:_onCloseViewFinish(viewName)
...
function SeasonSettlementTipsWork:_showGetCardView()
...
function SeasonSettlementTipsWork:_showChoiceCardView()
...
function SeasonSettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return SeasonSettlementTipsWork
