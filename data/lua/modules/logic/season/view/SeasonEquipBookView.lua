...
local var_0_0 = class("SeasonEquipBookView", BaseView)
...
function var_0_0.checkCreateIcon(arg_16_0)
	if not arg_16_0._icon then
		...
		arg_16_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_16_0, SeasonCelebrityCardEquip)
	end
end
