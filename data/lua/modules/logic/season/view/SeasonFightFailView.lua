-- chunkname: @modules/logic/season/view/SeasonFightFailView.lua

module("modules.logic.season.view.SeasonFightFailView", package.seeall)

local SeasonFightFailView = class("SeasonFightFailView", FightFailView)

function SeasonFightFailView:onInitView()
...
function SeasonFightFailView:onOpen()
...
function SeasonFightFailView:refreshTips()
...
function SeasonFightFailView:onClose()
	SeasonFightFailView.super.onClose(self)
end

function SeasonFightFailView:onDestroyView()
	SeasonFightFailView.super.onDestroyView(self)
end

return SeasonFightFailView
