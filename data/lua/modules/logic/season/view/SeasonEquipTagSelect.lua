...
local var_0_0 = class("SeasonEquipTagSelect", BaseView)
...
function var_0_0.refreshSelected(arg_11_0)
	...
	local var_11_1
	local var_11_2 = var_11_0 == Activity104EquipTagModel.NoTagId and "#cac8c5" or "#c66030"

	arg_11_0._txtlabel.color = GameUtil.parseColor(var_11_2)

	SLFramework.UGUI.GuiHelper.SetColor(arg_11_0._imagearrow, var_11_2)
end
