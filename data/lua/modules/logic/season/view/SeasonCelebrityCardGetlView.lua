...
slot0 = class("SeasonCelebrityCardGetlView", BaseViewExtended)
slot0.OpenType = {
	Get = 1
}
...
function slot0._showGetCard(slot0)
	slot0:com_loadAsset("ui/viewres/season/seasoncelebritycarditem.prefab", slot0._onCardItemLoaded)
end
...
function slot0._onCardItemLoaded(slot0, slot1)
	...
	slot0._scroll_view:setClass(SeasonCelebrityCardGetScrollItem)
