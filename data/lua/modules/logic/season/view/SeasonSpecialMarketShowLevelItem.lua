-- chunkname: @modules/logic/season/view/SeasonSpecialMarketShowLevelItem.lua

module("modules.logic.season.view.SeasonSpecialMarketShowLevelItem", package.seeall)

local SeasonSpecialMarketShowLevelItem = class("SeasonSpecialMarketShowLevelItem", LuaCompBase)

function SeasonSpecialMarketShowLevelItem:init(go)
	self.go = go
...
function SeasonSpecialMarketShowLevelItem:_btnOnClick()
	Activity104Controller.instance:dispatchEvent(Activity104Event.SwitchSpecialEpisode, self.index)
end

function SeasonSpecialMarketShowLevelItem:reset(index, targetIndex, maxSpecialLayer)
	self.index = index
...
function SeasonSpecialMarketShowLevelItem:_refreshItem()
...
function SeasonSpecialMarketShowLevelItem:destroy()
	self._btnClick:RemoveClickListener()
end

return SeasonSpecialMarketShowLevelItem
