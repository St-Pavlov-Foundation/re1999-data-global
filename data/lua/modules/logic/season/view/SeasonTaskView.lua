...
slot0 = class("SeasonTaskView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage(ResUrl.getSeasonIcon("full/bg3.png"))
...
function slot0.getItem(slot0, slot1)
	...
	slot4 = SeasonTaskItem.New(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._goContent, "item" .. slot1))
