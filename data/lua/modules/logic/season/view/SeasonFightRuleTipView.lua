-- chunkname: @modules/logic/season/view/SeasonFightRuleTipView.lua

module("modules.logic.season.view.SeasonFightRuleTipView", package.seeall)

local SeasonFightRuleTipView = class("SeasonFightRuleTipView", BaseView)

function SeasonFightRuleTipView:onInitView()
...
function SeasonFightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function SeasonFightRuleTipView:_closeView()
	self:closeThis()
end

function SeasonFightRuleTipView:onOpen()
...
function SeasonFightRuleTipView:createTab(go, tabType)
...
function SeasonFightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function SeasonFightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function SeasonFightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function SeasonFightRuleTipView:switchTab(type)
...
function SeasonFightRuleTipView:getTabActive(tabType)
...
function SeasonFightRuleTipView:onClose()
	return
end

function SeasonFightRuleTipView:onDestroyView()
