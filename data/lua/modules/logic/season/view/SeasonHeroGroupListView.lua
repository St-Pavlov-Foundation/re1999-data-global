...
slot0 = class("SeasonHeroGroupListView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	for slot6 = 1, 4 do
		...
		table.insert(slot0._heroItemList, MonoHelper.addNoUpdateLuaComOnceToGo(slot9, SeasonHeroGroupHeroItem, slot0))
...
function slot0._updateHeroList(slot0)
	for slot4, slot5 in ipairs(slot0._heroItemList) do
		...
		slot7.id = slot4
		slot7.heroUid = HeroGroupModel.instance:getCurGroupMO().heroList[slot4]
