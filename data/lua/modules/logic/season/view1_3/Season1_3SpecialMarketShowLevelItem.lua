-- chunkname: @modules/logic/season/view1_3/Season1_3SpecialMarketShowLevelItem.lua

module("modules.logic.season.view1_3.Season1_3SpecialMarketShowLevelItem", package.seeall)

local Season1_3SpecialMarketShowLevelItem = class("Season1_3SpecialMarketShowLevelItem", LuaCompBase)

function Season1_3SpecialMarketShowLevelItem:init(go)
	self.go = go
...
function Season1_3SpecialMarketShowLevelItem:_btnOnClick()
	Activity104Controller.instance:dispatchEvent(Activity104Event.SwitchSpecialEpisode, self.index)
end

function Season1_3SpecialMarketShowLevelItem:reset(index, targetIndex, maxSpecialLayer)
	self.index = index
...
function Season1_3SpecialMarketShowLevelItem:_refreshItem()
...
function Season1_3SpecialMarketShowLevelItem:destroy()
	self._btnClick:RemoveClickListener()
end

return Season1_3SpecialMarketShowLevelItem
