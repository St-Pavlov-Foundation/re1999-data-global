-- chunkname: @modules/logic/season/view1_3/Season1_3CelebrityCardItem.lua

module("modules.logic.season.view1_3.Season1_3CelebrityCardItem", package.seeall)

local Season1_3CelebrityCardItem = class("Season1_3CelebrityCardItem", LuaCompBase)

Season1_3CelebrityCardItem.AssetPath = "ui/viewres/v1a2_season/seasoncelebritycarditem.prefab"

function Season1_3CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season1_3CelebrityCardItem.AssetPath
...
function Season1_3CelebrityCardItem:_cardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season1_3CelebrityCardEquip)
...
function Season1_3CelebrityCardItem:showTag(enable)
...
function Season1_3CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season1_3CelebrityCardItem:showNewFlag(enable)
...
function Season1_3CelebrityCardItem:showNewFlag2(enable)
...
function Season1_3CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season1_3CelebrityCardItem:setColorDark(enable)
...
function Season1_3CelebrityCardItem:destroy()
	if self._icon then
...
return Season1_3CelebrityCardItem
