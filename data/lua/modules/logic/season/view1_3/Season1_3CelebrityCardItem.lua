...
local var_0_0 = class("Season1_3CelebrityCardItem", LuaCompBase)

var_0_0.AssetPath = "ui/viewres/v1a2_season/seasoncelebritycarditem.prefab"
...
function var_0_0._cardLoaded(arg_2_0)
	...
	arg_2_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(arg_2_0._cardGo, Season1_3CelebrityCardEquip)
