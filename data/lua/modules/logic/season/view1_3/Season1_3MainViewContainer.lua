...
slot0 = class("Season1_3MainViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}
	slot0.scene = Season1_3MainScene.New()
	slot0.view = Season1_3MainView.New()
...
function slot0.buildTabViews(slot0, slot1)
	...
	slot0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season1_3MainViewHelp)
