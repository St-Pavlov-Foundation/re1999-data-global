...
function var_0_0._btndiscountlockOnClick(arg_7_0)
	if string.nilorempty(arg_7_0._discountLockTipsStr) == false then
		ToastController.instance:showToastWithString(arg_7_0._discountLockTipsStr)
	end
end
...
function var_0_0._refreshMain(arg_22_0)
	...
	if not var_22_1 then
		if var_22_7 then
			...
			arg_22_0._discountLockTipsStr = arg_22_0._txtdiscountunlock.text
		else
