...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._goTarget = gohelper.findChild(var_1_0, "targetcontain")
	arg_1_0._gonormalcondition = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_normalcondition")
	arg_1_0._txtnormalcondition = gohelper.findChildText(var_1_0, "targetcontain/targetList/#go_normalcondition/#txt_normalcondition")
	arg_1_0._gonormalfinish = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_normalcondition/#go_normalfinish")
	arg_1_0._gonormalunfinish = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_normalcondition/#go_normalunfinish")
	arg_1_0._goplatinumcondition = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition")
	arg_1_0._txtplatinumcondition = gohelper.findChildText(var_1_0, "targetcontain/targetList/#go_platinumcondition/#txt_platinumcondition")
	arg_1_0._goplatinumfinish = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition/#go_platinumfinish")
	arg_1_0._goplatinumunfinish = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition/#go_platinumunfinish")
	arg_1_0._goplatinumcondition2 = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition2")
	arg_1_0._txtplatinumcondition2 = gohelper.findChildText(var_1_0, "targetcontain/targetList/#go_platinumcondition2/#txt_platinumcondition")
	arg_1_0._goplatinumfinish2 = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition2/#go_platinumfinish")
	arg_1_0._goplatinumunfinish2 = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_platinumcondition2/#go_platinumunfinish")
	arg_1_0._gotargetlist = gohelper.findChild(var_1_0, "targetcontain/targetList")
	arg_1_0._goplace = gohelper.findChild(var_1_0, "targetcontain/targetList/#go_place")
	arg_1_0._gostar3 = gohelper.findChild(var_1_0, "targetcontain/text/starcontainer/#go_star3")
	arg_1_0._gostar2 = gohelper.findChild(var_1_0, "targetcontain/text/starcontainer/#go_star2")
