...
function slot0.onInitView(slot0)
	...
	slot0._goTarget = gohelper.findChild(slot1, "targetcontain")
	slot0._gonormalcondition = gohelper.findChild(slot1, "targetcontain/targetList/#go_normalcondition")
	slot0._txtnormalcondition = gohelper.findChildText(slot1, "targetcontain/targetList/#go_normalcondition/#txt_normalcondition")
	slot0._gonormalfinish = gohelper.findChild(slot1, "targetcontain/targetList/#go_normalcondition/#go_normalfinish")
	slot0._gonormalunfinish = gohelper.findChild(slot1, "targetcontain/targetList/#go_normalcondition/#go_normalunfinish")
	slot0._goplatinumcondition = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition")
	slot0._txtplatinumcondition = gohelper.findChildText(slot1, "targetcontain/targetList/#go_platinumcondition/#txt_platinumcondition")
	slot0._goplatinumfinish = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition/#go_platinumfinish")
	slot0._goplatinumunfinish = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition/#go_platinumunfinish")
	slot0._goplatinumcondition2 = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition2")
	slot0._txtplatinumcondition2 = gohelper.findChildText(slot1, "targetcontain/targetList/#go_platinumcondition2/#txt_platinumcondition")
	slot0._goplatinumfinish2 = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition2/#go_platinumfinish")
	slot0._goplatinumunfinish2 = gohelper.findChild(slot1, "targetcontain/targetList/#go_platinumcondition2/#go_platinumunfinish")
	slot0._gotargetlist = gohelper.findChild(slot1, "targetcontain/targetList")
	slot0._goplace = gohelper.findChild(slot1, "targetcontain/targetList/#go_place")
	slot0._gostar3 = gohelper.findChild(slot1, "targetcontain/text/starcontainer/#go_star3")
	slot0._gostar2 = gohelper.findChild(slot1, "targetcontain/text/starcontainer/#go_star2")
