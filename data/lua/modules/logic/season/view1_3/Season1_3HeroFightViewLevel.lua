...
function Season1_3HeroFightViewLevel:onInitView()
	...
	self._goTarget = gohelper.findChild(_content, "targetcontain")
	self._gonormalcondition = gohelper.findChild(_content, "targetcontain/targetList/#go_normalcondition")
	self._txtnormalcondition = gohelper.findChildText(_content, "targetcontain/targetList/#go_normalcondition/#txt_normalcondition")
	self._gonormalfinish = gohelper.findChild(_content, "targetcontain/targetList/#go_normalcondition/#go_normalfinish")
	self._gonormalunfinish = gohelper.findChild(_content, "targetcontain/targetList/#go_normalcondition/#go_normalunfinish")
	self._goplatinumcondition = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition")
	self._txtplatinumcondition = gohelper.findChildText(_content, "targetcontain/targetList/#go_platinumcondition/#txt_platinumcondition")
	self._goplatinumfinish = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition/#go_platinumfinish")
	self._goplatinumunfinish = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition/#go_platinumunfinish")
	self._goplatinumcondition2 = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition2")
	self._txtplatinumcondition2 = gohelper.findChildText(_content, "targetcontain/targetList/#go_platinumcondition2/#txt_platinumcondition")
	self._goplatinumfinish2 = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition2/#go_platinumfinish")
	self._goplatinumunfinish2 = gohelper.findChild(_content, "targetcontain/targetList/#go_platinumcondition2/#go_platinumunfinish")
	self._gotargetlist = gohelper.findChild(_content, "targetcontain/targetList")
	self._goplace = gohelper.findChild(_content, "targetcontain/targetList/#go_place")
	self._gostar3 = gohelper.findChild(_content, "targetcontain/text/starcontainer/#go_star3")
	self._gostar2 = gohelper.findChild(_content, "targetcontain/text/starcontainer/#go_star2")
