...
slot0 = class("Season1_3HeroGroupFightView", BaseView)
slot1 = 1
...
function slot0._initData(slot0)
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_3HeroGroupFightView, slot0._onEscapeBtnClick, slot0)
...
function slot0._refreshMainCard(slot0)
	...
	if HeroGroupModel.instance:getCurGroupMO() then
		if slot1.isReplay and slot1.replay_activity104Equip_data and slot1.replay_activity104Equip_data["-100000"] and slot6[slot4] then
			slot5 = slot6[slot4].equipId
		end
	...
	if slot5 ~= 0 then
		if not slot0._superCardItem then
			slot0._superCardItem = Season1_3CelebrityCardItem.New()
...
function slot0._refreshUI(slot0)
	...
	slot0:_refreshCloth()
	slot0:_refreshMainCard()
	slot0.viewContainer:setNavigateOverrideClose(slot0.openSeason1_3MainView, slot0)
end
