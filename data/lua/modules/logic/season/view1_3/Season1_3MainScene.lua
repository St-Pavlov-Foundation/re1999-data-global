...
slot0 = class("Season1_3MainScene", BaseView)
...
function slot0._initSceneRootNode(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New("Season1_3MainScene")
...
function slot0._loadSceneFinish(slot0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_3MainView, slot0.autoInitMainViewCamera, slot0.resetCamera, slot0)
end
...
function slot0.showLevelObjs(slot0, slot1)
	...
	if ViewMgr.instance:getContainer(ViewName.Season1_3MainView) then
		slot5:stopUI(false)
	end
end
...
function slot0.focusRole(slot0, slot1)
	...
	slot0._tweenSizeId = ZProj.TweenHelper.DOTweenFloat(slot0.seasonCameraOrthographicSize, slot0.focusCameraOrthographicSize, slot3, slot0._onSizeUpdate, nil, slot0, nil, EaseType.OutCubic)
