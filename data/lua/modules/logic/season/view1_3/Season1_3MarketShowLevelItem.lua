-- chunkname: @modules/logic/season/view1_3/Season1_3MarketShowLevelItem.lua

module("modules.logic.season.view1_3.Season1_3MarketShowLevelItem", package.seeall)

local Season1_3MarketShowLevelItem = class("Season1_3MarketShowLevelItem", LuaCompBase)

function Season1_3MarketShowLevelItem:init(go, index, targetIndex, maxIndex)
	self.go = go
	self.index = index
...
function Season1_3MarketShowLevelItem:show()
...
function Season1_3MarketShowLevelItem:destroy()
	return
end

return Season1_3MarketShowLevelItem
