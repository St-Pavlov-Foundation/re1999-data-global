...
local var_0_0 = class("Season1_3TaskItem", UserDataDispose)

var_0_0.BlockKey = "Season1_3TaskItemAni"
...
function var_0_0.refreshRewardItem(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_2.equipId then
		...
		if not arg_11_1.equipIcon then
			arg_11_1.equipIcon = Season1_3CelebrityCardItem.New()
...
function var_0_0.onClickGoto(arg_16_0)
	...
	GameFacade.jump(arg_16_0.jumpId)
end
