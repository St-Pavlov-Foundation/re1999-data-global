-- chunkname: @modules/logic/season/view1_3/Season1_3EquipBookItem.lua

module("modules.logic.season.view1_3.Season1_3EquipBookItem", package.seeall)

local Season1_3EquipBookItem = class("Season1_3EquipBookItem", ListScrollCellExtend)

function Season1_3EquipBookItem:init(go)
	Season1_3EquipBookItem.super.init(self, go)
...
function Season1_3EquipBookItem:onUpdateMO(mo)
	self._mo = mo
...
Season1_3EquipBookItem.ColumnCount = 6
Season1_3EquipBookItem.AnimRowCount = 4
Season1_3EquipBookItem.OpenAnimTime = 0.06
Season1_3EquipBookItem.OpenAnimStartTime = 0.05

function Season1_3EquipBookItem:refreshUI()
...
function Season1_3EquipBookItem:checkPlayAnim()
...
function Season1_3EquipBookItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_3EquipBookItem:checkCreateIcon()
...
function Season1_3EquipBookItem:onClickSelf()
	if self._mo then
		Activity104EquipBookController.instance:changeSelect(self._mo.id)
	end
end

function Season1_3EquipBookItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
