...
local var_0_0 = class("Season1_3HeroGroupHeroItem", LuaCompBase)

function var_0_0.ctor(arg_1_0, arg_1_1)
	arg_1_0._Season1_3HeroGroupListView = arg_1_1
end
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	arg_2_0._cardItem1 = Season1_3HeroGroupCardItem.New(arg_2_0._gocarditem1, arg_2_0, {
		slot = 1
	})
	arg_2_0._gocarditem2 = gohelper.findChild(arg_2_1, "heroitemani/equipcard/cardlist/carditem2")
	arg_2_0._cardItem2 = Season1_3HeroGroupCardItem.New(arg_2_0._gocarditem2, arg_2_0, {
		slot = 2
	})
...
function var_0_0._onClickEquip(arg_11_0)
	...
	if OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Equip) or arg_11_0.trialCO then
		...
		if arg_11_0.trialCO then
			var_11_0.heroMo = HeroGroupTrialModel.instance:getHeroMo(arg_11_0.trialCO.heroId)
...
function var_0_0._updateAct104Equips(arg_13_0)
	...
	local var_13_1 = var_13_0:getAct104PosEquips(arg_13_0.mo.id - 1).equipUid or {}
	local var_13_2 = not var_13_0.isReplay and var_13_1[1]
	local var_13_3 = not var_13_0.isReplay and var_13_1[2]
	local var_13_4 = Activity104Model.instance:getItemIdByUid(var_13_1[1])
	local var_13_5 = Activity104Model.instance:getItemIdByUid(var_13_1[2])

	if var_13_0.isReplay then
		local var_13_6 = var_13_0.replay_activity104Equip_data[arg_13_0.mo.heroUid]

		var_13_4 = var_13_6 and var_13_6[1] and var_13_6[1].equipId or 0
		var_13_5 = var_13_6 and var_13_6[2] and var_13_6[2].equipId or 0
	end

	arg_13_0._cardItem1:setData(arg_13_0.mo, var_13_4, var_13_2)
	arg_13_0._cardItem2:setData(arg_13_0.mo, var_13_5, var_13_3)

	arg_13_0._hasUseSeasonEquipCard = arg_13_0._cardItem1:hasUseSeasonEquipCard() or arg_13_0._cardItem2:hasUseSeasonEquipCard()

	local var_13_7 = not arg_13_0.isAid and (arg_13_0._cardItem1.slotUnlock or arg_13_0._cardItem2.slotUnlock)
	local var_13_8 = var_13_7 and var_0_0.NonCardSlotBlackMaskHeight or var_0_0.HasCardSlotBlackMashHeight

	recthelper.setHeight(arg_13_0._goblackmask.transform, var_13_8)
	gohelper.setActive(arg_13_0._gocardlist, var_13_7)
	arg_13_0._cardItem1:setActive(var_13_7)
	arg_13_0._cardItem2:setActive(var_13_7)

	local var_13_9 = arg_13_0._cardItem1.slotUnlock and arg_13_0._cardItem2.slotUnlock and var_0_0.TwoSlotCardItem1Pos or var_0_0.SingleSlotCardItem1Pos

	recthelper.setAnchor(arg_13_0._cardItem1.transform, var_13_9.x, var_13_9.y)
end
...
function var_0_0._moveToTarget(arg_27_0, arg_27_1)
	for iter_27_0, iter_27_1 in ipairs(arg_27_0._Season1_3HeroGroupListView.heroPosTrList) do
		if arg_27_0._Season1_3HeroGroupListView._heroItemList[iter_27_0] ~= arg_27_0 then
			...
			if math.abs(var_27_1.x) * 2 < recthelper.getWidth(var_27_0) and math.abs(var_27_1.y) * 2 < recthelper.getHeight(var_27_0) then
				return arg_27_0._Season1_3HeroGroupListView._heroItemList[iter_27_0]
			end
		end
	end
...
function var_0_0._setEquipDragEnabled(arg_28_0, arg_28_1)
	for iter_28_0, iter_28_1 in ipairs(arg_28_0._Season1_3HeroGroupListView._heroItemList) do
...
function var_0_0.getHeroItemList(arg_41_0)
	return arg_41_0._Season1_3HeroGroupListView:getHeroItemList()
end
