...
local var_0_0 = class("Season1_3MarketView", BaseView)
...
function var_0_0._setLevels(arg_17_0)
	...
	if arg_17_0._layer <= 4 then
		for iter_17_0 = 1, 6 do
			...
			arg_17_0._showLvItems[iter_17_0] = Season1_3MarketShowLevelItem.New()
	...
	elseif arg_17_0._layer >= var_17_1 - 3 then
		for iter_17_1 = var_17_1 - 5, var_17_1 do
			...
			arg_17_0._showLvItems[iter_17_1] = Season1_3MarketShowLevelItem.New()
		...
		for iter_17_2 = arg_17_0._layer - 4, arg_17_0._layer + 4 do
			...
			arg_17_0._showLvItems[iter_17_2] = Season1_3MarketShowLevelItem.New()
...
function var_0_0._setStages(arg_19_0)
	...
	arg_19_0._simagedecorate:LoadImage(ResUrl.getV1A3SeasonIcon(string.format("icon/b_chatu_%s.png", var_19_0.stagePicture)))
end
...
function var_0_0._setInfo(arg_21_0)
	...
	arg_21_0._simagestageicon:LoadImage(ResUrl.getV1A3SeasonIcon(string.format("icon/a_chatu_%s.png", var_21_0.stagePicture)))
...
function var_0_0.refreshEquipCardItem(arg_22_0)
	...
	if var_22_0.firstPassEquipId > 0 then
		...
		if not arg_22_0._rewardItems[1].itemIcon then
			arg_22_0._rewardItems[1].itemIcon = Season1_3CelebrityCardItem.New()
