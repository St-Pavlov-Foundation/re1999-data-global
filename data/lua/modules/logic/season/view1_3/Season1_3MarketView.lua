...
function Season1_3MarketView:_setInfo()
	...
	local targetStageTagPos = isNewStage and Season1_3MarketView.NewStageTagPos or Season1_3MarketView.NomalStageTagPos
...
function Season1_3MarketView:_showPartStageItem(stage)
	if stage < 7 then
		...
		for i = 1, 6 do
			...
			self._partStageItems[i].canvasgroup.alpha = i <= stage and Season1_3MarketView.UnLockStageItemAlpha or Season1_3MarketView.LockStageItemAlpha
		end
	else
		for i = 1, 7 do
			if not self._partStageItems[i] then
