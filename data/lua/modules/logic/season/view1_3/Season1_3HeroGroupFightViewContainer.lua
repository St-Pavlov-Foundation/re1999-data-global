...
local var_0_0 = class("Season1_3HeroGroupFightViewContainer", BaseViewContainer)
...
function var_0_0.getSeason1_3HeroGroupFightView(arg_2_0)
...
function var_0_0.buildTabViews(arg_3_0, arg_3_1)
	if arg_3_1 == 1 then
		arg_3_0._navigateButtonsView = NavigateButtonsView.New({
			...
			true,
			true
		}, HelpEnum.HelpId.Season1_3HerogroupHelp, arg_3_0._closeCallback, nil, nil, arg_3_0)
