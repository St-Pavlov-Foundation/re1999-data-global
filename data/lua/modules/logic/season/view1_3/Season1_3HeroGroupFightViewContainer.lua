...
slot0 = class("Season1_3HeroGroupFightViewContainer", BaseViewContainer)
...
function slot0.getSeason1_3HeroGroupFightView(slot0)
...
function slot0.buildTabViews(slot0, slot1)
	if slot1 == 1 then
		slot0._navigateButtonsView = NavigateButtonsView.New({
			...
			true,
			true
		}, HelpEnum.HelpId.Season1_3HerogroupHelp, slot0._closeCallback, nil, , slot0)
