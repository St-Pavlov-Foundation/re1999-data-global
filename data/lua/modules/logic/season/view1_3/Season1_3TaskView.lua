...
slot0 = class("Season1_3TaskView", BaseView)
...
function slot0.getItem(slot0, slot1)
	...
	slot4 = Season1_3TaskItem.New(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._goContent, "item" .. slot1), slot0._goScroll)
