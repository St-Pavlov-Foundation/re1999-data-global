...
slot0 = class("Season1_3CelebrityCardGetlView", BaseViewExtended)
slot0.OpenType = {
	Get = 1
}
...
function slot0._showGetCard(slot0)
	slot0:com_loadAsset(Season1_3CelebrityCardItem.AssetPath, slot0._onCardItemLoaded)
end
...
function slot0._onCardItemLoaded(slot0, slot1)
	...
	slot0._scroll_view:setClass(Season1_3CelebrityCardGetScrollItem)
