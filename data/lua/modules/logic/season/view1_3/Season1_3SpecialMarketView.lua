...
local var_0_0 = class("Season1_3SpecialMarketView", BaseView)
...
function var_0_0._refreshLevel(arg_15_0)
	...
	for iter_15_0 = 1, var_15_0 do
		if not arg_15_0._showLvItems[iter_15_0] then
			...
			arg_15_0._showLvItems[iter_15_0] = Season1_3SpecialMarketShowLevelItem.New()
	...
	arg_15_0._simageleveldecorate:LoadImage(ResUrl.getV1A3SeasonIcon(string.format("icon/ty_chatu_%s.png", var_15_2.icon)))
end
...
function var_0_0._refreshInfo(arg_16_0)
	...
	arg_16_0._simagestageicon:LoadImage(ResUrl.getV1A3SeasonIcon(string.format("icon/a_chatu_%s.png", var_16_0.icon)))
