-- chunkname: @modules/logic/season/view1_3/Season1_3CelebrityCardGetItem.lua

module("modules.logic.season.view1_3.Season1_3CelebrityCardGetItem", package.seeall)

local Season1_3CelebrityCardGetItem = class("Season1_3CelebrityCardGetItem", BaseViewExtended)

function Season1_3CelebrityCardGetItem:onInitView()
...
function Season1_3CelebrityCardGetItem:addEvents()
	return
end

function Season1_3CelebrityCardGetItem:removeEvents()
	return
end

function Season1_3CelebrityCardGetItem:onRefreshViewParam(uid, noClick, equipId)
	self._uid = uid
	self._noClick = noClick
	self._equipId = equipId
end

function Season1_3CelebrityCardGetItem:onOpen()
	self:refreshData(self._uid)
end

function Season1_3CelebrityCardGetItem:refreshData(uid)
...
function Season1_3CelebrityCardGetItem:_checkCreateIcon()
	if not self._icon then
		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self.viewGO, Season1_3CelebrityCardEquip)
...
function Season1_3CelebrityCardGetItem:onBtnClick()
	if self._noClick then
		return
	end
...
function Season1_3CelebrityCardGetItem:_getItemID(uid)
	local item_id
...
function Season1_3CelebrityCardGetItem:onClose()
	return
end

function Season1_3CelebrityCardGetItem:onDestroyView()
	if self._icon then
...
return Season1_3CelebrityCardGetItem
