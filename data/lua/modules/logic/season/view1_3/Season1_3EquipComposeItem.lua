-- chunkname: @modules/logic/season/view1_3/Season1_3EquipComposeItem.lua

module("modules.logic.season.view1_3.Season1_3EquipComposeItem", package.seeall)

local Season1_3EquipComposeItem = class("Season1_3EquipComposeItem", ListScrollCellExtend)

function Season1_3EquipComposeItem:init(go)
	Season1_3EquipComposeItem.super.init(self, go)
...
function Season1_3EquipComposeItem:onUpdateMO(mo)
...
function Season1_3EquipComposeItem:refreshUI()
...
function Season1_3EquipComposeItem:setRoleIconDark(value)
	if value then
...
function Season1_3EquipComposeItem:refreshEquipedHero(heroUid)
...
Season1_3EquipComposeItem.ColumnCount = 6
Season1_3EquipComposeItem.AnimRowCount = 4
Season1_3EquipComposeItem.OpenAnimTime = 0.06
Season1_3EquipComposeItem.OpenAnimStartTime = 0.05

function Season1_3EquipComposeItem:checkPlayAnim()
...
function Season1_3EquipComposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_3EquipComposeItem:checkCreateIcon()
...
function Season1_3EquipComposeItem:onClickSelf()
	if self._mo then
		Activity104EquipComposeController.instance:changeSelectCard(self._mo.uid)
	end
end

function Season1_3EquipComposeItem:onLongPress()
	local data = {
...
function Season1_3EquipComposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season1_3EquipComposeItem
