-- chunkname: @modules/logic/season/view1_3/Season1_3FightFailView.lua

module("modules.logic.season.view1_3.Season1_3FightFailView", package.seeall)

local Season1_3FightFailView = class("Season1_3FightFailView", FightFailView)

function Season1_3FightFailView:onInitView()
...
function Season1_3FightFailView:onOpen()
...
function Season1_3FightFailView:refreshTips()
...
function Season1_3FightFailView:onClose()
	Season1_3FightFailView.super.onClose(self)
end

function Season1_3FightFailView:onDestroyView()
	Season1_3FightFailView.super.onDestroyView(self)
end

return Season1_3FightFailView
