-- chunkname: @modules/logic/season/view1_3/Season1_3FightRuleTipView.lua

module("modules.logic.season.view1_3.Season1_3FightRuleTipView", package.seeall)

local Season1_3FightRuleTipView = class("Season1_3FightRuleTipView", BaseView)

function Season1_3FightRuleTipView:onInitView()
...
function Season1_3FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season1_3FightRuleTipView:_closeView()
	self:closeThis()
end

function Season1_3FightRuleTipView:onOpen()
	self._ruleList = Season1_3FightRuleView.getRuleList()
...
function Season1_3FightRuleTipView:createTab(go, tabType)
...
function Season1_3FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season1_3FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season1_3FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season1_3FightRuleTipView:switchTab(type)
...
function Season1_3FightRuleTipView:getTabActive(tabType)
...
function Season1_3FightRuleTipView:onClose()
	return
end

function Season1_3FightRuleTipView:onDestroyView()
...
return Season1_3FightRuleTipView
