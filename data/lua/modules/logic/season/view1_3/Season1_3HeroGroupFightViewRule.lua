...
function var_0_0.onInitView(arg_1_0)
	local var_1_0 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/content")

	arg_1_0._gorules = gohelper.findChild(var_1_0, "#go_rules")
	arg_1_0._goimagenormal = gohelper.findChild(var_1_0, "#go_rules/title/text/#image_normalicondition")
	arg_1_0._goimagerare = gohelper.findChild(var_1_0, "#go_rules/title/text/#image_rarecondition")
	arg_1_0._goruleitem = gohelper.findChild(var_1_0, "#go_rules/rulelist/#go_ruleitem")
	arg_1_0._gonormal = gohelper.findChild(var_1_0, "#go_rules/rulelist/#go_ruleitem/image_normal")
	arg_1_0._gorare = gohelper.findChild(var_1_0, "#go_rules/rulelist/#go_ruleitem/image_rare")
	arg_1_0._txtruleinfo = gohelper.findChildText(var_1_0, "#go_rules/rulelist/#go_ruleitem/txt_ruleinfo")
	arg_1_0._goadditionRule = gohelper.findChild(var_1_0, "#go_additionRule")
	arg_1_0._goruletemp = gohelper.findChild(var_1_0, "#go_additionRule/#go_ruletemp")
	arg_1_0._imagetagicon = gohelper.findChildImage(var_1_0, "#go_additionRule/#go_ruletemp/#image_tagicon")
	arg_1_0._gorulelist = gohelper.findChild(var_1_0, "#go_additionRule/#go_rulelist")
	arg_1_0._btnadditionRuleclick = gohelper.findChildButtonWithAudio(var_1_0, "#go_additionRule/#go_rulelist/#btn_additionRuleclick")
	...
	arg_1_0._btnenemy = gohelper.findChildButtonWithAudio(var_1_0, "enemycontain/enemyList/#btn_enemy")
	arg_1_0._enemylist = gohelper.findChildButtonWithAudio(var_1_0, "enemycontain/enemyList/#go_enemyteam/enemyList")
	arg_1_0._txtrecommendlevel = gohelper.findChildText(var_1_0, "enemycontain/recommendtxt/#txt_recommendLevel")
	arg_1_0._goenemyteam = gohelper.findChild(var_1_0, "enemycontain/enemyList/#go_enemyteam")
	arg_1_0._gorecommendattr = gohelper.findChild(var_1_0, "enemycontain/#go_recommendAttr")
	arg_1_0._goattritem = gohelper.findChild(var_1_0, "enemycontain/#go_recommendAttr/attrlist/#go_attritem")
	arg_1_0._txtrecommonddes = gohelper.findChildTextMesh(var_1_0, "enemycontain/#go_recommendAttr/#txt_recommonddes")
	arg_1_0._btnadditionruledetail = gohelper.findChildButtonWithAudio(var_1_0, "#go_additionRule/#go_additionruletips/tips/#btn_additionruledetail")
	arg_1_0._goTask = gohelper.findChild(var_1_0, "#go_task")
	arg_1_0._txtTask = gohelper.findChildText(var_1_0, "#go_task/#go_taskitem/#txt_task")
