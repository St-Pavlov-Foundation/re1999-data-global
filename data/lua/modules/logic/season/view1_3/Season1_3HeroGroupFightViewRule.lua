...
function Season1_3HeroGroupFightViewRule:onInitView()
	local _content = gohelper.findChild(self.viewGO, "#go_container/infocontain/content")

	self._gorules = gohelper.findChild(_content, "#go_rules")
	self._goimagenormal = gohelper.findChild(_content, "#go_rules/title/text/#image_normalicondition")
	self._goimagerare = gohelper.findChild(_content, "#go_rules/title/text/#image_rarecondition")
	self._goruleitem = gohelper.findChild(_content, "#go_rules/rulelist/#go_ruleitem")
	self._gonormal = gohelper.findChild(_content, "#go_rules/rulelist/#go_ruleitem/image_normal")
	self._gorare = gohelper.findChild(_content, "#go_rules/rulelist/#go_ruleitem/image_rare")
	self._txtruleinfo = gohelper.findChildText(_content, "#go_rules/rulelist/#go_ruleitem/txt_ruleinfo")
	self._goadditionRule = gohelper.findChild(_content, "#go_additionRule")
	self._goruletemp = gohelper.findChild(_content, "#go_additionRule/#go_ruletemp")
	self._imagetagicon = gohelper.findChildImage(_content, "#go_additionRule/#go_ruletemp/#image_tagicon")
	self._gorulelist = gohelper.findChild(_content, "#go_additionRule/#go_rulelist")
	self._btnadditionRuleclick = gohelper.findChildButtonWithAudio(_content, "#go_additionRule/#go_rulelist/#btn_additionRuleclick")
	...
	self._btnenemy = gohelper.findChildButtonWithAudio(_content, "enemycontain/enemyList/#btn_enemy")
	self._enemylist = gohelper.findChildButtonWithAudio(_content, "enemycontain/enemyList/#go_enemyteam/enemyList")
	self._txtrecommendlevel = gohelper.findChildText(_content, "enemycontain/recommendtxt/#txt_recommendLevel")
	self._goenemyteam = gohelper.findChild(_content, "enemycontain/enemyList/#go_enemyteam")
	self._gorecommendattr = gohelper.findChild(_content, "enemycontain/#go_recommendAttr")
	self._goattritem = gohelper.findChild(_content, "enemycontain/#go_recommendAttr/attrlist/#go_attritem")
	self._txtrecommonddes = gohelper.findChildTextMesh(_content, "enemycontain/#go_recommendAttr/#txt_recommonddes")
	self._btnadditionruledetail = gohelper.findChildButtonWithAudio(_content, "#go_additionRule/#go_additionruletips/tips/#btn_additionruledetail")
	self._goTask = gohelper.findChild(_content, "#go_task")
	self._txtTask = gohelper.findChildText(_content, "#go_task/#go_taskitem/#txt_task")
