...
function slot0.onInitView(slot0)
	slot1 = gohelper.findChild(slot0.viewGO, "#go_container/infocontain/content")
	slot0._gorules = gohelper.findChild(slot1, "#go_rules")
	slot0._goimagenormal = gohelper.findChild(slot1, "#go_rules/title/text/#image_normalicondition")
	slot0._goimagerare = gohelper.findChild(slot1, "#go_rules/title/text/#image_rarecondition")
	slot0._goruleitem = gohelper.findChild(slot1, "#go_rules/rulelist/#go_ruleitem")
	slot0._gonormal = gohelper.findChild(slot1, "#go_rules/rulelist/#go_ruleitem/image_normal")
	slot0._gorare = gohelper.findChild(slot1, "#go_rules/rulelist/#go_ruleitem/image_rare")
	slot0._txtruleinfo = gohelper.findChildText(slot1, "#go_rules/rulelist/#go_ruleitem/txt_ruleinfo")
	slot0._goadditionRule = gohelper.findChild(slot1, "#go_additionRule")
	slot0._goruletemp = gohelper.findChild(slot1, "#go_additionRule/#go_ruletemp")
	slot0._imagetagicon = gohelper.findChildImage(slot1, "#go_additionRule/#go_ruletemp/#image_tagicon")
	slot0._gorulelist = gohelper.findChild(slot1, "#go_additionRule/#go_rulelist")
	slot0._btnadditionRuleclick = gohelper.findChildButtonWithAudio(slot1, "#go_additionRule/#go_rulelist/#btn_additionRuleclick")
	...
	slot0._btnenemy = gohelper.findChildButtonWithAudio(slot1, "enemycontain/enemyList/#btn_enemy")
	slot0._enemylist = gohelper.findChildButtonWithAudio(slot1, "enemycontain/enemyList/#go_enemyteam/enemyList")
	slot0._txtrecommendlevel = gohelper.findChildText(slot1, "enemycontain/recommendtxt/#txt_recommendLevel")
	slot0._goenemyteam = gohelper.findChild(slot1, "enemycontain/enemyList/#go_enemyteam")
	slot0._gorecommendattr = gohelper.findChild(slot1, "enemycontain/#go_recommendAttr")
	slot0._goattritem = gohelper.findChild(slot1, "enemycontain/#go_recommendAttr/attrlist/#go_attritem")
	slot0._txtrecommonddes = gohelper.findChildTextMesh(slot1, "enemycontain/#go_recommendAttr/#txt_recommonddes")
	slot0._btnadditionruledetail = gohelper.findChildButtonWithAudio(slot1, "#go_additionRule/#go_additionruletips/tips/#btn_additionruledetail")
	slot0._goTask = gohelper.findChild(slot1, "#go_task")
	slot0._txtTask = gohelper.findChildText(slot1, "#go_task/#go_taskitem/#txt_task")
