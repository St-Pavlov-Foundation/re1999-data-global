...
slot0 = class("Season1_3EquipSelfChoiceItem", ListScrollCellExtend)
...
function slot0.checkCreateIcon(slot0)
	if not slot0.icon then
		slot0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._view:getResInst(slot0._view.viewContainer:getSetting().otherRes[2], slot0._gocard, "icon"), Season1_3CelebrityCardEquip)
