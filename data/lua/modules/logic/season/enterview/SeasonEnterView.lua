...
local var_0_0 = class("SeasonEnterView", VersionActivityEnterBaseSubView)
...
function var_0_0.refreshEnterBtn(arg_9_0)
	...
	local var_9_3 = Activity104Enum.SeasonStore[arg_9_0.actId]
	local var_9_4 = ActivityHelper.getActivityStatus(var_9_3)

	gohelper.setActive(arg_9_0._goStore, var_9_4 == ActivityEnum.ActivityStatus.Normal)
end
