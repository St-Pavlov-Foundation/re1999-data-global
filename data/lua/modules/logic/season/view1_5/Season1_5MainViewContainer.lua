...
slot0 = class("Season1_5MainViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}
	slot0.scene = Season1_5MainScene.New()
	slot0.view = Season1_5MainView.New()
...
function slot0.buildTabViews(slot0, slot1)
	...
	slot0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season1_5MainViewHelp)
