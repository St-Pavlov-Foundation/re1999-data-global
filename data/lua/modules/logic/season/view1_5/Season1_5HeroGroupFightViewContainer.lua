-- chunkname: @modules/logic/season/view1_5/Season1_5HeroGroupFightViewContainer.lua

module("modules.logic.season.view1_5.Season1_5HeroGroupFightViewContainer", package.seeall)

local Season1_5HeroGroupFightViewContainer = class("Season1_5HeroGroupFightViewContainer", BaseViewContainer)

function Season1_5HeroGroupFightViewContainer:buildViews()
	return {
...
function Season1_5HeroGroupFightViewContainer:getSeason1_5HeroGroupFightView()
	return self._views[1]
end

function Season1_5HeroGroupFightViewContainer:buildTabViews(tabContainerId)
	if tabContainerId == 1 then
		self._navigateButtonsView = NavigateButtonsView.New({
			true,
			true,
			true
		}, HelpEnum.HelpId.Season1_5HerogroupHelp, self._closeCallback, nil, nil, self)
...
function Season1_5HeroGroupFightViewContainer:_closeCallback()
	self:closeThis()
...
function Season1_5HeroGroupFightViewContainer:handleVersionActivityCloseCall()
...
function Season1_5HeroGroupFightViewContainer:setNavigateOverrideClose(callBack, callbackObject)
	self._navigateButtonsView:setOverrideClose(callBack, callbackObject)
end

function Season1_5HeroGroupFightViewContainer:defaultOverrideCloseCheck(reallyClose, reallyCloseObj)
...
return Season1_5HeroGroupFightViewContainer
