...
local var_0_0 = class("Season1_5AdditionRuleTipView", BaseView)
...
function var_0_0.onOpen(arg_5_0)
	...
	local var_5_1 = SeasonConfig.instance:getRuleTips(var_5_0)

	for iter_5_0 = 1, math.max(#var_5_1, #arg_5_0._itemList) do
		local var_5_2 = arg_5_0:getOrCreateItem(iter_5_0)

		arg_5_0:updateItem(var_5_2, var_5_1[iter_5_0])
	end
end
