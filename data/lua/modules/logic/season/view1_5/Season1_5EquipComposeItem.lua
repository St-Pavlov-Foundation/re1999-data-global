-- chunkname: @modules/logic/season/view1_5/Season1_5EquipComposeItem.lua

module("modules.logic.season.view1_5.Season1_5EquipComposeItem", package.seeall)

local Season1_5EquipComposeItem = class("Season1_5EquipComposeItem", ListScrollCellExtend)

function Season1_5EquipComposeItem:init(go)
	Season1_5EquipComposeItem.super.init(self, go)
...
function Season1_5EquipComposeItem:onUpdateMO(mo)
...
function Season1_5EquipComposeItem:refreshUI()
...
function Season1_5EquipComposeItem:setRoleIconDark(value)
	if value then
...
function Season1_5EquipComposeItem:refreshEquipedHero(heroUid)
...
Season1_5EquipComposeItem.ColumnCount = 6
Season1_5EquipComposeItem.AnimRowCount = 4
Season1_5EquipComposeItem.OpenAnimTime = 0.06
Season1_5EquipComposeItem.OpenAnimStartTime = 0.05

function Season1_5EquipComposeItem:checkPlayAnim()
...
function Season1_5EquipComposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_5EquipComposeItem:checkCreateIcon()
...
function Season1_5EquipComposeItem:onClickSelf()
	if self._mo then
		Activity104EquipComposeController.instance:changeSelectCard(self._mo.uid)
	end
end

function Season1_5EquipComposeItem:onLongPress()
	local data = {
...
function Season1_5EquipComposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season1_5EquipComposeItem
