-- chunkname: @modules/logic/season/view1_5/Season1_5SettlementTipsWork.lua

module("modules.logic.season.view1_5.Season1_5SettlementTipsWork", package.seeall)

local Season1_5SettlementTipsWork = class("Season1_5SettlementTipsWork", BaseWork)

function Season1_5SettlementTipsWork:onStart(context)
...
function Season1_5SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season1_5SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season1_5SettlementTipsWork:_showGetCardView()
...
function Season1_5SettlementTipsWork:_showChoiceCardView()
...
function Season1_5SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season1_5SettlementTipsWork
