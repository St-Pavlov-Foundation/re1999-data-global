-- chunkname: @modules/logic/season/view1_5/Season1_5EquipBookItem.lua

module("modules.logic.season.view1_5.Season1_5EquipBookItem", package.seeall)

local Season1_5EquipBookItem = class("Season1_5EquipBookItem", ListScrollCellExtend)

function Season1_5EquipBookItem:init(go)
	Season1_5EquipBookItem.super.init(self, go)
...
function Season1_5EquipBookItem:onUpdateMO(mo)
	self._mo = mo
...
Season1_5EquipBookItem.ColumnCount = 6
Season1_5EquipBookItem.AnimRowCount = 4
Season1_5EquipBookItem.OpenAnimTime = 0.06
Season1_5EquipBookItem.OpenAnimStartTime = 0.05

function Season1_5EquipBookItem:refreshUI()
...
function Season1_5EquipBookItem:checkPlayAnim()
...
function Season1_5EquipBookItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_5EquipBookItem:checkCreateIcon()
...
function Season1_5EquipBookItem:onClickSelf()
	if self._mo then
		Activity104EquipBookController.instance:changeSelect(self._mo.id)
	end
end

function Season1_5EquipBookItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
