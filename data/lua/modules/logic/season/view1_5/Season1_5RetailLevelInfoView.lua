-- chunkname: @modules/logic/season/view1_5/Season1_5RetailLevelInfoView.lua

module("modules.logic.season.view1_5.Season1_5RetailLevelInfoView", package.seeall)

local Season1_5RetailLevelInfoView = class("Season1_5RetailLevelInfoView", BaseView)

function Season1_5RetailLevelInfoView:onInitView()
...
function Season1_5RetailLevelInfoView:addEvents()
...
function Season1_5RetailLevelInfoView:removeEvents()
...
function Season1_5RetailLevelInfoView:_btnclose1OnClick()
	self:closeThis()
end

function Season1_5RetailLevelInfoView:_btnclose2OnClick()
	self:closeThis()
end

function Season1_5RetailLevelInfoView:_btncloseOnClick()
	self:closeThis()
end

function Season1_5RetailLevelInfoView:_btnstartOnClick()
	Activity104Model.instance:enterAct104Battle(self.viewParam.episodeId, 0)
end

function Season1_5RetailLevelInfoView:_editableInitView()
...
function Season1_5RetailLevelInfoView:onUpdateParam()
	return
end

function Season1_5RetailLevelInfoView:onOpen()
	self._cardItems = {}
...
function Season1_5RetailLevelInfoView:_setInfo()
	...
	for i = 1, #self.viewParam.retail.showActivity104EquipIds do
		...
		if not self._cardItems[i] then
			self._cardItems[i] = Season1_5CelebrityCardItem.New()
...
Season1_5RetailLevelInfoView.MaxStageCount = 7

function Season1_5RetailLevelInfoView:_refreshStateUI()
	self._stageItemsTab = self._stageItemsTab or self:getUserDataTb_()

	local stage = Activity104Model.instance:getAct104CurStage()

	for i = 1, Season1_5RetailLevelInfoView.MaxStageCount do
...
function Season1_5RetailLevelInfoView:onClose()
	Activity104Controller.instance:dispatchEvent(Activity104Event.SelectRetail)
end

function Season1_5RetailLevelInfoView:onDestroyView()
...
return Season1_5RetailLevelInfoView
