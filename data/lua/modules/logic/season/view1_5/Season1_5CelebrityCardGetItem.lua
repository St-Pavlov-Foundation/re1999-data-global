-- chunkname: @modules/logic/season/view1_5/Season1_5CelebrityCardGetItem.lua

module("modules.logic.season.view1_5.Season1_5CelebrityCardGetItem", package.seeall)

local Season1_5CelebrityCardGetItem = class("Season1_5CelebrityCardGetItem", BaseViewExtended)

function Season1_5CelebrityCardGetItem:onInitView()
...
function Season1_5CelebrityCardGetItem:addEvents()
	return
end

function Season1_5CelebrityCardGetItem:removeEvents()
	return
end

function Season1_5CelebrityCardGetItem:onRefreshViewParam(uid, noClick, equipId)
	self._uid = uid
	self._noClick = noClick
	self._equipId = equipId
end

function Season1_5CelebrityCardGetItem:onOpen()
	self:refreshData(self._uid)
end

function Season1_5CelebrityCardGetItem:refreshData(uid)
...
function Season1_5CelebrityCardGetItem:_checkCreateIcon()
	if not self._icon then
		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self.viewGO, Season1_5CelebrityCardEquip)
...
function Season1_5CelebrityCardGetItem:onBtnClick()
	if self._noClick then
		return
	end
...
function Season1_5CelebrityCardGetItem:_getItemID(uid)
	local item_id
...
function Season1_5CelebrityCardGetItem:onClose()
	return
end

function Season1_5CelebrityCardGetItem:onDestroyView()
	if self._icon then
...
return Season1_5CelebrityCardGetItem
