...
local var_0_0 = class("Season1_5SettlementView", BaseViewExtended)
...
function var_0_0._showGetCardView(arg_12_0)
	if arg_12_0.equip_cards then
		...
		arg_12_0._showTipsFlow:addWork(Season1_5SettlementTipsWork.New())
...
function var_0_0._onRewardItemShow(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if arg_24_2.materilType == MaterialEnum.MaterialType.EquipCard then
		local var_24_1 = Season1_5CelebrityCardItem.New()
	...
	if not var_26_6 then
		...
		for iter_26_11 = 1, 4 do
			if var_26_7[iter_26_11] then
				...
				if var_26_12 then
					...
					local var_26_16 = arg_26_0:openSubView(Season1_5SettlementHeroItem, arg_26_0._hero_obj_list[iter_26_11], nil, var_26_6, nil, var_26_14, var_26_15, nil, var_26_7[iter_26_11])
				...
				local var_26_20 = arg_26_0:openSubView(Season1_5SettlementHeroItem, arg_26_0._hero_obj_list[iter_26_11], nil, var_26_6, var_26_17, var_26_18, var_26_19)
		...
		if var_26_10[var_26_21] then
			...
			if var_26_22 and var_26_22 ~= "0" then
				...
				arg_26_0:openSubView(Season1_5CelebrityCardGetItem, Season1_5CelebrityCardItem.AssetPath, arg_26_0._gosupercard, var_26_22, true)
			end
		end
	else
...
function var_0_0._onGetFightRecordGroupReply(arg_28_0, arg_28_1)
	for iter_28_0 = 1, 4 do
		...
		local var_28_5 = arg_28_0:openSubView(Season1_5SettlementHeroItem, var_28_0, nil, true, var_28_1, var_28_2, var_28_3, var_28_4)
	...
	if arg_28_1.replay_activity104Equip_data[var_28_6] then
		...
		arg_28_0:openSubView(Season1_5CelebrityCardGetItem, Season1_5CelebrityCardItem.AssetPath, arg_28_0._gosupercard, nil, nil, var_28_7)
	end
end
...
function var_0_0._onAwardItemShow(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	if arg_32_2.materilType == MaterialEnum.MaterialType.EquipCard then
		local var_32_9 = Season1_5CelebrityCardItem.New()
