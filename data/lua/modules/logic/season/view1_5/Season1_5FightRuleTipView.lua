-- chunkname: @modules/logic/season/view1_5/Season1_5FightRuleTipView.lua

module("modules.logic.season.view1_5.Season1_5FightRuleTipView", package.seeall)

local Season1_5FightRuleTipView = class("Season1_5FightRuleTipView", BaseView)

function Season1_5FightRuleTipView:onInitView()
...
function Season1_5FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season1_5FightRuleTipView:_closeView()
	self:closeThis()
end

function Season1_5FightRuleTipView:onOpen()
	self._ruleList = Season1_5FightRuleView.getRuleList()
...
function Season1_5FightRuleTipView:createTab(go, tabType)
...
function Season1_5FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season1_5FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season1_5FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season1_5FightRuleTipView:switchTab(type)
...
function Season1_5FightRuleTipView:getTabActive(tabType)
...
function Season1_5FightRuleTipView:onClose()
	return
end

function Season1_5FightRuleTipView:onDestroyView()
...
return Season1_5FightRuleTipView
