...
slot0 = class("Season1_5HeroGroupListView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	for slot6 = 1, 4 do
		...
		table.insert(slot0._heroItemList, MonoHelper.addNoUpdateLuaComOnceToGo(slot9, Season1_5HeroGroupHeroItem, slot0))
