-- chunkname: @modules/logic/season/view1_5/Season1_5FightFailView.lua

module("modules.logic.season.view1_5.Season1_5FightFailView", package.seeall)

local Season1_5FightFailView = class("Season1_5FightFailView", FightFailView)

function Season1_5FightFailView:onInitView()
...
function Season1_5FightFailView:onOpen()
...
function Season1_5FightFailView:refreshTips()
...
function Season1_5FightFailView:onClose()
	Season1_5FightFailView.super.onClose(self)
end

function Season1_5FightFailView:onDestroyView()
	Season1_5FightFailView.super.onDestroyView(self)
end

return Season1_5FightFailView
