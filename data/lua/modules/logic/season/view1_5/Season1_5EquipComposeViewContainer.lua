...
slot0 = class("Season1_5EquipComposeViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot2 = Season1_5EquipTagSelect.New()
...
function slot0.createEquipItemsParam(slot0)
	...
	slot1.cellClass = Season1_5EquipComposeItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = Season1_5EquipComposeItem.ColumnCount
	slot1.cellWidth = 170
	slot1.cellHeight = 235
	slot1.cellSpaceH = 8.48
	slot1.cellSpaceV = 1
	slot1.frameUpdateMs = 100
	slot1.minUpdateCountInFrame = Season1_5EquipComposeItem.ColumnCount
