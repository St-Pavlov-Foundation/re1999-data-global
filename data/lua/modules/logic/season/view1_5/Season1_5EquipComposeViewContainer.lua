...
local var_0_0 = class("Season1_5EquipComposeViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	local var_1_0 = arg_1_0:createEquipItemsParam()
	local var_1_1 = Season1_5EquipTagSelect.New()
...
function var_0_0.createEquipItemsParam(arg_2_0)
	...
	var_2_0.cellClass = Season1_5EquipComposeItem
	var_2_0.scrollDir = ScrollEnum.ScrollDirV
	var_2_0.lineCount = Season1_5EquipComposeItem.ColumnCount
	var_2_0.cellWidth = 170
	var_2_0.cellHeight = 235
	var_2_0.cellSpaceH = 8.48
	var_2_0.cellSpaceV = 1
	var_2_0.frameUpdateMs = 100
	var_2_0.minUpdateCountInFrame = Season1_5EquipComposeItem.ColumnCount
