...
slot0 = class("Season1_5EquipFloatTouch", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0._originX, slot0._originY, slot0._originZ = transformhelper.getLocalRotation(slot0._tfTouch)
...
function slot0.onDragEnd(slot0, slot1, slot2)
	...
	slot4 = recthelper.screenPosToAnchorPos(slot2.position, slot0._tfTouch)
