-- chunkname: @modules/logic/season/view1_5/Season1_5CelebrityCardItem.lua

module("modules.logic.season.view1_5.Season1_5CelebrityCardItem", package.seeall)

local Season1_5CelebrityCardItem = class("Season1_5CelebrityCardItem", LuaCompBase)

Season1_5CelebrityCardItem.AssetPath = "ui/viewres/v1a5_season/seasoncelebritycarditem.prefab"

function Season1_5CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season1_5CelebrityCardItem.AssetPath
...
function Season1_5CelebrityCardItem:_cardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season1_5CelebrityCardEquip)
...
function Season1_5CelebrityCardItem:showTag(enable)
...
function Season1_5CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season1_5CelebrityCardItem:showNewFlag(enable)
...
function Season1_5CelebrityCardItem:showNewFlag2(enable)
...
function Season1_5CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season1_5CelebrityCardItem:setColorDark(enable)
...
function Season1_5CelebrityCardItem:destroy()
	if self._icon then
...
return Season1_5CelebrityCardItem
