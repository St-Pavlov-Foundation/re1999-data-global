...
local var_0_0 = class("Season1_5CelebrityCardItem", LuaCompBase)

var_0_0.AssetPath = "ui/viewres/v1a5_season/seasoncelebritycarditem.prefab"
...
function var_0_0._cardLoaded(arg_2_0)
	...
	arg_2_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(arg_2_0._cardGo, Season1_5CelebrityCardEquip)
