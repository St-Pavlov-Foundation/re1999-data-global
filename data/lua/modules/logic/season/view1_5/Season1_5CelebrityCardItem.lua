...
slot0 = class("Season1_5CelebrityCardItem", LuaCompBase)
slot0.AssetPath = "ui/viewres/v1a5_season/seasoncelebritycarditem.prefab"
...
function slot0._cardLoaded(slot0)
	...
	slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._cardGo, Season1_5CelebrityCardEquip)
