...
local var_0_0 = class("Season1_5HeroGroupHeroItem", LuaCompBase)

function var_0_0.ctor(arg_1_0, arg_1_1)
	arg_1_0._Season1_5HeroGroupListView = arg_1_1
end
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	arg_2_0._cardItem1 = Season1_5HeroGroupCardItem.New(arg_2_0._gocarditem1, arg_2_0, {
		slot = 1
	})
	arg_2_0._gocarditem2 = gohelper.findChild(arg_2_1, "heroitemani/equipcard/cardlist/carditem2")
	arg_2_0._cardItem2 = Season1_5HeroGroupCardItem.New(arg_2_0._gocarditem2, arg_2_0, {
		slot = 2
	})
...
function var_0_0._moveToTarget(arg_27_0, arg_27_1)
	for iter_27_0, iter_27_1 in ipairs(arg_27_0._Season1_5HeroGroupListView.heroPosTrList) do
		if arg_27_0._Season1_5HeroGroupListView._heroItemList[iter_27_0] ~= arg_27_0 then
			...
			if math.abs(var_27_1.x) * 2 < recthelper.getWidth(var_27_0) and math.abs(var_27_1.y) * 2 < recthelper.getHeight(var_27_0) then
				return arg_27_0._Season1_5HeroGroupListView._heroItemList[iter_27_0]
			end
		end
	end
...
function var_0_0._setEquipDragEnabled(arg_28_0, arg_28_1)
	for iter_28_0, iter_28_1 in ipairs(arg_28_0._Season1_5HeroGroupListView._heroItemList) do
...
function var_0_0.getHeroItemList(arg_41_0)
	return arg_41_0._Season1_5HeroGroupListView:getHeroItemList()
end
