-- chunkname: @modules/logic/season/view1_5/Season1_5CelebrityCardGetlView.lua

module("modules.logic.season.view1_5.Season1_5CelebrityCardGetlView", package.seeall)

local Season1_5CelebrityCardGetlView = class("Season1_5CelebrityCardGetlView", BaseViewExtended)

Season1_5CelebrityCardGetlView.OpenType = {
	Get = 1
}

function Season1_5CelebrityCardGetlView:onInitView()
...
function Season1_5CelebrityCardGetlView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season1_5CelebrityCardGetlView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season1_5CelebrityCardGetlView:_btncloseOnClick()
	self:closeThis()
end

function Season1_5CelebrityCardGetlView:onOpen()
...
function Season1_5CelebrityCardGetlView:_showGetCard()
	self:com_loadAsset(Season1_5CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season1_5CelebrityCardGetlView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season1_5CelebrityCardGetScrollItem)
...
function Season1_5CelebrityCardGetlView:isItemID()
	return self.viewParam.is_item_id
end

function Season1_5CelebrityCardGetlView:onClose()
...
return Season1_5CelebrityCardGetlView
