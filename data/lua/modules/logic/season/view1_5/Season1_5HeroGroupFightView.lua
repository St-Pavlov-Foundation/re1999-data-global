...
slot0 = class("Season1_5HeroGroupFightView", BaseView)
slot1 = 1
...
function slot0._initData(slot0)
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_5HeroGroupFightView, slot0._onEscapeBtnClick, slot0)
	...
	if Activity104Model.instance:isSeasonPosUnlock(nil, , 1, Activity104EquipItemListModel.MainCharPos) then
		...
		if slot6 ~= 0 then
			if not slot0._superCardItem then
				slot0._superCardItem = Season1_5CelebrityCardItem.New()
