...
local var_0_0 = class("Season1_5HeroGroupFightView", BaseView)
local var_0_1 = 1
...
function var_0_0._initData(arg_18_0)
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_5HeroGroupFightView, arg_18_0._onEscapeBtnClick, arg_18_0)
	...
	if var_23_2 then
		...
		if var_23_5 ~= 0 then
			if not arg_23_0._superCardItem then
				arg_23_0._superCardItem = Season1_5CelebrityCardItem.New()
