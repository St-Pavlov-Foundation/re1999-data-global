...
local var_0_0 = class("Season1_2StoreView", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0._simagebg:LoadImage(ResUrl.getV1A2SeasonIcon("full/shangcheng_bj.jpg"))
...
function var_0_0.refreshStoreContent(arg_10_0)
	...
	for iter_10_4 = 1, math.max(#var_10_1, #arg_10_0.storeItemList) do
		...
		if not var_10_2 then
			var_10_2 = Season1_2StoreItem.New(arg_10_0:getItemGo(iter_10_4))
