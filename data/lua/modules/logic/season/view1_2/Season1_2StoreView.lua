...
slot0 = class("Season1_2StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage(ResUrl.getV1A2SeasonIcon("full/shangcheng_bj.jpg"))
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, math.max(slot6, #slot0.storeItemList) do
		if not slot0.storeItemList[slot6] then
			slot0.storeItemList[slot6] = Season1_2StoreItem.New(slot0:getItemGo(slot6))
		end
