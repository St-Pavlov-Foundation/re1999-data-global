-- chunkname: @modules/logic/season/view1_2/Season1_2SpecialMarketShowLevelItem.lua

module("modules.logic.season.view1_2.Season1_2SpecialMarketShowLevelItem", package.seeall)

local Season1_2SpecialMarketShowLevelItem = class("Season1_2SpecialMarketShowLevelItem", LuaCompBase)

function Season1_2SpecialMarketShowLevelItem:init(go)
	self.go = go
...
function Season1_2SpecialMarketShowLevelItem:_btnOnClick()
	Activity104Controller.instance:dispatchEvent(Activity104Event.SwitchSpecialEpisode, self.index)
end

function Season1_2SpecialMarketShowLevelItem:reset(index, targetIndex, maxSpecialLayer)
	self.index = index
...
function Season1_2SpecialMarketShowLevelItem:_refreshItem()
...
function Season1_2SpecialMarketShowLevelItem:destroy()
	self._btnClick:RemoveClickListener()
end

return Season1_2SpecialMarketShowLevelItem
