...
slot0 = class("Season1_2EquipComposeViewContainer", BaseViewContainer)
...
function slot0.createEquipItemsParam(slot0)
	...
	slot1.cellClass = Season1_2EquipComposeItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = Season1_2EquipComposeItem.ColumnCount
	slot1.cellWidth = 170
	slot1.cellHeight = 235
	slot1.cellSpaceH = 8.48
	slot1.cellSpaceV = 1
	slot1.frameUpdateMs = 100
	slot1.minUpdateCountInFrame = Season1_2EquipComposeItem.ColumnCount
