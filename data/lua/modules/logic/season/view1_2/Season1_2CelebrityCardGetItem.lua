-- chunkname: @modules/logic/season/view1_2/Season1_2CelebrityCardGetItem.lua

module("modules.logic.season.view1_2.Season1_2CelebrityCardGetItem", package.seeall)

local Season1_2CelebrityCardGetItem = class("Season1_2CelebrityCardGetItem", BaseViewExtended)

function Season1_2CelebrityCardGetItem:onInitView()
...
function Season1_2CelebrityCardGetItem:addEvents()
	return
end

function Season1_2CelebrityCardGetItem:removeEvents()
	return
end

function Season1_2CelebrityCardGetItem:onRefreshViewParam(uid, noClick, equipId)
	self._uid = uid
	self._noClick = noClick
	self._equipId = equipId
end

function Season1_2CelebrityCardGetItem:onOpen()
	self:refreshData(self._uid)
end

function Season1_2CelebrityCardGetItem:refreshData(uid)
...
function Season1_2CelebrityCardGetItem:_checkCreateIcon()
	if not self._icon then
		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self.viewGO, Season1_2CelebrityCardEquip)
...
function Season1_2CelebrityCardGetItem:onBtnClick()
	if self._noClick then
		return
	end
...
function Season1_2CelebrityCardGetItem:_getItemID(uid)
	local item_id
...
function Season1_2CelebrityCardGetItem:onClose()
	return
end

function Season1_2CelebrityCardGetItem:onDestroyView()
	if self._icon then
...
return Season1_2CelebrityCardGetItem
