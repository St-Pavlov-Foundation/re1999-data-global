...
local var_0_0 = class("Season1_2SettlementView", BaseViewExtended)
...
function var_0_0._showGetCardView(arg_12_0)
	if arg_12_0.equip_cards then
		...
		arg_12_0._showTipsFlow:addWork(Season1_2SettlementTipsWork.New())
...
function var_0_0.onOpen(arg_21_0)
	...
	if arg_21_0._config then
		arg_21_0._simagedecorate6:LoadImage(ResUrl.getV1A2SeasonIcon(string.format("icon/%s.png", arg_21_0._config.stagePicture)))
	end
...
function var_0_0._onRewardItemShow(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if arg_24_2.materilType == MaterialEnum.MaterialType.EquipCard then
		local var_24_1 = Season1_2CelebrityCardItem.New()
...
function var_0_0._onHeroItemLoaded(arg_26_0)
	...
	if not var_26_3 then
		...
		for iter_26_9 = 1, 4 do
			...
			local var_26_10 = arg_26_0:openSubView(Season1_2SettlementHeroItem, arg_26_0._hero_obj_list[iter_26_9], nil, var_26_3, var_26_7, var_26_8, var_26_9)
		...
		if var_26_6[var_26_11] then
			...
			if var_26_12 and var_26_12 ~= "0" then
				...
				arg_26_0:openSubView(Season1_2CelebrityCardGetItem, Season1_2CelebrityCardItem.AssetPath, arg_26_0._gosupercard, var_26_12, true)
			end
		end
	else
...
function var_0_0._onGetFightRecordGroupReply(arg_28_0, arg_28_1)
	for iter_28_0 = 1, 4 do
		...
		local var_28_4 = arg_28_0:openSubView(Season1_2SettlementHeroItem, var_28_0, nil, true, var_28_1, var_28_2, var_28_3)
	...
	if arg_28_1.replay_activity104Equip_data[var_28_5] then
		...
		arg_28_0:openSubView(Season1_2CelebrityCardGetItem, Season1_2CelebrityCardItem.AssetPath, arg_28_0._gosupercard, nil, nil, var_28_6)
	end
end
...
function var_0_0._onAwardItemShow(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	if arg_32_2.materilType == MaterialEnum.MaterialType.EquipCard then
		local var_32_9 = Season1_2CelebrityCardItem.New()
