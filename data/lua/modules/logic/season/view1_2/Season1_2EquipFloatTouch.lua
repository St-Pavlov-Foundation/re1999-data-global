-- chunkname: @modules/logic/season/view1_2/Season1_2EquipFloatTouch.lua

module("modules.logic.season.view1_2.Season1_2EquipFloatTouch", package.seeall)

local Season1_2EquipFloatTouch = class("Season1_2EquipFloatTouch", BaseView)

function Season1_2EquipFloatTouch:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function Season1_2EquipFloatTouch:addEvents()
	return
end

function Season1_2EquipFloatTouch:removeEvents()
	return
end

function Season1_2EquipFloatTouch:init(ctrlGOPath, touchGOPath)
	self._goctrlPath = ctrlGOPath
	self._gotouchPath = touchGOPath
end

function Season1_2EquipFloatTouch:_editableInitView()
...
function Season1_2EquipFloatTouch:onDestroyView()
	self:killTween()
...
function Season1_2EquipFloatTouch:onDragBegin(param, pointerEventData)
	return
end

function Season1_2EquipFloatTouch:onDragEnd(param, pointerEventData)
...
Season1_2EquipFloatTouch.Range_Rotaion_Min_X = -25
Season1_2EquipFloatTouch.Range_Rotaion_Max_X = 25
Season1_2EquipFloatTouch.Range_Rotaion_Min_Y = -25
Season1_2EquipFloatTouch.Range_Rotaion_Max_Y = 25

function Season1_2EquipFloatTouch:onDrag(param, pointerEventData)
	local pos = pointerEventData.position
	local halfSize = 250
	...
	local rotationX = Mathf.Lerp(Season1_2EquipFloatTouch.Range_Rotaion_Min_X, Season1_2EquipFloatTouch.Range_Rotaion_Max_X, anchorPosRateX)
	local rotationY = Mathf.Lerp(Season1_2EquipFloatTouch.Range_Rotaion_Min_Y, Season1_2EquipFloatTouch.Range_Rotaion_Max_Y, anchorPosRateY)
...
function Season1_2EquipFloatTouch:killTween()
...
return Season1_2EquipFloatTouch
