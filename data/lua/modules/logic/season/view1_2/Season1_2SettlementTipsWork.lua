-- chunkname: @modules/logic/season/view1_2/Season1_2SettlementTipsWork.lua

module("modules.logic.season.view1_2.Season1_2SettlementTipsWork", package.seeall)

local Season1_2SettlementTipsWork = class("Season1_2SettlementTipsWork", BaseWork)

function Season1_2SettlementTipsWork:onStart(context)
...
function Season1_2SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season1_2SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season1_2SettlementTipsWork:_showGetCardView()
...
function Season1_2SettlementTipsWork:_showChoiceCardView()
...
function Season1_2SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season1_2SettlementTipsWork
