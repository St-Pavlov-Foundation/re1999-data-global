-- chunkname: @modules/logic/season/view1_2/Season1_2EquipSelfChoiceItem.lua

module("modules.logic.season.view1_2.Season1_2EquipSelfChoiceItem", package.seeall)

local Season1_2EquipSelfChoiceItem = class("Season1_2EquipSelfChoiceItem", ListScrollCellExtend)

function Season1_2EquipSelfChoiceItem:init(go)
	Season1_2EquipSelfChoiceItem.super.init(self, go)
...
function Season1_2EquipSelfChoiceItem:addEvents()
	return
end

function Season1_2EquipSelfChoiceItem:removeEvents()
	return
end

function Season1_2EquipSelfChoiceItem:onUpdateMO(mo)
	self._mo = mo
	self._cfg = mo.cfg
...
function Season1_2EquipSelfChoiceItem:refreshUI()
...
function Season1_2EquipSelfChoiceItem:checkCreateIcon()
...
function Season1_2EquipSelfChoiceItem:showDetailTips()
	local data = {
...
function Season1_2EquipSelfChoiceItem:onClickSelf()
...
function Season1_2EquipSelfChoiceItem:onLongPress()
	self:showDetailTips()
end

function Season1_2EquipSelfChoiceItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
end

return Season1_2EquipSelfChoiceItem
