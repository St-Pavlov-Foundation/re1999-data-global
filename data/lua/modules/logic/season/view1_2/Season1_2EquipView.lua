...
local var_0_0 = class("Season1_2EquipView", BaseView)
...
function var_0_0.refreshDesc(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	if arg_13_2 == Activity104EquipItemListModel.EmptyUid then
		...
		if var_13_0 then
			local var_13_1 = SeasonConfig.instance:getSeasonEquipCo(var_13_0.itemId)

			if var_13_1 then
				arg_13_1.txtName.text = string.format("[%s]", var_13_1.name)

				local var_13_2
				local var_13_3 = SeasonEquipMetaUtils.getCareerColorDarkBg(var_13_0.itemId)

				if Activity104EquipItemListModel.instance.curSelectSlot ~= arg_13_3 then
					var_13_3 = var_13_3 .. SeasonEquipMetaUtils.No_Effect_Alpha
					var_13_2 = "#cac8c5" .. SeasonEquipMetaUtils.No_Effect_Alpha
				else
					var_13_2 = "#ec7731"
				end

				SLFramework.UGUI.GuiHelper.SetColor(arg_13_1.txtName, var_13_2)
				arg_13_0:refreshProps(var_13_1, arg_13_1, var_13_3)
				arg_13_0:refreshSkills(var_13_1, arg_13_1, var_13_3)
			else
				logError(string.format("can't find season equip config, id = [%s]", var_13_0.itemId))
			end
		else
...
function var_0_0.getOrCreateSlotIcon(arg_19_0, arg_19_1)
	...
	if not var_19_0 then
		...
		var_19_0 = MonoHelper.addNoUpdateLuaComOnceToGo(var_19_2, Season1_2CelebrityCardEquip)
...
function var_0_0.handleSaveSucc(arg_22_0, arg_22_1)
	if arg_22_1 == ModuleEnum.HeroGroupType.Season and arg_22_0._isManualSave then
...
function var_0_0._btnequipOnClick(arg_27_0)
	arg_27_0._isManualSave = Activity104EquipController.instance:saveShowSlot()
end
