...
slot0 = class("Season1_2TaskView", BaseView)

function slot0.onInitView(slot0)
	slot0._simagebg = gohelper.findChildSingleImage(slot0.viewGO, "#simage_bg")
	slot0._simagehouse = gohelper.findChildSingleImage(slot0.viewGO, "#simage_house")
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage(ResUrl.getV1A2SeasonIcon("full/bg1.png"))
	slot0._simagehouse:LoadImage(ResUrl.getV1A2SeasonIcon("bg_jz.png"))
...
function slot0.getItem(slot0, slot1)
	...
	slot4 = Season1_2TaskItem.New(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._goContent, "item" .. slot1), slot0._goScroll)
...
function slot0.onDestroyView(slot0)
	...
	slot0._simagehouse:UnLoadImage()
