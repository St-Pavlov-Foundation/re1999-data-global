...
local var_0_0 = class("Season1_2TaskView", BaseView)

function var_0_0.onInitView(arg_1_0)
	arg_1_0._simagebg = gohelper.findChildSingleImage(arg_1_0.viewGO, "#simage_bg")
	arg_1_0._simagehouse = gohelper.findChildSingleImage(arg_1_0.viewGO, "#simage_house")
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0._simagebg:LoadImage(ResUrl.getV1A2SeasonIcon("full/bg1.png"))
	arg_4_0._simagehouse:LoadImage(ResUrl.getV1A2SeasonIcon("bg_jz.png"))
...
function var_0_0.getItem(arg_10_0, arg_10_1)
	...
	local var_10_2 = Season1_2TaskItem.New(var_10_1, arg_10_0._goScroll)
...
function var_0_0.onDestroyView(arg_11_0)
	...
	arg_11_0._simagehouse:UnLoadImage()
