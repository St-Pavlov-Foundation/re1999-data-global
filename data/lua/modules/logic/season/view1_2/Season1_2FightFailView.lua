-- chunkname: @modules/logic/season/view1_2/Season1_2FightFailView.lua

module("modules.logic.season.view1_2.Season1_2FightFailView", package.seeall)

local Season1_2FightFailView = class("Season1_2FightFailView", FightFailView)

function Season1_2FightFailView:onInitView()
...
function Season1_2FightFailView:onOpen()
...
function Season1_2FightFailView:refreshTips()
...
function Season1_2FightFailView:onClose()
	Season1_2FightFailView.super.onClose(self)
end

function Season1_2FightFailView:onDestroyView()
	Season1_2FightFailView.super.onDestroyView(self)
end

return Season1_2FightFailView
