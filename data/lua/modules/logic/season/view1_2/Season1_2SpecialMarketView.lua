...
local var_0_0 = class("Season1_2SpecialMarketView", BaseView)
...
function var_0_0._refreshLevel(arg_15_0)
	...
	for iter_15_0 = 1, var_15_0 do
		if not arg_15_0._showLvItems[iter_15_0] then
			...
			arg_15_0._showLvItems[iter_15_0] = Season1_2SpecialMarketShowLevelItem.New()
	...
	arg_15_0._simageleveldecorate:LoadImage(ResUrl.getV1A2SeasonIcon("icon/" .. var_15_2.icon .. ".png"))
end
...
function var_0_0._refreshInfo(arg_16_0)
	...
	arg_16_0._simagestageicon:LoadImage(ResUrl.getV1A2SeasonIcon(string.format("icon/ct_%s.png", var_16_0.icon)))
