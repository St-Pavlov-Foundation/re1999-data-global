...
slot0 = class("Season1_2MarketView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagepage:LoadImage(ResUrl.getV1A2SeasonIcon("shuye.png"))
	slot0._simageuttu:LoadImage(ResUrl.getV1A2SeasonIcon("uttu_zs.png"))
	...
	slot0._simageempty:LoadImage(ResUrl.getV1A2SeasonIcon("kongzhuangtai.png"))
end
...
function slot0._setLevels(slot0)
	...
	if slot0._layer <= 4 then
		for slot7 = 1, 6 do
			slot0._showLvItems[slot7] = Season1_2MarketShowLevelItem.New()
...
function slot0._setStages(slot0)
	...
	slot0._simagedecorate:LoadImage(ResUrl.getV1A2SeasonIcon(string.format("icon/ct_%s.png", slot1.stagePicture)))
end
...
function slot0._setInfo(slot0)
	...
	slot0._simagestageicon:LoadImage(ResUrl.getV1A2SeasonIcon(string.format("icon/ct_%s.png", slot1.stagePicture)))
...
function slot0.refreshEquipCardItem(slot0)
	...
	if slot1.firstPassEquipId > 0 then
		if not slot0._rewardItems[1].itemIcon then
			slot0._rewardItems[1].itemIcon = Season1_2CelebrityCardItem.New()
