...
local var_0_0 = class("Season1_2FightCardItem", UserDataDispose)
...
function var_0_0._setName(arg_3_0)
	if arg_3_0.isMainRole then
		...
		local var_3_0 = HeroModel.instance:getById(arg_3_0.heroUid)
...
function var_0_0._setHead(arg_4_0)
	...
	if not arg_4_0.isMainRole then
		local var_4_1 = HeroModel.instance:getById(arg_4_0.heroUid)
...
function var_0_0._setCard(arg_5_0, arg_5_1)
	if not arg_5_0.cardItem then
		arg_5_0.cardItem = Season1_2CelebrityCardItem.New()
