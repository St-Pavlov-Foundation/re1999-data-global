...
local var_0_0 = class("Season1_2HeroGroupListView", BaseView)
...
function var_0_0._editableInitView(arg_2_0)
	...
	for iter_2_0 = 1, 4 do
		...
		local var_2_4 = MonoHelper.addNoUpdateLuaComOnceToGo(var_2_3, Season1_2HeroGroupHeroItem, arg_2_0)
...
function var_0_0._onEndDrag(arg_14_0, arg_14_1, arg_14_2)
	...
	arg_14_0:_setHeroItemPos(var_14_1, var_14_2, true, function()
		...
		local var_16_7 = var_16_0.heroList[var_16_1 + 1]
		local var_16_8 = var_16_0.heroList[var_16_2 + 1]

		var_16_0.heroList[var_16_1 + 1] = var_16_8
		var_16_0.heroList[var_16_2 + 1] = var_16_7

		arg_14_0:_updateHeroList()

		local var_16_9 = Activity104Model.instance:getCurSeasonId()
		local var_16_10 = Activity104Model.instance:getSeasonCurSnapshotSubId(var_16_9)
		local var_16_11 = {
			groupIndex = var_16_10,
			heroGroup = var_16_0
		}

		HeroGroupModel.instance:setHeroGroupSnapshot(ModuleEnum.HeroGroupType.Season, DungeonModel.instance.curSendEpisodeId, true, var_16_11)
	end)
end
...
function var_0_0._updateHeroList(arg_20_0)
	...
	for iter_20_0, iter_20_1 in ipairs(arg_20_0._heroItemList) do
		local var_20_1 = HeroSingleGroupMO.New()

		var_20_1:init(iter_20_0, var_20_0.heroList[iter_20_0])
		var_20_1:setAid(var_20_0.aidDict and var_20_0.aidDict[iter_20_0])
