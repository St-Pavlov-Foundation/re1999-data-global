...
slot0 = class("Season1_2HeroGroupListView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	for slot6 = 1, 4 do
		...
		table.insert(slot0._heroItemList, MonoHelper.addNoUpdateLuaComOnceToGo(slot9, Season1_2HeroGroupHeroItem, slot0))
...
function slot0._onEndDrag(slot0, slot1, slot2)
	...
	slot0:_setHeroItemPos(slot4, slot5, true, function ()
		...
		slot0.heroList[slot1 + 1] = slot0.heroList[slot2 + 1]
		slot0.heroList[slot2 + 1] = slot0.heroList[slot1 + 1]

		uv0:_updateHeroList()
		HeroGroupModel.instance:setHeroGroupSnapshot(ModuleEnum.HeroGroupType.Season, DungeonModel.instance.curSendEpisodeId, true, {
			groupIndex = Activity104Model.instance:getSeasonCurSnapshotSubId(Activity104Model.instance:getCurSeasonId()),
			heroGroup = slot0
		})
	end)
end
...
function slot0._updateHeroList(slot0)
	...
	for slot5, slot6 in ipairs(slot0._heroItemList) do
		...
		slot7:init(slot5, slot1.heroList[slot5])
		slot7:setAid(slot1.aidDict and slot1.aidDict[slot5])
		slot6:onUpdateMO(slot7)
	end
end
