-- chunkname: @modules/logic/season/view1_2/Season1_2CelebrityCardItem.lua

module("modules.logic.season.view1_2.Season1_2CelebrityCardItem", package.seeall)

local Season1_2CelebrityCardItem = class("Season1_2CelebrityCardItem", LuaCompBase)

Season1_2CelebrityCardItem.AssetPath = "ui/viewres/v1a2_season/seasoncelebritycarditem.prefab"

function Season1_2CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season1_2CelebrityCardItem.AssetPath
...
function Season1_2CelebrityCardItem:_cardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season1_2CelebrityCardEquip)
...
function Season1_2CelebrityCardItem:showTag(enable)
...
function Season1_2CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season1_2CelebrityCardItem:showNewFlag(enable)
...
function Season1_2CelebrityCardItem:showNewFlag2(enable)
...
function Season1_2CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season1_2CelebrityCardItem:setColorDark(enable)
...
function Season1_2CelebrityCardItem:destroy()
	if self._icon then
...
return Season1_2CelebrityCardItem
