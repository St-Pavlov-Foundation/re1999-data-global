...
local var_0_0 = class("Season1_2CelebrityCardItem", LuaCompBase)
...
function var_0_0._cardLoaded(arg_2_0)
	...
	arg_2_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(arg_2_0._cardGo, Season1_2CelebrityCardEquip)
