-- chunkname: @modules/logic/season/view1_2/Season1_2CelebrityCardGetlView.lua

module("modules.logic.season.view1_2.Season1_2CelebrityCardGetlView", package.seeall)

local Season1_2CelebrityCardGetlView = class("Season1_2CelebrityCardGetlView", BaseViewExtended)

Season1_2CelebrityCardGetlView.OpenType = {
	Get = 1
}

function Season1_2CelebrityCardGetlView:onInitView()
...
function Season1_2CelebrityCardGetlView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season1_2CelebrityCardGetlView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season1_2CelebrityCardGetlView:_btncloseOnClick()
	self:closeThis()
end

function Season1_2CelebrityCardGetlView:onOpen()
...
function Season1_2CelebrityCardGetlView:_showGetCard()
	self:com_loadAsset(Season1_2CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season1_2CelebrityCardGetlView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season1_2CelebrityCardGetScrollItem)
...
function Season1_2CelebrityCardGetlView:isItemID()
	return self.viewParam.is_item_id
end

function Season1_2CelebrityCardGetlView:onClose()
...
return Season1_2CelebrityCardGetlView
