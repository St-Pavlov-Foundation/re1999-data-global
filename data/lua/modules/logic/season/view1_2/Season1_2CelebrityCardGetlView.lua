...
slot0 = class("Season1_2CelebrityCardGetlView", BaseViewExtended)
slot0.OpenType = {
	Get = 1
}
...
function slot0._showGetCard(slot0)
	slot0:com_loadAsset(Season1_2CelebrityCardItem.AssetPath, slot0._onCardItemLoaded)
end
...
function slot0._onCardItemLoaded(slot0, slot1)
	...
	slot0._scroll_view:setClass(Season1_2CelebrityCardGetScrollItem)
