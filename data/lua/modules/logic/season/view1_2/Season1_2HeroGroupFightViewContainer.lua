-- chunkname: @modules/logic/season/view1_2/Season1_2HeroGroupFightViewContainer.lua

module("modules.logic.season.view1_2.Season1_2HeroGroupFightViewContainer", package.seeall)

local Season1_2HeroGroupFightViewContainer = class("Season1_2HeroGroupFightViewContainer", BaseViewContainer)

function Season1_2HeroGroupFightViewContainer:buildViews()
	return {
...
function Season1_2HeroGroupFightViewContainer:getSeason1_2HeroGroupFightView()
	return self._views[1]
end

function Season1_2HeroGroupFightViewContainer:buildTabViews(tabContainerId)
	if tabContainerId == 1 then
		self._navigateButtonsView = NavigateButtonsView.New({
			true,
			true,
			true
		}, HelpEnum.HelpId.Season1_2HerogroupHelp, self._closeCallback, nil, nil, self)
...
function Season1_2HeroGroupFightViewContainer:_closeCallback()
	self:closeThis()
...
function Season1_2HeroGroupFightViewContainer:handleVersionActivityCloseCall()
...
function Season1_2HeroGroupFightViewContainer:setNavigateOverrideClose(callBack, callbackObject)
	self._navigateButtonsView:setOverrideClose(callBack, callbackObject)
end

function Season1_2HeroGroupFightViewContainer:defaultOverrideCloseCheck(reallyClose, reallyCloseObj)
...
return Season1_2HeroGroupFightViewContainer
