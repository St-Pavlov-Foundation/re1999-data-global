...
local var_0_0 = class("Season1_2RetailLevelInfoView", BaseView)
...
function var_0_0._editableInitView(arg_9_0)
	...
	arg_9_0._simageleftbg:LoadImage(ResUrl.getV1A2SeasonIcon("msg_xia.png"))
	arg_9_0._simagerightbg:LoadImage(ResUrl.getV1A2SeasonIcon("msg_shang.png"))
end
...
function var_0_0._setInfo(arg_12_0)
	...
	for iter_12_2 = 1, #arg_12_0.viewParam.retail.showActivity104EquipIds do
		...
		if not arg_12_0._cardItems[iter_12_2] then
			arg_12_0._cardItems[iter_12_2] = Season1_2CelebrityCardItem.New()
