...
slot0 = class("Season1_2RetailLevelInfoView", BaseView)
...
function slot0._btnstartOnClick(slot0)
	Activity104Rpc.instance:sendBeforeStartAct104BattleRequest(Activity104Model.instance:getCurSeasonId(), 0, slot0.viewParam.episodeId)
end
...
function slot0._editableInitView(slot0)
	...
	slot0._simageleftbg:LoadImage(ResUrl.getV1A2SeasonIcon("msg_xia.png"))
	slot0._simagerightbg:LoadImage(ResUrl.getV1A2SeasonIcon("msg_shang.png"))
end
...
function slot0._setInfo(slot0)
	...
	for slot8 = 1, #slot0.viewParam.retail.showActivity104EquipIds do
		if not slot0._cardItems[slot8] then
			slot0._cardItems[slot8] = Season1_2CelebrityCardItem.New()
