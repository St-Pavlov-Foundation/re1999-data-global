...
local var_0_0 = class("Season3_0CelebrityCardTipView", BaseView)
...
function var_0_0.refreshSkills(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(var_15_0) do
		...
		local var_15_5 = HeroSkillModel.instance:skillDesToSpot(iter_15_1)

		var_15_4.txtDesc.text = SkillHelper.addLink(var_15_5)

		var_15_4.fixTmpBreakLine:refreshTmpContent(var_15_4.txtDesc)
		SLFramework.UGUI.GuiHelper.SetColor(var_15_4.txtDesc, var_15_1)
		SkillHelper.addHyperLinkClick(var_15_4.txtDesc)
...
function var_0_0.checkCreateIcon(arg_16_0)
	if not arg_16_0._icon then
		...
		arg_16_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_16_1, Season3_0CelebrityCardEquip)
	end
end
...
function var_0_0.getOrCreateSkillText(arg_18_0, arg_18_1)
	...
	if not var_18_0 then
		...
		var_18_0.fixTmpBreakLine = MonoHelper.addNoUpdateLuaComOnceToGo(var_18_0.txtDesc.gameObject, FixTmpBreakLine)
