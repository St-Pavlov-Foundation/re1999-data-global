...
local var_0_0 = class("Season3_0SumView", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0.simagePanelBg1:LoadImage(SeasonViewHelper.getSeasonIcon("sum_bg.png"))
	arg_4_0.simagePanelBg2:LoadImage(SeasonViewHelper.getSeasonIcon("sum_bg.png"))
	arg_4_0.simagePanelBg3:LoadImage(SeasonViewHelper.getSeasonIcon("sum_frame.png"))
end
...
function var_0_0.showMailView(arg_7_0)
	...
	UISpriteSetMgr.instance:setV1a6SeasonSumSprite(arg_7_0.mailChapterBg, string.format("v1a6_season_sum_chapterpic%s", var_7_8.stage))
end
...
function var_0_0.refreshCard(arg_12_0, arg_12_1, arg_12_2)
	...
	if not var_12_0.cardItem then
		var_12_0.cardItem = Season3_0CelebrityCardItem.New()
