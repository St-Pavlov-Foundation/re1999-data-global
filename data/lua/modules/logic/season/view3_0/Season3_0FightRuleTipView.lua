-- chunkname: @modules/logic/season/view3_0/Season3_0FightRuleTipView.lua

module("modules.logic.season.view3_0.Season3_0FightRuleTipView", package.seeall)

local Season3_0FightRuleTipView = class("Season3_0FightRuleTipView", BaseView)

function Season3_0FightRuleTipView:onInitView()
...
function Season3_0FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season3_0FightRuleTipView:_closeView()
	self:closeThis()
end

function Season3_0FightRuleTipView:onOpen()
	self._ruleList = Season3_0FightRuleView.getRuleList()
...
function Season3_0FightRuleTipView:createTab(go, tabType)
...
function Season3_0FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season3_0FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season3_0FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season3_0FightRuleTipView:switchTab(type)
...
function Season3_0FightRuleTipView:getTabActive(tabType)
...
function Season3_0FightRuleTipView:onClose()
	return
end

function Season3_0FightRuleTipView:onDestroyView()
...
return Season3_0FightRuleTipView
