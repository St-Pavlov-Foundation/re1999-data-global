...
local var_0_0 = class("Season3_0FightRuleTipView", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0.labelTab = arg_4_0:createTab(arg_4_0._goLabel, Activity104Enum.RuleTab.Rule)
	arg_4_0.cardTab = arg_4_0:createTab(arg_4_0._goCard, Activity104Enum.RuleTab.Card)
...
function var_0_0.onOpen(arg_7_0)
	arg_7_0._ruleList = Season3_0FightRuleView.getRuleList()
	arg_7_0._cardList = Activity104Model.instance:getFightCardDataList()

	if #arg_7_0._ruleList > 0 then
		arg_7_0:switchTab(Activity104Enum.RuleTab.Rule)
	else
		arg_7_0:switchTab(Activity104Enum.RuleTab.Card)
	end
end
...
function var_0_0.getTabActive(arg_13_0, arg_13_1)
	if arg_13_1 == Activity104Enum.RuleTab.Card then
