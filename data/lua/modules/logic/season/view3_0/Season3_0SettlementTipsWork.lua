-- chunkname: @modules/logic/season/view3_0/Season3_0SettlementTipsWork.lua

module("modules.logic.season.view3_0.Season3_0SettlementTipsWork", package.seeall)

local Season3_0SettlementTipsWork = class("Season3_0SettlementTipsWork", BaseWork)

function Season3_0SettlementTipsWork:onStart(context)
...
function Season3_0SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season3_0SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season3_0SettlementTipsWork:_showGetCardView()
...
function Season3_0SettlementTipsWork:_showChoiceCardView()
...
function Season3_0SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season3_0SettlementTipsWork
