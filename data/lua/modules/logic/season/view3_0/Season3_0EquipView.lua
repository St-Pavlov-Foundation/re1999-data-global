...
function Season3_0EquipView:removeEvents()
	...
	self:removeEventCb(Activity104EquipController.instance, Activity104EquipEvent.EquipUpdate, self.handleEquipUpdate, self)
	self:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnSnapshotSaveSucc, self.handleSaveSucc, self)
	self:removeEventCb(Activity104EquipController.instance, Activity104EquipEvent.EquipChangeCard, self.handleEquipCardChanged, self)
	self:removeEventCb(Activity104EquipController.instance, Activity104EquipEvent.EquipChangeSlot, self.handleEquipSlotChanged, self)
end
