...
function Season3_0MarketView:_setInfo()
	...
	local targetStageTagPos = isNewStage and Season3_0MarketView.NewStageTagPos or Season3_0MarketView.NomalStageTagPos
...
function Season3_0MarketView:_refreshPartStage(item, nextStage, maxStage)
	...
	item.canvasgroup.alpha = stage <= nextStage and Season3_0MarketView.UnLockStageItemAlpha or Season3_0MarketView.LockStageItemAlpha
end
