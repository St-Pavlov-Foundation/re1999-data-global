...
function Season3_0EquipBookView:removeEvents()
	...
	self:removeEventCb(Activity104EquipBookController.instance, Activity104Event.OnBookUpdateNotify, self.refreshUI, self)
	self:removeEventCb(Activity104EquipBookController.instance, Activity104Event.OnBookChangeSelectNotify, self.onChangeSelectCard, self)
end
