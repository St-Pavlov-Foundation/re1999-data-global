...
local var_0_0 = class("Season3_0FightCardItem", UserDataDispose)
...
function var_0_0._setCard(arg_5_0, arg_5_1)
	if not arg_5_0.cardItem then
		arg_5_0.cardItem = Season3_0CelebrityCardItem.New()
...
function var_0_0.createDescItem(arg_7_0, arg_7_1)
	...
	var_7_0.fixTmpBreakLine = MonoHelper.addNoUpdateLuaComOnceToGo(var_7_0.txtDesc.gameObject, FixTmpBreakLine)
...
function var_0_0.updateDescItem(arg_8_0, arg_8_1, arg_8_2)
	...
	arg_8_2 = HeroSkillModel.instance:skillDesToSpot(arg_8_2)
