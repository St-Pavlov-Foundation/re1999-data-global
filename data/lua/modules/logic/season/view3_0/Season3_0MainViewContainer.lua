...
local var_0_0 = class("Season3_0MainViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	local var_1_0 = {}

	arg_1_0.scene = Season3_0MainScene.New()
	arg_1_0.view = Season3_0MainView.New()
...
function var_0_0.buildTabViews(arg_3_0, arg_3_1)
	...
	arg_3_0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season3_0MainViewHelp)
