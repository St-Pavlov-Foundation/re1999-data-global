-- chunkname: @modules/logic/season/view1_6/Season1_6FightRuleTipView.lua

module("modules.logic.season.view1_6.Season1_6FightRuleTipView", package.seeall)

local Season1_6FightRuleTipView = class("Season1_6FightRuleTipView", BaseView)

function Season1_6FightRuleTipView:onInitView()
...
function Season1_6FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season1_6FightRuleTipView:_closeView()
	self:closeThis()
end

function Season1_6FightRuleTipView:onOpen()
	self._ruleList = Season1_6FightRuleView.getRuleList()
...
function Season1_6FightRuleTipView:createTab(go, tabType)
...
function Season1_6FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season1_6FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season1_6FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season1_6FightRuleTipView:switchTab(type)
...
function Season1_6FightRuleTipView:getTabActive(tabType)
...
function Season1_6FightRuleTipView:onClose()
	return
end

function Season1_6FightRuleTipView:onDestroyView()
...
return Season1_6FightRuleTipView
