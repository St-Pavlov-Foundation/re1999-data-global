...
slot0 = class("Season1_6HeroGroupFightViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	return {
		Season1_6HeroGroupFightView.New(),
		Season1_6HeroGroupListView.New(),
		Season1_6HeroGroupFightViewRule.New(),
		Season1_6HeroFightViewLevel.New(),
		HeroGroupInfoScrollView.New(),
		TabViewGroup.New(1, "#go_container/#go_btns/commonBtns")
	}
end

function slot0.getSeason1_6HeroGroupFightView(slot0)
...
function slot0.buildTabViews(slot0, slot1)
	if slot1 == 1 then
		slot0._navigateButtonsView = NavigateButtonsView.New({
			...
			true,
			true
		}, HelpEnum.HelpId.Season1_6HerogroupHelp, slot0._closeCallback, nil, , slot0)
