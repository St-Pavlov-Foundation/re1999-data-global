-- chunkname: @modules/logic/season/view1_6/Season1_6EquipComposeItem.lua

module("modules.logic.season.view1_6.Season1_6EquipComposeItem", package.seeall)

local Season1_6EquipComposeItem = class("Season1_6EquipComposeItem", ListScrollCellExtend)

function Season1_6EquipComposeItem:init(go)
	Season1_6EquipComposeItem.super.init(self, go)
...
function Season1_6EquipComposeItem:onUpdateMO(mo)
...
function Season1_6EquipComposeItem:refreshUI()
...
function Season1_6EquipComposeItem:setRoleIconDark(value)
	if value then
...
function Season1_6EquipComposeItem:refreshEquipedHero(heroUid)
...
Season1_6EquipComposeItem.ColumnCount = 6
Season1_6EquipComposeItem.AnimRowCount = 4
Season1_6EquipComposeItem.OpenAnimTime = 0.06
Season1_6EquipComposeItem.OpenAnimStartTime = 0.05

function Season1_6EquipComposeItem:checkPlayAnim()
...
function Season1_6EquipComposeItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_6EquipComposeItem:checkCreateIcon()
...
function Season1_6EquipComposeItem:onClickSelf()
	if self._mo then
		Activity104EquipComposeController.instance:changeSelectCard(self._mo.uid)
	end
end

function Season1_6EquipComposeItem:onLongPress()
	local data = {
...
function Season1_6EquipComposeItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
...
return Season1_6EquipComposeItem
