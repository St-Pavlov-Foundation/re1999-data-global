...
slot0 = class("Season1_6CelebrityCardTipView", BaseView)
...
function slot0.checkCreateIcon(slot0)
	if not slot0._icon then
		slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._gocard, "icon"), Season1_6CelebrityCardEquip)
	end
end
