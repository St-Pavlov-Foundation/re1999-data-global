...
local var_0_0 = class("Season1_6MainViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	local var_1_0 = {}

	arg_1_0.scene = Season1_6MainScene.New()
	arg_1_0.view = Season1_6MainView.New()
...
function var_0_0.buildTabViews(arg_3_0, arg_3_1)
	...
	arg_3_0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season1_6MainViewHelp)
