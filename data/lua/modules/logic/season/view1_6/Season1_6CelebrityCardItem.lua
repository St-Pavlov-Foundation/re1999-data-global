-- chunkname: @modules/logic/season/view1_6/Season1_6CelebrityCardItem.lua

module("modules.logic.season.view1_6.Season1_6CelebrityCardItem", package.seeall)

local Season1_6CelebrityCardItem = class("Season1_6CelebrityCardItem", LuaCompBase)

Season1_6CelebrityCardItem.AssetPath = "ui/viewres/v1a6_season/seasoncelebritycarditem.prefab"

function Season1_6CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season1_6CelebrityCardItem.AssetPath
...
function Season1_6CelebrityCardItem:_cardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season1_6CelebrityCardEquip)
...
function Season1_6CelebrityCardItem:showTag(enable)
...
function Season1_6CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season1_6CelebrityCardItem:showNewFlag(enable)
...
function Season1_6CelebrityCardItem:showNewFlag2(enable)
...
function Season1_6CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season1_6CelebrityCardItem:setColorDark(enable)
...
function Season1_6CelebrityCardItem:destroy()
	if self._icon then
...
return Season1_6CelebrityCardItem
