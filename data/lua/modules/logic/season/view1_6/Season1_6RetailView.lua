...
function slot0.onInitView(slot0)
	...
	slot0._txtruletips = gohelper.findChildText(slot0.viewGO, "right/#go_ruletips/bg/#txt_ruletips")
	slot0._gomaxrarecard = gohelper.findChild(slot0.viewGO, "right/#go_ruletips/bg/#txt_ruletips/#go_maxrarecard")
	slot0._gobtns = gohelper.findChild(slot0.viewGO, "#go_btns")
	slot0._txttitletips = gohelper.findChildText(slot0.viewGO, "title/tips/tips")
	slot0._txtsummon1 = gohelper.findChildText(slot0.viewGO, "right/#go_summon/#txt_summon1")
...
function slot0._showEntrance(slot0)
	...
	for slot7, slot8 in pairs(Activity104Model.instance:getAct104Retails()) do
		...
		if slot8.advancedId ~= 0 and slot8.advancedRare == 2 then
			...
			gohelper.findChildText(slot0["_gospecialtips" .. slot8.position], "bg/tips").text = string.format(luaLang("season_retail_specialtips"), slot11)
		end
