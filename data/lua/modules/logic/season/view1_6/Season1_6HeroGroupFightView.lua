...
local var_0_0 = class("Season1_6HeroGroupFightView", BaseView)
local var_0_1 = 1
...
function var_0_0._initData(arg_18_0)
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_6HeroGroupFightView, arg_18_0._onEscapeBtnClick, arg_18_0)
	...
	if var_23_2 then
		...
		if var_23_5 ~= 0 then
			if not arg_23_0._superCardItem then
				arg_23_0._superCardItem = Season1_6CelebrityCardItem.New()
