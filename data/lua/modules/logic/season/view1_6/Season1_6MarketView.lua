...
function slot0.onInitView(slot0)
	...
	slot0._txtdesc = gohelper.findChildText(slot0.viewGO, "#go_info/right/scroll/view/#txt_desc")
...
function slot0._editableInitView(slot0)
	...
	slot0._descScroll = gohelper.findChildScrollRect(slot0.viewGO, "#go_info/right/scroll")
end
...
function slot0._setParts(slot0)
	...
	if slot0._layer < Activity104Model.instance:getAct104CurLayer() or Activity104Model.instance:getMaxLayer() <= slot0._layer then
		...
		slot3 = Activity104Model.instance:isNextLayerNewStage(slot0._layer)

		gohelper.setActive(slot0._gostage, slot3)
		...
		if #string.splitToNumber(slot1.unlockEquipIndex, "#") > 0 then
			gohelper.setActive(slot0._gounlocktype1, slot4[1] < 5)
			gohelper.setActive(slot0._gounlocktype2, slot4[1] > 4 and slot4[1] < 9)
			gohelper.setActive(slot0._gounlocktype3, slot4[1] == 9)
		else
			gohelper.setActive(slot0._gounlocktype1, false)
			gohelper.setActive(slot0._gounlocktype2, false)
			gohelper.setActive(slot0._gounlocktype3, false)
		...
		gohelper.setActive(slot0._gopart, slot3 or #slot4 > 0)
		gohelper.setActive(slot0._gopartempty, not slot3 and #slot4 <= 0)
	...
	slot0._descScroll.verticalNormalizedPosition = 1

	recthelper.setHeight(slot0._descScroll.transform, slot2)
end
