...
function Season1_6MarketView:onInitView()
	...
	self._txtdesc = gohelper.findChildText(self.viewGO, "#go_info/right/scroll/view/#txt_desc")
...
function Season1_6MarketView:_editableInitView()
	...
	self._descScroll = gohelper.findChildScrollRect(self.viewGO, "#go_info/right/scroll")
end
...
function Season1_6MarketView:_setParts()
	...
	if self._layer < Activity104Model.instance:getAct104CurLayer() or self._layer >= Activity104Model.instance:getMaxLayer() then
		...
		if not isNewStage then
			descHeigh = 300
		end
	end

	self._descScroll.verticalNormalizedPosition = 1

	recthelper.setHeight(self._descScroll.transform, descHeigh)
end
