-- chunkname: @modules/logic/season/view1_6/Season1_6CelebrityCardGetlView.lua

module("modules.logic.season.view1_6.Season1_6CelebrityCardGetlView", package.seeall)

local Season1_6CelebrityCardGetlView = class("Season1_6CelebrityCardGetlView", BaseViewExtended)

Season1_6CelebrityCardGetlView.OpenType = {
	Get = 1
}

function Season1_6CelebrityCardGetlView:onInitView()
...
function Season1_6CelebrityCardGetlView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season1_6CelebrityCardGetlView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season1_6CelebrityCardGetlView:_btncloseOnClick()
	self:closeThis()
end

function Season1_6CelebrityCardGetlView:onOpen()
...
function Season1_6CelebrityCardGetlView:_showGetCard()
	self:com_loadAsset(Season1_6CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season1_6CelebrityCardGetlView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season1_6CelebrityCardGetScrollItem)
...
function Season1_6CelebrityCardGetlView:isItemID()
	return self.viewParam.is_item_id
end

function Season1_6CelebrityCardGetlView:onClose()
...
return Season1_6CelebrityCardGetlView
