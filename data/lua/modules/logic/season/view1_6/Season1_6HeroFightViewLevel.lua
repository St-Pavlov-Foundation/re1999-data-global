...
local var_0_0 = class("Season1_6HeroFightViewLevel", BaseView)
...
function var_0_0._refreshTarget(arg_6_0)
	if DungeonConfig.instance:getEpisodeCO(arg_6_0._episodeId).type == DungeonEnum.EpisodeType.SeasonRetail then
	...
	local var_6_4 = var_6_1 and var_6_1.star >= DungeonEnum.StarType.Normal and var_6_2
	local var_6_5 = var_6_1 and var_6_1.star >= DungeonEnum.StarType.Advanced and var_6_2
	local var_6_6 = false

	gohelper.setActive(arg_6_0._gonormalfinish, var_6_4)
	gohelper.setActive(arg_6_0._gonormalunfinish, not var_6_4)
	ZProj.UGUIHelper.SetColorAlpha(arg_6_0._txtnormalcondition, var_6_4 and 1 or 0.63)
	...
	if not string.nilorempty(var_6_3) then
		...
		gohelper.setActive(arg_6_0._goplatinumfinish, var_6_5)
		gohelper.setActive(arg_6_0._goplatinumunfinish, not var_6_5)
		ZProj.UGUIHelper.SetColorAlpha(arg_6_0._txtplatinumcondition, var_6_5 and 1 or 0.63)
	end

	gohelper.setActive(arg_6_0._goplace, false)
	arg_6_0:_showStar(var_6_1, var_6_3, var_6_4, var_6_5, var_6_6)
end
