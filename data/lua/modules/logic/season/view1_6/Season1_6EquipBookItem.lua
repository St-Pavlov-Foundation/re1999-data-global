-- chunkname: @modules/logic/season/view1_6/Season1_6EquipBookItem.lua

module("modules.logic.season.view1_6.Season1_6EquipBookItem", package.seeall)

local Season1_6EquipBookItem = class("Season1_6EquipBookItem", ListScrollCellExtend)

function Season1_6EquipBookItem:init(go)
	Season1_6EquipBookItem.super.init(self, go)
...
function Season1_6EquipBookItem:onUpdateMO(mo)
	self._mo = mo
...
Season1_6EquipBookItem.ColumnCount = 6
Season1_6EquipBookItem.AnimRowCount = 4
Season1_6EquipBookItem.OpenAnimTime = 0.06
Season1_6EquipBookItem.OpenAnimStartTime = 0.05

function Season1_6EquipBookItem:refreshUI()
...
function Season1_6EquipBookItem:checkPlayAnim()
...
function Season1_6EquipBookItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_6EquipBookItem:checkCreateIcon()
...
function Season1_6EquipBookItem:onClickSelf()
	if self._mo then
		Activity104EquipBookController.instance:changeSelect(self._mo.id)
	end
end

function Season1_6EquipBookItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
