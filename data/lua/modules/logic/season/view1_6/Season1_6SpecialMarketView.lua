...
slot0 = class("Season1_6SpecialMarketView", BaseView)
...
function slot0._btnstartOnClick(slot0)
	Activity104Model.instance:enterAct104Battle(SeasonConfig.instance:getSeasonSpecialCo(Activity104Model.instance:getCurSeasonId(), slot0._layer).episodeId, slot0._layer)
end
...
function slot0._refreshLevel(slot0)
	for slot5 = 1, Activity104Model.instance:getMaxSpecialLayer() do
		if not slot0._showLvItems[slot5] then
			slot0._showLvItems[slot5] = Season1_6SpecialMarketShowLevelItem.New()
