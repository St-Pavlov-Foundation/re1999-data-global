-- chunkname: @modules/logic/season/view1_4/Season1_4CelebrityCardGetlView.lua

module("modules.logic.season.view1_4.Season1_4CelebrityCardGetlView", package.seeall)

local Season1_4CelebrityCardGetlView = class("Season1_4CelebrityCardGetlView", BaseViewExtended)

Season1_4CelebrityCardGetlView.OpenType = {
	Get = 1
}

function Season1_4CelebrityCardGetlView:onInitView()
...
function Season1_4CelebrityCardGetlView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season1_4CelebrityCardGetlView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season1_4CelebrityCardGetlView:_btncloseOnClick()
	self:closeThis()
end

function Season1_4CelebrityCardGetlView:onOpen()
...
function Season1_4CelebrityCardGetlView:_showGetCard()
	self:com_loadAsset(Season1_4CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season1_4CelebrityCardGetlView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season1_4CelebrityCardGetScrollItem)
...
function Season1_4CelebrityCardGetlView:isItemID()
	return self.viewParam.is_item_id
end

function Season1_4CelebrityCardGetlView:onClose()
...
return Season1_4CelebrityCardGetlView
