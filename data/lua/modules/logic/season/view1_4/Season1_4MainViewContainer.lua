...
slot0 = class("Season1_4MainViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}
	slot0.scene = Season1_4MainScene.New()
	slot0.view = Season1_4MainView.New()
...
function slot0.buildTabViews(slot0, slot1)
	...
	slot0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season1_4MainViewHelp)
