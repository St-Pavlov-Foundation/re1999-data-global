-- chunkname: @modules/logic/season/view1_4/Season1_4FightFailView.lua

module("modules.logic.season.view1_4.Season1_4FightFailView", package.seeall)

local Season1_4FightFailView = class("Season1_4FightFailView", FightFailView)

function Season1_4FightFailView:onInitView()
...
function Season1_4FightFailView:onOpen()
...
function Season1_4FightFailView:refreshTips()
...
function Season1_4FightFailView:onClose()
	Season1_4FightFailView.super.onClose(self)
end

function Season1_4FightFailView:onDestroyView()
	Season1_4FightFailView.super.onDestroyView(self)
end

return Season1_4FightFailView
