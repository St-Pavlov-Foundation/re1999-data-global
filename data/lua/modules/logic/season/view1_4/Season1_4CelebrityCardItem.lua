-- chunkname: @modules/logic/season/view1_4/Season1_4CelebrityCardItem.lua

module("modules.logic.season.view1_4.Season1_4CelebrityCardItem", package.seeall)

local Season1_4CelebrityCardItem = class("Season1_4CelebrityCardItem", LuaCompBase)

Season1_4CelebrityCardItem.AssetPath = "ui/viewres/v1a4_season/seasoncelebritycarditem.prefab"

function Season1_4CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season1_4CelebrityCardItem.AssetPath
...
function Season1_4CelebrityCardItem:_cardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season1_4CelebrityCardEquip)
...
function Season1_4CelebrityCardItem:showTag(enable)
...
function Season1_4CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season1_4CelebrityCardItem:showNewFlag(enable)
...
function Season1_4CelebrityCardItem:showNewFlag2(enable)
...
function Season1_4CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season1_4CelebrityCardItem:setColorDark(enable)
...
function Season1_4CelebrityCardItem:destroy()
	if self._icon then
...
return Season1_4CelebrityCardItem
