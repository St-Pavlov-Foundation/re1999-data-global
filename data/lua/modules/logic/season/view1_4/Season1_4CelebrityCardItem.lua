...
slot0 = class("Season1_4CelebrityCardItem", LuaCompBase)
slot0.AssetPath = "ui/viewres/v1a4_season/seasoncelebritycarditem.prefab"
...
function slot0._cardLoaded(slot0)
	...
	slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._cardGo, Season1_4CelebrityCardEquip)
