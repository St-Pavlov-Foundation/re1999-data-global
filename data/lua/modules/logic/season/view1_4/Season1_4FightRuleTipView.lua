-- chunkname: @modules/logic/season/view1_4/Season1_4FightRuleTipView.lua

module("modules.logic.season.view1_4.Season1_4FightRuleTipView", package.seeall)

local Season1_4FightRuleTipView = class("Season1_4FightRuleTipView", BaseView)

function Season1_4FightRuleTipView:onInitView()
...
function Season1_4FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season1_4FightRuleTipView:_closeView()
	self:closeThis()
end

function Season1_4FightRuleTipView:onOpen()
	self._ruleList = Season1_4FightRuleView.getRuleList()
...
function Season1_4FightRuleTipView:createTab(go, tabType)
...
function Season1_4FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season1_4FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season1_4FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season1_4FightRuleTipView:switchTab(type)
...
function Season1_4FightRuleTipView:getTabActive(tabType)
...
function Season1_4FightRuleTipView:onClose()
	return
end

function Season1_4FightRuleTipView:onDestroyView()
...
return Season1_4FightRuleTipView
