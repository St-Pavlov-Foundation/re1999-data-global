...
slot0 = class("Season1_4MainScene", BaseView)
...
function slot0._initSceneRootNode(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New("Season1_4MainScene")
...
function slot0._loadSceneFinish(slot0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_4MainView, slot0.autoInitMainViewCamera, slot0.resetCamera, slot0)
end
...
function slot0.showLevelObjs(slot0, slot1)
	...
	if ViewMgr.instance:getContainer(ViewName.Season1_4MainView) then
		slot5:stopUI(false)
	end
end
