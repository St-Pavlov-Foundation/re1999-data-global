...
local var_0_0 = class("Season1_4MainScene", BaseView)
...
function var_0_0._initSceneRootNode(arg_19_0)
	...
	arg_19_0._sceneRoot = UnityEngine.GameObject.New("Season1_4MainScene")
...
function var_0_0._loadSceneFinish(arg_21_0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_4MainView, arg_21_0.autoInitMainViewCamera, arg_21_0.resetCamera, arg_21_0)
end
...
function var_0_0.showLevelObjs(arg_24_0, arg_24_1)
	...
	local var_24_4 = ViewMgr.instance:getContainer(ViewName.Season1_4MainView)
...
function var_0_0._hideLevelObjs(arg_25_0, arg_25_1)
	...
	local var_25_0 = ViewMgr.instance:getContainer(ViewName.Season1_4MainView)
