...
slot0 = class("Season1_4SumView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0.simagePanelBg1:LoadImage("singlebg/v1a4_season_sum_singlebg/v1a4_season_sum_bg.png")
	slot0.simagePanelBg2:LoadImage("singlebg/v1a4_season_sum_singlebg/v1a4_season_sum_bg.png")
	slot0.simagePanelBg3:LoadImage("singlebg/v1a4_season_sum_singlebg/v1a4_season_sum_frame.png")
end
...
function slot0.showMailView(slot0)
	...
	UISpriteSetMgr.instance:setV1a4SeasonSumSprite(slot0.mailChapterBg, string.format("v1a4_season_sum_chapterpic%s", slot9.stage))
end
...
function slot0.refreshCard(slot0, slot1, slot2)
	...
	if not slot3.cardItem then
		slot3.cardItem = Season1_4CelebrityCardItem.New()
