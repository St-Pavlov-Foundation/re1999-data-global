-- chunkname: @modules/logic/season/view1_4/Season1_4EquipBookItem.lua

module("modules.logic.season.view1_4.Season1_4EquipBookItem", package.seeall)

local Season1_4EquipBookItem = class("Season1_4EquipBookItem", ListScrollCellExtend)

function Season1_4EquipBookItem:init(go)
	Season1_4EquipBookItem.super.init(self, go)
...
function Season1_4EquipBookItem:onUpdateMO(mo)
	self._mo = mo
...
Season1_4EquipBookItem.ColumnCount = 6
Season1_4EquipBookItem.AnimRowCount = 4
Season1_4EquipBookItem.OpenAnimTime = 0.06
Season1_4EquipBookItem.OpenAnimStartTime = 0.05

function Season1_4EquipBookItem:refreshUI()
...
function Season1_4EquipBookItem:checkPlayAnim()
...
function Season1_4EquipBookItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season1_4EquipBookItem:checkCreateIcon()
...
function Season1_4EquipBookItem:onClickSelf()
	if self._mo then
		Activity104EquipBookController.instance:changeSelect(self._mo.id)
	end
end

function Season1_4EquipBookItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
