...
local var_0_0 = class("Season1_4HeroGroupFightView", BaseView)
local var_0_1 = 1
...
function var_0_0._initData(arg_18_0)
	...
	NavigateMgr.instance:addEscape(ViewName.Season1_4HeroGroupFightView, arg_18_0._onEscapeBtnClick, arg_18_0)
	...
	if var_23_2 then
		...
		if var_23_5 ~= 0 then
			if not arg_23_0._superCardItem then
				arg_23_0._superCardItem = Season1_4CelebrityCardItem.New()
	...
	if HeroGroupModel.instance.episodeId then
		...
		if FightController.instance:setFightHeroGroup() then
			...
			if arg_55_0._replayMode then
				...
				DungeonFightController.instance:sendStartDungeonRequest(var_55_0.chapterId, var_55_0.episodeId, var_55_0, arg_55_0._multiplication, nil, true)
			else
