-- chunkname: @modules/logic/season/view1_4/Season1_4SettlementTipsWork.lua

module("modules.logic.season.view1_4.Season1_4SettlementTipsWork", package.seeall)

local Season1_4SettlementTipsWork = class("Season1_4SettlementTipsWork", BaseWork)

function Season1_4SettlementTipsWork:onStart(context)
...
function Season1_4SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season1_4SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season1_4SettlementTipsWork:_showGetCardView()
...
function Season1_4SettlementTipsWork:_showChoiceCardView()
...
function Season1_4SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season1_4SettlementTipsWork
