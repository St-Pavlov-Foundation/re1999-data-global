-- chunkname: @modules/logic/season/view1_4/Season1_4MarketShowLevelItem.lua

module("modules.logic.season.view1_4.Season1_4MarketShowLevelItem", package.seeall)

local Season1_4MarketShowLevelItem = class("Season1_4MarketShowLevelItem", LuaCompBase)

function Season1_4MarketShowLevelItem:init(go, index, targetIndex, maxIndex)
	self.go = go
	self.index = index
...
function Season1_4MarketShowLevelItem:show()
...
function Season1_4MarketShowLevelItem:destroy()
	return
end

return Season1_4MarketShowLevelItem
