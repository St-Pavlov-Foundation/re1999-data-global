...
slot0 = class("Season1_4EquipViewContainer", BaseViewContainer)
...
function slot0.createEquipItemsParam(slot0)
	...
	slot1.cellClass = Season1_4EquipItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = Season1_4EquipItem.ColumnCount
	slot1.cellWidth = 170
	slot1.cellHeight = 235
	slot1.cellSpaceH = 8.4
	slot1.cellSpaceV = 0
	slot1.frameUpdateMs = 100
	slot1.minUpdateCountInFrame = Season1_4EquipItem.ColumnCount
