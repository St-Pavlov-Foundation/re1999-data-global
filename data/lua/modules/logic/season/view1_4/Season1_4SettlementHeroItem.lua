...
slot0 = class("Season1_4SettlementHeroItem", BaseViewExtended)
...
function slot0._showEquip104(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:openSubView(Season1_4CelebrityCardGetItem, Season1_4CelebrityCardItem.AssetPath, slot3 <= 1 and slot0._gosingle or slot0["_gocard" .. slot1], slot2, nil, slot4)
end
