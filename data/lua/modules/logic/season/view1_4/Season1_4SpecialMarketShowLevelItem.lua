-- chunkname: @modules/logic/season/view1_4/Season1_4SpecialMarketShowLevelItem.lua

module("modules.logic.season.view1_4.Season1_4SpecialMarketShowLevelItem", package.seeall)

local Season1_4SpecialMarketShowLevelItem = class("Season1_4SpecialMarketShowLevelItem", LuaCompBase)

function Season1_4SpecialMarketShowLevelItem:init(go)
	self.go = go
...
function Season1_4SpecialMarketShowLevelItem:_btnOnClick()
	Activity104Controller.instance:dispatchEvent(Activity104Event.SwitchSpecialEpisode, self.index)
end

function Season1_4SpecialMarketShowLevelItem:reset(index, targetIndex, maxSpecialLayer)
	self.index = index
...
function Season1_4SpecialMarketShowLevelItem:_refreshItem()
...
function Season1_4SpecialMarketShowLevelItem:destroy()
	self._btnClick:RemoveClickListener()
end

return Season1_4SpecialMarketShowLevelItem
