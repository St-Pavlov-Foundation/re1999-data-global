...
local var_0_0 = class("InvestigateTaskItem", ListScrollCell)
...
var_0_0.FinishKey = "InvestigateTaskItem FinishKey"
...
function var_0_0.secondAnimationDone(arg_8_0)
	...
	if arg_8_0.taskMo.getAll then
		...
		TaskRpc.instance:sendFinishTaskRequest(arg_8_0.co.taskId)
	end
end
...
function var_0_0.refreshNormalUI(arg_11_0)
	arg_11_0.co = lua_investigate_reward.configDict[arg_11_0.taskMo.id]
	arg_11_0._maxFinishCount = 1
	...
	if arg_11_0.taskMo.finishCount >= arg_11_0._maxFinishCount then
...
function var_0_0.canGetReward(arg_14_0)
	return arg_14_0.taskMo.finishCount < arg_14_0._maxFinishCount and arg_14_0.taskMo.hasFinished
end
