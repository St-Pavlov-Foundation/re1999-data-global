...
slot0 = class("InvestigateTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = InvestigateTaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(InvestigateTaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
