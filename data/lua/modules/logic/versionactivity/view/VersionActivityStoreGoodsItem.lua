...
slot0 = class("VersionActivityStoreGoodsItem", UserDataDispose)
...
function slot0.updateInfo(slot0, slot1)
	...
	UISpriteSetMgr.instance:setVersionActivitySprite(slot0.imageRare, "img_pinzhi_" .. slot7 + 1)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivityEnum.ActivityId.Act107, slot0.storeGoodsCo.id)
