...
local var_0_0 = class("VersionActivityStoreGoodsItem", UserDataDispose)
...
function var_0_0.updateInfo(arg_3_0, arg_3_1)
	...
	UISpriteSetMgr.instance:setVersionActivitySprite(arg_3_0.imageRare, "img_pinzhi_" .. var_3_6 + 1)
...
function var_0_0.refreshRemainBuyCount(arg_6_0)
	if arg_6_0.storeGoodsCo.maxBuyCount == 0 then
		...
		arg_6_0.remainBuyCount = arg_6_0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivityEnum.ActivityId.Act107, arg_6_0.storeGoodsCo.id)
