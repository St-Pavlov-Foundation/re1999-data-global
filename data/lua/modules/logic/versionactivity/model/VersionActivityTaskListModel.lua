...
local var_0_0 = class("VersionActivityTaskListModel", ListScrollModel)
...
function var_0_0.initTaskList(arg_3_0)
	arg_3_0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivityEnum.ActivityId.Act113)
end
