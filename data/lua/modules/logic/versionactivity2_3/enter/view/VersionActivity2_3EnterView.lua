...
slot0 = class("VersionActivity2_3EnterView", VersionActivityEnterBaseViewWithListNew)
...
function slot0._editableInitView(slot0)
	...
	slot0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.First, slot0._gotabitem1, VersionActivity2_3EnterViewTabItem1)
	slot0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.Second, slot0._gotabitem2, VersionActivity2_3EnterViewTabItem2)
...
function slot0._onTabScrollChange(slot0)
	for slot5, slot6 in ipairs(slot0.activityTabItemList) do
		if slot6:isShowRedDot() and slot0.viewPortHeight < -slot6:getAnchorY() + VersionActivity2_3Enum.RedDotOffsetY - recthelper.getAnchorY(slot0.rectTrContent) then
...
function slot0.refreshBtnVisible(slot0, slot1)
	gohelper.setActive(slot0.goReplayBtn, VersionActivity2_3EnterHelper.GetIsShowReplayBtn(slot0.curActId))
	gohelper.setActive(slot0.goAchievementBtn, VersionActivity2_3EnterHelper.GetIsShowAchievementBtn(slot0.curActId))
end

function slot0.onOpen(slot0)
	uv0.super.onOpen(slot0)

	if slot0.curActId ~= VersionActivity2_3Enum.ActivityId.Season then
