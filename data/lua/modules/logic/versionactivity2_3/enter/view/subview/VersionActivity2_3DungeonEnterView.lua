...
slot0 = class("VersionActivity2_3DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_3Enum.ActivityId.Dungeon
	slot0.animComp = VersionActivity2_3SubAnimatorComp.get(slot0.viewGO, slot0)
	...
	slot0:_setDesc()
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a3DungeonEnter)
...
function slot0.refreshRemainTime(slot0)
	...
	slot3 = ActivityModel.instance:getActivityInfo()[VersionActivity2_3Enum.ActivityId.DungeonStore]
...
function slot0.refreshActivityState(slot0)
	...
	gohelper.setActive(slot0.goStore, ActivityHelper.getActivityStatusAndToast(VersionActivity2_3Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal)
end
