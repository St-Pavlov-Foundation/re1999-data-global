...
local var_0_0 = class("VersionActivity2_3EnterBgmView", BaseView)
...
function var_0_0.initActHandle(arg_5_0)
	if not arg_5_0.actHandleDict then
		arg_5_0.actHandleDict = {
			...
			[VersionActivity2_3Enum.ActivityId.ZhiXinQuanEr] = arg_5_0._zhixinquanerBgmHandle
		}
	end
end
...
function var_0_0.onOpen(arg_6_0)
	...
	arg_6_0._isFirstOpenMainAct = var_6_2 == VersionActivity2_3Enum.ActivityId.Dungeon
...
function var_0_0.modifyBgm(arg_8_0, arg_8_1)
	arg_8_0._isMainAct = arg_8_1 == VersionActivity2_3Enum.ActivityId.Dungeon
...
function var_0_0.defaultBgmHandle(arg_10_0, arg_10_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_3Main, var_10_0)
end
...
function var_0_0._bossrushBgmHandle(arg_12_0, arg_12_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_3Main, var_12_0)
end

function var_0_0._zhixinquanerBgmHandle(arg_13_0, arg_13_1)
	...
	AudioBgmManager.instance:setSwitchData(AudioBgmEnum.Layer.VersionActivity2_3Main, FightEnum.AudioSwitchGroup, FightEnum.AudioSwitch.Comeshow)
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_3Main, var_13_0)
end
...
function var_0_0._reactivityBgmHandle(arg_14_0, arg_14_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_3Main, var_14_0)
end
