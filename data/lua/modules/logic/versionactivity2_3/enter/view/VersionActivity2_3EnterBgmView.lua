...
slot0 = class("VersionActivity2_3EnterBgmView", BaseView)
...
function slot0.initActHandle(slot0)
	if not slot0.actHandleDict then
		slot0.actHandleDict = {
			...
			[VersionActivity2_3Enum.ActivityId.ZhiXinQuanEr] = slot0._zhixinquanerBgmHandle
		}
	end
end
...
function slot0.onOpen(slot0)
	...
	slot0._isFirstOpenMainAct = VersionActivityEnterHelper.getActId(slot1[VersionActivityEnterHelper.getTabIndex(slot1, slot0.viewParam.jumpActId)]) == VersionActivity2_3Enum.ActivityId.Dungeon
...
function slot0.modifyBgm(slot0, slot1)
	slot0._isMainAct = slot1 == VersionActivity2_3Enum.ActivityId.Dungeon
	slot2 = 0
...
function slot0.defaultBgmHandle(slot0, slot1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_3Main, slot2)
end
...
function slot0._zhixinquanerBgmHandle(slot0, slot1)
	slot0.playingActId = slot1
	slot2 = ActivityConfig.instance:getActivityEnterViewBgm(slot1)
	slot0.bgmId = slot2
