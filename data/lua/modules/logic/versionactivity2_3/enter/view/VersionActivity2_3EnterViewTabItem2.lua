...
slot0 = class("VersionActivity2_3EnterViewTabItem2", VersionActivity2_3EnterViewTabItemBase)
...
function slot0.childRefreshSelect(slot0, slot1)
	...
	slot2 = VersionActivity2_3Enum.TabSetting.unselect

	if slot0.isSelect then
		slot2 = VersionActivity2_3Enum.TabSetting.select
	end
