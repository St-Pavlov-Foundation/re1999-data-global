...
slot0 = class("V2a3_WarmUpContainer", Activity125WarmUpViewBaseContainer)
slot1 = {
	Done = 1999,
	None = 0
}
slot2 = "v2a3_warmup_day%s"

function slot0.getImgResUrl(slot0, slot1)
	return ResUrl.getV2a3WarmUpSingleBg(string.format(uv0, slot1))
end

function slot0.buildViews(slot0)
	slot0._warmUp = V2a3_WarmUp.New()
	slot0._warmUpLeftView = V2a3_WarmUpLeftView.New()
