...
local var_0_0 = class("ZhiXinQuanErTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_1.cellClass = ZhiXinQuanErTaskItem
	...
	table.insert(var_1_0, ZhiXinQuanErTaskView.New())
