...
slot0 = class("Act174StoreGoodsItem", UserDataDispose)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_3Enum.ActivityId.Act174Store, slot0.storeGoodsCo.id)
