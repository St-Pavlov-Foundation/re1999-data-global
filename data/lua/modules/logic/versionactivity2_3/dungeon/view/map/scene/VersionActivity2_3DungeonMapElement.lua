...
local var_0_0 = class("VersionActivity2_3DungeonMapElement", LuaCompBase)
local var_0_1 = 1.6
...
function var_0_0.onClick(arg_23_0)
	VersionActivity2_3DungeonController.instance:dispatchEvent(VersionActivity2_3DungeonEvent.OnClickElement, arg_23_0)
end
