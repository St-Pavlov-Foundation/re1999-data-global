...
slot0 = class("VersionActivity2_3DungeonMapElement", LuaCompBase)
slot1 = 1.6
...
function slot0.onClick(slot0)
	VersionActivity2_3DungeonController.instance:dispatchEvent(VersionActivity2_3DungeonEvent.OnClickElement, slot0)
end
