...
function VersionActivity2_3DungeonMapChapterLayout:addEvents()
	...
	self:addEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, self._GuideShowElement, self)
...
function VersionActivity2_3DungeonMapChapterLayout:removeEvents()
	...
	self:removeEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end
