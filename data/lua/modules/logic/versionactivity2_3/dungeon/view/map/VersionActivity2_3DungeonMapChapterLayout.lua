...
local var_0_0 = class("VersionActivity2_3DungeonMapChapterLayout", BaseChildView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, arg_2_0._GuideShowElement, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.GuideShowElement, arg_3_0._GuideShowElement, arg_3_0)
end

function var_0_0._onOpenView(arg_4_0, arg_4_1)
	if arg_4_1 == ViewName.VersionActivity2_3DungeonMapLevelView then
...
function var_0_0._onCloseView(arg_5_0, arg_5_1)
	if arg_5_1 == ViewName.VersionActivity2_3DungeonMapLevelView then
...
function var_0_0._onGamepadKeyUp(arg_8_0, arg_8_1)
	...
	if var_8_1 ~= ViewName.VersionActivity2_3DungeonMapView and var_8_1 ~= ViewName.VersionActivity2_3DungeonMapLevelView then
		return
	end
...
function var_0_0._GuideShowElement(arg_23_0, arg_23_1)
	...
	if var_23_1 then
		...
		VersionActivity2_3DungeonController.instance:dispatchEvent(VersionActivity2_3DungeonEvent.FocusElement, var_23_0)
	end
end
