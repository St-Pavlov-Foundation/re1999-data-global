-- chunkname: @modules/logic/versionactivity2_3/dungeon/view/map/VersionActivity2_3DungeonMapFinishElement.lua

module("modules.logic.versionactivity2_3.dungeon.view.map.VersionActivity2_3DungeonMapFinishElement", package.seeall)

local VersionActivity2_3DungeonMapFinishElement = class("VersionActivity2_3DungeonMapFinishElement", DungeonMapFinishElement)

function VersionActivity2_3DungeonMapFinishElement:init(go)
	self._go = go
...
function VersionActivity2_3DungeonMapFinishElement:_onResLoaded()
	if not string.nilorempty(self.resPath) then
...
function VersionActivity2_3DungeonMapFinishElement:onDown()
	self:_onDown()
end

function VersionActivity2_3DungeonMapFinishElement:_onDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivity2_3DungeonMapFinishElement:onClick()
...
return VersionActivity2_3DungeonMapFinishElement
