...
local var_0_0 = class("VersionActivity2_3DungeonMapView", BaseView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnHideInteractUI, arg_2_0.showBtnUI, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnHideInteractUI, arg_3_0.showBtnUI, arg_3_0)
...
function var_0_0.onRemoveElement(arg_11_0, arg_11_1)
	local var_11_0 = VersionActivity2_3DungeonModel.instance:checkStoryCanUnlock(arg_11_1)
...
function var_0_0._editableInitView(arg_12_0)
	local var_12_0 = CurrencyConfig.instance:getCurrencyCo(CurrencyEnum.CurrencyType.V2a3Dungeon)
	...
	local var_12_2 = ActivityModel.instance:getActivityInfo()[VersionActivity2_3Enum.ActivityId.DungeonStore]
...
function var_0_0.refreshActivityCurrency(arg_18_0)
	local var_18_0 = CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V2a3Dungeon)
...
function var_0_0.onRefreshActivityState(arg_19_0, arg_19_1)
	if arg_19_1 == VersionActivity2_3Enum.ActivityId.Dungeon and not (ActivityHelper.getActivityStatusAndToast(arg_19_1) == ActivityEnum.ActivityStatus.Normal) then
		arg_19_0:closeThis()
...
function var_0_0._onOpenView(arg_20_0, arg_20_1)
	if arg_20_1 ~= ViewName.VersionActivity2_3DungeonMapLevelView then
		return
	end
...
function var_0_0._onCloseView(arg_23_0, arg_23_1)
	if arg_23_1 ~= ViewName.VersionActivity2_3DungeonMapLevelView then
		return
	end
...
function var_0_0.refreshStoreRemainTime(arg_31_0)
	local var_31_0 = VersionActivity2_3Enum.ActivityId.DungeonStore

	if ReactivityEnum.ActivityDefine[VersionActivity2_3Enum.ActivityId.Dungeon] then
		var_31_0 = VersionActivity2_9Enum.ActivityId.ReactivityStore
	end
