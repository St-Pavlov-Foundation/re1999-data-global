...
slot0 = class("VersionActivity2_3TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity2_3TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity2_3Enum.ActivityId.Dungeon)
	else
