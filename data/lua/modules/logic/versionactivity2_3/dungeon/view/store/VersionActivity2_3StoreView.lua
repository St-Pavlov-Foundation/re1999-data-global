...
slot0 = class("VersionActivity2_3StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_3Enum.ActivityId.DungeonStore
...
function slot0.refreshTime(slot0)
	slot0._txttime.text = ActivityModel.instance:getActivityInfo()[VersionActivity2_3Enum.ActivityId.DungeonStore]:getRemainTimeStr3(false, false)
end
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, #slot1 do
		if not slot0.storeItemList[slot6] then
			slot2 = VersionActivity2_3StoreItem.New()
