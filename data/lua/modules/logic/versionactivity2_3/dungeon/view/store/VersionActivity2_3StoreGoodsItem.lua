-- chunkname: @modules/logic/versionactivity2_3/dungeon/view/store/VersionActivity2_3StoreGoodsItem.lua

module("modules.logic.versionactivity2_3.dungeon.view.store.VersionActivity2_3StoreGoodsItem", package.seeall)

local VersionActivity2_3StoreGoodsItem = class("VersionActivity2_3StoreGoodsItem", UserDataDispose)

function VersionActivity2_3StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_3StoreGoodsItem:onClick()
...
function VersionActivity2_3StoreGoodsItem:updateInfo(storeGoodsCo)
	self.storeGoodsCo = storeGoodsCo

	self:refreshRemainBuyCount()

	local productItemType, productItemId, productItemQuantity = VersionActivity2_3EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setV2a3MainActivitySprite(self.imageRare, "v2a3_store_quality_" .. rare)
	...
	self.costItemType, self.costItemId, self.costItemQuantity = VersionActivity2_3EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.cost)
...
function VersionActivity2_3StoreGoodsItem:refreshRemainBuyCount()
...
function VersionActivity2_3StoreGoodsItem:setImageIconNative()
	self.imageIcon:SetNativeSize()
end

function VersionActivity2_3StoreGoodsItem:refreshTag()
...
function VersionActivity2_3StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity2_3StoreGoodsItem:onDestroy()
...
return VersionActivity2_3StoreGoodsItem
