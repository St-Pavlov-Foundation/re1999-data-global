...
local var_0_0 = class("VersionActivity2_3TaskListModel", ListScrollModel)
...
function var_0_0.initTask(arg_3_0)
	arg_3_0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_3Enum.ActivityId.Dungeon)
end
