...
slot0 = class("VersionActivity2_3TaskListModel", ListScrollModel)
...
function slot0.initTask(slot0)
	slot0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_3Enum.ActivityId.Dungeon)
end
