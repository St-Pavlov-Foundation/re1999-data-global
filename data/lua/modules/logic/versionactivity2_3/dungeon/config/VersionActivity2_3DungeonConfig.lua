...
slot0 = class("VersionActivity2_3DungeonConfig", BaseConfig)

function slot1(slot0)
	if DungeonConfig.instance:getEpisodeCO(slot0).chapterId ~= VersionActivity2_3DungeonEnum.DungeonChapterId.ElementFight then
		if slot1.chapterId == VersionActivity2_3DungeonEnum.DungeonChapterId.Hard then
			slot1 = DungeonConfig.instance:getEpisodeCO(slot0 - 10000)
		else
			while slot1.chapterId ~= VersionActivity2_3DungeonEnum.DungeonChapterId.Story do
...
function slot0.getEpisodeMapConfig(slot0, slot1)
	return DungeonConfig.instance:getChapterMapCfg(VersionActivity2_3DungeonEnum.DungeonChapterId.Story, uv0(slot1).preEpisode)
end
