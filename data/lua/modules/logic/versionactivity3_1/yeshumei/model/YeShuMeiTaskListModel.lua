...
local var_0_0 = class("YeShuMeiTaskListModel", ListScrollModel)

function var_0_0.init(arg_1_0, arg_1_1)
	local var_1_0 = TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity211)
	local var_1_1 = {}
	local var_1_2 = 0

	if var_1_0 ~= nil then
		local var_1_3 = YeShuMeiConfig.instance:getTaskByActId(arg_1_1)

		for iter_1_0, iter_1_1 in ipairs(var_1_3) do
			local var_1_4 = YeShuMeiTaskMo.New()
	...
	if var_1_2 > 1 then
		local var_1_5 = YeShuMeiTaskMo.New()
