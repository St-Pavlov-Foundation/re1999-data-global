...
local var_0_0 = class("YeShuMeiTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_1.cellClass = YeShuMeiTaskItem
	...
	local var_1_3 = LuaListScrollViewWithAnimator.New(YeShuMeiTaskListModel.instance, var_1_1, var_1_2)

	var_1_3.dontPlayCloseAnimation = true

	table.insert(var_1_0, var_1_3)
	table.insert(var_1_0, YeShuMeiTaskView.New())
