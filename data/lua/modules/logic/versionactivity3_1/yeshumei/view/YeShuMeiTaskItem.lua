...
local var_0_0 = class("YeShuMeiTaskItem", ListScrollCellExtend)
...
function var_0_0._btngetallOnClick(arg_6_0)
	YeShuMeiController.instance:dispatchEvent(YeShuMeiEvent.OneClickClaimReward, arg_6_0._taskMo.activityId, true)
	UIBlockHelper.instance:startBlock("YeShuMeiTaskItem_finishAnim", 0.5)
...
function var_0_0._editableAddEvents(arg_10_0)
	YeShuMeiController.instance:registerCallback(YeShuMeiEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	YeShuMeiController.instance:unregisterCallback(YeShuMeiEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end

function var_0_0._onOneClickClaimReward(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_0._taskMo and arg_12_0._taskMo.activityId == arg_12_1 and (arg_12_0._taskMo:alreadyGotReward() or arg_12_0._taskMo.id == -99999 and arg_12_2) then
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	...
	local var_14_0 = YeShuMeiTaskListModel.instance:getRankDiff(arg_14_1)
