...
local var_0_0 = class("V3a1_WarmUp_radiotaskitem", RougeSimpleItemBase)
...
function var_0_0._editableInitView(arg_5_0)
	...
	arg_5_0._click = gohelper.findChildButtonWithAudio(arg_5_0.viewGO, "btn_click", AudioEnum.UI.OpenRewardNoticeView)
...
function var_0_0._checkIfOpenAndToast(arg_17_0)
	...
	if not arg_17_0:_isEpisodeReallyOpen(var_17_0) then
