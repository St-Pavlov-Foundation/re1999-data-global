...
local var_0_0 = class("V3a1_GaoSiNiao_GameView_GridItem_Empty", V3a1_GaoSiNiao_GameView_GridItem_PieceBase)
...
function var_0_0._editableInitView(arg_5_0)
	...
	arg_5_0._image_Piece = gohelper.findChild(arg_5_0.viewGO, "image_Slot")
...
function var_0_0.resetRotate(arg_7_0)
	return
end

function var_0_0.setGray_Blood(arg_8_0, arg_8_1)
	return
end
