...
local var_0_0 = class("VersionActivity3_1CanJumpFunc")

function var_0_0.canJumpTo12402(arg_1_0, arg_1_1)
	local var_1_0, var_1_1, var_1_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity3_1Enum.ActivityId.EnterView)

	if var_1_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_1_1, var_1_2
	end

	local var_1_3 = VersionActivity3_1Enum.ActivityId.Reactivity
...
function var_0_0.canJumpTo13103(arg_2_0, arg_2_1)
	local var_2_0, var_2_1, var_2_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity3_1Enum.ActivityId.EnterView)

	if var_2_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_2_1, var_2_2
	end

	local var_2_3 = VersionActivity3_1Enum.ActivityId.Dungeon
...
function var_0_0.canJumpTo13106(arg_3_0, arg_3_1)
	local var_3_0, var_3_1, var_3_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity3_1Enum.ActivityId.EnterView)

	if var_3_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_3_1, var_3_2
	end

	local var_3_3 = VersionActivity3_1Enum.ActivityId.Survival
