...
function slot0.onInitView(slot0)
	...
	slot0._closeFlag = gohelper.findChild(slot0.viewGO, "Root/#go_Tips/close")
	slot0._animTips = slot0._goTips:GetComponent(gohelper.Type_Animator)
	slot0._btnTipClose = gohelper.findChildButtonWithAudio(slot0.viewGO, "Root/#go_Tips/close")
...
function slot0.onOpen(slot0)
	...
	Activity160Rpc.instance:sendGetAct160InfoRequest(slot0.actId)
...
function slot0._onOpenViewFinish(slot0, slot1)
	...
	elseif slot1 == ViewName.ActivityWelfareView then
		slot2 = ActivityEnum.Activity.NoviceSign

		ActivityBeginnerController.instance:setFirstEnter(slot2)
...
function slot0._initTipsView(slot0)
	...
	for slot4, slot5 in ipairs(slot0.missionCO) do
		...
		slot7 = gohelper.findChild(slot0.viewGO, "Root/#go_Tips/List/#go_" .. slot4)
