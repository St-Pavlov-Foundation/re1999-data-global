...
function slot0._editableInitView(slot0)
	...
	slot0._simagebg:LoadImage(ResUrl.getSocialIcon("img_tips_bg.png"))
...
function slot0._refreshUI(slot0)
	if not slot0._mo.bg or slot0._mo.bg == 0 then
		...
		gohelper.setActive(slot0._gocustombg, false)
	else
		gohelper.setActive(slot0._simagebg, false)
		gohelper.setActive(slot0._gocustombg, true)
		slot0._simagebg2:LoadImage(string.format("singlebg/playerinfo/%s.png", PlayerConfig.instance:getBgCo(slot0._mo.bg).infobg))
	end
