...
function var_0_0.canGetReward(arg_11_0, arg_11_1)
	local var_11_0 = WeekWalk_2Config.instance:getWeekWalkTaskList(arg_11_1)
	...
	for iter_11_0, iter_11_1 in ipairs(var_11_0) do
		...
		local var_11_2 = lua_task_weekwalk_ver2.configDict[iter_11_1.id]
...
function var_0_0._taskStatus(arg_13_0, arg_13_1)
	...
	local var_13_1 = lua_task_weekwalk_ver2.configDict[arg_13_1.id]
...
function var_0_0.updateTaskList(arg_15_0)
	arg_15_0._taskList = TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.WeekWalk_2)
end
