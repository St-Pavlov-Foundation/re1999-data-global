...
slot0 = class("DragonBoatFestivalView", BaseView)
...
function slot0.onOpen(slot0)
	...
	slot0._simageLogo:LoadImage(ResUrl.getV1a9LogoSingleBg("v1a9_logo2"))
	slot0:_refreshItems()
	slot0:_refreshMap()
...
function slot0._refreshMap(slot0)
	...
	slot4 = DragonBoatFestivalModel.instance:isGiftUnlock(slot1)

	if slot1 == slot2 and not DragonBoatFestivalModel.instance:isGiftGet(slot2) and not slot0._hasClickReward then
		slot4 = false
	end

	gohelper.setActive(slot0._goPuzzlePicClose, not slot4)
	gohelper.setActive(slot0._goPuzzlePicOpen, slot4)
	UISpriteSetMgr.instance:setDragonBoatSprite(slot0._imagePuzzlePic, DragonBoatFestivalConfig.instance:getDragonBoatCo(slot1).dayicon)
end
