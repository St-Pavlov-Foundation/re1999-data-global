...
local var_0_0 = class("MainUISwitchItem", ListScrollCellExtend)
...
function var_0_0._onClick(arg_7_0)
	...
	if arg_7_0._showReddot then
		MainUISwitchController.closeReddot(var_7_0)
		arg_7_0:_updateReddot()
	end

	AudioMgr.instance:trigger(AudioEnum.MainSceneSkin.play_ui_main_switch_scene)
	MainUISwitchListModel.instance:selectCellIndex(arg_7_0._index)
	MainUISwitchController.instance:dispatchEvent(MainUISwitchEvent.SwitchMainUI, var_7_0)
end
...
function var_0_0.onUpdateMO(arg_8_0, arg_8_1)
	...
	local var_8_1 = ResUrl.getMainSceneSwitchLangIcon(var_8_0)

	arg_8_0._simageicon:LoadImage(var_8_1)

	local var_8_2 = MainUISwitchModel.instance:getCurUseUI() == arg_8_0._mo.co.id

	gohelper.setActive(arg_8_0._goTag, var_8_2)

	local var_8_3 = MainUISwitchListModel.instance:getSelectedCellIndex() == arg_8_0._index
	...
	local var_8_4 = MainUISwitchModel.getUIStatus(arg_8_0._mo.co.id) == MainSceneSwitchEnum.SceneStutas.Unlock
...
function var_0_0._updateReddot(arg_9_0)
	arg_9_0._showReddot = MainUISwitchController.hasReddot(arg_9_0._mo.co.id)
...
function var_0_0._onAnimDone(arg_11_0)
	...
	local var_11_0 = arg_11_0._isSelect and 1 or MainUISwitchEnum.ItemUnSelectedScale
