...
slot0 = class("VersionActivity1_8EnterController", BaseController)
...
function slot0.openVersionActivityEnterView(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:_internalOpenView(ViewName.VersionActivity1_8EnterView, slot5, slot8, slot0, {
		actId = VersionActivity1_8Enum.ActivityId.EnterView,
		jumpActId = slot3,
		activityIdList = VersionActivityEnterHelper.getActIdList(VersionActivity1_8Enum.EnterViewActSetting),
