...
local var_0_0 = class("VersionActivity1_8CanJumpFunc")

function var_0_0.canJumpTo11804(arg_1_0, arg_1_1)
	local var_1_0, var_1_1, var_1_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity1_8Enum.ActivityId.EnterView)

	if var_1_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_1_1, var_1_2
	end

	local var_1_3 = VersionActivity1_8Enum.ActivityId.Dungeon
...
function var_0_0.canJumpTo11815(arg_2_0, arg_2_1)
	local var_2_0, var_2_1, var_2_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity1_8Enum.ActivityId.DungeonReturnToWork)

	if var_2_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_2_1, var_2_2
	end

	local var_2_3 = arg_2_1 and arg_2_1[3] == 2

	if not Activity157Model.instance:getIsUnlockEntrance() then
		return false, ToastEnum.V1a8Activity157NotUnlock
	end

	if var_2_3 and not Activity157Model.instance:getIsUnlockFactoryBlueprint() then
