...
slot0 = class("VersionActivity1_8DungeonMapEpisodeView", BaseView)
slot1 = 0.5
slot2 = -240
slot3 = 0.41
slot4 = 1.7
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivity1_8DungeonController.instance, VersionActivity1_8DungeonEvent.OnClickElement, slot0.hideUI, slot0)
	slot0:addEventCb(VersionActivity1_8DungeonController.instance, VersionActivity1_8DungeonEvent.OnHideInteractUI, slot0.showUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivity1_8DungeonController.instance, VersionActivity1_8DungeonEvent.OnClickElement, slot0.hideUI, slot0)
	slot0:removeEventCb(VersionActivity1_8DungeonController.instance, VersionActivity1_8DungeonEvent.OnHideInteractUI, slot0.showUI, slot0)
...
function slot0.checkHardModeIsOpen(slot0)
	return VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapterAndGetToast(VersionActivity1_8Enum.ActivityId.Dungeon)
end
...
function slot0.refreshModeLockText(slot0)
	if ServerTime.now() < VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity1_8DungeonEnum.DungeonChapterId.Hard) then
		slot3 = slot1 - slot2
		...
		if Mathf.Floor(slot3 / TimeUtil.OneDaySecond) > 0 then
			if slot6 > 0 then
				slot8 = GameUtil.getSubPlaceholderLuaLang(luaLang("hournum"), {
					ActivityModel.instance:getActivityInfo()[VersionActivity1_8Enum.ActivityId.Dungeon]:getRemainTimeStr2(slot3),
					slot6
				})
			end
		...
		if slot3 then
			...
			slot0._txtHardModeUnlockTime.text = string.format(luaLang("versionactivity1_3_hardlocktip"), "FR-" .. DungeonConfig.instance:getChapterEpisodeIndexWithSP(DungeonConfig.instance:getEpisodeCO(slot4).chapterId, slot4))
...
function slot0.playUnlockAnimation(slot0, slot1)
	...
	if slot0:IsNeedPlayHardModeUnlockAnimation() then
		VersionActivity1_8DungeonController.instance:savePlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim, uv0)
...
function slot0.IsNeedPlayHardModeUnlockAnimation(slot0)
	...
	if VersionActivity1_8DungeonController.instance:getPlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim, uv0) ~= uv1 and VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(VersionActivity1_8Enum.ActivityId.Dungeon) then
		slot1 = true
	end
...
function slot0._unlockAniDone(slot0)
	if not VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(VersionActivity1_8Enum.ActivityId.Dungeon) then
		return
	end
