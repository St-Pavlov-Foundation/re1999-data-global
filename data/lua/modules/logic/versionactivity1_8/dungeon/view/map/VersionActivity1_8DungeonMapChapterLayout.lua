...
local var_0_0 = class("VersionActivity1_8DungeonMapChapterLayout", BaseChildView)
...
function var_0_0._onCloseView(arg_5_0, arg_5_1)
	if arg_5_1 == ViewName.VersionActivity1_8DungeonMapLevelView then
...
function var_0_0._onGamepadKeyUp(arg_8_0, arg_8_1)
	...
	if var_8_1 ~= ViewName.VersionActivity1_8DungeonMapView and var_8_1 ~= ViewName.VersionActivity1_8DungeonMapLevelView then
		return
	end
...
function var_0_0.isSelectedEpisodeRightEpisode(arg_22_0, arg_22_1)
	...
	if DungeonConfig.instance:getChapterEpisodeIndexWithSP(var_22_1.chapterId, var_22_1._config.id) > DungeonConfig.instance:getChapterEpisodeIndexWithSP(var_22_2.chapterId, var_22_2.id) then
		var_22_0 = true
	end
