...
slot0 = class("VersionActivity1_8DungeonMapChapterLayout", BaseChildView)
slot1 = "default"
slot2 = 600
slot3 = 100
slot4 = 0.26
...
function slot0._onGamepadKeyUp(slot0, slot1)
	...
	if slot2[#slot2] ~= ViewName.VersionActivity1_8DungeonMapView and slot3 ~= ViewName.VersionActivity1_8DungeonMapLevelView then
		return
	end
...
function slot0.isSelectedEpisodeRightEpisode(slot0, slot1)
	...
	if DungeonConfig.instance:getChapterEpisodeIndexWithSP(slot4.chapterId, slot4.id) < DungeonConfig.instance:getChapterEpisodeIndexWithSP(slot3.chapterId, slot3._config.id) then
		slot2 = true
	end
