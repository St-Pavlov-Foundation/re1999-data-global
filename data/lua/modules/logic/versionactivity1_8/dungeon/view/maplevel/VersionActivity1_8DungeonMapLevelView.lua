...
function slot0.buildEpisodeName(slot0, slot1)
	...
	return slot0:buildColorText(string.format("<size=100>%s</size>%s", slot3, slot4), slot0.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard and "#cfccc9" or "#cfccc9")
end
