...
slot0 = class("VersionActivity1_8StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity1_8Enum.ActivityId.DungeonStore
...
function slot0.refreshTime(slot0)
	slot0._txttime.text = ActivityModel.instance:getActivityInfo()[VersionActivity1_8Enum.ActivityId.DungeonStore]:getRemainTimeStr3(false, true)
end
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, #slot1 do
		if not slot0.storeItemList[slot6] then
			slot2 = VersionActivity1_8StoreItem.New()
