...
local var_0_0 = class("ActWeilaLevelView", BaseView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnStoryOpenEnd, arg_2_0._onStoryOpenEnd, arg_2_0)
	arg_2_0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnFightOpenEnd, arg_2_0._onFightOpenEnd, arg_2_0)
	arg_2_0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnGoStoryEnd, arg_2_0._onGoStoryEnd, arg_2_0)
end
...
function var_0_0._editableInitView(arg_8_0)
	arg_8_0.actId = VersionActivity1_8Enum.ActivityId.Weila
...
function var_0_0.onOpen(arg_9_0)
	arg_9_0:addEventCb(ActWeilaController.instance, ActWeilaEvent.StoryItemClick, arg_9_0.OnStoryItemClick, arg_9_0)
	arg_9_0:addEventCb(ActWeilaController.instance, ActWeilaEvent.FightItemClick, arg_9_0.OnFightItemClick, arg_9_0)
	arg_9_0:addEventCb(ActWeilaController.instance, ActWeilaEvent.TabSwitch, arg_9_0.OnTabSwitch, arg_9_0)
	...
	if arg_9_0.viewParam and arg_9_0.viewParam.needShowFight then
		local var_9_3 = ActWeilaModel.instance:getEnterFightIndex()
...
function var_0_0._checkFirstEnter(arg_10_0)
	if not arg_10_0.storyItemList[2]:isUnlock() and PlayerPrefsHelper.getNumber("ActWeilaFirstEnter", 0) == 0 then
...
function var_0_0._initStageItems(arg_25_0)
	...
	for iter_25_0 = 1, var_25_4 do
		...
		local var_25_7 = MonoHelper.addNoUpdateLuaComOnceToGo(var_25_6, WeilaStoryItem, arg_25_0)
	...
	for iter_25_1 = 1, var_25_10 do
		...
		local var_25_13 = MonoHelper.addNoUpdateLuaComOnceToGo(var_25_12, WeilaFightItem, arg_25_0)
...
function var_0_0._playStoryFinishAnim(arg_27_0)
	local var_27_0 = ActWeilaModel.instance:getNewFinishStoryLvl()
...
function var_0_0._playFightFinishAnim(arg_32_0)
	local var_32_0 = ActWeilaModel.instance:getNewFinishFightLvl()
