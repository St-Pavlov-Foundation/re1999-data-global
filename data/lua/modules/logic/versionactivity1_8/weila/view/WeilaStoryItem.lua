...
slot0 = class("WeilaStoryItem", LuaCompBase)
...
function slot0._btnOnClick(slot0)
	...
	ActWeilaController.instance:dispatchEvent(ActWeilaEvent.StoryItemClick, slot0.index)
end
...
function slot0.refreshStatus(slot0)
	...
	slot0.isPass = ActWeilaModel.instance:isLevelPass(slot0.id)
