...
function ActWeilaTaskItem:_editableAddEvents()
	self:addEventCb(ActWeilaController.instance, ActWeilaEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end

function ActWeilaTaskItem:_editableRemoveEvents()
	self:removeEventCb(ActWeilaController.instance, ActWeilaEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end
