...
local var_0_0 = class("ActWeilaTaskItem", ListScrollCellExtend)
...
function var_0_0._btnfinishbgOnClick(arg_5_0)
	if ActWeilaController.instance:delayReward(ActWeilaEnum.AnimatorTime.TaskReward, arg_5_0._actTaskMO) then
		arg_5_0:_onOneClickClaimReward()
	end
end

function var_0_0._btngetallOnClick(arg_6_0)
	if ActWeilaController.instance:delayReward(ActWeilaEnum.AnimatorTime.TaskReward, arg_6_0._actTaskMO) then
...
function var_0_0._editableAddEvents(arg_8_0)
	arg_8_0:addEventCb(ActWeilaController.instance, ActWeilaEvent.OneClickClaimReward, arg_8_0._onOneClickClaimReward, arg_8_0)
end

function var_0_0._editableRemoveEvents(arg_9_0)
	arg_9_0:removeEventCb(ActWeilaController.instance, ActWeilaEvent.OneClickClaimReward, arg_9_0._onOneClickClaimReward, arg_9_0)
end
...
function var_0_0.onUpdateMO(arg_12_0, arg_12_1)
	...
	local var_12_0 = ActWeilaTaskListModel.instance.instance:getRankDiff(arg_12_1)
...
function var_0_0._moveByRankDiff(arg_13_0, arg_13_1)
	if arg_13_1 and arg_13_1 ~= 0 then
		...
		arg_13_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_13_0.viewTrs, 0, ActWeilaEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
