...
slot0 = class("ActWindSongTaskItem", ListScrollCellExtend)
...
function slot0._btnfinishbgOnClick(slot0)
	if ActWindSongController.instance:delayReward(ActWindSongEnum.AnimatorTime.TaskReward, slot0._actTaskMO) then
...
function slot0._editableAddEvents(slot0)
	slot0:addEventCb(ActWindSongController.instance, ActWindSongEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._editableRemoveEvents(slot0)
	slot0:removeEventCb(ActWindSongController.instance, ActWindSongEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end
...
function slot0.onUpdateMO(slot0, slot1)
	...
	slot0:_refreshUI()
	slot0:_moveByRankDiff(ActWindSongTaskListModel.instance.instance:getRankDiff(slot1))
end
...
function slot0._moveByRankDiff(slot0, slot1)
	if slot1 and slot1 ~= 0 then
		...
		slot0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(slot0.viewTrs, 0, ActWindSongEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
