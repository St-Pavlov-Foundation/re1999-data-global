...
slot0 = class("ActWindSongTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot2.cellClass = ActWindSongTaskItem
	...
	slot4 = LuaListScrollViewWithAnimator.New(ActWindSongTaskListModel.instance, slot2, {
		[slot7] = (slot7 - 1) * 0.06
	})
	slot4.dontPlayCloseAnimation = true

	table.insert(slot1, slot4)
	table.insert(slot1, ActWindSongTaskView.New())
