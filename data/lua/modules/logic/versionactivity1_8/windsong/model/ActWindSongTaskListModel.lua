...
slot0 = class("ActWindSongTaskListModel", ListScrollModel)
...
function slot0.refreshData(slot0)
	...
	for slot7, slot8 in ipairs(TaskModel.instance:getTaskMoList(TaskEnum.TaskType.RoleActivity, VersionActivity1_8Enum.ActivityId.WindSong)) do
