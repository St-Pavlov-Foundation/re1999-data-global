...
slot0 = class("ActIsoldeTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot2.cellClass = ActIsoldeTaskItem
	...
	slot4 = LuaListScrollViewWithAnimator.New(ActIsoldeTaskListModel.instance, slot2, {
		[slot7] = (slot7 - 1) * 0.06
	})
	slot4.dontPlayCloseAnimation = true

	table.insert(slot1, slot4)
	table.insert(slot1, ActIsoldeTaskView.New())
