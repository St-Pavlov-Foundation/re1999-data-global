...
local var_0_0 = class("ActIsoldeTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_1.cellClass = ActIsoldeTaskItem
	...
	local var_1_3 = LuaListScrollViewWithAnimator.New(ActIsoldeTaskListModel.instance, var_1_1, var_1_2)

	var_1_3.dontPlayCloseAnimation = true

	table.insert(var_1_0, var_1_3)
	table.insert(var_1_0, ActIsoldeTaskView.New())
