...
slot0 = class("IsoldeStoryItem", LuaCompBase)
...
function slot0._btnOnClick(slot0)
	...
	ActIsoldeController.instance:dispatchEvent(ActIsoldeEvent.StoryItemClick, slot0.index)
end
...
function slot0.refreshStatus(slot0)
	...
	slot0.isPass = ActIsoldeModel.instance:isLevelPass(slot0.id)
