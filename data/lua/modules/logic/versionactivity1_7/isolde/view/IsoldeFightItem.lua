...
local var_0_0 = class("IsoldeFightItem", LuaCompBase)
...
function var_0_0._btnOnClick(arg_5_0)
	...
	ActIsoldeController.instance:dispatchEvent(ActIsoldeEvent.FightItemClick, arg_5_0.index)
end
...
function var_0_0._btnOnHard(arg_7_0)
	if not ActIsoldeModel.instance:isLevelUnlock(arg_7_0.hardConfig.id) then
		GameFacade.showToast(ToastEnum.DungeonIsLockNormal)
...
function var_0_0.setParam(arg_8_0, arg_8_1, arg_8_2)
...
function var_0_0.refreshStatus(arg_10_0)
	arg_10_0.unlock = ActIsoldeModel.instance:isLevelUnlock(arg_10_0.id)

	local var_10_0 = ActIsoldeModel.instance:isLevelUnlock(arg_10_0.hardConfig.id)
...
function var_0_0.refreshStar(arg_11_0)
	local var_11_0 = ActIsoldeModel.instance:isLevelPass(arg_11_0.id)
	local var_11_1 = ActIsoldeModel.instance:isLevelPass(arg_11_0.hardConfig.id)
...
function var_0_0.enterFight(arg_14_0, arg_14_1)
	...
	if var_14_0 and var_14_1 and var_14_2 > 0 then
		ActIsoldeModel.instance:setEnterFightIndex(arg_14_0.index)
