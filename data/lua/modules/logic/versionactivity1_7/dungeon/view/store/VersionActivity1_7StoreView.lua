...
slot0 = class("VersionActivity1_7StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage("singlebg/v1a7_mainactivity_singlebg/v1a7_store_fullbg.png")
...
function slot0.refreshTime(slot0)
	slot0._txttime.text = TimeUtil.SecondToActivityTimeFormat(ActivityModel.instance:getActivityInfo()[VersionActivity1_7Enum.ActivityId.DungeonStore]:getRealEndTimeStamp() - ServerTime.now())
end
