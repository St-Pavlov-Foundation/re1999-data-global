...
local var_0_0 = class("VersionActivity1_7StoreGoodsItem", ListScrollCell)
...
function var_0_0.refreshRemainBuyCount(arg_8_0)
	if arg_8_0.goodsCo.maxBuyCount == 0 then
		...
		arg_8_0.remainBuyCount = arg_8_0.goodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_7Enum.ActivityId.DungeonStore, arg_8_0.goodsCo.id)
...
function var_0_0.refreshRareBg(arg_10_0)
	UISpriteSetMgr.instance:setV1a7MainActivitySprite(arg_10_0.imageRare, "v1a7_store_quality_" .. arg_10_0.rare)
