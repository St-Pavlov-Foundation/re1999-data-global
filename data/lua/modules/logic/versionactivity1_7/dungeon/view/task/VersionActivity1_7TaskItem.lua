...
slot0 = class("VersionActivity1_7TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity1_7TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity1_7Enum.ActivityId.Dungeon)
	else
