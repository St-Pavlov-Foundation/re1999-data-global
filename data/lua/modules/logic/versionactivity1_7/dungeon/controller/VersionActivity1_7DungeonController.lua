...
local var_0_0 = class("VersionActivity1_7DungeonController", BaseController)
...
function var_0_0.openVersionActivityDungeonMapView(arg_3_0)
	local var_3_0, var_3_1, var_3_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity1_7Enum.ActivityId.Dungeon)
...
function var_0_0.openStoreView(arg_4_0)
	local var_4_0, var_4_1, var_4_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity1_7Enum.ActivityId.DungeonStore)
	...
	Activity107Rpc.instance:sendGet107GoodsInfoRequest(VersionActivity1_7Enum.ActivityId.DungeonStore, arg_4_0._openStoreView, arg_4_0)
end
...
function var_0_0.openTaskView(arg_6_0)
	local var_6_0, var_6_1, var_6_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity1_7Enum.ActivityId.Dungeon)
