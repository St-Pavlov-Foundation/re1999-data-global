...
slot0 = class("MarcusStoryItem", LuaCompBase)
...
function slot0._btnOnClick(slot0)
	...
	ActMarcusController.instance:dispatchEvent(ActMarcusEvent.StoryItemClick, slot0.index)
end
...
function slot0.refreshStatus(slot0)
	...
	slot0.isPass = ActMarcusModel.instance:isLevelPass(slot0.id)
