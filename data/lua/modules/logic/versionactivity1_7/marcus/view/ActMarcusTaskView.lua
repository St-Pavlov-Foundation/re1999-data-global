...
slot0 = class("ActMarcusTaskView", BaseView)
...
function slot0._onFinishTask(slot0, slot1)
	if ActMarcusTaskListModel.instance:getById(slot1) then
		ActMarcusTaskListModel.instance:refreshData()
	end
end

function slot0._showLeftTime(slot0)
	slot0._txtLimitTime.text = ActivityHelper.getActivityRemainTimeStr(VersionActivity1_7Enum.ActivityId.Marcus)
end
