...
local var_0_0 = class("ActMarcusTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_1.cellClass = ActMarcusTaskItem
	...
	local var_1_3 = LuaListScrollViewWithAnimator.New(ActMarcusTaskListModel.instance, var_1_1, var_1_2)

	var_1_3.dontPlayCloseAnimation = true

	table.insert(var_1_0, var_1_3)
	table.insert(var_1_0, ActMarcusTaskView.New())
