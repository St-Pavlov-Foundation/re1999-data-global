...
slot0 = class("ActMarcusTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot2.cellClass = ActMarcusTaskItem
	...
	slot4 = LuaListScrollViewWithAnimator.New(ActMarcusTaskListModel.instance, slot2, {
		[slot7] = (slot7 - 1) * 0.06
	})
	slot4.dontPlayCloseAnimation = true

	table.insert(slot1, slot4)
	table.insert(slot1, ActMarcusTaskView.New())
