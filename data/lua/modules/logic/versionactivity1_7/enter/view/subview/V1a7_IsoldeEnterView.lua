...
local var_0_0 = class("V1a7_IsoldeEnterView", BaseView)
...
function var_0_0._btnEnterOnClick(arg_4_0)
	...
	local var_4_1 = PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivity1_7Enum.ActivityId.Isolde) .. "#" .. tostring(var_4_0)
	local var_4_2 = PlayerPrefsHelper.getNumber(var_4_1, 0) == 1

	if OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Act_70103) or var_4_2 then
		ActIsoldeController.instance:enterActivity()

		return
	end

	local var_4_3 = OpenConfig.instance:getOpenCo(OpenEnum.UnlockFunc.Act_70103)
...
function var_0_0._editableInitView(arg_7_0)
	arg_7_0.actId = VersionActivity1_7Enum.ActivityId.Isolde
