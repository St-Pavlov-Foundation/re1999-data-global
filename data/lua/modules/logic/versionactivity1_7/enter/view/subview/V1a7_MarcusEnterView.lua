...
slot0 = class("V1a7_MarcusEnterView", BaseView)
...
function slot0._btnEnterOnClick(slot0)
	if OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Act_70104) or PlayerPrefsHelper.getNumber(PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivity1_7Enum.ActivityId.Marcus) .. "#" .. tostring(PlayerModel.instance:getPlayinfo().userId), 0) == 1 then
	...
	GameFacade.showMessageBox(MessageBoxIdDefine.Activity130OpenTips, MsgBoxEnum.BoxType.Yes_No, function ()
		...
		ActMarcusController.instance:enterActivity()
	end, nil, , , , , DungeonConfig.instance:getEpisodeDisplay(OpenConfig.instance:getOpenCo(OpenEnum.UnlockFunc.Act_70104).episodeId))
end
