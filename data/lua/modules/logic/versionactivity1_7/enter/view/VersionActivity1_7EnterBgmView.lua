...
slot0 = class("VersionActivity1_7EnterBgmView", BaseView)
...
function slot0.onOpen(slot0)
	slot0._isFirstOpenMainAct = VersionActivityEnterHelper.getActId(slot0.viewParam.activityIdList[VersionActivityEnterHelper.getTabIndex(slot0.viewParam.activityIdList, slot0.viewParam.jumpActId)]) == VersionActivity1_7Enum.ActivityId.Dungeon
...
function slot0.initActHandle(slot0)
	if not slot0.actHandleDict then
		slot0.actHandleDict = {
			[VersionActivity1_7Enum.ActivityId.BossRush] = slot0.playBossRushBgm
		}
	end
end

function slot0.modifyBgm(slot0, slot1)
	slot0._isMainAct = slot1 == VersionActivity1_7Enum.ActivityId.Dungeon
	slot2 = 0
...
function slot0.defaultBgmHandle(slot0, slot1)
	...
	if ActivityConfig.instance:getActivityEnterViewBgm(slot1) == 0 then
		...
		slot2 = AudioEnum.Bgm.Act1_7DungeonBgm
	end
	...
	AudioBgmManager.instance:modifyAndPlay(AudioBgmEnum.Layer.VersionActivity1_7Main, slot2, AudioEnum.Bgm.Stop_LeiMiTeBeiBgm)
end
...
function slot0.playBossRushBgm(slot0, slot1)
	...
	AudioBgmManager.instance:modifyAndPlay(AudioBgmEnum.Layer.VersionActivity1_7Main, slot2, AudioEnum.Bgm.Stop_LeiMiTeBeiBgm, nil, , FightEnum.AudioSwitchGroup, FightEnum.AudioSwitch.Comeshow)
end
