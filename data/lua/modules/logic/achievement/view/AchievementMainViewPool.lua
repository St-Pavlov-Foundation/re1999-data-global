...
local var_0_0 = class("AchievementMainViewPool", BaseView)
...
function var_0_0.createIconInternal(arg_11_0)
	local var_11_0 = AchievementMainIcon.New()
	local var_11_1 = arg_11_0:getResInst(arg_11_0._resPath, arg_11_0._gopool, "icon" .. tostring(arg_11_0._iconIndex))
