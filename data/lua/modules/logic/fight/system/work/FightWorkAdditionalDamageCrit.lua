...
local var_0_0 = class("FightWorkAdditionalDamageCrit", FightEffectBase)
...
function var_0_0.onStart(arg_1_0)
	...
	if var_1_0 then
		...
		if var_1_1 > 0 then
			...
			FightFloatMgr.instance:float(var_1_0.id, FightEnum.FloatType.crit_additional_damage, var_1_2, nil, arg_1_0.actEffectData.effectNum1 == 1)
