module("modules.logic.fight.system.work.FightDistributeCardNomalWork", package.seeall)

slot0 = class("FightDistributeCardNomalWork", BaseWork)
slot0.handCardScale = 0.52
slot0.handCardScaleTime = 0.25

function slot0.ctor(slot0, slot1, slot2)
	slot0._beforeCards = slot1
	slot0._newCards = slot2
end
...
function slot0._delayDistribute(slot0)
	...
	FightCardModel.instance:enqueueDistribute(slot0._beforeCards, slot0._newCards)
