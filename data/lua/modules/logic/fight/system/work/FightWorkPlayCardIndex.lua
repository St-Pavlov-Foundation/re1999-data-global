...
function var_0_0.onStart(arg_2_0, arg_2_1)
	if FightHelper.isPlayerCardSkill(arg_2_0._fightStepMO) then
		FightController.instance:dispatchEvent(FightEvent.InvalidUsedCard, arg_2_0._fightStepMO.cardIndex, -1)
		FightPlayCardModel.instance:playCard(arg_2_0._fightStepMO.cardIndex)
