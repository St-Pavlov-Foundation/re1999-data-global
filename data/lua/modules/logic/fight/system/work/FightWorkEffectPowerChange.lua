...
function var_0_0.beforePlayEffectData(arg_1_0)
	...
	arg_1_0._powerId = arg_1_0._actEffectMO.configEffect
...
function var_0_0.onStart(arg_2_0)
	...
	if not arg_2_0._powerData then
		logError(string.format("找不到灵光数据,灵光id:%s, 角色或怪物id:%s, 步骤类型:%s, actId:%s", arg_2_0._powerId, arg_2_0._entityMO.modelId, arg_2_0._fightStepMO.actType, arg_2_0._fightStepMO.actId))
		arg_2_0:onDone(true)
	...
	if arg_2_0._oldValue ~= arg_2_0._newValue then
		FightController.instance:dispatchEvent(FightEvent.PowerChange, arg_2_0._actEffectMO.targetId, arg_2_0._powerId, arg_2_0._oldValue, arg_2_0._newValue)
	end
