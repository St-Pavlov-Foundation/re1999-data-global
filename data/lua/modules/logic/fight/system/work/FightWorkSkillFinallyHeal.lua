...
function var_0_0.ctor(arg_1_0, arg_1_1)
	...
	arg_1_0._actEffectMOs = {}
end

function var_0_0.addActEffectMO(arg_2_0, arg_2_1)
	table.insert(arg_2_0._actEffectMOs, arg_2_1)
end
...
function var_0_0.onStart(arg_3_0)
	...
	local var_3_1 = arg_3_0._fightStepMO.actId
...
function var_0_0._onSkillEnd(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	if arg_5_3 ~= arg_5_0._fightStepMO then
		return
	end

	arg_5_0:_removeEvents()

	for iter_5_0, iter_5_1 in ipairs(arg_5_0._actEffectMOs) do
...
function var_0_0._onTimelineHeal(arg_6_0, arg_6_1)
	tabletool.removeValue(arg_6_0._actEffectMOs, arg_6_1)
end
