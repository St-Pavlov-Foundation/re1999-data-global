...
local var_0_0 = class("FightWorkKill", FightEffectBase)
...
function var_0_0.onStart(arg_2_0)
	...
	FightController.instance:dispatchEvent(FightEvent.OnCurrentHpChange, arg_2_0._entityId, arg_2_0._oldValue, arg_2_0._newValue)
	arg_2_0:onDone(true)
end
