...
function slot0.onStart(slot0)
	...
	elseif not FightEntityModel.instance:getDeadById(slot0._actEffectMO.targetId) then
		logError("damage effect fail, entity not exist " .. slot0._actEffectMO.targetId)
	end
