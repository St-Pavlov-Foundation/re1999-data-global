...
function var_0_0.onInitView(arg_1_0)
	...
	for iter_1_0 = 1, 4 do
		table.insert(arg_1_0._imgBgs, gohelper.findChildImage(arg_1_0.viewGO, "imgBg/" .. iter_1_0))
		table.insert(arg_1_0._imgBgGos, gohelper.findChild(arg_1_0.viewGO, "imgBg/" .. iter_1_0))
	end
...
function var_0_0.refreshItemData(arg_2_0, arg_2_1)
	...
	arg_2_0._isUnique = FightCardModel.instance:isUniqueSkill(arg_2_0._entityMO.id, var_2_1)

	local var_2_3 = FightCardModel.instance:getSkillLv(var_2_2, var_2_1)

	var_2_3 = arg_2_0._isUnique and FightEnum.UniqueSkillCardLv or var_2_3 == FightEnum.UniqueSkillCardLv and 1 or var_2_3

	UISpriteSetMgr.instance:setFightSprite(arg_2_0._imgTag, "jnk_gj" .. var_2_0.showTag)

	for iter_2_0, iter_2_1 in ipairs(arg_2_0._imgBgs) do
...
function var_0_0._refreshAni(arg_3_0)
	...
	if arg_3_0._isUnique and arg_3_0._canUse then
...
function var_0_0.onSelectMonsterCardMo(arg_4_0, arg_4_1)
	...
	local var_4_1 = FightCardModel.instance:isUniqueSkill(arg_4_0._cardData.uid, arg_4_0._cardData.skillId)
...
function var_0_0._onExSkillPointChange(arg_7_0, arg_7_1)
	if arg_7_1 == arg_7_0._entityMO.id and arg_7_0._isUnique then
		arg_7_0:_refreshAni()
	end
end

function var_0_0._onExPointChange(arg_8_0, arg_8_1)
	if arg_8_1 == arg_8_0._entityMO.id and arg_8_0._isUnique then
		arg_8_0:_refreshAni()
	end
end

function var_0_0.onDestructor(arg_9_0)
	for iter_9_0, iter_9_1 in ipairs(arg_9_0._imgBgs) do
