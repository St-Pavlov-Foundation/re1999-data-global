...
local var_0_0 = class("FightRestartAbandonType161", FightRestartAbandonType1)
...
function var_0_0.canRestart(arg_2_0)
	local var_2_0 = ActivityModel.instance:getActivityInfo()[VersionActivity1_6Enum.ActivityId.Dungeon]
