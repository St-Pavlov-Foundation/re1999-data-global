...
local var_0_0 = class("VersionActivity2_6StoreView", BaseView)
...
function var_0_0.refreshTime(arg_9_0)
	local var_9_0 = ActivityModel.instance:getActivityInfo()[VersionActivity2_6Enum.ActivityId.DungeonStore]:getRealEndTimeStamp() - ServerTime.now()
