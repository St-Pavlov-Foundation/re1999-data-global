...
local var_0_0 = class("VersionActivity2_6TaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = VersionActivity2_6TaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity2_6TaskListModel.instance, var_1_0, var_1_1)
