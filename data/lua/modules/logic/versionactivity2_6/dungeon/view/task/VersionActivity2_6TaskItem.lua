-- chunkname: @modules/logic/versionactivity2_6/dungeon/view/task/VersionActivity2_6TaskItem.lua

module("modules.logic.versionactivity2_6.dungeon.view.task.VersionActivity2_6TaskItem", package.seeall)

local VersionActivity2_6TaskItem = class("VersionActivity2_6TaskItem", ListScrollCell)

function VersionActivity2_6TaskItem:init(go)
	self.viewGO = go
...
function VersionActivity2_6TaskItem:addEventListeners()
	...
	VersionActivity2_6DungeonController.instance:registerCallback(VersionActivity2_6DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end

function VersionActivity2_6TaskItem:removeEventListeners()
	self.btnNotFinish:RemoveClickListener()
	self.btnFinish:RemoveClickListener()
	self.btnFinishAll:RemoveClickListener()
	VersionActivity2_6DungeonController.instance:unregisterCallback(VersionActivity2_6DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end

function VersionActivity2_6TaskItem:_btnNotFinishOnClick()
...
function VersionActivity2_6TaskItem:_btnFinishAllOnClick()
	VersionActivity2_6DungeonController.instance:dispatchEvent(VersionActivity2_6DungeonEvent.OnClickAllTaskFinish)
end

function VersionActivity2_6TaskItem:_OnClickAllTaskFinish()
	if self.taskMo then
...
VersionActivity2_6TaskItem.FinishKey = "VersionActivity2_6TaskItem FinishKey"

function VersionActivity2_6TaskItem:_btnFinishOnClick()
	UIBlockMgr.instance:startBlock(VersionActivity2_6TaskItem.FinishKey)
...
function VersionActivity2_6TaskItem:firstAnimationDone()
	self._view.viewContainer.taskAnimRemoveItem:removeByIndex(self._index, self.secondAnimationDone, self)
end

function VersionActivity2_6TaskItem:secondAnimationDone()
	UIBlockMgr.instance:endBlock(VersionActivity2_6TaskItem.FinishKey)
	self.animatorPlayer:Play(UIAnimationName.Idle)

	if self.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, nil, nil, nil, VersionActivity2_6Enum.ActivityId.Dungeon)
	else
		TaskRpc.instance:sendFinishTaskRequest(self.co.id)
	end
end

function VersionActivity2_6TaskItem:_editableInitView()
	self.rewardItemList = {}
end

function VersionActivity2_6TaskItem:onUpdateMO(taskMo)
	self.taskMo = taskMo
...
function VersionActivity2_6TaskItem:refreshNormalUI()
...
function VersionActivity2_6TaskItem:refreshRewardItems()
...
function VersionActivity2_6TaskItem:refreshGetAllUI()
	return
end

function VersionActivity2_6TaskItem:canGetReward()
	return self.taskMo.finishCount < self.co.maxFinishCount and self.taskMo.hasFinished
end

function VersionActivity2_6TaskItem:getAnimator()
	return self.animator
end

function VersionActivity2_6TaskItem:onDestroyView()
	self._simagenormalbg:UnLoadImage()
	self._simagegetallbg:UnLoadImage()
end

return VersionActivity2_6TaskItem
