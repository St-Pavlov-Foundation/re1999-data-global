...
local var_0_0 = class("VersionActivity2_6TaskView", BaseView)
...
function var_0_0.refreshRemainTime(arg_8_0)
	local var_8_0 = ActivityModel.instance:getActivityInfo()[VersionActivity2_6Enum.ActivityId.Dungeon]:getRealEndTimeStamp() - ServerTime.now()
