...
local var_0_0 = class("DiceHeroTaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._taskMO.config.jumpId > 0 and GameFacade.jump(arg_4_0._taskMO.config.jumpId) then
...
function var_0_0._editableAddEvents(arg_10_0)
	DiceHeroController.instance:registerCallback(DiceHeroEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	DiceHeroController.instance:unregisterCallback(DiceHeroEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	...
	local var_14_0 = DiceHeroTaskListModel.instance:getRankDiff(arg_14_1)
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_6/dicehero/v2a6_dicehero_taskitem.prefab"
