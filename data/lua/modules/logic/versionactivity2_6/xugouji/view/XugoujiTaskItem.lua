...
local var_0_0 = class("XugoujiTaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._taskMO.config.jumpId > 0 then
		GameFacade.jump(arg_4_0._taskMO.config.jumpId)
	end
end
...
function var_0_0._btngetallOnClick(arg_6_0)
	XugoujiController.instance:dispatchEvent(XugoujiEvent.OneClickClaimReward, arg_6_0._taskMO.activityId)
	UIBlockHelper.instance:startBlock("LoperaTaskItem_finishAnim", 0.5)
...
function var_0_0._onOneClickClaimReward(arg_12_0, arg_12_1)
	if arg_12_0._taskMO and arg_12_0._taskMO.activityId == arg_12_1 and arg_12_0._taskMO:alreadyGotReward() then
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	...
	local var_14_0 = Activity188TaskListModel.instance:getRankDiff(arg_14_1)
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_6/v2a6_xugouji/v2a6_xugouji_taskitem.prefab"
