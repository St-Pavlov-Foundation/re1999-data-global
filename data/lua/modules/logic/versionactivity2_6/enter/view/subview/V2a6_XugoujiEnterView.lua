...
local var_0_0 = class("V2a6_XugoujiEnterView", VersionActivityEnterBaseSubView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0.actCo = ActivityConfig.instance:getActivityCo(VersionActivity2_6Enum.ActivityId.Xugouji)
	arg_4_0._txtDescr.text = arg_4_0.actCo.actDesc
end

function var_0_0.onOpen(arg_5_0)
	var_0_0.super.onOpen(arg_5_0)
	RedDotController.instance:addRedDot(arg_5_0._gored, RedDotEnum.DotNode.V2a6XugoujiTask)
...
function var_0_0._refreshTime(arg_10_0)
	local var_10_0 = ActivityModel.instance:getActivityInfo()[VersionActivity2_6Enum.ActivityId.Xugouji]
	...
	if var_10_0 then
		...
		local var_10_3 = ActivityHelper.getActivityStatus(VersionActivity2_6Enum.ActivityId.Xugouji) ~= ActivityEnum.ActivityStatus.Normal
