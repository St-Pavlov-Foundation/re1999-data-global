...
slot0 = class("VersionActivity2_0CanJumpFunc")
...
function slot0.canJumpTo12003(slot0, slot1)
	...
	slot6, slot7, slot8 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.Dungeon)
...
function slot0.canJumpTo12005(slot0, slot1)
	slot2, slot3, slot4 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.DungeonGraffiti)
