...
local var_0_0 = class("VersionActivity2_0CanJumpFunc")

function var_0_0.canJumpTo12003(arg_1_0, arg_1_1)
	local var_1_0, var_1_1, var_1_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.EnterView)

	if var_1_0 ~= ActivityEnum.ActivityStatus.Normal then
		return false, var_1_1, var_1_2
	end

	local var_1_3 = VersionActivity2_0Enum.ActivityId.Dungeon
...
function var_0_0.canJumpTo12005(arg_2_0, arg_2_1)
	local var_2_0, var_2_1, var_2_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.DungeonGraffiti)
