...
local var_0_0 = class("VersionActivity2_0TaskListModel", ListScrollModel)
...
function var_0_0.initTask(arg_4_0)
	...
	arg_4_0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_0Enum.ActivityId.Dungeon)
end
