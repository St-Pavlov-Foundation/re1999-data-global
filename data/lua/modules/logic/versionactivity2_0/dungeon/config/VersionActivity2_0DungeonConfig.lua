...
local var_0_0 = class("VersionActivity2_0DungeonConfig", BaseConfig)

local function var_0_1(arg_1_0)
	local var_1_0 = DungeonConfig.instance:getEpisodeCO(arg_1_0)

	if var_1_0.chapterId ~= VersionActivity2_0DungeonEnum.DungeonChapterId.ElementFight then
		if var_1_0.chapterId == VersionActivity2_0DungeonEnum.DungeonChapterId.Hard then
			arg_1_0 = arg_1_0 - 10000
			var_1_0 = DungeonConfig.instance:getEpisodeCO(arg_1_0)
		else
			while var_1_0.chapterId ~= VersionActivity2_0DungeonEnum.DungeonChapterId.Story do
...
function var_0_0.getEpisodeMapConfig(arg_2_0, arg_2_1)
	...
	return DungeonConfig.instance:getChapterMapCfg(VersionActivity2_0DungeonEnum.DungeonChapterId.Story, var_2_0.preEpisode)
end
