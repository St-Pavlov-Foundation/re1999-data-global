...
local var_0_0 = class("VersionActivity2_0DungeonMapChapterLayout", BaseChildView)
...
function var_0_0._onOpenView(arg_4_0, arg_4_1)
	if arg_4_1 == ViewName.VersionActivity2_0DungeonMapLevelView then
...
function var_0_0._onCloseView(arg_5_0, arg_5_1)
	if arg_5_1 == ViewName.VersionActivity2_0DungeonMapLevelView then
...
function var_0_0._onGamepadKeyUp(arg_8_0, arg_8_1)
	...
	if var_8_1 ~= ViewName.VersionActivity2_0DungeonMapView and var_8_1 ~= ViewName.VersionActivity2_0DungeonMapLevelView then
		return
	end
