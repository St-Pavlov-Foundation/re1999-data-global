...
slot0 = class("VersionActivity2_0DungeonMapChapterLayout", BaseChildView)
slot1 = "default"
slot2 = 600
slot3 = 100
slot4 = 0.26
...
function slot0._onGamepadKeyUp(slot0, slot1)
	...
	if slot2[#slot2] ~= ViewName.VersionActivity2_0DungeonMapView and slot3 ~= ViewName.VersionActivity2_0DungeonMapLevelView then
		return
	end
