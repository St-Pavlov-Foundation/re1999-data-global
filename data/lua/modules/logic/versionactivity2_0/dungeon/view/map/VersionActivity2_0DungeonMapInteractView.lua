...
local var_0_0 = class("VersionActivity2_0DungeonMapInteractView", BaseView)
...
function var_0_0.onInitView(arg_1_0, arg_1_1)
	...
	arg_1_0.interactItemAnim = ZProj.ProjAnimatorPlayer.Get(arg_1_0._gointeractitem)
...
function var_0_0.addEvents(arg_6_0)
	...
	arg_6_0:addEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, arg_6_0.showInteractUI, arg_6_0)
...
function var_0_0.removeEvents(arg_7_0)
	...
	arg_7_0:removeEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, arg_7_0.showInteractUI, arg_7_0)
...
function var_0_0.hide(arg_11_0)
	...
	if VersionActivity2_0DungeonModel.instance:getOpenGraffitiEntranceState() then
		arg_11_0.viewContainer.mapView:showRestaurantPartBtnUI()
		arg_11_0.viewContainer.mapSceneElements:onHideInteractUI()
	else
...
function var_0_0.refreshRewards(arg_13_0)
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_1) do
		...
		var_13_2.icon:setMOValue(iter_13_1[1], iter_13_1[2], iter_13_1[3], nil, true)
...
function var_0_0.onClickRoot(arg_28_0)
	if arg_28_0._isClickClose then
		return
	end

	arg_28_0.interactItemAnim:Play(UIAnimationName.Close, arg_28_0.hide, arg_28_0)

	arg_28_0._isClickClose = true
end

function var_0_0._btncloseOnClick(arg_29_0)
	if arg_29_0._isClickClose then
		return
	end

	arg_29_0.interactItemAnim:Play(UIAnimationName.Close, arg_29_0.hide, arg_29_0)

	arg_29_0._isClickClose = true
end
...
function var_0_0._onClickFightBtn(arg_31_0)
	...
	VersionActivity2_0DungeonModel.instance:setLastEpisodeId(arg_31_0.activityDungeonMo.episodeId)
...
function var_0_0._onClickEnterDialogueBtn(arg_32_0)
	...
	VersionActivity2_0DungeonController.instance:openDialogueView(arg_32_0.dialogueId)
end
...
function var_0_0.finishElement(arg_33_0, arg_33_1)
	...
	DungeonRpc.instance:sendMapElementRequest(var_33_0, arg_33_1, arg_33_0.updateAct161Info, arg_33_0)
end

function var_0_0.updateAct161Info(arg_34_0)
