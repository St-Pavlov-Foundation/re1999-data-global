...
local var_0_0 = class("VersionActivity2_0DungeonMapScene", BaseView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.FocusElement, arg_2_0.onFocusElement, arg_2_0)
	arg_2_0:addEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.ManualClickElement, arg_2_0.manualClickElement, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.FocusElement, arg_3_0.onFocusElement, arg_3_0)
	arg_3_0:removeEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.ManualClickElement, arg_3_0.manualClickElement, arg_3_0)
...
function var_0_0._onScreenResize(arg_6_0)
	if arg_6_0._sceneGo then
		...
		var_6_0.orthographicSize = VersionActivity2_0DungeonEnum.DungeonMapCameraSize * var_6_1
...
function var_0_0.onActivityDungeonMoChange(arg_8_0)
	local var_8_0 = VersionActivity2_0DungeonModel.instance:getMapNeedTweenState()
...
function var_0_0._initMapRootNode(arg_19_0)
	arg_19_0._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_0DungeonEnum.SceneRootName)
...
function var_0_0._initCamera(arg_22_0)
	...
	var_22_0.orthographicSize = VersionActivity2_0DungeonEnum.DungeonMapCameraSize * var_22_1
end

function var_0_0.refreshMap(arg_23_0, arg_23_1, arg_23_2)
	arg_23_0._mapCfg = arg_23_2 or VersionActivity2_0DungeonConfig.instance:getEpisodeMapConfig(arg_23_0.activityDungeonMo.episodeId)
	...
	if arg_23_0._mapCfg.id == arg_23_0._lastLoadMapId then
		...
		if VersionActivity2_0DungeonModel.instance:getOpenGraffitiEntranceState() then
			arg_23_0:_setGraffitiMapSceneCanvas()
		else
			arg_23_0:_setMapPos()
		end
	else
...
function var_0_0._initScene(arg_28_0)
	...
	local var_28_9 = VersionActivity2_0DungeonEnum.DungeonMapCameraSize / var_28_8
...
function var_0_0._addSceneCanvas(arg_32_0)
	local var_32_0 = arg_32_0._sceneCanvas
	local var_32_1 = arg_32_0._mapLoader:getAssetItem(var_32_0):GetResource(var_32_0)

	arg_32_0._graffitiCanvasGo = gohelper.clone(var_32_1, arg_32_0._sceneGo, "graffitiMapSceneCanvas")
	arg_32_0._graffitiCanvasGo:GetComponent("Canvas").worldCamera = CameraMgr.instance:getMainCamera()

	arg_32_0:_setGraffitiMapSceneCanvas()
end

function var_0_0._setGraffitiMapSceneCanvas(arg_33_0)
	Activity161Controller.instance:dispatchEvent(Activity161Event.SetGraffitiMapSceneCanvas, {
		mapConfig = arg_33_0._mapCfg,
		canvasGO = arg_33_0._graffitiCanvasGo,
		sceneGO = arg_33_0._sceneGo
	})
	arg_33_0:_setMapPos()
end
...
function var_0_0.directSetScenePos(arg_38_0, arg_38_1)
	...
	VersionActivity2_0DungeonController.instance:dispatchEvent(VersionActivity2_0DungeonEvent.OnMapPosChanged, arg_38_0._scenePos, arg_38_0.needTween)
...
function var_0_0.disposeOldMap(arg_46_0)
	if arg_46_0._sceneTrans then
		arg_46_0._oldScenePos = arg_46_0._scenePos
	else
		arg_46_0._oldScenePos = nil
	end

	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnDisposeOldMap, arg_46_0.viewName)

	if arg_46_0._oldSceneGo then
		gohelper.destroy(arg_46_0._oldSceneGo)

		arg_46_0._oldSceneGo = nil
	end
	...
	if arg_46_0._oldMapLoader then
		arg_46_0._oldMapLoader:dispose()

		arg_46_0._oldMapLoader = nil
	end
end

function var_0_0._disposeScene(arg_47_0)
	arg_47_0._oldScenePos = arg_47_0._scenePos

	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnDisposeScene)

	if arg_47_0._mapAudioGo then
		arg_47_0._mapAudioGo = nil

		AudioMgr.instance:trigger(AudioEnum.UI.stop_ui_noise_allarea)
	end

	if arg_47_0._sceneGo then
		gohelper.destroy(arg_47_0._sceneGo)

		arg_47_0._sceneGo = nil
	end

	arg_47_0._sceneTrans = nil
	arg_47_0._elementRoot = nil

	if arg_47_0._mapLoader then
		arg_47_0._mapLoader:dispose()

		arg_47_0._mapLoader = nil
	end
