...
local var_0_0 = class("VersionActivity2_0DungeonMapElement", LuaCompBase)
local var_0_1 = 1.6
...
function var_0_0._effectAnimDone(arg_17_0)
	if DungeonMapModel.instance:elementIsFinished(arg_17_0._config.id) then
...
function var_0_0._onClickDown(arg_22_0)
	if VersionActivity2_0DungeonModel.instance:getOpeningGraffitiEntranceState() then
		return
	end
...
function var_0_0.onClick(arg_23_0)
	VersionActivity2_0DungeonController.instance:dispatchEvent(VersionActivity2_0DungeonEvent.OnClickElement, arg_23_0)
end
