...
slot0 = class("VersionActivity2_0DungeonMapElement", LuaCompBase)
slot1 = 1.6
...
function slot0._effectAnimDone(slot0)
	if DungeonMapModel.instance:elementIsFinished(slot0._config.id) then
...
function slot0.onClick(slot0)
	VersionActivity2_0DungeonController.instance:dispatchEvent(VersionActivity2_0DungeonEvent.OnClickElement, slot0)
end
