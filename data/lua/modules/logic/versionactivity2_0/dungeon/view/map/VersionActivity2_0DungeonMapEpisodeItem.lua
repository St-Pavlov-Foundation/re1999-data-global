...
function VersionActivity2_0DungeonMapEpisodeItem:calculatePosInContent()
	...
	if halfWidth > VersionActivity2_0DungeonEnum.EpisodeItemMinWidth then
		local offset = halfWidth - VersionActivity2_0DungeonEnum.EpisodeItemMinWidth

		halfWidth = (kPrefabWidth + offset) / 2
	end

	self._maxWidth = math.max(halfWidth * 2, VersionActivity2_0DungeonEnum.EpisodeItemMinWidth)
