...
slot0 = class("VersionActivity2_0StoreGoodsItem", UserDataDispose)
...
function slot0.updateInfo(slot0, slot1)
	...
	slot2, slot3, slot4 = VersionActivity2_0EnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setV2a0MainActivitySprite(slot0.imageRare, "v2a0_store_quality_" .. slot7)
	...
	slot0.costItemType, slot0.costItemId, slot0.costItemQuantity = VersionActivity2_0EnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.cost)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_0Enum.ActivityId.DungeonStore, slot0.storeGoodsCo.id)
