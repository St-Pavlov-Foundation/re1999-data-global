-- chunkname: @modules/logic/versionactivity2_0/dungeon/view/store/VersionActivity2_0StoreGoodsItem.lua

module("modules.logic.versionactivity2_0.dungeon.view.store.VersionActivity2_0StoreGoodsItem", package.seeall)

local VersionActivity2_0StoreGoodsItem = class("VersionActivity2_0StoreGoodsItem", UserDataDispose)

function VersionActivity2_0StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_0StoreGoodsItem:onClick()
...
function VersionActivity2_0StoreGoodsItem:updateInfo(storeGoodsCo)
	self.storeGoodsCo = storeGoodsCo

	self:refreshRemainBuyCount()

	local productItemType, productItemId, productItemQuantity = VersionActivity2_0EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setV2a0MainActivitySprite(self.imageRare, "v2a0_store_quality_" .. rare)
	...
	self.costItemType, self.costItemId, self.costItemQuantity = VersionActivity2_0EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.cost)
...
function VersionActivity2_0StoreGoodsItem:refreshRemainBuyCount()
...
function VersionActivity2_0StoreGoodsItem:setImageIconNative()
	self.imageIcon:SetNativeSize()
end

function VersionActivity2_0StoreGoodsItem:refreshTag()
...
function VersionActivity2_0StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity2_0StoreGoodsItem:onDestroy()
...
return VersionActivity2_0StoreGoodsItem
