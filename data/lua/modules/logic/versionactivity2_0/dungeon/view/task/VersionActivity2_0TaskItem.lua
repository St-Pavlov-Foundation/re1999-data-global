-- chunkname: @modules/logic/versionactivity2_0/dungeon/view/task/VersionActivity2_0TaskItem.lua

module("modules.logic.versionactivity2_0.dungeon.view.task.VersionActivity2_0TaskItem", package.seeall)

local VersionActivity2_0TaskItem = class("VersionActivity2_0TaskItem", ListScrollCellExtend)

function VersionActivity2_0TaskItem:onInitView()
...
function VersionActivity2_0TaskItem:addEvents()
	...
	self.btnFinishAll:AddClickListener(self._btnFinishOnClick, self)
end

function VersionActivity2_0TaskItem:removeEvents()
	self.btnNotFinish:RemoveClickListener()
	self.btnFinish:RemoveClickListener()
	self.btnFinishAll:RemoveClickListener()
end

function VersionActivity2_0TaskItem:_btnNotFinishOnClick()
...
function VersionActivity2_0TaskItem:_btnFinishOnClick()
...
function VersionActivity2_0TaskItem:firstAnimationDone()
	self._view.viewContainer.taskAnimRemoveItem:removeByIndex(self._index, self.secondAnimationDone, self)
end

function VersionActivity2_0TaskItem:secondAnimationDone()
	UIBlockMgr.instance:endBlock(VersionActivity2_0DungeonEnum.BlockKey.TaskGetReward)
	self._animatorPlayer:Play(UIAnimationName.Idle)

	if self.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, nil, nil, nil, VersionActivity2_0Enum.ActivityId.Dungeon)
	else
		TaskRpc.instance:sendFinishTaskRequest(self.co.id)
	end
end

function VersionActivity2_0TaskItem:_editableInitView()
	self.rewardItemList = {}
end

function VersionActivity2_0TaskItem:onUpdateMO(mo)
	self.taskMo = mo
...
function VersionActivity2_0TaskItem:refreshGetAllUI()
	return
end

function VersionActivity2_0TaskItem:refreshNormalUI()
...
function VersionActivity2_0TaskItem:refreshRewardItems()
...
function VersionActivity2_0TaskItem:getAnimator()
	return self._animator
end

function VersionActivity2_0TaskItem:onDestroyView()
...
return VersionActivity2_0TaskItem
