...
local var_0_0 = class("VersionActivity2_0TaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = VersionActivity2_0TaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity2_0TaskListModel.instance, var_1_0, var_1_1)
