...
slot0 = class("V2a0_DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0.actId = VersionActivity2_0Enum.ActivityId.Dungeon
	...
	slot0:_setDesc()
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a0DungeonEnter)
...
function slot0.onOpen(slot0)
	...
	if slot0.viewContainer:getIsFirstPlaySubViewAnim() then
		slot0.animComp.animator:Play("open1", 0, 0)

		slot0.animComp.animator.speed = 1

		slot0.viewContainer:markPlayedSubViewAnim()
	else
		slot0.animComp.animator:Play(UIAnimationName.Open, 0, 0)
...
function slot0.refreshRemainTime(slot0)
	...
	slot0._txtStoreTime.text = ActivityModel.instance:getActivityInfo()[VersionActivity2_0Enum.ActivityId.DungeonStore]:getRemainTimeStr2ByEndTime(true)
end
...
function slot0.refreshActivityState(slot0)
	...
	gohelper.setActive(slot0.goStore, ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal)
end
