...
local var_0_0 = class("V2a0_DungeonEnterView", BaseView)
...
function var_0_0._editableInitView(arg_9_0)
	arg_9_0.actId = VersionActivity2_0Enum.ActivityId.Dungeon
	...
	arg_9_0:_setDesc()
	RedDotController.instance:addRedDot(arg_9_0._goreddot, RedDotEnum.DotNode.V2a0DungeonEnter)
	RedDotController.instance:addRedDot(arg_9_0._gotaskreddot, RedDotEnum.DotNode.V2a0DungeonTask)
end
...
function var_0_0.onOpen(arg_12_0)
	...
	if arg_12_0.viewContainer:getIsFirstPlaySubViewAnim() then
		arg_12_0.animComp.animator:Play("open1", 0, 0)

		arg_12_0.animComp.animator.speed = 1

		arg_12_0.viewContainer:markPlayedSubViewAnim()
	else
		arg_12_0.animComp.animator:Play(UIAnimationName.Open, 0, 0)
...
function var_0_0.refreshRemainTime(arg_15_0)
	...
	local var_15_2 = ActivityModel.instance:getActivityInfo()[VersionActivity2_0Enum.ActivityId.DungeonStore]
...
function var_0_0.refreshActivityState(arg_16_0)
	...
	local var_16_3 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal

	gohelper.setActive(arg_16_0.goStore, var_16_3)
end

function var_0_0.refreshStoreCurrency(arg_17_0)
	local var_17_0 = CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V2a0Dungeon)
