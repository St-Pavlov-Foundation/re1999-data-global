...
local var_0_0 = class("ShelterHeroGroupListView", HeroGroupListView)
local var_0_1 = {
	{
		-1097.6,
		166.6
...
function var_0_0._checkRestrictHero(arg_10_0)
	...
	local var_10_2 = var_10_1.intrudeBox.fight

	for iter_10_0 = 1, 5 do
		local var_10_3 = HeroSingleGroupModel.instance:getById(iter_10_0)

		if var_10_3 then
			local var_10_4 = HeroModel.instance:getById(var_10_3.heroUid)
			local var_10_5 = var_10_4 and var_10_1:getHeroMo(var_10_4.heroId)

			if HeroGroupModel.instance:isRestrict(var_10_3.heroUid) or not var_10_4 or var_10_2.usedHeroId[var_10_4.heroId] or var_10_5.health <= 0 then
