...
local var_0_0 = class("SurvivalEventChoiceItem", LuaCompBase)
...
function var_0_0.init(arg_1_0, arg_1_1)
	...
	arg_1_0._imageicon = gohelper.findChildImage(arg_1_1, "#go_State/#go_Icon/#image_Icon")
end
...
function var_0_0.updateData(arg_4_0, arg_4_1)
	...
	if arg_4_1 then
		...
		local var_4_1 = arg_4_1.icon

		if not arg_4_1.isValid then
			var_4_0 = SurvivalConst.EventChoiceColor.Gray
		end

		var_4_1 = var_4_1 ~= SurvivalEnum.EventChoiceIcon.None and var_4_1 or SurvivalEnum.EventChoiceIcon.Return
		...
		gohelper.setActive(arg_4_0._goicon, var_4_1 ~= SurvivalEnum.EventChoiceIcon.None)

		if var_4_1 ~= SurvivalEnum.EventChoiceIcon.None then
			arg_4_0._imageicon.color = GameUtil.parseColor(var_4_0)

			UISpriteSetMgr.instance:setSurvivalSprite(arg_4_0._imageicon, "survival_event_icon_" .. tostring(var_4_1))
		end
