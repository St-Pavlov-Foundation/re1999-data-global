module("modules.logic.story.view.StoryActivityChapterClose3_1", package.seeall)

local var_0_0 = class("StoryActivityChapterClose3_1", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v3a1/storyactivitychapterclose.prefab"
end
