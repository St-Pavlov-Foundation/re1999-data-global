...
local var_0_0 = class("StoryActivityChapterClose2_4", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v2a4/storyactivitychapterclose.prefab"
end
...
function var_0_0.onUpdateView(arg_3_0)
	...
	arg_3_0._audioId = AudioEnum.Story.play_activitysfx_diqiu_chapter_continue

	arg_3_0.simageBg:LoadImage(string.format("singlebg/v2a4_opening_singlebg/bg%s.jpg", var_3_0 and 3 or 2))
	arg_3_0:_playAudio()
end
