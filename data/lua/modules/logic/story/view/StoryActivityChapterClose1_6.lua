module("modules.logic.story.view.StoryActivityChapterClose1_6", package.seeall)

local var_0_0 = class("StoryActivityChapterClose1_6", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v1a6/storyactivitychapterclose.prefab"
end
...
function var_0_0.onUpdateView(arg_3_0)
	...
	arg_3_0._audioId = AudioEnum.Story.play_activitysfx_shuori_chapter_continue

	if not var_3_0 then
		arg_3_0._simageIcon:LoadImage("singlebg_lang/txt_v1a6_storyactivityopenclose/txt_v1a6_story_continue.png")
	else
		arg_3_0._simageIcon:LoadImage("singlebg_lang/txt_v1a6_storyactivityopenclose/txt_v1a6_story_end.png")
	end
