module("modules.logic.story.view.StoryActivityChapterOpenSP01_1", package.seeall)

local var_0_0 = class("StoryActivityChapterOpenSP01_1", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/sp01/storyactivitychapteropen1.prefab"
end
...
function var_0_0.play(arg_4_0)
	...
	local var_4_5 = string.format("chapter_1_%s", var_4_4 and var_4_4.labelRes)
	local var_4_6 = string.format("title_1_%s", var_4_3)
