module("modules.logic.story.view.StoryActivityChapterOpenSP01_2", package.seeall)

local var_0_0 = class("StoryActivityChapterOpenSP01_2", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/sp01/storyactivitychapteropen2.prefab"
end
...
function var_0_0.play(arg_4_0)
	...
	local var_4_5 = string.format("chapter_2_%s", var_4_4 and var_4_4.labelRes)
	local var_4_6 = string.format("title_2_%s", var_4_3)
...
function var_0_0.getVideoName(arg_9_0, arg_9_1)
	return arg_9_1 == 1 and "s01_opening"
end

function var_0_0.getLangResBg(arg_10_0, arg_10_1)
	return string.format("singlebg_lang/txt_sp01_storyactivityopenclose/%s.png", arg_10_1)
end
