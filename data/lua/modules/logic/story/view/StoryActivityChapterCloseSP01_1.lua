module("modules.logic.story.view.StoryActivityChapterCloseSP01_1", package.seeall)

local var_0_0 = class("StoryActivityChapterCloseSP01_1", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/sp01/storyactivitychapterclose1.prefab"
end
