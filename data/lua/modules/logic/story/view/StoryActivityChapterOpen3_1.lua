module("modules.logic.story.view.StoryActivityChapterOpen3_1", package.seeall)

local var_0_0 = class("StoryActivityChapterOpen3_1", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v3a1/storyactivitychapteropen.prefab"
end
...
function var_0_0.getVideoName(arg_9_0, arg_9_1)
	return arg_9_1 == 1 and "3_1_opening_1" or "3_1_opening_2"
end

function var_0_0.getLangResBg(arg_10_0, arg_10_1)
	return string.format("singlebg_lang/txt_v3a1_storyactivityopenclose/%s.png", arg_10_1)
end
