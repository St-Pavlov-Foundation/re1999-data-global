...
local var_0_0 = class("StoryActivityChapterOpen2_7", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v2a7/storyactivitychapteropen.prefab"
end
...
function var_0_0.getVideoName(arg_9_0, arg_9_1)
	return arg_9_1 == 1 and "2_7_opening_1"
end

function var_0_0.getLangResBg(arg_10_0, arg_10_1)
	return string.format("singlebg_lang/txt_v2a7_storyactivityopenclose/%s.png", arg_10_1)
end
