module("modules.logic.story.view.StoryActivityChapterClose2_1", package.seeall)

local var_0_0 = class("StoryActivityChapterClose2_1", StoryActivityChapterBase)

function var_0_0.onCtor(arg_1_0)
	arg_1_0.assetPath = "ui/viewres/story/v2a1/storyactivitychapterclose.prefab"
end
...
function var_0_0.onUpdateView(arg_3_0)
	...
	arg_3_0._audioId = var_3_0 and AudioEnum.Story.play_activitysfx_wangshi_chapter_close or AudioEnum.Story.play_activitysfx_wangshi_subsection_close
