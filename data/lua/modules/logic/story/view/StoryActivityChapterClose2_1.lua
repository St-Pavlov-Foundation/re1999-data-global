...
slot0 = class("StoryActivityChapterClose2_1", StoryActivityChapterBase)

function slot0.onCtor(slot0)
	slot0.assetPath = "ui/viewres/story/v2a1/storyactivitychapterclose.prefab"
end
...
function slot0.onUpdateView(slot0)
	...
	slot0._audioId = slot1 and AudioEnum.Story.play_activitysfx_wangshi_chapter_close or AudioEnum.Story.play_activitysfx_wangshi_subsection_close
