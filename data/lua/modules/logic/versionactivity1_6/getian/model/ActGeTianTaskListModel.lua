...
local var_0_0 = class("ActGeTianTaskListModel", ListScrollModel)
...
function var_0_0.refreshData(arg_2_0)
	...
	if var_2_0 ~= nil then
		local var_2_3 = RoleActivityConfig.instance:getActicityTaskList(ActGeTianEnum.ActivityId)

		for iter_2_0, iter_2_1 in pairs(var_2_3) do
			local var_2_4 = ActGeTianTaskMO.New()
	...
	if var_2_2 > 1 then
		local var_2_5 = ActGeTianTaskMO.New()

		var_2_5.id = ActGeTianEnum.TaskMOAllFinishId
		var_2_5.activityId = ActGeTianEnum.ActivityId
...
function var_0_0.getSortIndex(arg_4_0)
	if arg_4_0.id == ActGeTianEnum.TaskMOAllFinishId then
		return 1
...
function var_0_0.preFinish(arg_8_0, arg_8_1)
	...
	if arg_8_1.id == ActGeTianEnum.TaskMOAllFinishId then
		for iter_8_0, iter_8_1 in ipairs(var_8_2) do
			if iter_8_1:alreadyGotReward() and iter_8_1.id ~= ActGeTianEnum.TaskMOAllFinishId then
	...
	if var_8_0 then
		local var_8_3 = arg_8_0:getById(ActGeTianEnum.TaskMOAllFinishId)
...
function var_0_0.getGotRewardCount(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in ipairs(var_9_0) do
		if iter_9_1:alreadyGotReward() and not iter_9_1.preFinish and iter_9_1.id ~= ActGeTianEnum.TaskMOAllFinishId then
			var_9_1 = var_9_1 + 1
		end
	end
