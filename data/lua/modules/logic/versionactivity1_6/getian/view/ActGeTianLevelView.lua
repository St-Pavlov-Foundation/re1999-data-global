...
function var_0_0.onOpen(arg_9_0)
	...
	RedDotController.instance:addRedDot(var_9_0, RedDotEnum.DotNode.V1a6RoleActivityTask, ActGeTianEnum.ActivityId)
	arg_9_0:OnDotChange()
	...
	if arg_9_0.viewParam and arg_9_0.viewParam.needShowFight then
		local var_9_1 = ActGeTianModel.instance:getEnterFightIndex()
