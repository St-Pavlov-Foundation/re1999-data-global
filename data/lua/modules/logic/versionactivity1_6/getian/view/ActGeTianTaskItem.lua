...
local var_0_0 = class("ActGeTianTaskItem", ListScrollCellExtend)

var_0_0.prefabPath = "ui/viewres/versionactivity_1_6/v1a6_getian/v1a6_getian_taskitem.prefab"
...
function var_0_0._btnfinishbgOnClick(arg_5_0)
	if ActGeTianController.instance:delayReward(ActGeTianEnum.AnimatorTime.TaskReward, arg_5_0._actTaskMO) then
		arg_5_0:_onOneClickClaimReward(arg_5_0._actTaskMO.activityId)
	end
end

function var_0_0._btngetallOnClick(arg_6_0)
	if ActGeTianController.instance:delayReward(ActGeTianEnum.AnimatorTime.TaskReward, arg_6_0._actTaskMO) then
		ActGeTianController.instance:dispatchEvent(ActGeTianEvent.OneClickClaimReward, arg_6_0._actTaskMO.activityId)
	end
end
...
function var_0_0._editableAddEvents(arg_8_0)
	arg_8_0:addEventCb(ActGeTianController.instance, ActGeTianEvent.OneClickClaimReward, arg_8_0._onOneClickClaimReward, arg_8_0)
end

function var_0_0._editableRemoveEvents(arg_9_0)
	arg_9_0:removeEventCb(ActGeTianController.instance, ActGeTianEvent.OneClickClaimReward, arg_9_0._onOneClickClaimReward, arg_9_0)
end
...
function var_0_0.onUpdateMO(arg_12_0, arg_12_1)
	...
	local var_12_0 = ActGeTianTaskListModel.instance.instance:getRankDiff(arg_12_1)
...
function var_0_0._moveByRankDiff(arg_13_0, arg_13_1)
	if arg_13_1 and arg_13_1 ~= 0 then
		...
		arg_13_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_13_0.viewTrs, 0, ActGeTianEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function var_0_0._refreshUI(arg_15_0)
	...
	local var_15_1 = var_15_0.id ~= ActGeTianEnum.TaskMOAllFinishId
