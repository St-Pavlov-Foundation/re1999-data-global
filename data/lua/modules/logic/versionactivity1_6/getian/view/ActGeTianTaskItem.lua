...
slot0 = class("ActGeTianTaskItem", ListScrollCellExtend)
slot0.prefabPath = "ui/viewres/versionactivity_1_6/v1a6_getian/v1a6_getian_taskitem.prefab"
...
function slot0._btnfinishbgOnClick(slot0)
	if ActGeTianController.instance:delayReward(ActGeTianEnum.AnimatorTime.TaskReward, slot0._actTaskMO) then
...
function slot0._btngetallOnClick(slot0)
	if ActGeTianController.instance:delayReward(ActGeTianEnum.AnimatorTime.TaskReward, slot0._actTaskMO) then
		ActGeTianController.instance:dispatchEvent(ActGeTianEvent.OneClickClaimReward, slot0._actTaskMO.activityId)
	end
end
...
function slot0._editableAddEvents(slot0)
	slot0:addEventCb(ActGeTianController.instance, ActGeTianEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._editableRemoveEvents(slot0)
	slot0:removeEventCb(ActGeTianController.instance, ActGeTianEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end
...
function slot0.onUpdateMO(slot0, slot1)
	...
	slot0:_refreshUI()
	slot0:_moveByRankDiff(ActGeTianTaskListModel.instance.instance:getRankDiff(slot1))
end
...
function slot0._moveByRankDiff(slot0, slot1)
	if slot1 and slot1 ~= 0 then
		...
		slot0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(slot0.viewTrs, 0, ActGeTianEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function slot0._refreshUI(slot0)
	...
	slot2 = slot1.id ~= ActGeTianEnum.TaskMOAllFinishId
