...
local var_0_0 = class("GeTianFightItem", LuaCompBase)
...
function var_0_0._btnOnClick(arg_5_0)
	...
	ActGeTianController.instance:dispatchEvent(ActGeTianEvent.FightItemClick, arg_5_0.index)
end
...
function var_0_0._btnOnHard(arg_7_0)
	if not ActGeTianModel.instance:isLevelUnlock(arg_7_0.hardConfig.id) then
		GameFacade.showToast(ToastEnum.DungeonIsLockNormal)
...
function var_0_0.refreshStatus(arg_10_0)
	arg_10_0.unlock = ActGeTianModel.instance:isLevelUnlock(arg_10_0.id)

	local var_10_0 = ActGeTianModel.instance:isLevelUnlock(arg_10_0.hardConfig.id)
...
function var_0_0.refreshStar(arg_11_0)
	local var_11_0 = ActGeTianModel.instance:isLevelPass(arg_11_0.id)
	local var_11_1 = ActGeTianModel.instance:isLevelPass(arg_11_0.hardConfig.id)
...
function var_0_0.enterFight(arg_14_0, arg_14_1)
	...
	if var_14_0 and var_14_1 and var_14_2 > 0 then
		ActGeTianModel.instance:setEnterFightIndex(arg_14_0.index)
