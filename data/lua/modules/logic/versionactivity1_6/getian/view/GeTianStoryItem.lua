...
slot0 = class("GeTianStoryItem", LuaCompBase)
...
function slot0._btnOnClick(slot0)
	...
	ActGeTianController.instance:dispatchEvent(ActGeTianEvent.StoryItemClick, slot0.index)
end
...
function slot0.refreshStatus(slot0)
	...
	slot0.isPass = ActGeTianModel.instance:isLevelPass(slot0.id)
...
function slot0.onStoryFinished(slot0)
	...
	DungeonModel.instance:setLastSendEpisodeId(slot0.config.id)
