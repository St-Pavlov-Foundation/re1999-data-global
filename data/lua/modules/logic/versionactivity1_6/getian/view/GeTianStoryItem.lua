...
local var_0_0 = class("GeTianStoryItem", LuaCompBase)
...
function var_0_0._btnOnClick(arg_5_0)
	...
	ActGeTianController.instance:dispatchEvent(ActGeTianEvent.StoryItemClick, arg_5_0.index)
end
...
function var_0_0.refreshStatus(arg_9_0)
	arg_9_0.unlock = ActGeTianModel.instance:isLevelUnlock(arg_9_0.id)

	gohelper.setActive(arg_9_0._golock, not arg_9_0.unlock)

	arg_9_0.isPass = ActGeTianModel.instance:isLevelPass(arg_9_0.id)
...
function var_0_0.onStoryFinished(arg_13_0)
	...
	DungeonModel.instance:setLastSendEpisodeId(arg_13_0.config.id)
