...
local var_0_0 = class("QuNiangStoryItem", LuaCompBase)
...
function var_0_0._btnOnClick(arg_5_0)
	...
	ActQuNiangController.instance:dispatchEvent(ActQuNiangEvent.StoryItemClick, arg_5_0.index)
end
...
function var_0_0.refreshStatus(arg_9_0)
	arg_9_0.unlock = ActQuNiangModel.instance:isLevelUnlock(arg_9_0.id)

	gohelper.setActive(arg_9_0._golock, not arg_9_0.unlock)

	arg_9_0.isPass = ActQuNiangModel.instance:isLevelPass(arg_9_0.id)
