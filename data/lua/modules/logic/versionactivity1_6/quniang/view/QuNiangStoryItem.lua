...
slot0 = class("QuNiangStoryItem", LuaCompBase)
...
function slot0._btnOnClick(slot0)
	...
	ActQuNiangController.instance:dispatchEvent(ActQuNiangEvent.StoryItemClick, slot0.index)
end
...
function slot0.refreshStatus(slot0)
	...
	slot0.isPass = ActQuNiangModel.instance:isLevelPass(slot0.id)
