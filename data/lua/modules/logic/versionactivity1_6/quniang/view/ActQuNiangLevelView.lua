...
function slot0.onOpen(slot0)
	...
	RedDotController.instance:addRedDot(gohelper.findChild(slot0._btnTask.gameObject, "#go_reddot"), RedDotEnum.DotNode.V1a6RoleActivityTask, ActQuNiangEnum.ActivityId)
	slot0:OnDotChange()
	slot0:_showLeftTime()
