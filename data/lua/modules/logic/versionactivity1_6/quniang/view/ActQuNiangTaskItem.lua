...
function ActQuNiangTaskItem:_editableAddEvents()
	self:addEventCb(ActQuNiangController.instance, ActQuNiangEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end

function ActQuNiangTaskItem:_editableRemoveEvents()
	self:removeEventCb(ActQuNiangController.instance, ActQuNiangEvent.OneClickClaimReward, self._onOneClickClaimReward, self)
end
