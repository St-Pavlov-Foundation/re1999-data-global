...
local var_0_0 = class("ActQuNiangTaskItem", ListScrollCellExtend)

var_0_0.prefabPath = "ui/viewres/versionactivity_1_6/v1a6_quniang/v1a6_quniang_taskitem.prefab"
...
function var_0_0._btnfinishbgOnClick(arg_5_0)
	if ActQuNiangController.instance:delayReward(ActQuNiangEnum.AnimatorTime.TaskReward, arg_5_0._actTaskMO) then
		arg_5_0:_onOneClickClaimReward(arg_5_0._actTaskMO.activityId)
	end
end

function var_0_0._btngetallOnClick(arg_6_0)
	if ActQuNiangController.instance:delayReward(ActQuNiangEnum.AnimatorTime.TaskReward, arg_6_0._actTaskMO) then
		ActQuNiangController.instance:dispatchEvent(ActQuNiangEvent.OneClickClaimReward, arg_6_0._actTaskMO.activityId)
	end
end
...
function var_0_0._editableAddEvents(arg_8_0)
	arg_8_0:addEventCb(ActQuNiangController.instance, ActQuNiangEvent.OneClickClaimReward, arg_8_0._onOneClickClaimReward, arg_8_0)
end

function var_0_0._editableRemoveEvents(arg_9_0)
	arg_9_0:removeEventCb(ActQuNiangController.instance, ActQuNiangEvent.OneClickClaimReward, arg_9_0._onOneClickClaimReward, arg_9_0)
end

function var_0_0._onOneClickClaimReward(arg_10_0, arg_10_1)
	if arg_10_0._actTaskMO and arg_10_0._actTaskMO.activityId == arg_10_1 and arg_10_0._actTaskMO:alreadyGotReward() then
...
function var_0_0.onUpdateMO(arg_12_0, arg_12_1)
	...
	local var_12_0 = ActQuNiangTaskListModel.instance.instance:getRankDiff(arg_12_1)
...
function var_0_0._moveByRankDiff(arg_13_0, arg_13_1)
	if arg_13_1 and arg_13_1 ~= 0 then
		...
		arg_13_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_13_0.viewTrs, 0, ActQuNiangEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function var_0_0._refreshUI(arg_15_0)
	...
	local var_15_1 = var_15_0.id ~= ActQuNiangEnum.TaskMOAllFinishId
