...
local var_0_0 = class("V1a6_Role_PanelSignView", Activity101SignViewBase)
...
function var_0_0.onOpen(arg_9_0)
	...
	arg_9_0._viewAni = arg_9_0.viewGO:GetComponent(typeof(UnityEngine.Animator))
	arg_9_0._viewAni.enabled = true
...
function var_0_0.onClose(arg_10_0)
	arg_10_0._viewAni.enabled = false
