...
local var_0_0 = class("VersionActivity1_6DungeonMapChapterLayout", BaseChildView)
...
function var_0_0.setSelectEpisodeId(arg_5_0, arg_5_1, arg_5_2)
	arg_5_0.selectedEpisodeItem = arg_5_0._episodeItemDict[arg_5_1]

	for iter_5_0, iter_5_1 in pairs(arg_5_0._episodeItemDict) do
		iter_5_1:updateSelectStatus(arg_5_0.selectedEpisodeItem, arg_5_2)
	end
end
...
function var_0_0._onGamepadKeyUp(arg_7_0, arg_7_1)
	...
	if (var_7_1 == ViewName.VersionActivity1_6DungeonMapView or var_7_1 == ViewName.VersionActivity1_6DungeonMapLevelView) and arg_7_0._focusIndex and not DungeonMapModel.instance:getMapInteractiveItemVisible() and (arg_7_1 == GamepadEnum.KeyCode.LB or arg_7_1 == GamepadEnum.KeyCode.RB) then
...
function var_0_0._onOpenView(arg_15_0, arg_15_1)
	if arg_15_1 == ViewName.VersionActivity1_6DungeonMapLevelView then
...
function var_0_0._onCloseView(arg_16_0, arg_16_1)
	if arg_16_1 == ViewName.VersionActivity1_6DungeonMapLevelView then
