...
slot0 = class("VersionActivity1_6TaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity1_6TaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity1_6TaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
