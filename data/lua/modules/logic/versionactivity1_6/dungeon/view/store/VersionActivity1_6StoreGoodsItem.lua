...
slot0 = class("VersionActivity1_6StoreGoodsItem", UserDataDispose)
...
function slot0.updateInfo(slot0, slot1)
	...
	UISpriteSetMgr.instance:setV1a6DungeonStoreSprite(slot0.imageRare, "v1a6_store_quality_" .. slot7)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_6Enum.ActivityId.DungeonStore, slot0.storeGoodsCo.id)
