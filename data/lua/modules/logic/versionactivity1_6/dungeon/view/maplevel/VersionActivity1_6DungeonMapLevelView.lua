...
function var_0_0.refreshEpisodeTextInfo(arg_40_0)
	...
	local var_40_4 = lua_battle.configDict[arg_40_0.showEpisodeCo.battleId]
	local var_40_5 = lua_battle.configDict[arg_40_0.showEpisodeCo.firstBattleId]
	local var_40_6 = var_40_5 and not string.nilorempty(var_40_5.balance)
	local var_40_7 = var_40_4 and not string.nilorempty(var_40_4.balance)
	local var_40_8 = DungeonModel.instance:hasPassLevel(arg_40_0.showEpisodeCo.id)

	if (var_40_6 or var_40_7) and not var_40_8 then
		arg_40_0._txtrecommondlv.text = "---"
