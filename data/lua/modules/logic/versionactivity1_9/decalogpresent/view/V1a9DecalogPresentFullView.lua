...
slot0 = class("V1a9DecalogPresentFullView", BaseView)
...
function slot0.onInitView(slot0)
	...
	slot0._goReceived = gohelper.findChild(slot0.viewGO, "#btn_Claim/#go_Received")
...
function slot0._btnClaimOnClick(slot0)
	DecalogPresentController.instance:receiveDecalogPresent(slot0.refreshCanGet, slot0)
end
...
function slot0.refreshCanGet(slot0)
	slot1 = DecalogPresentModel.instance:isShowRedDot()
