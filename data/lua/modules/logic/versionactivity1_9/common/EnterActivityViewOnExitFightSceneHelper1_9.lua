...
function slot0.enterActivity11906(slot0, slot1)
	uv0.enterVersionActivityDungeonCommon(uv0._enterActivityDungeonAterFight11906, slot0, slot1)
end
...
function slot0._enterActivityDungeonAterFight11906(slot0, slot1)
...
function slot0.checkFightAfterStory11906(slot0, slot1, slot2)
...
function slot0.enterFightAgain11906()
...
function slot0.enterActivity11908(slot0, slot1)
	DungeonModel.instance:resetSendChapterEpisodeId()

	slot2 = VersionActivity1_9Enum.ActivityId.Lucy
...
function slot0.enterActivity11909(slot0, slot1)
	DungeonModel.instance:resetSendChapterEpisodeId()

	slot2 = VersionActivity1_9Enum.ActivityId.KaKaNia
...
function slot0.enterActivity11910(slot0, slot1)
