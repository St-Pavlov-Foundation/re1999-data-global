...
slot0 = class("VersionActivity1_9EnterController", BaseController)
...
function slot0.openVersionActivityEnterView(slot0, slot1, slot2, slot3)
	if not slot0:checkCanOpen(VersionActivity1_9Enum.ActivityId.EnterView) then
		return
	end
...
function slot0._openVersionActivityEnterView(slot0, slot1, slot2, slot3)
	if not VersionActivityBaseController.instance:isPlayedActivityVideo(VersionActivity1_9Enum.ActivityId.EnterView) then
		if not (ActivityModel.instance:getActMO(VersionActivity1_9Enum.ActivityId.EnterView) and slot4.config and slot4.config.storyId) then
...
function slot0.GetActivityPrefsKey(slot0)
	return VersionActivity1_9Enum.ActivityId.EnterView .. slot0
end
