...
local var_0_0 = class("VersionActivity1_9EnterController", BaseController)
...
function var_0_0.openVersionActivityEnterView(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	if not arg_4_0:checkCanOpen(VersionActivity1_9Enum.ActivityId.EnterView) then
		return
	end
...
function var_0_0._onFinishStory(arg_5_0)
	if not arg_5_0:checkCanOpen(VersionActivity1_9Enum.ActivityId.EnterView) then
		return
	end
...
function var_0_0._openVersionActivityEnterView(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if not VersionActivityBaseController.instance:isPlayedActivityVideo(VersionActivity1_9Enum.ActivityId.EnterView) then
		local var_6_0 = ActivityModel.instance:getActMO(VersionActivity1_9Enum.ActivityId.EnterView)
...
function var_0_0.directOpenVersionActivityEnterView(arg_7_0, arg_7_1)
	if not arg_7_0:checkCanOpen(VersionActivity1_9Enum.ActivityId.EnterView) then
		return
	end
...
function var_0_0.GetActivityPrefsKey(arg_9_0)
	return VersionActivity1_9Enum.ActivityId.EnterView .. arg_9_0
end
