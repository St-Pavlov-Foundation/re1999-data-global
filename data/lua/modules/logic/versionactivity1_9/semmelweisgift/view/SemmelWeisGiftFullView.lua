...
local var_0_0 = class("SemmelWeisGiftFullView", BaseView)
...
function var_0_0._btnClaimOnClick(arg_4_0)
	SemmelWeisGiftController.instance:receiveSemmelWeisGift(arg_4_0.refreshCanGet, arg_4_0)
end
...
function var_0_0.refreshCanGet(arg_9_0)
	local var_9_0 = SemmelWeisGiftModel.instance:isShowRedDot()
...
function var_0_0.refreshRemainTime(arg_10_0)
	local var_10_0 = SemmelWeisGiftModel.instance:getSemmelWeisGiftActId()
