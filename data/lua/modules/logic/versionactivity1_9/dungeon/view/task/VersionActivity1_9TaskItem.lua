...
slot0 = class("VersionActivity1_9TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity1_9TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity1_9Enum.ActivityId.Dungeon)
	else
