...
function ActKaKaNiaLevelView:_initStageItems()
	...
	for i = 1, levelCount do
		...
		local stageItem = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, KaKaNiaStoryItem, self)
	...
	for i = 1, levelCount do
		...
		local cloneGo = self:getResInst(path, stageGo)
		local stageItem = MonoHelper.addNoUpdateLuaComOnceToGo(cloneGo, KaKaNiaFightItem, self)
