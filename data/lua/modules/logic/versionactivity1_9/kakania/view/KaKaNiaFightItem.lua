-- chunkname: @modules/logic/versionactivity1_9/kakania/view/KaKaNiaFightItem.lua

module("modules.logic.versionactivity1_9.kakania.view.KaKaNiaFightItem", package.seeall)

local KaKaNiaFightItem = class("KaKaNiaFightItem", LuaCompBase)

function KaKaNiaFightItem:init(go)
	self.viewGO = go
...
function KaKaNiaFightItem:addEventListeners()
...
function KaKaNiaFightItem:removeEventListeners()
	self._btnclick:RemoveClickListener()
	self._btnNormal:RemoveClickListener()
	self._btnHard:RemoveClickListener()
end

function KaKaNiaFightItem:onDestroy()
	return
end

function KaKaNiaFightItem:_btnOnClick()
...
function KaKaNiaFightItem:_btnOnNormal()
	self:enterFight(self.config)
end

function KaKaNiaFightItem:_btnOnHard()
...
function KaKaNiaFightItem:setParam(co, _index, _actId)
	self.config = co
	self.id = co.id
	self.actId = _actId
...
function KaKaNiaFightItem:_refreshUI()
	self:refreshStatus()
...
function KaKaNiaFightItem:refreshStatus()
...
function KaKaNiaFightItem:refreshStar()
...
function KaKaNiaFightItem:refreshSelect(_index)
...
function KaKaNiaFightItem:isUnlock()
	return self.unlock
end

function KaKaNiaFightItem:enterFight(episodeConfig)
