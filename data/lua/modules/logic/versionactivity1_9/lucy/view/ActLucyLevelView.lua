...
local var_0_0 = class("ActLucyLevelView", BaseView)
...
function var_0_0._editableInitView(arg_8_0)
	arg_8_0.actId = VersionActivity1_9Enum.ActivityId.Lucy
...
function var_0_0._checkFirstEnter(arg_10_0)
	if not arg_10_0.storyItemList[2]:isUnlock() and PlayerPrefsHelper.getNumber("ActLucyFirstEnter", 0) == 0 then
...
function var_0_0._initStageItems(arg_25_0)
	...
	for iter_25_0 = 1, var_25_4 do
		...
		local var_25_7 = MonoHelper.addNoUpdateLuaComOnceToGo(var_25_6, LucyStoryItem, arg_25_0)
	...
	for iter_25_1 = 1, var_25_10 do
		...
		local var_25_13 = MonoHelper.addNoUpdateLuaComOnceToGo(var_25_12, LucyFightItem, arg_25_0)
