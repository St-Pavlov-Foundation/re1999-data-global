-- chunkname: @modules/logic/versionactivity1_9/lucy/view/LucyFightItem.lua

module("modules.logic.versionactivity1_9.lucy.view.LucyFightItem", package.seeall)

local LucyFightItem = class("LucyFightItem", LuaCompBase)

function LucyFightItem:init(go)
	self.viewGO = go
...
function LucyFightItem:addEventListeners()
...
function LucyFightItem:removeEventListeners()
	self._btnclick:RemoveClickListener()
	self._btnNormal:RemoveClickListener()
	self._btnHard:RemoveClickListener()
end

function LucyFightItem:onDestroy()
	return
end

function LucyFightItem:_btnOnClick()
...
function LucyFightItem:_btnOnNormal()
	self:enterFight(self.config)
end

function LucyFightItem:_btnOnHard()
...
function LucyFightItem:setParam(co, _index, _actId)
	self.config = co
	self.id = co.id
	self.actId = _actId
...
function LucyFightItem:_refreshUI()
	self:refreshStatus()
...
function LucyFightItem:refreshStatus()
...
function LucyFightItem:refreshStar()
...
function LucyFightItem:refreshSelect(_index)
...
function LucyFightItem:isUnlock()
	return self.unlock
end

function LucyFightItem:enterFight(episodeConfig)
