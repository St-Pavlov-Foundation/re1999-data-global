...
local var_0_0 = class("VersionActivity2_8TaskItem", ListScrollCell)
...
function var_0_0.addEventListeners(arg_2_0)
	...
	VersionActivity2_8DungeonTaskStoreController.instance:registerCallback(VersionActivity2_8DungeonEvent.OnClickAllTaskFinish, arg_2_0._OnClickAllTaskFinish, arg_2_0)
end
...
function var_0_0.removeEventListeners(arg_3_0)
	...
	VersionActivity2_8DungeonTaskStoreController.instance:unregisterCallback(VersionActivity2_8DungeonEvent.OnClickAllTaskFinish, arg_3_0._OnClickAllTaskFinish, arg_3_0)
end
...
function var_0_0._OnClickAllTaskFinish(arg_6_0)
	if arg_6_0.taskMo then
		if arg_6_0.taskMo.getAll then
			arg_6_0:_btnFinishOnClick()
		elseif arg_6_0.taskMo.finishCount < arg_6_0.co.maxFinishCount and arg_6_0.taskMo.hasFinished then
			arg_6_0:getAnimator():Play(UIAnimationName.Finish, 0, 0)
		end
	end
end

var_0_0.FinishKey = "VersionActivity2_8TaskItem FinishKey"
