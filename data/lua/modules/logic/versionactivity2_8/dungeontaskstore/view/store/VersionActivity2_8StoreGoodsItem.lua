...
local var_0_0 = class("VersionActivity2_8StoreGoodsItem", ListScrollCell)
...
function var_0_0.refreshRemainBuyCount(arg_8_0)
	if arg_8_0.goodsCo.maxBuyCount == 0 then
		...
		arg_8_0.remainBuyCount = arg_8_0.goodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_8DungeonTaskStoreController.instance:getModuleConfig().DungeonStore, arg_8_0.goodsCo.id)
