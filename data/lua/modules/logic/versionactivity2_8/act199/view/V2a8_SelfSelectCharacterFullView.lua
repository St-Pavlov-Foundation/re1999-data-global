...
local var_0_0 = class("V2a8_SelfSelectCharacterFullView", BaseView)
...
function var_0_0.onRefreshActivity(arg_12_0)
	local var_12_0 = ActivityHelper.getActivityStatus(arg_12_0._actId)

	if var_12_0 == ActivityEnum.ActivityStatus.NotOnLine or var_12_0 == ActivityEnum.ActivityStatus.Expired then
