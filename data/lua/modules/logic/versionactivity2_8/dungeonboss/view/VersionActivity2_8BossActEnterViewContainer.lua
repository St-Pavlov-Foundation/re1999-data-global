...
local var_0_0 = class("VersionActivity2_8BossActEnterViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	local var_1_0 = {}

	arg_1_0._mapScene = VersionActivity2_8BossActSceneView.New()

	table.insert(var_1_0, VersionActivity2_8BossActEnterView.New())
	table.insert(var_1_0, arg_1_0._mapScene)
	table.insert(var_1_0, TabViewGroup.New(1, "anim/#go_lefttop"))
