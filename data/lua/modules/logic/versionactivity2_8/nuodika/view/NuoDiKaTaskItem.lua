...
local var_0_0 = class("NuoDiKaTaskItem", ListScrollCellExtend)
...
function var_0_0._btngetallOnClick(arg_6_0)
	NuoDiKaController.instance:dispatchEvent(NuoDiKaEvent.OneClickClaimReward, arg_6_0._act180TaskMO.activityId)
	UIBlockHelper.instance:startBlock("NuoDiKaTaskItem_finishAnim", 0.5)
...
function var_0_0._editableAddEvents(arg_10_0)
	NuoDiKaController.instance:registerCallback(NuoDiKaEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	NuoDiKaController.instance:unregisterCallback(NuoDiKaEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	...
	local var_14_0 = NuoDiKaTaskListModel.instance:getRankDiff(arg_14_1)
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_8/v2a8_nuodika/v2a8_nuodika_taskitem.prefab"
