...
local var_0_0 = class("V2a8_WarmUpLeftView", BaseView)
...
function var_0_0.onOpen(arg_6_0)
	arg_6_0._animEvent:AddEventListener("play_ui_fuleyuan_yure_open", arg_6_0._play_ui_fuleyuan_yure_open, arg_6_0)
	arg_6_0._animEvent:AddEventListener("play_ui_fuleyuan_yure_paper", arg_6_0._play_ui_fuleyuan_yure_paper, arg_6_0)
	arg_6_0._animEvent:AddEventListener("play_ui_fuleyuan_yure_whoosh", arg_6_0._play_ui_fuleyuan_yure_whoosh, arg_6_0)
end
...
function var_0_0._refresh(arg_18_0)
	...
	if var_18_0 then
		...
		elseif var_0_5.Clicked == var_18_2 then
			...
			logError("[V2a8_WarmUpLeftView] invalid state: " .. tostring(var_18_2))
		end
	end
end
...
local var_0_7 = "V2a8_WarmUpLeftView:kBlock_Click"
local var_0_8 = 9.99
