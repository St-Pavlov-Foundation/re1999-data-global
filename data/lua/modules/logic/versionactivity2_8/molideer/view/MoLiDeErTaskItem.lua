...
local var_0_0 = class("MoLiDeErTaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._act194TaskMO.config.jumpId > 0 then
		GameFacade.jump(arg_4_0._act194TaskMO.config.jumpId)
	end
end

function var_0_0._btnfinishbgOnClick(arg_5_0)
	arg_5_0:_onOneClickClaimReward(arg_5_0._act194TaskMO.activityId)
...
function var_0_0._btngetallOnClick(arg_6_0)
	LiangYueController.instance:dispatchEvent(MoLiDeErEvent.OneClickClaimReward, arg_6_0._act194TaskMO.activityId, true)
	UIBlockHelper.instance:startBlock("MoLiDeErTaskItem_finishAnim", 0.5)
	TaskDispatcher.runDelay(arg_6_0._delayFinishAll, arg_6_0, 0.5)
end

function var_0_0._delayFinish(arg_7_0)
	TaskRpc.instance:sendFinishTaskRequest(arg_7_0._act194TaskMO.config.id)
end
...
function var_0_0._editableAddEvents(arg_10_0)
	LiangYueController.instance:registerCallback(MoLiDeErEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	LiangYueController.instance:unregisterCallback(MoLiDeErEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end

function var_0_0._onOneClickClaimReward(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_0._act194TaskMO and arg_12_0._act194TaskMO.activityId == arg_12_1 and (arg_12_0._act194TaskMO:alreadyGotReward() or arg_12_0._act194TaskMO.id == -99999 and arg_12_2) then
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	arg_14_0._act194TaskMO = arg_14_1

	local var_14_0 = MoLiDeErTaskListModel.instance:getRankDiff(arg_14_1)
...
function var_0_0._refreshUI(arg_17_0)
	local var_17_0 = arg_17_0._act194TaskMO
