...
local var_0_0 = class("MoLiDeErTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_1.cellClass = MoLiDeErTaskItem
	...
	local var_1_3 = LuaListScrollViewWithAnimator.New(MoLiDeErTaskListModel.instance, var_1_1, var_1_2)

	var_1_3.dontPlayCloseAnimation = true

	table.insert(var_1_0, var_1_3)
	table.insert(var_1_0, MoLiDeErTaskView.New())
