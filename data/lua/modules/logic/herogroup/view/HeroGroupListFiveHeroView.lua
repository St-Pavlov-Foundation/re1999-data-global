...
local var_0_0 = class("HeroGroupListFiveHeroView", BaseView)
...
function var_0_0._editableInitView(arg_2_0)
	...
	arg_2_0._playerMax = lua_battle.configDict[var_2_0].playerMax
	arg_2_0._roleNum = ModuleEnum.FiveHeroEnum.MaxHeroNum
	...
	for iter_2_0 = 1, arg_2_0._roleNum do
		local var_2_1 = gohelper.findChild(arg_2_0.heroContainer, "pos" .. iter_2_0 .. "/container").transform
		...
		table.insert(arg_2_0.heroPosTrList, var_2_1)
	...
	local var_2_4 = arg_2_0._roleNum
	local var_2_5 = HeroGroupModel.instance:getBattleRoleNum()

	if var_2_5 then
		var_2_4 = math.min(var_2_5, var_2_4)
	end

	local var_2_6 = math.min(arg_2_0._playerMax, var_2_4)

	arg_2_0._openCount = var_2_6

	for iter_2_1 = 1, arg_2_0._roleNum do
		local var_2_7 = gohelper.findChild(arg_2_0.viewGO, "herogroupcontain/hero/bg" .. iter_2_1 .. "/bg")

		table.insert(arg_2_0._bgList, var_2_7)

		local var_2_8 = gohelper.findChildTextMesh(arg_2_0.viewGO, "herogroupcontain/hero/bg" .. iter_2_1 .. "/bg/#txt_order")

		var_2_8.text = iter_2_1 <= var_2_6 and tostring(iter_2_1) or ""

		table.insert(arg_2_0._orderList, var_2_8)
	end
...
function var_0_0._checkRestrictHero(arg_8_0)
	...
	for iter_8_0 = 1, arg_8_0._roleNum do
...
function var_0_0._onHeroGroupExit(arg_10_0)
	...
	for iter_10_2 = 1, arg_10_0._roleNum do
		local var_10_0 = ZProj.TweenHelper.DOTweenFloat(0, 1, 0.03 * (arg_10_0._roleNum - iter_10_2), nil, arg_10_0._closeTweenFinish, arg_10_0, iter_10_2, EaseType.Linear)
...
function var_0_0.canDrag(arg_12_0, arg_12_1, arg_12_2)
	...
	if not arg_12_2 and (var_12_1.mo:isEmpty() or var_12_1.mo.aid == -1 or arg_12_1 > arg_12_0._roleNum) then
		return false
	end
...
function var_0_0._onEndDrag(arg_15_0, arg_15_1, arg_15_2)
	...
	if var_15_0 > arg_15_0._roleNum then
		arg_15_0:_setHeroItemPos(var_15_1, var_15_2, true, var_15_3, arg_15_0)
...
function var_0_0._calcIndex(arg_21_0, arg_21_1)
	for iter_21_0 = 1, arg_21_0._roleNum do
...
function var_0_0.onDestroyView(arg_22_0)
	...
	for iter_22_0 = 1, arg_22_0._roleNum do
