...
function EnemyInfoView:onInitView()
	...
	self._btnattribute = gohelper.findChildButton(self.viewGO, "enemyinfo/#go_desccontainer/Viewport/#go_desccontainer/#go_attribute/#btn_attribute")
	...
	self._goattributetipview = gohelper.findChild(self.viewGO, "#go_attributetipview")
	self._btnattributetipview = gohelper.findChildButton(self.viewGO, "#go_attributetipview/#btn_close")
	self._goattributetipcontent = gohelper.findChild(self.viewGO, "#go_attributetipview/bg/content")
...
function EnemyInfoView:addEvents()
	...
	self._btnattributetipview:AddClickListener(self._closeAttributeTipView, self)
...
function EnemyInfoView:removeEvents()
	...
	self._btnattributetipview:RemoveClickListener()
...
function EnemyInfoView:_refreshSpeicalSkillIcon(monsterConfig)
	...
	gohelper.setActive(self._gopassiveskill, #skills > 0)
...
function EnemyInfoView:_refreshAttribute(monsterConfig)
	...
	self._btnattribute:RemoveClickListener()
	self._btnattribute:AddClickListener(self._onAttributeClick, self, data)
end

function EnemyInfoView:_getMontBaseAttr(monsterConfig)
...
function EnemyInfoView:_onAttributeClick(data)
	if self._showattributetip then
		return
	end

	gohelper.CreateObjList(self, self._onMonsterAttrItemShow, data, self._goattributetipcontent)
	gohelper.setActive(self._goattributetipview, true)

	self._showattributetip = true
end

function EnemyInfoView:_closeAttributeTipView()
	if self._showattributetip then
		gohelper.setActive(self._goattributetipview, false)

		self._showattributetip = false
	end
end
