...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._btnattribute = gohelper.findChildButton(arg_1_0.viewGO, "enemyinfo/#go_desccontainer/Viewport/#go_desccontainer/#go_attribute/#btn_attribute")
	...
	arg_1_0._goattributetipview = gohelper.findChild(arg_1_0.viewGO, "#go_attributetipview")
	arg_1_0._btnattributetipview = gohelper.findChildButton(arg_1_0.viewGO, "#go_attributetipview/#btn_close")
	arg_1_0._goattributetipcontent = gohelper.findChild(arg_1_0.viewGO, "#go_attributetipview/bg/content")
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0._btnattributetipview:AddClickListener(arg_2_0._closeAttributeTipView, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0._btnattributetipview:RemoveClickListener()
...
function var_0_0._refreshSpeicalSkillIcon(arg_14_0, arg_14_1)
	...
	gohelper.setActive(arg_14_0._gopassiveskill, #var_14_1 > 0)
...
function var_0_0._refreshAttribute(arg_23_0, arg_23_1)
	local var_23_0 = arg_23_0:_getMontBaseAttr(arg_23_1)

	gohelper.CreateObjList(arg_23_0, arg_23_0._onMonsterAttrItemShow, var_23_0, arg_23_0._goattribute)
	gohelper.setActive(arg_23_0._btnattribute.gameObject, true)
	arg_23_0._btnattribute:RemoveClickListener()
	arg_23_0._btnattribute:AddClickListener(arg_23_0._onAttributeClick, arg_23_0, var_23_0)
end

function var_0_0._getMontBaseAttr(arg_24_0, arg_24_1)
	local var_24_0 = lua_monster_skill_template.configDict[arg_24_1.skillTemplate]
	local var_24_1 = CharacterDataConfig.instance:getMonsterAttributeScoreList(arg_24_1.id)

	table.insert(var_24_1, 2, table.remove(var_24_1, 4))
	...
	for iter_24_0, iter_24_1 in ipairs(var_24_1) do
		table.insert(var_24_3, {
			id = HeroConfig.instance:getIDByAttrType(var_24_2[iter_24_0]),
			value = iter_24_1
		})
	end
...
function var_0_0._onMonsterAttrItemShow(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	local var_25_0 = arg_25_1.transform
	local var_25_1 = var_25_0:Find("icon"):GetComponent(gohelper.Type_Image)
	local var_25_2 = var_25_0:Find("name"):GetComponent(gohelper.Type_TextMesh)
	local var_25_3 = var_25_0:Find("rate"):GetComponent(gohelper.Type_Image)
	local var_25_4 = HeroConfig.instance:getHeroAttributeCO(arg_25_2.id)

	if SLFramework.UGUI.GuiHelper.GetPreferredWidth(var_25_2, var_25_4.name) > recthelper.getWidth(var_25_2.transform) then
		var_25_2.overflowMode = TMPro.TextOverflowModes.Ellipsis
	end

	var_25_2.text = var_25_4.name

	UISpriteSetMgr.instance:setCommonSprite(var_25_1, "icon_att_" .. var_25_4.id)
	UISpriteSetMgr.instance:setCommonSprite(var_25_3, "sx_" .. arg_25_2.value, true)
end

function var_0_0._setInfoShowState(arg_26_0)
	arg_26_0._isShowAttributeInfo = not arg_26_0._isShowAttributeInfo

	gohelper.setActive(arg_26_0._gonormalicon, not arg_26_0._isShowAttributeInfo)
	gohelper.setActive(arg_26_0._godescscrollview, not arg_26_0._isShowAttributeInfo)
	gohelper.setActive(arg_26_0._goselecticon, arg_26_0._isShowAttributeInfo)
	gohelper.setActive(arg_26_0._goattribute, arg_26_0._isShowAttributeInfo)

	arg_26_0.scrollDescContainer.verticalNormalizedPosition = 1
end

function var_0_0._onAttributeClick(arg_27_0, arg_27_1)
	if arg_27_0._showattributetip then
		return
	end

	gohelper.CreateObjList(arg_27_0, arg_27_0._onMonsterAttrItemShow, arg_27_1, arg_27_0._goattributetipcontent)
	gohelper.setActive(arg_27_0._goattributetipview, true)

	arg_27_0._showattributetip = true
end

function var_0_0._closeAttributeTipView(arg_28_0)
	if arg_28_0._showattributetip then
		gohelper.setActive(arg_28_0._goattributetipview, false)

		arg_28_0._showattributetip = false
	end
end

function var_0_0.onUpdateParam(arg_29_0)
	arg_29_0._battleId = arg_29_0.viewParam.battleId
	arg_29_0._battleInfo = arg_29_0.viewParam.battleInfo

	arg_29_0:_refreshUI()
end

function var_0_0.onOpen(arg_30_0)
	arg_30_0:addEventCb(HeroGroupController.instance, HeroGroupEvent.OnClickEnemyItem, arg_30_0._refreshInfo, arg_30_0)

	arg_30_0._battleId = arg_30_0.viewParam.battleId
	arg_30_0._battleInfo = arg_30_0.viewParam.battleInfo
	arg_30_0._adventure = arg_30_0.viewParam.adventure

	arg_30_0:_refreshUI()
end

function var_0_0._detectBossMultiHp(arg_31_0, arg_31_1)
	local var_31_0 = lua_monster_template.configDict[arg_31_1.template]
	local var_31_1 = #FightConfig.instance:getMultiHpListByMonsterId(arg_31_1.id)

	gohelper.setActive(arg_31_0._multiHpRoot, var_31_1 > 1)

	if var_31_1 > 1 then
		arg_31_0:com_createObjList(nil, var_31_1, arg_31_0._multiHpRoot, arg_31_0._multiHpItem)
	end
end

function var_0_0.onClose(arg_32_0)
	arg_32_0:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnClickEnemyItem, arg_32_0._refreshInfo, arg_32_0)
end

function var_0_0.onDestroyView(arg_33_0)
	arg_33_0._simagerightbg:UnLoadImage()

	arg_33_0._simagerightbg = nil

	if arg_33_0._enemyGroupItemGOs then
		for iter_33_0 = 1, #arg_33_0._enemyGroupItemGOs do
			if arg_33_0._enemyGroupItemGOs[iter_33_0].enemyItemGOs then
				for iter_33_1 = 1, #arg_33_0._enemyGroupItemGOs[iter_33_0].enemyItemGOs do
					local var_33_0 = arg_33_0._enemyGroupItemGOs[iter_33_0].enemyItemGOs[iter_33_1]

					var_33_0.btn:RemoveClickListener()
					HeroGroupController.instance:unregisterCallback(HeroGroupEvent.OnClickEnemyItem, var_33_0.onClickEnemyItem, var_33_0)
				end
			end
		end
	end

	if arg_33_0._skillGOs then
		for iter_33_2 = 1, #arg_33_0._skillGOs do
			local var_33_1 = arg_33_0._skillGOs[iter_33_2]

			var_33_1.tag:UnLoadImage()
			var_33_1.icon:UnLoadImage()
			var_33_1.btn:RemoveClickListener()
		end
	end

	for iter_33_3, iter_33_4 in ipairs(arg_33_0._superItemList) do
		iter_33_4.btn:RemoveClickListener()
	end

	arg_33_0:__onDispose()
end
