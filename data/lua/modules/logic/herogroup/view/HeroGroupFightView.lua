...
function slot0.onInitView(slot0)
	...
	slot0._goclothbg = gohelper.findChild(slot0.viewGO, "#go_container/btnContain/btnCloth/bg")
	slot0._txtclothname = gohelper.findChildText(slot0.viewGO, "#go_container/btnContain/btnCloth/bg/#txt_clothName")
	slot0._txtclothnameen = gohelper.findChildText(slot0.viewGO, "#go_container/btnContain/btnCloth/bg/#txt_clothName/#txt_clothNameEn")
...
function slot0._editableInitView(slot0)
	...
	if slot0._goclothbg then
		slot0._iconGO = slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._goclothbg.gameObject)
		gohelper.onceAddComponent(slot0._iconGO, typeof(UnityEngine.UI.LayoutElement)).ignoreLayout = true
		slot0._iconGO.transform.anchorMin = Vector2.up
		slot0._iconGO.transform.anchorMax = Vector2.up
		slot0._iconGO.transform.pivot = Vector2.up

		recthelper.setAnchor(slot0._iconGO.transform, -90, 70)
	end
...
function slot0._refreshReplay(slot0)
	if slot0._chapterConfig.type == DungeonEnum.ChapterType.WeekWalk then
		...
		recthelper.setWidth(slot0._goReplayBtn.transform, slot0._replayMode and 500 or 83)
...
function slot0._switchReplayMul(slot0)
	...
	gohelper.findChildTextMesh(slot0._goreplayready, "tip").color = GameConfig:GetCurLangType() == LangSettings.zh and Color.white or SLFramework.UGUI.GuiHelper.ParseColor("#D6B5B5")
end
