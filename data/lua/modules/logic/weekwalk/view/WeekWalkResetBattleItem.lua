...
local var_0_0 = class("WeekWalkResetBattleItem", ListScrollCellExtend)
...
function var_0_0._setStarStatus(arg_10_0, arg_10_1)
	local var_10_0 = arg_10_0._mapInfo:getStarNumConfig()
	...
	for iter_10_0 = 1, var_10_0 do
		...
		gohelper.setActive(gohelper.findChild(var_10_1, "full"), iter_10_0 <= arg_10_1)
	end
end
...
function var_0_0._setNormalStatus(arg_11_0)
	...
	arg_11_0:_setStarStatus(arg_11_0._battleInfo.star)
end
