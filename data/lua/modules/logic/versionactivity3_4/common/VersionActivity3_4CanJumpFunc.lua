-- chunkname: @modules/logic/versionactivity3_4/common/VersionActivity3_4CanJumpFunc.lua

module("modules.logic.versionactivity3_4.common.VersionActivity3_4CanJumpFunc", package.seeall)

local VersionActivity3_4CanJumpFunc = class("VersionActivity3_4CanJumpFunc")

function VersionActivity3_4CanJumpFunc:canJumpTo13402(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity3_4Enum.ActivityId.EnterView)

	if status ~= ActivityEnum.ActivityStatus.Normal then
		return false, toastId, toastParamList
	end

	local actId = VersionActivity3_4Enum.ActivityId.Dungeon
...
function VersionActivity3_4CanJumpFunc:canJumpTo13403(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity3_4Enum.ActivityId.DungeonStore)
...
function VersionActivity3_4CanJumpFunc:canJumpTo13440(paramsList)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity3_4Enum.ActivityId.ReactivityStore)
...
return VersionActivity3_4CanJumpFunc
