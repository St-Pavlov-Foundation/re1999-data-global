...
local var_0_0 = class("HeroGroupPresetSingleGroupModel", ListScrollModel)
...
function var_0_0.setMaxHeroCount(arg_5_0, arg_5_1, arg_5_2)
	...
	arg_5_2 = arg_5_2 or HeroSingleGroupPresetMO
...
function var_0_0.setSingleGroup(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_2 and arg_6_1 then
		...
		for iter_6_1 = 1, #var_6_2 do
			...
			var_6_2[iter_6_1]:setHeroGroup(arg_6_1)
...
function var_0_0.isFull(arg_16_0)
	...
	for iter_16_0, iter_16_1 in ipairs(var_16_0) do
		if iter_16_1:canAddHero() and HeroGroupPresetModel.instance:isPositionOpen(iter_16_1.id) then
			return false
		end
	end
