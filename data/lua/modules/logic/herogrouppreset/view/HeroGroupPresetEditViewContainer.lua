...
local var_0_0 = class("HeroGroupPresetEditViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = HeroGroupPresetEditItem
	...
	return {
		...
		LuaListScrollViewWithAnimator.New(HeroGroupPresetEditListModel.instance, var_1_0, var_1_1),
...
function var_0_0.getQuickEditScroll(arg_2_0)
	...
	var_2_0.cellClass = HeroGroupPresetQuickEditItem
	...
	return LuaListScrollViewWithAnimator.New(HeroGroupPresetQuickEditListModel.instance, var_2_0, var_2_1)
end
