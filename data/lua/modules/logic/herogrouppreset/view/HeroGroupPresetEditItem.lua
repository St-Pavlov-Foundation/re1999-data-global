...
local var_0_0 = class("HeroGroupPresetEditItem", ListScrollCell)
...
function var_0_0._initObj(arg_2_0, arg_2_1)
	...
	arg_2_0._heroItem:setStyle_HeroGroupEdit()
end
...
function var_0_0.updateLimitStatus(arg_7_0)
	...
	elseif HeroGroupPresetQuickEditListModel.instance.isTowerBattle then
		...
		if HeroGroupPresetModel.instance:isRestrict(arg_7_0._mo.uid) then
...
function var_0_0.onUpdateMO(arg_8_0, arg_8_1)
	...
	local var_8_1 = HeroGroupPresetEditListModel.instance:isInTeamHero(arg_8_0._mo.uid)
...
function var_0_0.updateTrialRepeat(arg_10_0)
	local var_10_0 = HeroGroupPresetSingleGroupModel.instance:getById(arg_10_0._view.viewContainer.viewParam.singleGroupMOId)
	...
	if var_10_0 and not var_10_0:isEmpty() and (var_10_0.trial and var_10_0:getTrialCO().heroId == arg_10_0._mo.heroId or not var_10_0.trial and (not var_10_0:getHeroCO() or var_10_0:getHeroCO().id == arg_10_0._mo.heroId)) then
		if not var_10_0.trial and not var_10_0.aid and not var_10_0:getHeroCO() and HeroGroupPresetController.instance:useTrial() then
	...
	local var_10_1 = HeroGroupPresetEditListModel.instance:isRepeatHero(arg_10_0._mo.heroId, arg_10_0._mo.uid)
...
function var_0_0._onItemClick(arg_12_0)
	...
	local var_12_0 = HeroGroupPresetSingleGroupModel.instance:getById(arg_12_0._view.viewContainer.viewParam.singleGroupMOId)

	if arg_12_0._mo:isTrial() and not HeroGroupPresetSingleGroupModel.instance:isInGroup(arg_12_0._mo.uid) and (var_12_0:isEmpty() or not var_12_0.trial) and HeroGroupPresetEditListModel.instance:isTrialLimit() then
	...
	if HeroGroupPresetModel.instance:isRestrict(arg_12_0._mo.uid) then
		local var_12_1 = HeroGroupPresetModel.instance:getCurrentBattleConfig()
