...
function var_0_0.initMoList(arg_1_0)
	arg_1_0._subType = MaterialEnum.MaterialType.BlockPackage
	arg_1_0._moList = {}

	for iter_1_0, iter_1_1 in ipairs(lua_block_package.configList) do
		if iter_1_1.canExchange then
			...
			local var_1_2 = RoomGiftShowBlockMo.New()
...
function var_0_0.setMoList(arg_3_0, arg_3_1)
	...
	if var_3_0 then
		...
		for iter_3_0, iter_3_1 in ipairs(var_3_0) do
			...
			if var_3_3 then
				if not arg_3_0._themeBlocks[var_3_3] then
					arg_3_0._themeBlocks[var_3_3] = {}
				end
				...
				table.insert(arg_3_0._themeBlocks[var_3_3], iter_3_1)
			else
				logError("该地块包没找到主题:" .. iter_3_1.id)
			end
		end
	end
...
function var_0_0._sort(arg_7_0, arg_7_1)
	...
	local var_7_2 = arg_7_0:getBlockNum()
	local var_7_3 = arg_7_1:getBlockNum()
...
function var_0_0.setThemeList(arg_8_0)
	RoomThemeFilterListModel.instance:initThemeData(arg_8_0._themeIds)
end

function var_0_0.isHasTheme(arg_9_0, arg_9_1)
	return LuaUtil.tableContains(arg_9_0._themeIds, arg_9_1)
end
...
function var_0_0.setThemeMoList(arg_10_0)
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0) do
		if arg_10_0:isHasTheme(iter_10_1) then
			local var_10_1 = {
				themeId = iter_10_1,
				moList = arg_10_0._themeBlocks[iter_10_1]
			}

			table.insert(arg_10_0._themeMoList, var_10_1)
		else
			RoomThemeFilterListModel.instance:setSelectById(iter_10_1, false)
		end
	end

	arg_10_0:_sortThemeBlocks()
end
...
function var_0_0._sortThemeBlocks(arg_12_0)
