...
slot0 = class("RoomDebugThemeFilterListModel", ListScrollModel)
...
function slot0.checkSelectByItem(slot0, slot1, slot2)
	if not slot0:getIsAll() and slot0:getSelectCount() > 0 and not slot0:isSelectById(RoomConfig.instance:getThemeIdByItem(slot1, slot2)) then
		return false
	end
