...
slot0 = class("RoomDebugThemeFilterItem", ListScrollCellExtend)
...
function slot0._onBtnclick(slot0)
	...
	if RoomDebugThemeFilterListModel.instance:isSelectById(slot0._themeItemMO.id) then
		RoomDebugThemeFilterListModel.instance:setSelectById(slot1, false)
	else
		RoomDebugThemeFilterListModel.instance:setSelectById(slot1, true)
	end
...
function slot0._refreshUI(slot0)
	...
	if slot0._lastSelect ~= RoomDebugThemeFilterListModel.instance:isSelectById(slot0._themeItemMO.id) then
