...
local var_0_0 = class("TowerTaskItem", ListScrollCellExtend)
...
var_0_0.BlockKey = "TowerTaskItemRewardGetAnim"
...
function var_0_0._btncangetOnClick(arg_5_0)
	...
	TowerController.instance:dispatchEvent(TowerEvent.OnTaskRewardGetFinish, arg_5_0._index)
...
function var_0_0._onPlayActAniFinished(arg_7_0)
	...
	if arg_7_0.mo.canGetAll then
		local var_7_0 = TowerTaskModel.instance:getAllCanGetList()

		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.Tower, 0, var_7_0, nil, nil, 0)
	else
...
function var_0_0.checkPlayAnim(arg_10_0)
	...
	local var_10_0 = TowerTaskModel.instance:getDelayPlayTime(arg_10_0.mo)
...
function var_0_0.refreshReward(arg_13_0)
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_1) do
		...
		if not var_13_2 then
			var_13_2 = {
				itemIcon = IconMgr.instance:getCommonPropItemIcon(arg_13_0._gorewardContent)
			}
...
function var_0_0.refreshState(arg_14_0)
	if TowerTaskModel.instance:isTaskFinished(arg_14_0.mo) then
		gohelper.setActive(arg_14_0._gohasget, true)
		gohelper.setActive(arg_14_0._btnnormal.gameObject, false)
		gohelper.setActive(arg_14_0._btncanget.gameObject, false)
		gohelper.setActive(arg_14_0._golight, true)
	elseif arg_14_0.mo.hasFinished then
		gohelper.setActive(arg_14_0._gohasget, false)
		gohelper.setActive(arg_14_0._btnnormal.gameObject, false)
		gohelper.setActive(arg_14_0._btncanget.gameObject, true)
		gohelper.setActive(arg_14_0._golight, true)
	else
		gohelper.setActive(arg_14_0._gohasget, false)
		gohelper.setActive(arg_14_0._btnnormal.gameObject, arg_14_0.jumpId and arg_14_0.jumpId > 0)
		gohelper.setActive(arg_14_0._btncanget.gameObject, false)
		gohelper.setActive(arg_14_0._golight, false)
	end
end
...
function var_0_0.onDestroyView(arg_16_0)
	TaskDispatcher.cancelTask(arg_16_0._onPlayActAniFinished, arg_16_0)

	if arg_16_0.rewardItemTab then
		for iter_16_0, iter_16_1 in pairs(arg_16_0.rewardItemTab) do
			if iter_16_1.itemIcon then
				iter_16_1.itemIcon:onDestroy()

				iter_16_1.itemIcon = nil
			end
		end

		arg_16_0.rewardItemTab = nil
	end
