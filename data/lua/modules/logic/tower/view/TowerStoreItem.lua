...
local var_0_0 = class("TowerStoreItem", UserDataDispose)
...
function var_0_0.onInitView(arg_1_0, arg_1_1)
	...
	arg_1_0._btnTips = gohelper.findChildButtonWithAudio(arg_1_0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#btn_Tips")
	arg_1_0._goTips = gohelper.findChild(arg_1_0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips")
	arg_1_0._txtTimeTips = gohelper.findChildText(arg_1_0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips/image_Tips/#txt_TimeTips")
	arg_1_0._btnclosetip = gohelper.findChildButtonWithAudio(arg_1_0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips/#btn_closetip")
...
function var_0_0.refreshTag(arg_7_0)
	...
	local var_7_0 = TowerStoreModel.instance:getStore()
	local var_7_1, var_7_2 = TowerStoreModel.instance:getStoreGroupName(var_7_0[arg_7_0.groupId])
...
function var_0_0.refreshGoods(arg_8_0)
	...
	for iter_8_0, iter_8_1 in pairs(var_8_0) do
		...
		if not var_8_1 then
			var_8_1 = TowerStoreGoodsItem.New()
		...
		local var_8_3 = TowerStoreModel.instance:getStoreGoodsNewData(arg_8_0.groupGoodsMoList.id, iter_8_1.goodsId)
...
function var_0_0.hideStoreItem(arg_12_0)
	gohelper.setActive(arg_12_0.go, false)
end

function var_0_0.onDestroy(arg_13_0)
	for iter_13_0, iter_13_1 in ipairs(arg_13_0.goodsItemList) do
		iter_13_1:onDestroy()
	end
...
function var_0_0.onClose(arg_14_0)
	arg_14_0._btnTips:RemoveClickListener()
	arg_14_0._btnclosetip:RemoveClickListener()
end
