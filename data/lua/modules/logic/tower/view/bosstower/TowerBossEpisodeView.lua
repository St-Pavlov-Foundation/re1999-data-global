...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0.btnTeach = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "root/Right/btnTeach")
	arg_1_0.goTeachFinish = gohelper.findChild(arg_1_0.viewGO, "root/Right/btnTeach/go_teachFinish")
	arg_1_0.animTeachFinishEffect = gohelper.findChild(arg_1_0.viewGO, "root/Right/btnTeach/go_teachFinish/go_hasget"):GetComponent(gohelper.Type_Animator)
