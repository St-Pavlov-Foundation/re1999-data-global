...
local var_0_0 = class("V2a4_Role_FullSignView_Part2", V2a4_Role_FullSignView)

function var_0_0._editableInitView(arg_1_0)
	GameUtil.loadSImage(arg_1_0._simageFullBG, ResUrl.getV2a4SignSingleBg("v2a4_sign_fullbg2"))
