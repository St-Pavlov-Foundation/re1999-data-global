-- chunkname: @modules/logic/activity/view/V2a4_Role_PanelSignView.lua

module("modules.logic.activity.view.V2a4_Role_PanelSignView", package.seeall)

local V2a4_Role_PanelSignView = class("V2a4_Role_PanelSignView", Activity101SignViewBase)

function V2a4_Role_PanelSignView:onInitView()
	...
	self._simageTitle_glow = gohelper.findChildSingleImage(self.viewGO, "Root/vx_effect/#simage_Title_glow")
...
function V2a4_Role_PanelSignView:addEvents()
...
function V2a4_Role_PanelSignView:removeEvents()
...
function V2a4_Role_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V2a4_Role_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V2a4_Role_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V2a4_Role_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V2a4_Role_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V2a4_Role_PanelSignView:onOpen()
...
function V2a4_Role_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V2a4_Role_PanelSignView:onDestroyView()
	Activity101SignViewBase._internal_onDestroy(self)
	self._simagePanelBG:UnLoadImage()
	self._simageTitle:UnLoadImage()
	self._simageTitle_glow:UnLoadImage()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V2a4_Role_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V2a4_Role_PanelSignView:_refreshTimeTick()
	self._txtLimitTime.text = self:getRemainTimeStr()
end

return V2a4_Role_PanelSignView
