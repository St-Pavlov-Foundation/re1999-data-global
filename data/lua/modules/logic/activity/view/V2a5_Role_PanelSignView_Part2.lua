...
local var_0_0 = class("V2a5_Role_PanelSignView_Part2", V2a5_Role_PanelSignView)

function var_0_0._editableInitView(arg_1_0)
	GameUtil.loadSImage(arg_1_0._simagePanelBG, ResUrl.getV2a5SignSingleBg("v2a5_sign_panelbg2"))
