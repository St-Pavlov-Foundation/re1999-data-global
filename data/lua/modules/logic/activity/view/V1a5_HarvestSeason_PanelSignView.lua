...
local var_0_0 = class("V1a5_HarvestSeason_PanelSignView", Activity101SignViewBase)
...
function var_0_0._editableInitView(arg_9_0)
	arg_9_0._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_harvestseason_title"))
	arg_9_0._simagePanelBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_harvestseason_sign_panelbg"))
end
