-- chunkname: @modules/logic/activity/view/V1a5_HarvestSeason_PanelSignView.lua

module("modules.logic.activity.view.V1a5_HarvestSeason_PanelSignView", package.seeall)

local V1a5_HarvestSeason_PanelSignView = class("V1a5_HarvestSeason_PanelSignView", Activity101SignViewBase)

function V1a5_HarvestSeason_PanelSignView:onInitView()
...
function V1a5_HarvestSeason_PanelSignView:addEvents()
...
function V1a5_HarvestSeason_PanelSignView:removeEvents()
...
function V1a5_HarvestSeason_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V1a5_HarvestSeason_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V1a5_HarvestSeason_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V1a5_HarvestSeason_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V1a5_HarvestSeason_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V1a5_HarvestSeason_PanelSignView:_editableInitView()
	self._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_harvestseason_title"))
	self._simagePanelBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_harvestseason_sign_panelbg"))
end

function V1a5_HarvestSeason_PanelSignView:onOpen()
...
function V1a5_HarvestSeason_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V1a5_HarvestSeason_PanelSignView:onDestroyView()
...
function V1a5_HarvestSeason_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V1a5_HarvestSeason_PanelSignView:_refreshTimeTick()
