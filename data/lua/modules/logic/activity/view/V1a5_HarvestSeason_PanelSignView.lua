...
slot0 = class("V1a5_HarvestSeason_PanelSignView", Activity101SignViewBase)
...
function slot0._editableInitView(slot0)
	slot0._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_harvestseason_title"))
	slot0._simagePanelBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_harvestseason_sign_panelbg"))
end
