-- chunkname: @modules/logic/activity/view/V2a1_Role_FullSignView.lua

module("modules.logic.activity.view.V2a1_Role_FullSignView", package.seeall)

local V2a1_Role_FullSignView = class("V2a1_Role_FullSignView", Activity101SignViewBase)

function V2a1_Role_FullSignView:onInitView()
...
function V2a1_Role_FullSignView:addEvents()
	Activity101SignViewBase.addEvents(self)
end

function V2a1_Role_FullSignView:removeEvents()
	Activity101SignViewBase.removeEvents(self)
end

function V2a1_Role_FullSignView:onOpen()
...
function V2a1_Role_FullSignView:onClose()
	self._isFirstUpdateScrollPos = nil

	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V2a1_Role_FullSignView:onDestroyView()
...
function V2a1_Role_FullSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V2a1_Role_FullSignView:_refreshTimeTick()
	self._txtLimitTime.text = self:getRemainTimeStr()
end

return V2a1_Role_FullSignView
