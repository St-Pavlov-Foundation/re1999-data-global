...
function slot0._addEvents(slot0)
	slot0:addEventCb(BackpackController.instance, BackpackEvent.UpdateItemList, slot0._refreshTask, slot0)
...
function slot0._removeEvents(slot0)
	slot0:removeEventCb(BackpackController.instance, BackpackEvent.UpdateItemList, slot0._refreshTask, slot0)
