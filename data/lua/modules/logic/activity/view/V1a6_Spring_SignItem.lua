...
slot0 = class("V1a6_Spring_SignItem", Activity101SignViewItemBase)
...
function slot0.onInitView(slot0)
	...
	slot0._goKelinqu = gohelper.findChild(slot0.viewGO, "Root/#go_SelectedBG/#go_Kelinqu")
...
function slot0._editableInitView(slot0)
	...
	gohelper.setActive(slot0._goKelinqu, false)
end
...
function slot0.onRefresh(slot0)
	...
	gohelper.setActive(slot0._goKelinqu, slot4 and slot8 == 1)
