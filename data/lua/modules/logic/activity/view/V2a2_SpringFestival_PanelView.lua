-- chunkname: @modules/logic/activity/view/V2a2_SpringFestival_PanelView.lua

module("modules.logic.activity.view.V2a2_SpringFestival_PanelView", package.seeall)

local V2a2_SpringFestival_PanelView = class("V2a2_SpringFestival_PanelView", Activity101SignViewBase)

function V2a2_SpringFestival_PanelView:onInitView()
...
function V2a2_SpringFestival_PanelView:addEvents()
...
function V2a2_SpringFestival_PanelView:removeEvents()
...
function V2a2_SpringFestival_PanelView:_btnCloseOnClick()
	self:closeThis()
end

function V2a2_SpringFestival_PanelView:_btnemptyTopOnClick()
	self:closeThis()
end

function V2a2_SpringFestival_PanelView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V2a2_SpringFestival_PanelView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V2a2_SpringFestival_PanelView:_btnemptyRightOnClick()
	self:closeThis()
end

function V2a2_SpringFestival_PanelView:_editableInitView()
	self._txtLimitTime.text = ""

	self:internal_set_openMode(Activity101SignViewBase.eOpenMode.PaiLian)
end

function V2a2_SpringFestival_PanelView:onOpen()
...
function V2a2_SpringFestival_PanelView:onClose()
	self:_clearTimeTick()
end

function V2a2_SpringFestival_PanelView:onDestroyView()
	Activity101SignViewBase._internal_onDestroy(self)
	self:_clearTimeTick()
end

function V2a2_SpringFestival_PanelView:_clearTimeTick()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V2a2_SpringFestival_PanelView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V2a2_SpringFestival_PanelView:_refreshTimeTick()
