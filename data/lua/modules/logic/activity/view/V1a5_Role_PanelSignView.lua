-- chunkname: @modules/logic/activity/view/V1a5_Role_PanelSignView.lua

module("modules.logic.activity.view.V1a5_Role_PanelSignView", package.seeall)

local V1a5_Role_PanelSignView = class("V1a5_Role_PanelSignView", Activity101SignViewBase)

function V1a5_Role_PanelSignView:onInitView()
...
function V1a5_Role_PanelSignView:addEvents()
...
function V1a5_Role_PanelSignView:removeEvents()
...
function V1a5_Role_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V1a5_Role_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V1a5_Role_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V1a5_Role_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V1a5_Role_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V1a5_Role_PanelSignView:onOpen()
...
function V1a5_Role_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V1a5_Role_PanelSignView:onDestroyView()
...
function V1a5_Role_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V1a5_Role_PanelSignView:_refreshTimeTick()
	self._txtLimitTime.text = self:getRemainTimeStr()
end

return V1a5_Role_PanelSignView
