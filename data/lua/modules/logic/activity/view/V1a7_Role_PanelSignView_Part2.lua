-- chunkname: @modules/logic/activity/view/V1a7_Role_PanelSignView_Part2.lua

module("modules.logic.activity.view.V1a7_Role_PanelSignView_Part2", package.seeall)

local V1a7_Role_PanelSignView_Part2 = class("V1a7_Role_PanelSignView_Part2", V1a7_Role_PanelSignView)

function V1a7_Role_PanelSignView_Part2:_editableInitView()
	...
	self._simagePanelBG:LoadImage(ResUrl.getV1a7SignSingleBg("v1a7_sign_panel_bg2"))
