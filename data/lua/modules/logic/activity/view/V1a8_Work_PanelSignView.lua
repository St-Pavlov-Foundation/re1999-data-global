-- chunkname: @modules/logic/activity/view/V1a8_Work_PanelSignView.lua

module("modules.logic.activity.view.V1a8_Work_PanelSignView", package.seeall)

local V1a8_Work_PanelSignView = class("V1a8_Work_PanelSignView", Activity101SignViewBase)

function V1a8_Work_PanelSignView:onInitView()
...
function V1a8_Work_PanelSignView:addEvents()
...
function V1a8_Work_PanelSignView:removeEvents()
...
function V1a8_Work_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V1a8_Work_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V1a8_Work_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V1a8_Work_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V1a8_Work_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V1a8_Work_PanelSignView:_editableInitView()
	self._simageTitle:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	self._simageTitle_eff:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	self._simagePanelBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_sign_work_panel_bg"))
end

function V1a8_Work_PanelSignView:onOpen()
...
function V1a8_Work_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V1a8_Work_PanelSignView:onDestroyView()
...
function V1a8_Work_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V1a8_Work_PanelSignView:_refreshTimeTick()
