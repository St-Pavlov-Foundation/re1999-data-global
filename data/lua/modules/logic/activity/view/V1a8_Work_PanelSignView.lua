...
slot0 = class("V1a8_Work_PanelSignView", Activity101SignViewBase)
...
function slot0._editableInitView(slot0)
	slot0._simageTitle:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	slot0._simageTitle_eff:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	slot0._simagePanelBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_sign_work_panel_bg"))
end
