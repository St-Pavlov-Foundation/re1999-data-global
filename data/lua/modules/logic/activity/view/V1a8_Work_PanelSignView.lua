...
local var_0_0 = class("V1a8_Work_PanelSignView", Activity101SignViewBase)
...
function var_0_0._editableInitView(arg_9_0)
	arg_9_0._simageTitle:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	arg_9_0._simageTitle_eff:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title"))
	arg_9_0._simagePanelBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_sign_work_panel_bg"))
end
...
function var_0_0.onDestroyView(arg_12_0)
	...
	arg_12_0._simageTitle_eff:UnLoadImage()
