-- chunkname: @modules/logic/activity/view/V1a5_HarvestSeason_SignItem.lua

module("modules.logic.activity.view.V1a5_HarvestSeason_SignItem", package.seeall)

local V1a5_HarvestSeason_SignItem = class("V1a5_HarvestSeason_SignItem", Activity101SignViewItemBase)

function V1a5_HarvestSeason_SignItem:onInitView()
...
function V1a5_HarvestSeason_SignItem:addEvents()
	return
end

function V1a5_HarvestSeason_SignItem:removeEvents()
	return
end
...
function V1a5_HarvestSeason_SignItem:_editableInitView()
...
return V1a5_HarvestSeason_SignItem
