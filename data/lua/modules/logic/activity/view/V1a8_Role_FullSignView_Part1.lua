-- chunkname: @modules/logic/activity/view/V1a8_Role_FullSignView_Part1.lua

module("modules.logic.activity.view.V1a8_Role_FullSignView_Part1", package.seeall)

local V1a8_Role_FullSignView_Part1 = class("V1a8_Role_FullSignView_Part1", V1a8_Role_FullSignView)

function V1a8_Role_FullSignView_Part1:_editableInitView()
	...
	self._simageFullBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_role_fullsignview_bg_1"))
