...
local var_0_0 = class("V1a8_Role_FullSignView_Part1", V1a8_Role_FullSignView)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simageFullBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_role_fullsignview_bg_1"))
