...
local var_0_0 = class("V2a3_Role_PanelSignView_Part2", V2a3_Role_PanelSignView)

function var_0_0._editableInitView(arg_1_0)
	arg_1_0._simagePanelBG:LoadImage(ResUrl.getV2a3SignSingleBg("v2a3_sign_panelbg2"))
