-- chunkname: @modules/logic/activity/view/V2a4_Role_PanelSignView_Part2.lua

module("modules.logic.activity.view.V2a4_Role_PanelSignView_Part2", package.seeall)

local V2a4_Role_PanelSignView_Part2 = class("V2a4_Role_PanelSignView_Part2", V2a4_Role_PanelSignView)

function V2a4_Role_PanelSignView_Part2:_editableInitView()
	GameUtil.loadSImage(self._simagePanelBG, ResUrl.getV2a4SignSingleBg("v2a4_sign_panelbg2"))
