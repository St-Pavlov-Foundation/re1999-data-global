-- chunkname: @modules/logic/activity/view/V1a7_Role_PanelSignView_Part1.lua

module("modules.logic.activity.view.V1a7_Role_PanelSignView_Part1", package.seeall)

local V1a7_Role_PanelSignView_Part1 = class("V1a7_Role_PanelSignView_Part1", V1a7_Role_PanelSignView)

function V1a7_Role_PanelSignView_Part1:_editableInitView()
	...
	self._simagePanelBG:LoadImage(ResUrl.getV1a7SignSingleBg("v1a7_sign_panel_bg1"))
