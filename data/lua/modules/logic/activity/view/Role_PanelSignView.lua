-- chunkname: @modules/logic/activity/view/Role_PanelSignView.lua

module("modules.logic.activity.view.Role_PanelSignView", package.seeall)

local Role_PanelSignView = class("Role_PanelSignView", Activity101SignViewBase)

function Role_PanelSignView:onInitView()
...
function Role_PanelSignView:addEvents()
...
function Role_PanelSignView:removeEvents()
...
function Role_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function Role_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function Role_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function Role_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function Role_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function Role_PanelSignView:onOpen()
...
function Role_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function Role_PanelSignView:onDestroyView()
...
function Role_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function Role_PanelSignView:_refreshTimeTick()
	self._txtLimitTime.text = self:getRemainTimeStr()
end

return Role_PanelSignView
