...
local var_0_0 = class("V1a5_HarvestSeason_FullSignView", Activity101SignViewBase)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_harvestseason_title"))
	arg_4_0._simageFullBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_harvestseason_bg"))
end
