...
local var_0_0 = class("ActivityChessGameHandler", BaseView)
...
function var_0_0.drawBaseTile(arg_2_0, arg_2_1, arg_2_2)
	local var_2_0 = ActivityChessGameModel.instance:getBaseTile(arg_2_1, arg_2_2)
	local var_2_1 = arg_2_0._viewObj:getBaseTile(arg_2_1, arg_2_2)

	if var_2_0 == ActivityChessEnum.TileBaseType.Normal then
		gohelper.setActive(var_2_1.imageTile.gameObject, true)
		UISpriteSetMgr.instance:setActivityChessMapSprite(var_2_1.imageTile, "img_di")
	else
