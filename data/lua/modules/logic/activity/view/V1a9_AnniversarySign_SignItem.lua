...
local var_0_0 = class("V1a9_AnniversarySign_SignItem", Activity101SignViewItemBase)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._goIcon3 = gohelper.findChild(arg_1_0.viewGO, "Root/Item/#go_item2/#go_Icon3")
