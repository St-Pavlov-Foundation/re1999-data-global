-- chunkname: @modules/logic/activity/view/V2a0_Role_PanelSignView.lua

module("modules.logic.activity.view.V2a0_Role_PanelSignView", package.seeall)

local V2a0_Role_PanelSignView = class("V2a0_Role_PanelSignView", Activity101SignViewBase)

function V2a0_Role_PanelSignView:onInitView()
...
function V2a0_Role_PanelSignView:addEvents()
...
function V2a0_Role_PanelSignView:removeEvents()
...
function V2a0_Role_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V2a0_Role_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V2a0_Role_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V2a0_Role_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V2a0_Role_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V2a0_Role_PanelSignView:onOpen()
...
function V2a0_Role_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V2a0_Role_PanelSignView:onDestroyView()
...
function V2a0_Role_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V2a0_Role_PanelSignView:_refreshTimeTick()
	self._txtLimitTime.text = self:getRemainTimeStr()
end

return V2a0_Role_PanelSignView
