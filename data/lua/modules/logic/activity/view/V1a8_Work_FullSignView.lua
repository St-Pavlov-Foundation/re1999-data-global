...
slot0 = class("V1a8_Work_FullSignView", Activity101SignViewBase)
...
function slot0._editableInitView(slot0)
	slot0._simageTitle:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title2"))
	slot0._simageTitle_eff:LoadImage(ResUrl.getV1a8SignSingleBgLang("v1a8_sign_work_panel_title2"))
	slot0._simageFullBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_sign_work_full_bg"))
end
