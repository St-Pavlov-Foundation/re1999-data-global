-- chunkname: @modules/logic/activity/view/goldenmilletpresent/GoldenMilletPresentImplContainer.lua

module("modules.logic.activity.view.goldenmilletpresent.GoldenMilletPresentImplContainer", package.seeall)

local GoldenMilletPresentImplContainer = class("GoldenMilletPresentImplContainer", BaseViewContainer)

function GoldenMilletPresentImplContainer:actId()
	return GoldenMilletPresentModel.instance:getGoldenMilletPresentActId()
end

function GoldenMilletPresentImplContainer:getDayCO(day)
	return ActivityType101Config.instance:getDayCO(self:actId(), day)
end

function GoldenMilletPresentImplContainer:getSignMaxDay()
	return ActivityType101Config.instance:getSignMaxDay(self:actId())
end

function GoldenMilletPresentImplContainer:getDayBonusList(day)
...
function GoldenMilletPresentImplContainer:isType101RewardGet(day)
	return ActivityType101Model.instance:isType101RewardGet(self:actId(), day)
end

function GoldenMilletPresentImplContainer:isType101RewardCouldGet(day)
	return ActivityType101Model.instance:isType101RewardCouldGet(self:actId(), day)
end

function GoldenMilletPresentImplContainer:getFirstAvailableIndex()
	return ActivityType101Model.instance:getFirstAvailableIndex(self:actId())
end

function GoldenMilletPresentImplContainer:isDayOpen(day)
	return ActivityType101Model.instance:isDayOpen(self:actId(), day)
end

function GoldenMilletPresentImplContainer:getType101LoginCount()
	return ActivityType101Model.instance:getType101LoginCount(self:actId())
end

function GoldenMilletPresentImplContainer:sendGet101BonusRequest(day, cb, cbObj)
	return Activity101Rpc.instance:sendGet101BonusRequest(self:actId(), day, cb, cbObj)
end

function GoldenMilletPresentImplContainer:isGoldenMilletPresentOpen(...)
	return GoldenMilletPresentModel.instance:isGoldenMilletPresentOpen(...)
end

function GoldenMilletPresentImplContainer:getRemainTimeStr()
...
function GoldenMilletPresentImplContainer:getRemainTimeSec()
...
function GoldenMilletPresentImplContainer:getSkinCo(skinId)
	return SkinConfig.instance:getSkinCo(skinId)
end

function GoldenMilletPresentImplContainer:getSkinCo_characterId()
...
function GoldenMilletPresentImplContainer:getHeroCO(heroId)
	return HeroConfig.instance:getHeroCO(heroId)
end

function GoldenMilletPresentImplContainer:getActivityCo()
	return ActivityConfig.instance:getActivityCo(self:actId())
end

function GoldenMilletPresentImplContainer:getJumpId()
	return ActivityType101Config.instance:getConstAsNum(3, 0)
end

function GoldenMilletPresentImplContainer:getSkinGoodsIdList()
...
return GoldenMilletPresentImplContainer
