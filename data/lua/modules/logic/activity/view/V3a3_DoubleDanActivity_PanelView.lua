-- chunkname: @modules/logic/activity/view/V3a3_DoubleDanActivity_PanelView.lua

module("modules.logic.activity.view.V3a3_DoubleDanActivity_PanelView", package.seeall)

local V3a3_DoubleDanActivity_PanelView = class("V3a3_DoubleDanActivity_PanelView", V3a3_DoubleDanActivityViewImpl)

function V3a3_DoubleDanActivity_PanelView:onInitView()
...
function V3a3_DoubleDanActivity_PanelView:addEvents()
...
function V3a3_DoubleDanActivity_PanelView:removeEvents()
...
function V3a3_DoubleDanActivity_PanelView:_btnCloseOnClick()
	self:closeThis()
end

function V3a3_DoubleDanActivity_PanelView:_btnemptyTopOnClick()
	self:closeThis()
end

function V3a3_DoubleDanActivity_PanelView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V3a3_DoubleDanActivity_PanelView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V3a3_DoubleDanActivity_PanelView:_btnemptyRightOnClick()
	self:closeThis()
end

function V3a3_DoubleDanActivity_PanelView:ctor(...)
	V3a3_DoubleDanActivity_PanelView.super.ctor(self, ...)
end

function V3a3_DoubleDanActivity_PanelView:_editableInitView()
	V3a3_DoubleDanActivity_PanelView.super._editableInitView(self)
end

function V3a3_DoubleDanActivity_PanelView:onDestroyView()
	V3a3_DoubleDanActivity_PanelView.super.onDestroyView(self)
end

return V3a3_DoubleDanActivity_PanelView
