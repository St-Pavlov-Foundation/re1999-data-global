...
local var_0_0 = class("V1a5_Role_FullSignView_Part1", V1a5_Role_FullSignView)

function var_0_0._editableInitView(arg_1_0)
	arg_1_0._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_sign_kerandian_title"))
	arg_1_0._simageFullBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_kerandian_sign_fullbg"))
