-- chunkname: @modules/logic/activity/view/V1a8_Role_FullSignView_Part2.lua

module("modules.logic.activity.view.V1a8_Role_FullSignView_Part2", package.seeall)

local V1a8_Role_FullSignView_Part2 = class("V1a8_Role_FullSignView_Part2", V1a8_Role_FullSignView)

function V1a8_Role_FullSignView_Part2:_editableInitView()
	...
	self._simageFullBG:LoadImage(ResUrl.getV1a8SignSingleBg("v1a8_role_fullsignview_bg_2"))
