...
local var_0_0 = class("ActivityNorSignItem", ListScrollCell)
...
function var_0_0._onItemClick(arg_4_0)
	local var_4_0 = ActivityType101Model.instance:isType101RewardCouldGet(ActivityEnum.Activity.NorSign, arg_4_0._index)
	local var_4_1 = ActivityType101Model.instance:getType101LoginCount(ActivityEnum.Activity.NorSign)

	if var_4_0 then
		Activity101Rpc.instance:sendGet101BonusRequest(ActivityEnum.Activity.NorSign, arg_4_0._index)
	end

	if var_4_1 < arg_4_0._index then
...
function var_0_0._refreshItem(arg_6_0)
	...
	local var_6_0 = string.splitToNumber(ActivityConfig.instance:getNorSignActivityCo(ActivityEnum.Activity.NorSign, arg_6_0._index).bonus, "#")
	local var_6_1, var_6_2 = ItemModel.instance:getItemConfigAndIcon(var_6_0[1], var_6_0[2])

	if not arg_6_0._item then
		arg_6_0._item = IconMgr.instance:getCommonPropItemIcon(arg_6_0._goreward)
	end

	arg_6_0._item:setMOValue(var_6_0[1], var_6_0[2], var_6_0[3], nil, true)
	...
	local var_6_3 = ActivityType101Model.instance:isType101RewardGet(ActivityEnum.Activity.NorSign, arg_6_0._index)
	local var_6_4 = ActivityType101Model.instance:isType101RewardCouldGet(ActivityEnum.Activity.NorSign, arg_6_0._index)
	local var_6_5 = ActivityType101Model.instance:getType101LoginCount(ActivityEnum.Activity.NorSign)

	gohelper.setActive(arg_6_0._goget, var_6_3)
	gohelper.setActive(arg_6_0._gomask, var_6_3 or var_6_5 < arg_6_0._index)
	gohelper.setActive(arg_6_0._todaybg, var_6_4)
	gohelper.setActive(arg_6_0._gotomorrowtag, arg_6_0._index == var_6_5 + 1)
	...
	if not var_6_3 and var_6_4 then
