...
slot0 = class("V1a5_Role_PanelSignView_Part1", V1a5_Role_PanelSignView)

function slot0._editableInitView(slot0)
	slot0._simageTitle:LoadImage(ResUrl.getV1a5SignSingleBgLang("v1a5_sign_kerandian_title"))
	slot0._simagePanelBG:LoadImage(ResUrl.getV1a5SignSingleBg("v1a5_kerandian_sign_panelbg"))
