...
local var_0_0 = class("V2a2_Role_PanelSignView_Part1", V2a2_Role_PanelSignView)

function var_0_0._editableInitView(arg_1_0)
	arg_1_0._simagePanelBG:LoadImage(ResUrl.getV2a2SignSingleBg("v2a2_sign_panelbg1"))
