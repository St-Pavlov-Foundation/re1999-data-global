-- chunkname: @modules/logic/activity/view/V2a2_SpringFestival_SignItem.lua

module("modules.logic.activity.view.V2a2_SpringFestival_SignItem", package.seeall)

local V2a2_SpringFestival_SignItem = class("V2a2_SpringFestival_SignItem", Activity101SignViewItemBase)

function V2a2_SpringFestival_SignItem:onInitView()
...
function V2a2_SpringFestival_SignItem:addEvents()
	return
end

function V2a2_SpringFestival_SignItem:removeEvents()
	return
end
...
function V2a2_SpringFestival_SignItem:_editableInitView()
...
function V2a2_SpringFestival_SignItem:_onItemClick()
...
function V2a2_SpringFestival_SignItem:_refreshRewardItem(item, itemCo)
...
return V2a2_SpringFestival_SignItem
