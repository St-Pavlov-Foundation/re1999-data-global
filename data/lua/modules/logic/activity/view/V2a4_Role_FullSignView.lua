...
slot0 = class("V2a4_Role_FullSignView", Activity101SignViewBase)

function slot0.onInitView(slot0)
	slot0._simageFullBG = gohelper.findChildSingleImage(slot0.viewGO, "#simage_FullBG")
	slot0._simageTitle = gohelper.findChildSingleImage(slot0.viewGO, "Root/#simage_Title")
	slot0._simageTitle_glow = gohelper.findChildSingleImage(slot0.viewGO, "Root/vx_effect/#simage_Title_glow")
...
function slot0.onDestroyView(slot0)
	...
	slot0._simageTitle_glow:UnLoadImage()
	TaskDispatcher.cancelTask(slot0._refreshTimeTick, slot0)
end
