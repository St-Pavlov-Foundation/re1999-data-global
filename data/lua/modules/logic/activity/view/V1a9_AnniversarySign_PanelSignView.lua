-- chunkname: @modules/logic/activity/view/V1a9_AnniversarySign_PanelSignView.lua

module("modules.logic.activity.view.V1a9_AnniversarySign_PanelSignView", package.seeall)

local V1a9_AnniversarySign_PanelSignView = class("V1a9_AnniversarySign_PanelSignView", Activity101SignViewBase)

function V1a9_AnniversarySign_PanelSignView:onInitView()
...
function V1a9_AnniversarySign_PanelSignView:addEvents()
...
function V1a9_AnniversarySign_PanelSignView:removeEvents()
...
function V1a9_AnniversarySign_PanelSignView:_btnCloseOnClick()
	self:closeThis()
end

function V1a9_AnniversarySign_PanelSignView:_btnemptyTopOnClick()
	self:closeThis()
end

function V1a9_AnniversarySign_PanelSignView:_btnemptyBottomOnClick()
	self:closeThis()
end

function V1a9_AnniversarySign_PanelSignView:_btnemptyLeftOnClick()
	self:closeThis()
end

function V1a9_AnniversarySign_PanelSignView:_btnemptyRightOnClick()
	self:closeThis()
end

function V1a9_AnniversarySign_PanelSignView:_editableInitView()
	return
end

function V1a9_AnniversarySign_PanelSignView:onOpen()
...
function V1a9_AnniversarySign_PanelSignView:onClose()
	TaskDispatcher.cancelTask(self._refreshTimeTick, self)
end

function V1a9_AnniversarySign_PanelSignView:onDestroyView()
...
function V1a9_AnniversarySign_PanelSignView:onRefresh()
	self:_refreshList()
	self:_refreshTimeTick()
end

function V1a9_AnniversarySign_PanelSignView:_refreshTimeTick()
