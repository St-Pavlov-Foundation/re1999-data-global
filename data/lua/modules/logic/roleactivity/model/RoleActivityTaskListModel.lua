...
slot0 = class("RoleActivityTaskListModel", ListScrollModel)
...
function slot0.refreshData(slot0)
	...
	for slot7, slot8 in ipairs(TaskModel.instance:getTaskMoList(TaskEnum.TaskType.RoleActivity, slot0.actId)) do
