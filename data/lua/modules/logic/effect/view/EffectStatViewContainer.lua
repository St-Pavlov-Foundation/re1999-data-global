...
slot0 = class("EffectStatViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot2.cellClass = EffectStatItem
	...
	table.insert(slot1, LuaListScrollView.New(EffectStatModel.instance, slot2))
	table.insert(slot1, EffectStatView.New())
...
function slot0._toSwitchTab(slot0, slot1, slot2)
	EffectStatModel.instance:switchTab(slot2)
end
