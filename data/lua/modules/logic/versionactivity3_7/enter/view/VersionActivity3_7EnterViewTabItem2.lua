...
function VersionActivity3_7EnterViewTabItem2:afterSetData()
	...
	self.redDotIcon = RedDotController.instance:addRedDot(self.goRedDot, self.activityCo.redDotId, VersionActivity3_7Enum.CharacterActId[self.actId] and self.actId or self.redDotUid)
