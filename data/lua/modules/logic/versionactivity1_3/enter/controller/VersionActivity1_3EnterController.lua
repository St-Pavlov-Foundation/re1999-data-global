...
slot0 = class("VersionActivity1_3EnterController", BaseController)
...
function slot0.openVersionActivityEnterView(slot0, slot1, slot2)
	...
	slot0:_enterVersionActivityView(ViewName.VersionActivity1_3EnterView, VersionActivity1_3Enum.ActivityId.EnterView, slot0._openVersionActivityEnterView, slot0)
end
...
function slot0._openVersionActivityEnterView(slot0)
	if not VersionActivityBaseController.instance:isPlayedActivityVideo(VersionActivity1_3Enum.ActivityId.EnterView) then
		if not (ActivityModel.instance:getActMO(VersionActivity1_3Enum.ActivityId.EnterView) and slot1.config and slot1.config.storyId) then
...
function slot0.directOpenVersionActivityEnterView(slot0)
	slot0:_enterVersionActivityView(ViewName.VersionActivity1_3EnterView, VersionActivity1_3Enum.ActivityId.EnterView, function ()
		ViewMgr.instance:openView(ViewName.VersionActivity1_3EnterView, {
			skipOpenAnim = true,
			actId = VersionActivity1_3Enum.ActivityId.EnterView,
			activityIdList = VersionActivity1_3Enum.EnterViewActIdList
...
function slot0.openStoreView(slot0)
	slot0:_enterVersionActivityView(ViewName.VersionActivity1_3StoreView, VersionActivity1_3Enum.ActivityId.DungeonStore, slot0._openStoreView, slot0)
end
...
function slot0.openTaskView(slot0)
	slot0:_enterVersionActivityView(ViewName.VersionActivityTaskView, VersionActivity1_3Enum.ActivityId.Act113, slot0._openTaskView, slot0)
end
...
function slot0.GetActivityPrefsKey(slot0)
	return VersionActivity1_3Enum.ActivityId.EnterView .. slot0
end
