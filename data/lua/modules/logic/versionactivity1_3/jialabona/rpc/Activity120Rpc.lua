...
local var_0_0 = class("Activity120Rpc", BaseRpc)

function var_0_0.sendGetActInfoRequest(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	local var_1_0 = Activity120Module_pb.GetAct120InfoRequest()
...
function var_0_0.onReceiveGetAct120InfoReply(arg_2_0, arg_2_1, arg_2_2)
	if arg_2_1 == 0 then
		Activity120Model.instance:onReceiveGetAct120InfoReply(arg_2_2)
...
function var_0_0.sendActStartEpisodeRequest(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	local var_3_0 = Activity120Module_pb.Act120StartEpisodeRequest()
...
function var_0_0.onReceiveAct120StartEpisodeReply(arg_4_0, arg_4_1, arg_4_2)
	if arg_4_1 == 0 then
		Va3ChessGameModel.instance:clearLastMapRound()
		Activity120Model.instance:increaseCount(arg_4_2.map.id)
...
function var_0_0.sendActBeginRoundRequest(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	local var_5_0 = Activity120Module_pb.Act120BeginRoundRequest()
...
function var_0_0.onReceiveAct120BeginRoundReply(arg_6_0, arg_6_1, arg_6_2)
	if arg_6_1 == 0 then
		-- block empty
	end
...
function var_0_0.sendActUseItemRequest(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5)
	local var_7_0 = Activity120Module_pb.Act120UseItemRequest()
...
function var_0_0.onReceiveAct120UseItemReply(arg_8_0, arg_8_1, arg_8_2)
	if arg_8_1 == 0 then
		-- block empty
	end
end

function var_0_0.onReceiveAct120StepPush(arg_9_0, arg_9_1, arg_9_2)
...
function var_0_0.sendActEventEndRequest(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	local var_10_0 = Activity120Module_pb.Act120EventEndRequest()
...
function var_0_0.onReceiveAct120EventEndReply(arg_11_0, arg_11_1, arg_11_2)
	if arg_11_1 == 0 then
		-- block empty
	end
end
...
function var_0_0.sendActAbortRequest(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	local var_12_0 = Activity120Module_pb.Act120AbortRequest()
...
function var_0_0.onReceiveAct120AbortReply(arg_13_0, arg_13_1, arg_13_2)
	if arg_13_1 == 0 then
		Va3ChessGameController.instance:gameOver()
	end
end

function var_0_0.sendActCheckPointRequest(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	local var_14_0 = Activity120Module_pb.Act120CheckPointRequest()

	var_14_0.activityId = arg_14_1
	var_14_0.lastCheckPoint = arg_14_2 and true or false

	arg_14_0:sendMsg(var_14_0, arg_14_3, arg_14_4)
end

function var_0_0.onReceiveAct120CheckPointReply(arg_15_0, arg_15_1, arg_15_2)
	if arg_15_1 == 0 then
		Activity120Model.instance:increaseCount(arg_15_2.map.id)
		Va3ChessRpcController.instance:onReceiveActStartEpisodeReply(arg_15_1, arg_15_2)
	end
end
