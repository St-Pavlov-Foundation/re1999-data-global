...
local var_0_0 = class("Activity120TaskListModel", ListScrollModel)

function var_0_0.init(arg_1_0, arg_1_1)
	local var_1_0 = TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity120)
	local var_1_1 = {}
	local var_1_2 = 0

	if var_1_0 ~= nil then
		local var_1_3 = Activity120Config.instance:getTaskByActId(arg_1_1)

		for iter_1_0, iter_1_1 in ipairs(var_1_3) do
			local var_1_4 = Activity120TaskMO.New()
	...
	if var_1_2 > 1 then
		local var_1_5 = Activity120TaskMO.New()

		var_1_5.id = JiaLaBoNaEnum.TaskMOAllFinishId
...
function var_0_0.getSortIndex(arg_3_0)
	if arg_3_0.id == JiaLaBoNaEnum.TaskMOAllFinishId then
		return 1
...
function var_0_0.preFinish(arg_7_0, arg_7_1)
	...
	if arg_7_1.id == JiaLaBoNaEnum.TaskMOAllFinishId then
		for iter_7_0, iter_7_1 in ipairs(var_7_2) do
			if iter_7_1:alreadyGotReward() and iter_7_1.id ~= JiaLaBoNaEnum.TaskMOAllFinishId then
	...
	if var_7_0 then
		local var_7_3 = arg_7_0:getById(JiaLaBoNaEnum.TaskMOAllFinishId)
...
function var_0_0.getGotRewardCount(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0) do
		if iter_8_1:alreadyGotReward() and not iter_8_1.preFinish and iter_8_1.id ~= JiaLaBoNaEnum.TaskMOAllFinishId then
			var_8_1 = var_8_1 + 1
		end
	end
