...
slot0 = class("JiaLaBoNaStoryView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0._simagePanelBG:LoadImage(ResUrl.getJiaLaBoNaIcon("v1a3_role1_storybg"))
end
...
function slot0.onOpen(slot0)
	JiaLaBoNaStoryListModel.instance:init(slot0.viewParam.actId, slot0.viewParam.episodeId)

	slot0._txtTitle.text = Activity120Config.instance:getEpisodeCo(slot0.viewParam.actId, slot0.viewParam.episodeId) and slot1.name or ""
