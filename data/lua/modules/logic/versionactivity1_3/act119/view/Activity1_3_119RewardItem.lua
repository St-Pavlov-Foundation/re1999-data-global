...
local var_0_0 = class("Activity1_3_119RewardItem")
...
function var_0_0.onInitView(arg_2_0)
	...
	for iter_2_0 = 1, 3 do
		...
		arg_2_0._rewards[iter_2_0]._bg = gohelper.findChild(arg_2_0._rewards[iter_2_0]._goreward, "image_RewardBG")
		arg_2_0._rewards[iter_2_0]._itemposContent = gohelper.findChild(arg_2_0._rewards[iter_2_0]._goreward, "#go_Item")
...
function var_0_0.updateTaskStatus(arg_6_0, arg_6_1)
	...
	gohelper.setActive(var_6_0._goclaimed, arg_6_1 == Activity119Enum.TaskStatus.GotReward)
	gohelper.setActive(var_6_0._goclaim, arg_6_1 == Activity119Enum.TaskStatus.Finished)
	gohelper.setActive(var_6_0._golocked, arg_6_1 == Activity119Enum.TaskStatus.Unfinished)

	var_6_0._canvasGroup.alpha = arg_6_1 == Activity119Enum.TaskStatus.GotReward and 0.7 or 1

	for iter_6_0 = 1, #arg_6_0.bonusItems do
		arg_6_0.bonusItems[iter_6_0]:setAlpha(arg_6_1 == Activity119Enum.TaskStatus.GotReward and 0.5 or 1)
	end
end
