...
slot0 = class("Activity1_3_119RewardItem")
...
function slot0.onInitView(slot0)
	...
	for slot4 = 1, 3 do
		...
		slot0._rewards[slot4]._bg = gohelper.findChild(slot0._rewards[slot4]._goreward, "image_RewardBG")
		slot0._rewards[slot4]._itemposContent = gohelper.findChild(slot0._rewards[slot4]._goreward, "#go_Item")
...
function slot0.updateTaskStatus(slot0, slot1)
	gohelper.setActive(slot0._rewards[slot0.bonusCount]._goclaimed, slot1 == Activity119Enum.TaskStatus.GotReward)
	gohelper.setActive(slot2._goclaim, slot1 == Activity119Enum.TaskStatus.Finished)
	gohelper.setActive(slot2._golocked, slot1 == Activity119Enum.TaskStatus.Unfinished)

	slot2._canvasGroup.alpha = slot1 == Activity119Enum.TaskStatus.GotReward and 0.7 or 1

	for slot6 = 1, #slot0.bonusItems do
		slot0.bonusItems[slot6]:setAlpha(slot1 == Activity119Enum.TaskStatus.GotReward and 0.5 or 1)
	end
end
