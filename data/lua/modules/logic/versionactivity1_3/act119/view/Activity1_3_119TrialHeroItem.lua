...
slot0 = class("Activity1_3_119TrialHeroItem")
...
function slot0.onInitView(slot0)
	...
	slot0._quality = gohelper.findChildImage(slot0.go, "#image_QualityBG")
	slot0._career = gohelper.findChildImage(slot0.go, "image_Career")
	slot0._icon = gohelper.findChildSingleImage(slot0.go, "image_Mask/#image_RoleIcon")
end
