...
local var_0_0 = class("Va3ChessGameHandler", BaseView)
...
function var_0_0.drawBaseTile(arg_2_0, arg_2_1, arg_2_2)
	local var_2_0 = Va3ChessGameModel.instance:getBaseTile(arg_2_1, arg_2_2)
	local var_2_1 = arg_2_0._viewObj:getBaseTile(arg_2_1, arg_2_2)

	if var_2_0 == Va3ChessEnum.TileBaseType.Normal then
