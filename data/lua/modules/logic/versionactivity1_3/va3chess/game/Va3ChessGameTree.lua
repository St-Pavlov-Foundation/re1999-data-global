...
local var_0_0 = class("Va3ChessGameTree")
...
function var_0_0.buildTree(arg_1_0, arg_1_1)
	...
	while #var_1_1 > 0 and var_1_2 <= var_1_0 do
		...
		for iter_1_0, iter_1_1 in pairs(var_1_3.nodes) do
			...
			arg_1_0:processChildNode(var_1_3, iter_1_1, iter_1_1.x - Va3ChessEnum.ClickRangeX, iter_1_1.y)
			arg_1_0:processChildNode(var_1_3, iter_1_1, iter_1_1.x + Va3ChessEnum.ClickRangeX, iter_1_1.y)
			arg_1_0:processChildNode(var_1_3, iter_1_1, iter_1_1.x, iter_1_1.y - Va3ChessEnum.ClickRangeY)
			arg_1_0:processChildNode(var_1_3, iter_1_1, iter_1_1.x, iter_1_1.y + Va3ChessEnum.ClickRangeY)
		end
