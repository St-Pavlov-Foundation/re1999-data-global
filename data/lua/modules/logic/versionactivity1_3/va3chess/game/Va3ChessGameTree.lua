...
function slot0.buildTree(slot0, slot1)
	...
	while #slot3 > 0 and slot4 <= slot2 do
		...
		for slot9, slot10 in pairs(slot5.nodes) do
			...
			slot0:processChildNode(slot5, slot10, slot10.x - Va3ChessEnum.ClickRangeX, slot10.y)
			slot0:processChildNode(slot5, slot10, slot10.x + Va3ChessEnum.ClickRangeX, slot10.y)
			slot0:processChildNode(slot5, slot10, slot10.x, slot10.y - Va3ChessEnum.ClickRangeY)
			slot0:processChildNode(slot5, slot10, slot10.x, slot10.y + Va3ChessEnum.ClickRangeY)
		end
