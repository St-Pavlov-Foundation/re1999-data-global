...
function slot0.refreshEpisodeTextInfo(slot0)
	slot1 = DungeonConfig.instance:getChapterCO(slot0.showEpisodeCo.chapterId)
	...
	if slot0._txtmapName.preferredWidth < 445 then
		recthelper.setAnchorX(slot0._txtmapNum.transform, -77)
	else
		recthelper.setAnchorX(slot0._txtmapNum.transform, -172)
	end

	slot0._txtMapChapterIndex.text = slot0:buildColorText(slot1.chapterIndex .. " .", slot2)
