...
local var_0_0 = class("VersionActivity1_3TaskListModel", ListScrollModel)
...
function var_0_0.initTask(arg_3_0)
	arg_3_0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity1_3Enum.ActivityId.Dungeon)
end
