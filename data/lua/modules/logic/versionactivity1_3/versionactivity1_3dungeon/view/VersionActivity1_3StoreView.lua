...
slot0 = class("VersionActivity1_3StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage("singlebg/v1a3_store_singlebg/v1a3_store_fullbg.png")
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, #ActivityStoreConfig.instance:getActivityStoreGroupDict(VersionActivity1_3Enum.ActivityId.DungeonStore) do
		if not slot0.storeItemList[slot6] then
			slot2 = VersionActivity1_3StoreItem.New()
...
function slot0.refreshTime(slot0)
	slot2 = ActivityModel.instance:getActivityInfo()[VersionActivity1_3Enum.ActivityId.DungeonStore]:getRealEndTimeStamp() - ServerTime.now()
