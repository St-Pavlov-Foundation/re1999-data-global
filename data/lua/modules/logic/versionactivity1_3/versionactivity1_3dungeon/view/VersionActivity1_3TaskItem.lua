...
slot0 = class("VersionActivity1_3TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity1_3TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity1_3Enum.ActivityId.Dungeon)
	else
