...
local var_0_0 = class("VersionActivity1_3TaskItem", ListScrollCell)
...
var_0_0.FinishKey = "VersionActivity1_3TaskItem FinishKey"
...
function var_0_0.refreshRewardItems(arg_12_0)
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_1) do
		...
		if not var_12_5 then
			...
			transformhelper.setLocalScale(var_12_5.go.transform, 0.6, 0.6, 1)
