...
local var_0_0 = class("VersionActivity1_3StoreGoodsItem", UserDataDispose)
...
function var_0_0.onClick(arg_2_0)
	...
	ViewMgr.instance:openView(ViewName.VersionActivity1_3NormalStoreGoodsView, arg_2_0.storeGoodsCo)
end
...
function var_0_0.updateInfo(arg_3_0, arg_3_1)
	...
	UISpriteSetMgr.instance:setV1a3StoreSprite(arg_3_0.imageRare, "v1a3_store_quality_" .. var_3_6)
...
function var_0_0.refreshRemainBuyCount(arg_6_0)
	if arg_6_0.storeGoodsCo.maxBuyCount == 0 then
		...
		arg_6_0.remainBuyCount = arg_6_0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_3Enum.ActivityId.DungeonStore, arg_6_0.storeGoodsCo.id)
