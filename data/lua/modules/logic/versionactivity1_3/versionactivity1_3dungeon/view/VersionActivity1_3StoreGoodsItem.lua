...
slot0 = class("VersionActivity1_3StoreGoodsItem", UserDataDispose)
...
function slot0.onClick(slot0)
	...
	ViewMgr.instance:openView(ViewName.VersionActivity1_3NormalStoreGoodsView, slot0.storeGoodsCo)
end
...
function slot0.updateInfo(slot0, slot1)
	...
	UISpriteSetMgr.instance:setV1a3StoreSprite(slot0.imageRare, "v1a3_store_quality_" .. slot7)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_3Enum.ActivityId.DungeonStore, slot0.storeGoodsCo.id)
