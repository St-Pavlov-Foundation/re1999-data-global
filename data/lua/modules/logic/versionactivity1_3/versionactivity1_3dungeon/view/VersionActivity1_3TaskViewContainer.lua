...
slot0 = class("VersionActivity1_3TaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity1_3TaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity1_3TaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
