...
local var_0_0 = class("VersionActivity1_3TaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = VersionActivity1_3TaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity1_3TaskListModel.instance, var_1_0, var_1_1)
