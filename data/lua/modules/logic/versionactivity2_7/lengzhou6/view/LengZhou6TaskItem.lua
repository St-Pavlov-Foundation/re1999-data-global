...
local var_0_0 = class("LengZhou6TaskItem", ListScrollCellExtend)
...
function var_0_0._btngetallOnClick(arg_7_0)
	LengZhou6Controller.instance:dispatchEvent(LengZhou6Event.OneClickClaimReward, arg_7_0._mo.activityId)
	UIBlockHelper.instance:startBlock(LengZhou6Enum.BlockKey.OneClickClaimReward, 0.5)
...
function var_0_0._editableAddEvents(arg_11_0)
	LengZhou6Controller.instance:registerCallback(LengZhou6Event.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end

function var_0_0._editableRemoveEvents(arg_12_0)
	LengZhou6Controller.instance:unregisterCallback(LengZhou6Event.OneClickClaimReward, arg_12_0._onOneClickClaimReward, arg_12_0)
end
...
function var_0_0._refreshUI(arg_14_0)
	...
	local var_14_0 = arg_14_0._mo.id ~= LengZhou6Enum.TaskMOAllFinishId
...
function var_0_0._moveByRankDiff(arg_16_0)
	local var_16_0 = LengZhou6TaskListModel.instance:getRankDiff(arg_16_0._mo)
