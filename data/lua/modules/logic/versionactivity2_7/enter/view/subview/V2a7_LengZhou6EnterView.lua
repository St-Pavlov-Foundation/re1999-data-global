...
local var_0_0 = class("V2a7_LengZhou6EnterView", VersionActivityEnterBaseSubView)
...
function var_0_0._btnEnterOnClick(arg_4_0)
	LengZhou6Controller.instance:enterLevelView(arg_4_0.actId)
end
...
function var_0_0._btnTrialOnClick(arg_6_0)
	if ActivityHelper.getActivityStatus(arg_6_0.actId) == ActivityEnum.ActivityStatus.Normal then
...
function var_0_0._btnLockedOnClick(arg_7_0)
...
function var_0_0._editableInitView(arg_8_0)
	arg_8_0.actId = LengZhou6Model.instance:getAct190Id()
...
function var_0_0.onOpen(arg_10_0)
	RedDotController.instance:addRedDot(arg_10_0._goreddot, RedDotEnum.DotNode.V2a7LengZhou6)
