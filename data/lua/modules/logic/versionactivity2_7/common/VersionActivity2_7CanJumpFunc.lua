-- chunkname: @modules/logic/versionactivity2_7/common/VersionActivity2_7CanJumpFunc.lua

module("modules.logic.versionactivity2_7.common.VersionActivity2_7CanJumpFunc", package.seeall)

local VersionActivity2_7CanJumpFunc = class("VersionActivity2_7CanJumpFunc")

function VersionActivity2_7CanJumpFunc:canJumpTo12003(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity2_7Enum.ActivityId.EnterView)

	if status ~= ActivityEnum.ActivityStatus.Normal then
		return false, toastId, toastParamList
	end

	local actId = VersionActivity2_7Enum.ActivityId.Reactivity
...
function VersionActivity2_7CanJumpFunc:canJumpTo12005(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity2_7Enum.ActivityId.DungeonGraffiti)
...
function VersionActivity2_7CanJumpFunc:canJumpTo12706(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity2_7Enum.ActivityId.EnterView)
	...
	local actId = VersionActivity2_7Enum.ActivityId.Dungeon
	local actStatus, actToastId, actToastParamList = ActivityHelper.getActivityStatusAndToast(actId)
...
return VersionActivity2_7CanJumpFunc
