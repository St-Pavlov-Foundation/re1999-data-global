...
slot0 = class("V2a2_LoperaEnterView", VersionActivityEnterBaseSubView)
...
function slot0._editableInitView(slot0)
	slot0.actCo = ActivityConfig.instance:getActivityCo(VersionActivity2_2Enum.ActivityId.Lopera)
...
function slot0._refreshTime(slot0)
	if ActivityModel.instance:getActivityInfo()[VersionActivity2_2Enum.ActivityId.Lopera] then
		...
		slot3 = ActivityHelper.getActivityStatus(VersionActivity2_2Enum.ActivityId.Lopera) ~= ActivityEnum.ActivityStatus.Normal
