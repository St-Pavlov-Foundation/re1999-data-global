...
slot0 = class("V2a2_EliminateEnterView", VersionActivityEnterBaseSubView)
...
function slot0.onInitView(slot0)
	...
	slot0._txtunlocked = gohelper.findChildTextMesh(slot0.viewGO, "Right/#btn_Locked/#txt_UnLocked")
...
function slot0._editableInitView(slot0)
	slot0.actCo = ActivityConfig.instance:getActivityCo(VersionActivity2_2Enum.ActivityId.Eliminate)
	slot0._txtDescr.text = slot0.actCo.actDesc
	slot0._txtunlocked.text = lua_toast.configDict[ToastEnum.EliminateLockDungeon].tips
end
...
function slot0._refreshTime(slot0)
	if ActivityModel.instance:getActivityInfo()[VersionActivity2_2Enum.ActivityId.Eliminate] then
		...
		slot3 = ActivityHelper.getActivityStatus(VersionActivity2_2Enum.ActivityId.Eliminate) ~= ActivityEnum.ActivityStatus.Normal
