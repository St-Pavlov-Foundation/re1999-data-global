...
slot0 = class("V2a2_DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_2Enum.ActivityId.Dungeon
	slot0.animComp = VersionActivity2_2SubAnimatorComp.get(slot0.viewGO, slot0)
	...
	slot0:_setDesc()
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a2DungeonEnter)
...
function slot0.refreshRemainTime(slot0)
	...
	slot3 = ActivityModel.instance:getActivityInfo()[VersionActivity2_2Enum.ActivityId.DungeonStore]
...
function slot0.refreshActivityState(slot0)
	slot2 = ActivityHelper.getActivityStatusAndToast(slot0.actId) == ActivityEnum.ActivityStatus.Normal or ActivityHelper.getActivityStatusAndToast(VersionActivity2_2Enum.ActivityId.EnterView) == ActivityEnum.ActivityStatus.Normal
	...
	gohelper.setActive(slot0.goStore, ActivityHelper.getActivityStatusAndToast(VersionActivity2_2Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal)
end

function slot0.refreshStoreCurrency(slot0)
	slot0._txtStoreNum.text = GameUtil.numberDisplay(CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V2a2Dungeon) and slot1.quantity or 0)
end
