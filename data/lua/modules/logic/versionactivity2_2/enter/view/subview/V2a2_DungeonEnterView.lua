...
local var_0_0 = class("V2a2_DungeonEnterView", BaseView)
...
function var_0_0._editableInitView(arg_9_0)
	...
	arg_9_0.actId = VersionActivity2_2Enum.ActivityId.Dungeon
	arg_9_0.animComp = VersionActivity2_2SubAnimatorComp.get(arg_9_0.viewGO, arg_9_0)
	...
	arg_9_0:_setDesc()
	RedDotController.instance:addRedDot(arg_9_0._goreddot, RedDotEnum.DotNode.V2a2DungeonEnter)
	RedDotController.instance:addRedDot(arg_9_0._gotaskreddot, RedDotEnum.DotNode.V2a2DungeonTask)
end
...
function var_0_0.refreshRemainTime(arg_15_0)
	...
	local var_15_2 = ActivityModel.instance:getActivityInfo()[VersionActivity2_2Enum.ActivityId.DungeonStore]
...
function var_0_0.refreshActivityState(arg_16_0)
	...
	var_16_1 = var_16_1 or ActivityHelper.getActivityStatusAndToast(VersionActivity2_2Enum.ActivityId.EnterView) == ActivityEnum.ActivityStatus.Normal
	...
	gohelper.setActive(arg_16_0._btntask, not var_16_2)

	local var_16_3 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_2Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal

	gohelper.setActive(arg_16_0.goStore, var_16_3)
end

function var_0_0.refreshStoreCurrency(arg_17_0)
	local var_17_0 = CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V2a2Dungeon)
