...
slot0 = class("VersionActivity2_2EnterViewTabItem2", VersionActivity2_2EnterViewTabItemBase)
...
function slot0.childRefreshSelect(slot0, slot1)
	...
	slot2 = VersionActivity2_2Enum.TabSetting.unselect

	if slot0.isSelect then
		slot2 = VersionActivity2_2Enum.TabSetting.select
	end
