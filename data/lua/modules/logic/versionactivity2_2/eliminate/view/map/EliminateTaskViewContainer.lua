...
local var_0_0 = class("EliminateTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = EliminateTaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(EliminateTaskListModel.instance, var_1_0, var_1_1)
