...
slot0 = class("EliminateTaskItem", ListScrollCell)
...
slot0.FinishKey = "EliminateTaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		...
		EliminateRpc.instance:sendGetMatch3WarChessTaskRewardRequest(slot0.co.id)
	end
end
