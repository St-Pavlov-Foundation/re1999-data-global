...
local var_0_0 = class("V2a2_WarmUpContainer", Activity125WarmUpViewBaseContainer)
local var_0_1 = {
	Done = 1999,
	None = 0
}
...
function var_0_0.buildViews(arg_1_0)
	arg_1_0._warmUp = V2a2_WarmUp.New()
	arg_1_0._warmUpLeftView = V2a2_WarmUpLeftView.New()
