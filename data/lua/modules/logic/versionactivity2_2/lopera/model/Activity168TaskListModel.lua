...
local var_0_0 = class("Activity168TaskListModel", ListScrollModel)

function var_0_0.init(arg_1_0, arg_1_1)
	local var_1_0 = TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity168)
	local var_1_1 = {}
	local var_1_2 = 0

	if var_1_0 ~= nil then
		local var_1_3 = Activity168Config.instance:getTaskList(arg_1_1)

		for iter_1_0, iter_1_1 in ipairs(var_1_3) do
			local var_1_4 = Activity168TaskMO.New()
	...
	if var_1_2 > 1 then
		local var_1_5 = Activity168TaskMO.New()
...
function var_0_0.getSortIndex(arg_3_0)
	if arg_3_0.id == LoperaEnum.TaskMOAllFinishId then
		return 1
...
function var_0_0.preFinish(arg_7_0, arg_7_1)
	...
	if arg_7_1.id == LoperaEnum.TaskMOAllFinishId then
		for iter_7_0, iter_7_1 in ipairs(var_7_2) do
			if iter_7_1:alreadyGotReward() and iter_7_1.id ~= LoperaEnum.TaskMOAllFinishId then
	...
	if var_7_0 then
		local var_7_3 = arg_7_0:getById(LoperaEnum.TaskMOAllFinishId)
