...
slot0 = class("VersionActivity2_2TaskListModel", ListScrollModel)
...
function slot0.initTask(slot0)
	slot0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_2Enum.ActivityId.Dungeon)
end
