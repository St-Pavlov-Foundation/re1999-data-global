...
slot0 = class("VersionActivity2_2StoreGoodsItem", ListScrollCell)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.goodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.goodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_2Enum.ActivityId.DungeonStore, slot0.goodsCo.id)
