...
slot0 = class("VersionActivity2_2TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity2_2TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity2_2Enum.ActivityId.Dungeon)
	else
