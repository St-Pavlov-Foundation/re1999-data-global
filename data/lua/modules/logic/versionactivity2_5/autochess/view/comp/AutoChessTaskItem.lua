...
local var_0_0 = class("AutoChessTaskItem", ListScrollCellExtend)
...
function var_0_0._btngetallOnClick(arg_6_0)
	AutoChessController.instance:dispatchEvent(AutoChessEvent.OneClickClaimReward, arg_6_0._taskMo.activityId)
	UIBlockHelper.instance:startBlock("AutoChessTaskItem_finishAnim", 0.5)
...
function var_0_0._editableAddEvents(arg_10_0)
	arg_10_0:addEventCb(AutoChessController.instance, AutoChessEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	arg_11_0:removeEventCb(AutoChessController.instance, AutoChessEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	...
	local var_14_0 = AutoChessTaskListModel.instance:getRankDiff(arg_14_1)
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_5/autochess/item/autochesstaskitem.prefab"
