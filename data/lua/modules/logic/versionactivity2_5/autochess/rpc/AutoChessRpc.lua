...
function var_0_0.sendAutoChessEnterSceneRequest(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	local var_3_0 = AutoChessModule_pb.AutoChessEnterSceneRequest()

	var_3_0.moduleId = arg_3_1
	var_3_0.episodeId = arg_3_2
	var_3_0.masterId = arg_3_3
...
function var_0_0.onReceiveAutoChessEnterSceneReply(arg_4_0, arg_4_1, arg_4_2)
	if arg_4_1 == 0 then
		AutoChessModel.instance:enterSceneReply(arg_4_2.moduleId, arg_4_2.scene)
		AutoChessController.instance:enterGame(arg_4_0.episodeId)
	end
...
function var_0_0.onReceiveAutoChessEnterFightReply(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_0 = AutoChessModel.instance:getChessMo(arg_6_2.moduleId)
...
function var_0_0.onReceiveAutoChessBuyChessReply(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = AutoChessModel.instance:getChessMo(arg_8_2.moduleId)
...
function var_0_0.sendAutoChessBuildRequest(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7, arg_9_8, arg_9_9)
	AutoChessController.instance:setGuideEventFlag(arg_9_2)
...
function var_0_0.onReceiveAutoChessBuildReply(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_0 = AutoChessModel.instance:getChessMo(arg_10_2.moduleId)
...
function var_0_0.onReceiveAutoChessRefreshMallReply(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_0 = AutoChessModel.instance:getChessMo(arg_12_2.moduleId)
...
function var_0_0.onReceiveAutoChessFreezeItemReply(arg_14_0, arg_14_1, arg_14_2)
	...
	AutoChessModel.instance:getChessMo(arg_14_2.moduleId):freezeReply(arg_14_2.mallId, arg_14_2.type)
end
...
function var_0_0.onReceiveAutoChessMallRegionSelectItemReply(arg_16_0, arg_16_1, arg_16_2)
	...
	AutoChessModel.instance:getChessMo(arg_16_2.moduleId):updateSvrMallRegion(arg_16_2.region)
...
function var_0_0.sendAutoChessUseMasterSkillRequest(arg_17_0, arg_17_1, arg_17_2)
...
function var_0_0.onReceiveAutoChessUseMasterSkillReply(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_0 = AutoChessModel.instance:getChessMo(arg_18_2.moduleId)
...
function var_0_0.onReceiveAutoChessPreviewFightReply(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_0 = AutoChessModel.instance:getChessMo(arg_20_2.moduleId)
...
function var_0_0.onReceiveAutoChessGiveUpReply(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_0 = AutoChessModel.instance:getChessMo(arg_22_2.moduleId, true)
...
function var_0_0.onReceiveAutoChessScenePush(arg_23_0, arg_23_1, arg_23_2)
	...
	AutoChessModel.instance:getChessMo(arg_23_2.moduleId):updateSvrScene(arg_23_2.scene)
end
