...
local var_0_0 = class("VersionActivity2_5EnterViewTabItem2", VersionActivity2_5EnterViewTabItemBase)
...
function var_0_0.childRefreshSelect(arg_3_0, arg_3_1)
	...
	local var_3_0 = VersionActivity2_5Enum.TabSetting.unselect

	if arg_3_0.isSelect then
		var_3_0 = VersionActivity2_5Enum.TabSetting.select
	end
