...
slot0 = class("VersionActivity2_5DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_5Enum.ActivityId.Dungeon
	...
	slot0:_setDesc()
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a5DungeonEnter)
	RedDotController.instance:addRedDot(slot0._gotaskreddot, RedDotEnum.DotNode.V2a5DungeonTask)
...
function slot0.refreshRemainTime(slot0)
	...
	slot3 = ActivityModel.instance:getActivityInfo()[VersionActivity2_5Enum.ActivityId.DungeonStore]
...
function slot0.refreshActivityState(slot0)
	...
	gohelper.setActive(slot0.goStore, ActivityHelper.getActivityStatusAndToast(VersionActivity2_5Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal)
end
