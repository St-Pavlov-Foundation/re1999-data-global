...
local var_0_0 = class("VersionActivity2_5FeiLinShiDuoEnterView", VersionActivityEnterBaseSubView)
...
function var_0_0._btnEnterOnClick(arg_4_0)
	FeiLinShiDuoGameController.instance:enterEpisodeLevelView(arg_4_0.actId)
end
...
function var_0_0._editableInitView(arg_8_0)
	...
	arg_8_0.actId = VersionActivity2_5Enum.ActivityId.FeiLinShiDuo
...
function var_0_0.onOpen(arg_10_0)
	RedDotController.instance:addRedDot(arg_10_0._goreddot, RedDotEnum.DotNode.V2a5_Act185)
