...
local var_0_0 = class("VersionActivity2_5EnterBgmView", BaseView)
...
function var_0_0.initActHandle(arg_5_0)
	if not arg_5_0.actHandleDict then
		arg_5_0.actHandleDict = {
			...
			[VersionActivity2_5Enum.ActivityId.AutoChess] = arg_5_0._autochessBgmHandle
		}
	end
end
...
function var_0_0.onOpen(arg_6_0)
	...
	arg_6_0._isFirstOpenMainAct = var_6_2 == VersionActivity2_5Enum.ActivityId.Dungeon
...
function var_0_0.modifyBgm(arg_8_0, arg_8_1)
	arg_8_0._isMainAct = arg_8_1 == VersionActivity2_5Enum.ActivityId.Dungeon
...
function var_0_0.defaultBgmHandle(arg_10_0, arg_10_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_5Main, var_10_0)
end
...
function var_0_0._bossrushBgmHandle(arg_12_0, arg_12_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_5Main, var_12_0)
end
...
function var_0_0._reactivityBgmHandle(arg_13_0, arg_13_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_5Main, var_13_0)
end

function var_0_0._autochessBgmHandle(arg_14_0, arg_14_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_5Main, var_14_0)
end
