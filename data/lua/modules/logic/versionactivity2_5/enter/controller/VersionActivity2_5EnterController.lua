...
slot0 = class("VersionActivity2_5EnterController", BaseController)
...
function slot0.openVersionActivityEnterView(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:_internalOpenView(ViewName.VersionActivity2_5EnterView, slot5, slot8, slot0, {
		actId = VersionActivity2_5Enum.ActivityId.EnterView,
		jumpActId = slot3,
		activityIdList = VersionActivityEnterHelper.getActIdList(VersionActivity2_5Enum.EnterViewActSetting),
