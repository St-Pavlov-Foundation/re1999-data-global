...
local var_0_0 = class("VersionActivity2_5EnterHelper")
...
function var_0_0.getItemTypeIdQuantity(arg_4_0)
	...
	local var_4_0 = GameUtil.splitString2(arg_4_0, true)[1]
...
function var_0_0.GetActivityPrefsKey(arg_6_0)
	return VersionActivity2_5Enum.ActivityId.EnterView .. arg_6_0
end
