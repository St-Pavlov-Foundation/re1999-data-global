...
local var_0_0 = class("V2a5_WarmUp", BaseView)
...
function var_0_0.onDestroyView(arg_12_0)
	...
	GameUtil.onDestroyViewMemberList(arg_12_0, "_itemTabList")
end
...
function var_0_0._refreshTabList(arg_20_0)
	...
	for iter_20_0 = 1, var_20_1 do
		...
		if iter_20_0 > #arg_20_0._itemTabList then
			var_20_4 = arg_20_0:_create_V2a5_WarmUp_radiotaskitem(iter_20_0)
...
function var_0_0._refreshRewards(arg_24_0)
	...
	for iter_24_0 = 1, var_24_2 do
		...
		if iter_24_0 > #arg_24_0._rewardItemList then
			var_24_3 = arg_24_0:_create_V2a5_WarmUp_rewarditem(iter_24_0)
...
function var_0_0._create_V2a5_WarmUp_radiotaskitem(arg_35_0, arg_35_1)
	local var_35_0 = gohelper.cloneInPlace(arg_35_0._goradiotaskitem)
	local var_35_1 = V2a5_WarmUp_radiotaskitem.New({
		parent = arg_35_0,
...
function var_0_0._create_V2a5_WarmUp_rewarditem(arg_36_0, arg_36_1)
	local var_36_0 = gohelper.cloneInPlace(arg_36_0._gorewarditem)
	local var_36_1 = V2a5_WarmUp_rewarditem.New({
		parent = arg_36_0,
...
function var_0_0.onUpdateActivity(arg_43_0)
	arg_43_0._descScrollRect:StopMovement()
	arg_43_0:_resetTweenDescPos()
	arg_43_0:_refresh()
end
