...
slot0 = class("FeiLinShiDuoTaskListModel", ListScrollModel)

function slot0.init(slot0, slot1)
	slot3 = {}
	slot4 = 0

	if TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity185) ~= nil then
		for slot9, slot10 in ipairs(FeiLinShiDuoConfig.instance:getTaskByActId(slot1)) do
			slot11 = FeiLinShiDuoTaskMo.New()
