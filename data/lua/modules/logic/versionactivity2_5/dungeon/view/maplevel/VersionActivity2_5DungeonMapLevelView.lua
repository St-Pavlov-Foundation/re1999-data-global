...
local k_VersionActivity2_5Dungeon = {
	2510101,
	2510116,
	2520117,
	2510117
...
function VersionActivity2_5DungeonMapLevelView:_buildEpisodeName_overseas(firstName, remainName, txtColor, episodeCo, nameLen)
	local isLang = LangSettings.instance:isJp() or LangSettings.instance:isEn()
	local is90 = false

	if isLang then
		local curEpisodeCoId = self.showEpisodeCo.id

		for _, episodeId in ipairs(k_VersionActivity2_5Dungeon) do
			if curEpisodeCoId == episodeId then
				is90 = true
...
function VersionActivity2_5DungeonMapLevelView:buildEpisodeName(episodeCo)
	...
	return self:_buildEpisodeName_overseas(firstName, remainName, txtColor, episodeCo, nameLen)
end
