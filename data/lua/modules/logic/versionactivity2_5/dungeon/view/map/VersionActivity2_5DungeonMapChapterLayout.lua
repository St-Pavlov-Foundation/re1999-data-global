...
function VersionActivity2_5DungeonMapChapterLayout:addEvents()
	...
	self:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.GuideShowElement, self._GuideShowElement, self)
...
function VersionActivity2_5DungeonMapChapterLayout:removeEvents()
	...
	self:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end
