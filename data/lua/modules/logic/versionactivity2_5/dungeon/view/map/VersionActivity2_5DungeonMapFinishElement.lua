-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/VersionActivity2_5DungeonMapFinishElement.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.VersionActivity2_5DungeonMapFinishElement", package.seeall)

local VersionActivity2_5DungeonMapFinishElement = class("VersionActivity2_5DungeonMapFinishElement", DungeonMapFinishElement)

function VersionActivity2_5DungeonMapFinishElement:init(go)
	self._go = go
...
function VersionActivity2_5DungeonMapFinishElement:_onResLoaded()
	if not string.nilorempty(self.resPath) then
...
function VersionActivity2_5DungeonMapFinishElement:onDown()
	self:_onDown()
end

function VersionActivity2_5DungeonMapFinishElement:_onDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivity2_5DungeonMapFinishElement:onClick()
...
return VersionActivity2_5DungeonMapFinishElement
