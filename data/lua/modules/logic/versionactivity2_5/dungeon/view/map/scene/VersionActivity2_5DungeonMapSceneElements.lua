...
function VersionActivity2_5DungeonMapSceneElements:addEvents()
	...
	self:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_5DungeonMapSceneElements:removeEvents()
	...
	self:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
