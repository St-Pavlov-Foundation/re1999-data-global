...
local var_0_0 = class("VersionActivity2_5DungeonMapSceneElements", BaseView)
local var_0_1 = 0.5
local var_0_2 = 0.5
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, arg_2_0.onHideInteractUI, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, arg_3_0.onHideInteractUI, arg_3_0)
...
function var_0_0.onGamepadKeyDown(arg_6_0, arg_6_1)
	...
	for iter_6_0 = 0, var_6_3 do
		...
		local var_6_5 = MonoHelper.getLuaComFromGo(var_6_4.transform.parent.gameObject, VersionActivity2_5DungeonMapElement)
...
function var_0_0._removeElement(arg_21_0, arg_21_1)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnRemoveElement, var_21_0)
end
...
function var_0_0.showNewElements(arg_22_0)
	...
	for iter_22_0, iter_22_1 in ipairs(var_22_0) do
		...
		if VersionActivity2_5DungeonConfig.instance:checkElementBelongMapId(var_22_2, arg_22_0._mapCfg.id) and var_22_2.showCamera == 1 then
...
function var_0_0._doFocusElement(arg_24_0)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, var_24_0, true)
end
...
function var_0_0._addElement(arg_28_0, arg_28_1)
	...
	if var_28_0 then
		...
		var_28_0 = MonoHelper.addLuaComOnceToGo(var_28_1, VersionActivity2_5DungeonMapElement, {
			arg_28_1,
			arg_28_0
		})
	end
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnAddOneElement, var_28_0)
end
...
function var_0_0.showElements(arg_29_0)
	...
	local var_29_3 = VersionActivity2_5DungeonModel.instance:getElementCoList(arg_29_0._mapCfg.id)
...
function var_0_0._arrowClick(arg_31_0, arg_31_1)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, arg_31_1)
end
