...
local var_0_0 = class("VersionActivity2_5DungeonMapEpisodeView", BaseView)
local var_0_1 = 0.5
local var_0_2 = -240
local var_0_3 = 0.41
local var_0_4 = 1.7
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, arg_2_0.hideUI, arg_2_0)
	arg_2_0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, arg_2_0.showUI, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, arg_3_0.hideUI, arg_3_0)
	arg_3_0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, arg_3_0.showUI, arg_3_0)
...
function var_0_0.refreshModeLockText(arg_11_0)
	local var_11_0 = VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity2_5DungeonEnum.DungeonChapterId.Hard)
	...
	if var_11_1 < var_11_0 then
		...
		local var_11_6 = ActivityModel.instance:getActivityInfo()[VersionActivity2_5Enum.ActivityId.Dungeon]
...
function var_0_0.checkHardModeIsOpen(arg_21_0)
	local var_21_0 = VersionActivity2_5Enum.ActivityId.Dungeon
...
function var_0_0.playUnlockAnimation(arg_28_0, arg_28_1)
	...
	if arg_28_0:IsNeedPlayHardModeUnlockAnimation() then
		local var_28_0 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim

		VersionActivity2_5DungeonController.instance:savePlayerPrefs(var_28_0, var_0_6)
...
function var_0_0.IsNeedPlayHardModeUnlockAnimation(arg_29_0)
	...
	local var_29_1 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim

	if VersionActivity2_5DungeonController.instance:getPlayerPrefs(var_29_1, var_0_5) ~= var_0_6 then
		local var_29_2 = VersionActivity2_5Enum.ActivityId.Dungeon
...
function var_0_0._unlockAniDone(arg_30_0)
	local var_30_0 = VersionActivity2_5Enum.ActivityId.Dungeon
