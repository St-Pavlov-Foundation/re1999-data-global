...
function slot0.calculatePosInContent(slot0)
	if VersionActivity2_5DungeonEnum.EpisodeItemMinWidth < math.max(recthelper.getAnchorX(slot0._txtsectionname.transform) + slot0._txtsectionname.preferredWidth, recthelper.getAnchorX(slot0._txtnameen.transform) + slot0._txtsectionname.preferredWidth) then
		slot5 = (uv0 + slot5 - VersionActivity2_5DungeonEnum.EpisodeItemMinWidth) / 2
	end

	slot0._maxWidth = math.max(slot5 * 2, VersionActivity2_5DungeonEnum.EpisodeItemMinWidth)
