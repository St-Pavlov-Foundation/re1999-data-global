...
function var_0_0.calculatePosInContent(arg_28_0)
	...
	if var_28_4 > VersionActivity2_5DungeonEnum.EpisodeItemMinWidth then
		local var_28_5 = var_28_4 - VersionActivity2_5DungeonEnum.EpisodeItemMinWidth

		var_28_4 = (var_0_1 + var_28_5) / 2
	end

	arg_28_0._maxWidth = math.max(var_28_4 * 2, VersionActivity2_5DungeonEnum.EpisodeItemMinWidth)
