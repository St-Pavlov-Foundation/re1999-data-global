...
function VersionActivity2_5DungeonMapEpisodeItem:calculatePosInContent()
	...
	if halfWidth > VersionActivity2_5DungeonEnum.EpisodeItemMinWidth then
		local offset = halfWidth - VersionActivity2_5DungeonEnum.EpisodeItemMinWidth

		halfWidth = (kPrefabWidth + offset) / 2
	end

	self._maxWidth = math.max(halfWidth * 2, VersionActivity2_5DungeonEnum.EpisodeItemMinWidth)
