...
slot0 = class("VersionActivity2_5DungeonMapScene", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.FocusElement, slot0.onFocusElement, slot0)
	slot0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.ManualClickElement, slot0.manualClickElement, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.FocusElement, slot0.onFocusElement, slot0)
	slot0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.ManualClickElement, slot0.manualClickElement, slot0)
...
function slot0._onScreenResize(slot0)
	if slot0._sceneGo then
		CameraMgr.instance:getMainCamera().orthographicSize = VersionActivity2_5DungeonEnum.DungeonMapCameraSize * GameUtil.getAdapterScale()
...
function slot0.onActivityDungeonMoChange(slot0)
	slot0:refreshMap(VersionActivity2_5DungeonModel.instance:getMapNeedTweenState())
end
...
function slot0._initMapRootNode(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_5DungeonEnum.SceneRootName)
...
function slot0._initCamera(slot0)
	...
	slot1.orthographicSize = VersionActivity2_5DungeonEnum.DungeonMapCameraSize * GameUtil.getAdapterScale()
end

function slot0.refreshMap(slot0, slot1, slot2)
	slot0._mapCfg = slot2 or VersionActivity2_5DungeonConfig.instance:getEpisodeMapConfig(slot0.activityDungeonMo.episodeId)
...
function slot0._initScene(slot0)
	...
	slot11 = VersionActivity2_5DungeonEnum.DungeonMapCameraSize / (CameraMgr.instance:getUICamera() and slot9.orthographicSize or 5)
...
function slot0._focusUnfinishStoryElement(slot0)
	if VersionActivity2_5DungeonModel.instance:checkAndGetUnfinishStoryElementCo(slot0._mapCfg.id) then
		VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.FocusElement, slot1.id)
	end
end
...
function slot0.directSetScenePos(slot0, slot1)
	...
	VersionActivity2_5DungeonController.instance:dispatchEvent(VersionActivity2_5DungeonEvent.OnMapPosChanged, slot0._scenePos, slot0.needTween)
