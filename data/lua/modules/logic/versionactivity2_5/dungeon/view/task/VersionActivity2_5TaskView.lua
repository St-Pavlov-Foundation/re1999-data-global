...
slot0 = class("VersionActivity2_5TaskView", BaseView)
...
function slot0.refreshRemainTime(slot0)
	slot0._txtremaintime.text = TimeUtil.SecondToActivityTimeFormat(ActivityModel.instance:getActivityInfo()[VersionActivity2_5Enum.ActivityId.Dungeon]:getRealEndTimeStamp() - ServerTime.now())
end
