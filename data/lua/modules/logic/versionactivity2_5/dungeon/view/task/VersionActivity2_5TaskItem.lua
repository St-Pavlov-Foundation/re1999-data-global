...
function VersionActivity2_5TaskItem:addEventListeners()
	...
	self:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
...
function VersionActivity2_5TaskItem:removeEventListeners()
	...
	self:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickAllTaskFinish, self._OnClickAllTaskFinish, self)
end
