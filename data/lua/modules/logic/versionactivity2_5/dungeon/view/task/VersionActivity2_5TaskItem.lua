...
slot0 = class("VersionActivity2_5TaskItem", ListScrollCell)
...
function slot0.addEventListeners(slot0)
	...
	slot0:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickAllTaskFinish, slot0._OnClickAllTaskFinish, slot0)
end
...
function slot0.removeEventListeners(slot0)
	...
	slot0:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickAllTaskFinish, slot0._OnClickAllTaskFinish, slot0)
end
...
slot0.FinishKey = "VersionActivity2_5TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity2_5Enum.ActivityId.Dungeon)
	else
