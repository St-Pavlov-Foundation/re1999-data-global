...
local var_0_0 = class("VersionActivity2_5StoreItem", UserDataDispose)
local var_0_1 = 424
local var_0_2 = 382.32
local var_0_3 = 300

local function var_0_4(arg_1_0, arg_1_1)
	local var_1_0 = VersionActivity2_5Enum.ActivityId.DungeonStore
...
function var_0_0.refreshGoods(arg_8_0)
	...
	for iter_8_0, iter_8_1 in ipairs(arg_8_0.groupGoodsCoList) do
		...
		if not var_8_1 then
			...
			var_8_1 = VersionActivity2_5StoreGoodsItem.New()
