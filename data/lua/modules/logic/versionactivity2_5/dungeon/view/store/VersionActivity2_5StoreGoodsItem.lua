...
local var_0_0 = class("VersionActivity2_5StoreGoodsItem", UserDataDispose)
...
function var_0_0.updateInfo(arg_3_0, arg_3_1)
	...
	local var_3_0, var_3_1, var_3_2 = VersionActivity2_5EnterHelper.getItemTypeIdQuantity(arg_3_0.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setV2a5MainActivitySprite(arg_3_0.imageRare, "v2a5_store_quality_" .. var_3_5)
	...
	arg_3_0.costItemType, arg_3_0.costItemId, arg_3_0.costItemQuantity = VersionActivity2_5EnterHelper.getItemTypeIdQuantity(arg_3_0.storeGoodsCo.cost)
...
function var_0_0.refreshRemainBuyCount(arg_4_0)
	if arg_4_0.storeGoodsCo.maxBuyCount == 0 then
		...
		local var_4_0 = VersionActivity2_5Enum.ActivityId.DungeonStore
