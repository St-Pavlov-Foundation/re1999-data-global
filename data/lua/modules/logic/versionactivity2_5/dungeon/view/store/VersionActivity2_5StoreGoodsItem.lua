-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/store/VersionActivity2_5StoreGoodsItem.lua

module("modules.logic.versionactivity2_5.dungeon.view.store.VersionActivity2_5StoreGoodsItem", package.seeall)

local VersionActivity2_5StoreGoodsItem = class("VersionActivity2_5StoreGoodsItem", UserDataDispose)

function VersionActivity2_5StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_5StoreGoodsItem:onClick()
...
function VersionActivity2_5StoreGoodsItem:updateInfo(storeGoodsCo)
	self.storeGoodsCo = storeGoodsCo

	self:refreshRemainBuyCount()

	local productItemType, productItemId, productItemQuantity = VersionActivity2_5EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.product)
	...
	self.costItemType, self.costItemId, self.costItemQuantity = VersionActivity2_5EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.cost)
...
function VersionActivity2_5StoreGoodsItem:refreshRemainBuyCount()
...
function VersionActivity2_5StoreGoodsItem:setImageIconNative()
	self.imageIcon:SetNativeSize()
end

function VersionActivity2_5StoreGoodsItem:refreshTag()
...
function VersionActivity2_5StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity2_5StoreGoodsItem:onDestroy()
...
return VersionActivity2_5StoreGoodsItem
