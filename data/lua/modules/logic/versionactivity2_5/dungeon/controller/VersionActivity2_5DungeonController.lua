...
slot0 = class("VersionActivity2_5DungeonController", BaseController)
...
function slot0.openStoreView(slot0)
	if not VersionActivityEnterHelper.checkCanOpen(VersionActivity2_5Enum.ActivityId.DungeonStore) then
		return
	end
...
function slot0._internalOpenVersionActivityDungeonMapView(slot0)
	...
	if not slot0.dungeonMapViewParam.episodeId and VersionActivity2_5DungeonModel.instance:getInitEpisodeId() > 0 then
		slot0.dungeonMapViewParam.episodeId = slot1
	end

	ViewMgr.instance:openView(ViewName.VersionActivity2_5DungeonMapView, slot0.dungeonMapViewParam)
end
...
function slot1(slot0)
	...
	return string.format("2_3Dungeon_%s_%s", VersionActivity2_5Enum.ActivityId.Dungeon, slot0)
end
