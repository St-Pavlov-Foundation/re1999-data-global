...
local var_0_0 = class("VersionActivity2_5DungeonController", BaseController)
...
function var_0_0.openStoreView(arg_5_0)
	local var_5_0 = VersionActivity2_5Enum.ActivityId.DungeonStore
...
function var_0_0._internalOpenVersionActivityDungeonMapView(arg_9_0)
	...
	if not arg_9_0.dungeonMapViewParam.episodeId then
		local var_9_0 = VersionActivity2_5DungeonModel.instance:getInitEpisodeId()
	...
	ViewMgr.instance:openView(ViewName.VersionActivity2_5DungeonMapView, arg_9_0.dungeonMapViewParam)
end
...
local function var_0_1(arg_11_0)
	...
	return (string.format("2_3Dungeon_%s_%s", VersionActivity2_5Enum.ActivityId.Dungeon, arg_11_0))
end
