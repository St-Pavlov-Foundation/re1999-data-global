...
slot0 = class("VersionActivity2_5DungeonModel", BaseModel)
...
function slot0.getElementCoList(slot0, slot1)
	...
	for slot7, slot8 in pairs(DungeonMapModel.instance:getAllElements()) do
		if DungeonConfig.instance:getChapterMapElement(slot8) and lua_chapter_map.configDict[slot9.mapId] and slot10.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Story and slot1 == slot9.mapId then
...
function slot0.getElementCoListWithFinish(slot0, slot1)
	...
	for slot7, slot8 in pairs(slot0:getAllNormalElementCoList(slot1)) do
		...
		if lua_chapter_map.configDict[slot8.mapId] and slot10.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Story then
...
function slot0.getInitEpisodeId(slot0)
	...
	for slot7, slot8 in ipairs(DungeonConfig.instance:getChapterEpisodeCOList(VersionActivity2_5DungeonEnum.DungeonChapterId.Story)) do
