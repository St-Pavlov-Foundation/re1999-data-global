...
slot0 = class("LiangYueTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot2.cellClass = LiangYueTaskItem
	...
	slot4 = LuaListScrollViewWithAnimator.New(LiangYueTaskListModel.instance, slot2, {
		[slot7] = (slot7 - 1) * 0.06
	})
	slot4.dontPlayCloseAnimation = true

	table.insert(slot1, slot4)
	table.insert(slot1, LiangYueTaskView.New())
