...
slot0 = class("LiangYueTaskListModel", ListScrollModel)

function slot0.init(slot0, slot1)
	slot3 = {}
	slot4 = 0

	if TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity184) ~= nil then
		for slot9, slot10 in ipairs(LiangYueConfig.instance:getTaskByActId(slot1)) do
			slot11 = LiangYueTaskMo.New()
