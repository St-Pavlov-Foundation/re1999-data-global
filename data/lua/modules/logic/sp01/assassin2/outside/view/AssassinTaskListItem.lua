...
local var_0_0 = class("AssassinTaskListItem", ListScrollCell)
...
function var_0_0.init(arg_1_0, arg_1_1)
	...
	arg_1_0.btnNotFinish = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_normal/#btn_notfinishbg", AudioEnum2_9.StealthGame.play_ui_cikeshang_normalclick)
	arg_1_0.goRunning = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_normal/#go_running", AudioEnum2_9.StealthGame.play_ui_cikeshang_normalclick)
	arg_1_0.btnFinish = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_normal/#btn_finishbg", AudioEnum2_9.StealthGame.play_ui_cikeshang_normalclick)
	arg_1_0.btnFinishAll = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_getall/#btn_getall/#btn_getall", AudioEnum2_9.StealthGame.play_ui_cikeshang_normalclick)
...
function var_0_0.addEventListeners(arg_2_0)
	...
	arg_2_0:addEventCb(AssassinController.instance, AssassinEvent.OnClickAllTaskFinish, arg_2_0._OnClickAllTaskFinish, arg_2_0)
end
...
function var_0_0.removeEventListeners(arg_3_0)
	...
	arg_3_0:removeEventCb(AssassinController.instance, AssassinEvent.OnClickAllTaskFinish, arg_3_0._OnClickAllTaskFinish, arg_3_0)
end
...
var_0_0.FinishKey = "AssassinTaskListItem FinishKey"
...
function var_0_0._OnClickAllTaskFinish(arg_7_0)
	if arg_7_0.taskMo then
		...
		elseif arg_7_0.taskMo.finishCount < arg_7_0.co.maxFinishCount and arg_7_0.taskMo.hasFinished then
			arg_7_0:getAnimator():Play(UIAnimationName.Finish, 0, 0)
		end
	end
end
