...
local var_0_0 = class("AssassinTaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = AssassinTaskListItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(AssassinTaskListModel.instance, var_1_0, var_1_1)
