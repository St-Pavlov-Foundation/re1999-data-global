...
local var_0_0 = class("V2a9_VersionSummonFull_Part2", V2a9_VersionSummonFull)

function var_0_0._editableInitView(arg_1_0)
	arg_1_0._simageRole:LoadImage(ResUrl.getV2a9VersionSummonSingleBg("v2a9_versionsummon_fullrole2"))
