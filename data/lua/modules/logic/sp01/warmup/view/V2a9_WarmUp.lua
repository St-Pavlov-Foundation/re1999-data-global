...
local var_0_0 = class("V2a9_WarmUp", BaseView)
...
function var_0_0._refreshTabList(arg_21_0)
	...
	for iter_21_0 = 1, var_21_1 do
		...
		if iter_21_0 > #arg_21_0._itemTabList then
			var_21_4 = arg_21_0:_create_V2a9_WarmUp_radiotaskitem(iter_21_0)
...
function var_0_0._refreshRewards(arg_25_0)
	...
	for iter_25_0 = 1, var_25_2 do
		...
		if iter_25_0 > #arg_25_0._rewardItemList then
			var_25_3 = arg_25_0:_create_V2a9_WarmUp_rewarditem(iter_25_0)
...
function var_0_0._create_V2a9_WarmUp_radiotaskitem(arg_36_0, arg_36_1)
	local var_36_0 = gohelper.cloneInPlace(arg_36_0._goradiotaskitem)
	local var_36_1 = V2a9_WarmUp_radiotaskitem.New({
		parent = arg_36_0,
...
function var_0_0._create_V2a9_WarmUp_rewarditem(arg_37_0, arg_37_1)
	local var_37_0 = gohelper.cloneInPlace(arg_37_0._gorewarditem)
	local var_37_1 = V2a9_WarmUp_rewarditem.New({
		parent = arg_37_0,
