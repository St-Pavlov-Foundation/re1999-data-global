...
local var_0_0 = class("V2a9_WarmUpLeftView", BaseView)
...
function var_0_0._editableInitView(arg_5_0)
	...
	arg_5_0._openGo = gohelper.findChild(arg_5_0._middleGo, "opened_effect")
	arg_5_0._unopenGo = gohelper.findChild(arg_5_0._middleGo, "turnon_effect")
	arg_5_0._godrag = gohelper.findChild(arg_5_0._unopenGo, "drag")
	arg_5_0._guideGo = gohelper.findChild(arg_5_0._unopenGo, "guide")
	arg_5_0._simagepic = gohelper.findChildSingleImage(arg_5_0._middleGo, "#simage_pic")
...
function var_0_0._refresh(arg_18_0)
	...
	if var_18_0 then
		...
		elseif var_0_5.Clicked == var_18_2 then
			...
			logError("[V2a9_WarmUpLeftView] invalid state: " .. tostring(var_18_2))
		end
	end
end
...
local var_0_7 = "V2a9_WarmUpLeftView:kBlock_Click"
local var_0_8 = 9.99
