...
slot0 = class("VersionActivity1_5TaskListModel", ListScrollModel)
...
function slot0.initTask(slot0)
	slot0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity1_5Enum.ActivityId.Dungeon)
end
