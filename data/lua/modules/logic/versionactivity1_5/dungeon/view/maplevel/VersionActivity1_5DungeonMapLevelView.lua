...
function var_0_0.buildEpisodeName(arg_52_0)
	...
	if LangSettings.instance:isKr() then
		return arg_52_0:buildColorText(string.format("<size=105>%s</size>%s", var_52_1, var_52_2), var_52_4)
	elseif LangSettings.instance:isEn() then
		return arg_52_0:buildColorText(string.format("<size=100>%s</size>%s", var_52_1, var_52_2), var_52_4)
	else
		return arg_52_0:buildColorText(string.format("<size=90>%s</size>%s", var_52_1, var_52_2), var_52_4)
	end
end
