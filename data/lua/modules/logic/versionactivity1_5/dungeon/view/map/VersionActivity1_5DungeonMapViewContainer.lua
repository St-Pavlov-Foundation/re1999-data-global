...
function slot0.onContainerInit(slot0)
	...
	slot0.versionActivityDungeonBaseMo:init(VersionActivity1_5Enum.ActivityId.Dungeon, slot5, slot0.viewParam.episodeId)
	slot0.versionActivityDungeonBaseMo:setLayoutClass(VersionActivity1_5DungeonMapChapterLayout)

	slot4 = VersionActivity1_5DungeonMapEpisodeItem
