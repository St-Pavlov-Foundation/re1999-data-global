...
function var_0_0.refreshTime(arg_11_0)
	local var_11_0 = ActivityModel.instance:getActivityInfo()[VersionActivity1_5Enum.ActivityId.DungeonStore]:getRemainTimeStr3()

	arg_11_0._txttime.text = formatLuaLang("remain", var_11_0)
end
