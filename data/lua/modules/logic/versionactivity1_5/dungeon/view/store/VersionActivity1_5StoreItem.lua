...
local var_0_0 = class("VersionActivity1_5StoreItem", UserDataDispose)
...
function var_0_0.refreshTag(arg_5_0)
	...
	arg_5_0.txtTagName.text = luaLang("versionactivity1_5_store_tag_" .. arg_5_0.groupId)
...
function var_0_0.refreshGoods(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.groupGoodsCoList) do
		...
		if not var_6_1 then
			var_6_1 = VersionActivity1_5StoreGoodsItem.New()
...
function var_0_0.sortGoods(arg_8_0, arg_8_1)
	local var_8_0 = arg_8_0.maxBuyCount ~= 0 and arg_8_0.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_5Enum.ActivityId.DungeonStore, arg_8_0.id) <= 0

	if var_8_0 ~= (arg_8_1.maxBuyCount ~= 0 and arg_8_1.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity1_5Enum.ActivityId.DungeonStore, arg_8_1.id) <= 0) then
		if var_8_0 then
			return false
		end
