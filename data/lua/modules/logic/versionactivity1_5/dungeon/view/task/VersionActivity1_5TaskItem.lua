...
slot0 = class("VersionActivity1_5TaskItem", ListScrollCell)
...
slot0.FinishKey = "VersionActivity1_5TaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity1_5Enum.ActivityId.Dungeon)
	else
