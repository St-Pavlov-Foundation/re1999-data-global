...
slot0 = class("VersionActivity1_5TaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity1_5TaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity1_5TaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
