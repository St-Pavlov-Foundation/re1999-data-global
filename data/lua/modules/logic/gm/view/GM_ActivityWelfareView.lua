...
slot0 = class("GM_ActivityWelfareView", BaseView)
slot1 = "#FFFF00"

function slot0.register()
	uv0.ActivityWelfareView_register(ActivityWelfareView)
	uv0.ActivityWelfareCategoryItem_register(ActivityWelfareCategoryItem)
end

function slot0.ActivityWelfareView_register(slot0)
...
function slot0.ActivityWelfareCategoryItem_register(slot0)
	GMMinusModel.instance:saveOriginalFunc(slot0, "_refreshItem")
	GMMinusModel.instance:saveOriginalFunc(slot0, "refreshSelect")
	...
	function slot0.refreshSelect(slot0, ...)
		GMMinusModel.instance:callOriginalSelfFunc(slot0, "refreshSelect", ...)

		if not uv0.s_ShowAllTabId then
			return
		end

		gohelper.setActive(slot0._gonewwelfare, false)
		gohelper.setActive(slot0._goselectwelfare, false)
...
function slot0._onItem1ToggleValueChanged(slot0)
	...
	GMController.instance:dispatchEvent(GMEvent.ActivityWelfareView_ShowAllTabIdUpdate, slot1)
end
