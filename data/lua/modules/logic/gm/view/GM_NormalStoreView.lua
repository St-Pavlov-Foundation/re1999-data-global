...
slot0 = class("GM_NormalStoreView", BaseView)
...
function slot0._onItem1ToggleValueChanged(slot0)
	...
	GMController.instance:dispatchEvent(GMEvent.NormalStoreView_ShowAllTabIdUpdate, slot1)
end

slot0.s_ShowAllGoodsId = false

function slot0._refreshItem2(slot0)
	slot0._item2Toggle.isOn = uv0.s_ShowAllGoodsId
end

function slot0._onItem2ToggleValueChanged(slot0)
	slot1 = slot0._item2Toggle.isOn
	uv0.s_ShowAllGoodsId = slot1

	GMController.instance:dispatchEvent(GMEvent.NormalStoreView_ShowAllGoodsIdUpdate, slot1)
end
