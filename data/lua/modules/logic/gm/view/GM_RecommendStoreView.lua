...
slot0 = class("GM_RecommendStoreView", BaseView)
...
function slot0._onItem1ToggleValueChanged(slot0)
	...
	GMController.instance:dispatchEvent(GMEvent.RecommendStore_ShowAllBannerUpdate, slot1)
end
...
function slot0._onItem2ToggleValueChanged(slot0)
	...
	GMController.instance:dispatchEvent(GMEvent.RecommendStore_ShowAllTabIdUpdate, slot1)
end
...
function slot0._onItem3ToggleValueChanged(slot0)
	...
	GMController.instance:dispatchEvent(GMEvent.RecommendStore_StopBannerLoopAnimUpdate, slot1)
end
