...
local var_0_0 = class("GM_SummonPoolHistoryView", BaseView)
local var_0_1 = "#00FF00"

function var_0_0.register()
	var_0_0.SummonPoolHistoryView_register(SummonPoolHistoryView)
	var_0_0.SummonPoolHistoryTypeItem_register(SummonPoolHistoryTypeItem)
end

function var_0_0.SummonPoolHistoryView_register(arg_2_0)
	...
	function arg_2_0.addEvents(arg_4_0, ...)
		...
		GM_SummonPoolHistoryViewContainer.addEvents(arg_4_0)
	end
	...
	function arg_2_0.removeEvents(arg_5_0, ...)
		...
		GM_SummonPoolHistoryViewContainer.removeEvents(arg_5_0)
	end
...
function var_0_0.SummonPoolHistoryTypeItem_register(arg_7_0)
	GMMinusModel.instance:saveOriginalFunc(arg_7_0, "onUpdateMO")

	function arg_7_0.onUpdateMO(arg_8_0, arg_8_1, ...)
		GMMinusModel.instance:callOriginalSelfFunc(arg_8_0, "onUpdateMO", arg_8_1, ...)
		...
		local var_8_1 = var_8_0.name .. gohelper.getRichColorText(var_8_0.id, var_0_1)

		arg_8_0._txtunname.text = var_8_1
...
function var_0_0._onItem1ToggleValueChanged(arg_15_0)
	...
	GMController.instance:dispatchEvent(GMEvent.SummonPoolHistoryView_ShowAllTabIdUpdate, var_15_0)
end
