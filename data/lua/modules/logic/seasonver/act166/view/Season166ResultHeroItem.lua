...
function slot0.init(slot0, slot1)
	...
	slot0._gostar1 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star1")
	slot0._gostar2 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star2")
	slot0._gostar3 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star3")
	slot0._gostar4 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star4")
	slot0._gostar5 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star5")
	slot0._gostar6 = gohelper.findChild(slot1, "heroitemani/hero/vertical/go_starList/#go_star6")
