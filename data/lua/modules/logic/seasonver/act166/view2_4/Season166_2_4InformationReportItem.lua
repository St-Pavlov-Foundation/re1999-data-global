...
local var_0_0 = class("Season166_2_4InformationReportItem", LuaCompBase)
...
function var_0_0.onClickItem(arg_3_0)
	...
	local var_3_1 = var_3_0 and var_3_0:getInformationMO(arg_3_0.infoId)
	local var_3_2 = {
		actId = arg_3_0.activityId,
		infoId = arg_3_0.infoId
	}
	local var_3_3 = var_3_1 and Season166Enum.UnlockState or Season166Enum.LockState

	var_3_2.unlockState = var_3_3

	ViewMgr.instance:openView(ViewName.Season166InformationAnalyView, var_3_2)

	arg_3_0.canShowNew = false

	Season166Controller.instance:dispatchEvent(Season166Event.ClickInfoReportItem, var_3_2)
	arg_3_0:refreshUnlockState(var_3_3)
end
