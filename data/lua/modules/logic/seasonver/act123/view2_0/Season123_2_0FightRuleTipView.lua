-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0FightRuleTipView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0FightRuleTipView", package.seeall)

local Season123_2_0FightRuleTipView = class("Season123_2_0FightRuleTipView", BaseView)

function Season123_2_0FightRuleTipView:onInitView()
...
function Season123_2_0FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season123_2_0FightRuleTipView:_closeView()
	self:closeThis()
end

function Season123_2_0FightRuleTipView:onOpen()
...
function Season123_2_0FightRuleTipView:createTab(go, tabType)
...
function Season123_2_0FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season123_2_0FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season123_2_0FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season123_2_0FightRuleTipView:switchTab(type)
...
function Season123_2_0FightRuleTipView:getTabActive(tabType)
...
function Season123_2_0FightRuleTipView:onClose()
	return
end

function Season123_2_0FightRuleTipView:onDestroyView()
...
return Season123_2_0FightRuleTipView
