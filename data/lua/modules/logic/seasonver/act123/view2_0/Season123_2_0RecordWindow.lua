-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0RecordWindow.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0RecordWindow", package.seeall)

local Season123_2_0RecordWindow = class("Season123_2_0RecordWindow", BaseView)
local CAN_DISPLAY_ITEM_COUNT = 5
local ITEM_DELAY_ACTIVE_INTERVAL_TIME = 0.06
local BLOCK_TIME_EXTEND = 0.2

function Season123_2_0RecordWindow:onInitView()
...
function Season123_2_0RecordWindow:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_0RecordWindow:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_0RecordWindow:_btncloseOnClick()
	self:onClickModalMask()
end

function Season123_2_0RecordWindow:onClickModalMask()
	self:closeThis()
end

function Season123_2_0RecordWindow:_editableInitView()
	gohelper.setActive(self._gorecorditem, false)
end

function Season123_2_0RecordWindow:onOpen()
	...
	if bestRecordDataList and #bestRecordDataList > 0 then
		local bestRecordItem = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobestrecorditem, Season123_2_0RecordWindowItem)
	...
	if normalRecordDataList and #normalRecordDataList > 0 then
		...
		gohelper.CreateObjList(self, self._onRecordItemLoad, normalRecordDataList, self._goContent, self._gorecorditem, Season123_2_0RecordWindowItem)
...
function Season123_2_0RecordWindow:_onRecordItemLoad(cellComponent, data, index)
	if not data then
		return
	end
...
function Season123_2_0RecordWindow:_onItemPlayAnimFinish()
	UIBlockMgr.instance:endBlock(self.viewName .. "itemPlayAnim")
end

function Season123_2_0RecordWindow:onClose()
	TaskDispatcher.cancelTask(self._onItemPlayAnimFinish, self)
	self:_onItemPlayAnimFinish()
end

function Season123_2_0RecordWindow:onDestroyView()
	return
end

return Season123_2_0RecordWindow
