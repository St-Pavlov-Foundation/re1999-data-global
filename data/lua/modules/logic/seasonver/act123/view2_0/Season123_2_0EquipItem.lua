...
local var_0_0 = class("Season123_2_0EquipItem", ListScrollCellExtend)
...
function var_0_0.checkCreateIcon(arg_11_0)
	if not arg_11_0.icon then
		...
		arg_11_0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_11_1, Season123_2_0CelebrityCardEquip)
