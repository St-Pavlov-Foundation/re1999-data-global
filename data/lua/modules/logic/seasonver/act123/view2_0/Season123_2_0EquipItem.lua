-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EquipItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EquipItem", package.seeall)

local Season123_2_0EquipItem = class("Season123_2_0EquipItem", ListScrollCellExtend)

function Season123_2_0EquipItem:init(go)
	Season123_2_0EquipItem.super.init(self, go)
...
function Season123_2_0EquipItem:addEvents()
	return
end

function Season123_2_0EquipItem:removeEvents()
	return
end

function Season123_2_0EquipItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_2_0EquipItem.ColumnCount = 6
Season123_2_0EquipItem.AnimRowCount = 4
Season123_2_0EquipItem.OpenAnimTime = 0.06
Season123_2_0EquipItem.OpenAnimStartTime = 0.05

function Season123_2_0EquipItem:checkPlayAnim()
...
function Season123_2_0EquipItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_0EquipItem:refreshUI()
...
function Season123_2_0EquipItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_2_0EquipItem:refreshEquipedHero(heroUid)
...
function Season123_2_0EquipItem:refreshIcon(itemId, itemUid)
...
function Season123_2_0EquipItem:checkCreateIcon()
...
function Season123_2_0EquipItem:setRoleIconDark(value)
	if value then
...
function Season123_2_0EquipItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_2_0EquipItem:checkClickNew(itemUid)
...
Season123_2_0EquipItem.Toast_Same_Card = 2851
Season123_2_0EquipItem.Toast_Wrong_Type = 2852
Season123_2_0EquipItem.Toast_MainRole_Wrong_Type = 2854
Season123_2_0EquipItem.Toast_Other_Hero_Equiped = 2853
Season123_2_0EquipItem.Toast_Career_Wrong = 2859
Season123_2_0EquipItem.Toast_Slot_Lock = 67
Season123_2_0EquipItem.Toast_Pos_Wrong = 70501

function Season123_2_0EquipItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipItemListModel.instance:slotIsLock(Season123EquipItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_2_0EquipItem.Toast_Slot_Lock)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipItemListModel.instance.curPos == Season123EquipItemListModel.MainCharPos then
				GameFacade.showToast(Season123_2_0EquipItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_2_0EquipItem.Toast_Wrong_Type)
			end
		...
		if isCareerWrong then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Career_Wrong)
		...
		if isPosWrong then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, tarPosStr)
...
function Season123_2_0EquipItem:onDestroyView()
	if self.icon then
