...
slot0 = class("Season123_2_0SettlementHeroItem", BaseViewExtended)
...
function slot0._showEquip123(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:openSubView(Season123_2_0CelebrityCardGetItem, Season123_2_0CelebrityCardItem.AssetPath, slot3 <= 1 and slot0._gosingle or slot0["_gocard" .. slot1], slot2, nil, slot4)
end
