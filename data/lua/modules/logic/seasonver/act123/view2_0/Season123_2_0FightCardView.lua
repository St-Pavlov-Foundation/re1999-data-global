...
slot0 = class("Season123_2_0FightCardView", BaseView)
...
function slot0.createItem(slot0, slot1)
	slot3 = Season123_2_0FightCardItem.New(gohelper.cloneInPlace(slot0._goCardItem, string.format("card%s", slot1)))
