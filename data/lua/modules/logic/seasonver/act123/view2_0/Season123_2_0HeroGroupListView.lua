...
slot0 = class("Season123_2_0HeroGroupListView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	for slot4 = 1, 4 do
		...
		table.insert(slot0._heroItemList, MonoHelper.addNoUpdateLuaComOnceToGo(slot7, Season123_2_0HeroGroupHeroItem, slot0))
...
function slot0._onEndDrag(slot0, slot1, slot2)
	...
	if not slot11 or not slot13 then
		...
		if not slot11 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, slot12)
		end

		if not slot13 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, slot14)
		end
