...
local var_0_0 = class("Season123_2_0HeroGroupListView", BaseView)
...
function var_0_0._editableInitView(arg_2_0)
	...
	for iter_2_0 = 1, 4 do
		...
		local var_2_2 = MonoHelper.addNoUpdateLuaComOnceToGo(var_2_1, Season123_2_0HeroGroupHeroItem, arg_2_0)
...
function var_0_0._onEndDrag(arg_14_0, arg_14_1, arg_14_2)
	...
	if not var_14_11 or not var_14_13 then
		...
		if not var_14_11 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, var_14_12)
		end

		if not var_14_13 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, var_14_14)
		end
