-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0BatchDecomposeViewContainer.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0BatchDecomposeViewContainer", package.seeall)

local Season123_2_0BatchDecomposeViewContainer = class("Season123_2_0BatchDecomposeViewContainer", BaseViewContainer)

function Season123_2_0BatchDecomposeViewContainer:buildViews()
...
function Season123_2_0BatchDecomposeViewContainer:createEquipItemsParam()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "left_container/#go_scrollcontainer/#scroll_equip"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_2_0DecomposeItem
...
function Season123_2_0BatchDecomposeViewContainer:buildTabViews(tabContainerId)
...
function Season123_2_0BatchDecomposeViewContainer:getLineCount()
...
function Season123_2_0BatchDecomposeViewContainer:playCloseTransition()
...
function Season123_2_0BatchDecomposeViewContainer:onCloseAnimDone()
	self:onPlayCloseTransitionFinish()
end

return Season123_2_0BatchDecomposeViewContainer
