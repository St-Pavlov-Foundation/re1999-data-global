-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0SettlementTipsWork.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0SettlementTipsWork", package.seeall)

local Season123_2_0SettlementTipsWork = class("Season123_2_0SettlementTipsWork", BaseWork)

function Season123_2_0SettlementTipsWork:onStart(context)
...
function Season123_2_0SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season123_2_0SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season123_2_0SettlementTipsWork:_showGetCardView()
...
function Season123_2_0SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season123_2_0SettlementTipsWork
