...
function var_0_0.refreshSkills(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	for iter_15_2, iter_15_3 in ipairs(var_15_3) do
		local var_15_4 = arg_15_0:getOrCreateSkillText(iter_15_2, arg_15_2)

		gohelper.setActive(var_15_4.go, true)

		iter_15_3 = HeroSkillModel.instance:skillDesToSpot(iter_15_3)
		var_15_4.txtDesc.text = SkillHelper.addLink(iter_15_3)

		SLFramework.UGUI.GuiHelper.SetColor(var_15_4.txtDesc, arg_15_3)
		SkillHelper.addHyperLinkClick(var_15_4.txtDesc, arg_15_0.setSkillClickCallBack, arg_15_0)

		var_15_1[var_15_4] = true
	end

	for iter_15_4, iter_15_5 in pairs(arg_15_2.skillItems) do
		if not var_15_1[iter_15_5] then
			gohelper.setActive(iter_15_5.go, false)
		end
	end
end
