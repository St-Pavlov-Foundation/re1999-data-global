...
function slot0.refreshSkills(slot0, slot1, slot2, slot3)
	...
	for slot10, slot11 in ipairs(Season123EquipMetaUtils.getSkillEffectStrList(slot1)) do
	...
	for slot10, slot11 in ipairs(slot6) do
		slot12 = slot0:getOrCreateSkillText(slot10, slot2)

		gohelper.setActive(slot12.go, true)

		slot12.txtDesc.text = SkillHelper.addLink(HeroSkillModel.instance:skillDesToSpot(slot11))

		SLFramework.UGUI.GuiHelper.SetColor(slot12.txtDesc, slot3)
		SkillHelper.addHyperLinkClick(slot12.txtDesc, slot0.setSkillClickCallBack, slot0)

		slot5[slot12] = true
	end

	for slot10, slot11 in pairs(slot2.skillItems) do
