-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0RetailViewContainer.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0RetailViewContainer", package.seeall)

local Season123_2_0RetailViewContainer = class("Season123_2_0RetailViewContainer", BaseViewContainer)

function Season123_2_0RetailViewContainer:buildViews()
	return {
...
function Season123_2_0RetailViewContainer:buildTabViews(tabContainerId)
...
function Season123_2_0RetailViewContainer:buildCurrency()
...
function Season123_2_0RetailViewContainer:refreshCurrencyType()
...
return Season123_2_0RetailViewContainer
