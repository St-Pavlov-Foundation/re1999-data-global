...
slot0 = class("Season123_2_0CelebrityCardItem", LuaCompBase)
slot0.AssetPath = "ui/viewres/seasonver/v2a0_act123/season123celebritycarditem.prefab"
...
function slot0.handleCardLoaded(slot0)
	...
	slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._cardGo, Season123_2_0CelebrityCardEquip)
