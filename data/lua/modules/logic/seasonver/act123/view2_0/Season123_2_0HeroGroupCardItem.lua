...
local var_0_0 = class("Season123_2_0HeroGroupCardItem", UserDataDispose)
	...
	if arg_6_0.posUnlock then
		...
		if var_6_3 ~= nil and var_6_3 ~= 0 then
			if not arg_6_0._seasonCardItem then
				arg_6_0._seasonCardItem = Season123_2_0CelebrityCardItem.New()
...
function var_0_0.canExchange(arg_20_0, arg_20_1)
	...
	if var_20_16 or var_20_18 then
		if var_20_16 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, var_20_17)
		end

		if var_20_18 then
			GameFacade.showToast(Season123_2_0EquipItem.Toast_Pos_Wrong, var_20_19)
		end
