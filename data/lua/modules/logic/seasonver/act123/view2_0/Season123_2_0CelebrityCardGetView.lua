-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0CelebrityCardGetView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0CelebrityCardGetView", package.seeall)

local Season123_2_0CelebrityCardGetView = class("Season123_2_0CelebrityCardGetView", BaseViewExtended)

Season123_2_0CelebrityCardGetView.OpenType = {
	Get = 1
}

function Season123_2_0CelebrityCardGetView:onInitView()
...
function Season123_2_0CelebrityCardGetView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_0CelebrityCardGetView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_0CelebrityCardGetView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_0CelebrityCardGetView:onOpen()
...
function Season123_2_0CelebrityCardGetView:_showGetCard()
	self:com_loadAsset(Season123_2_0CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season123_2_0CelebrityCardGetView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season123_2_0CelebrityCardGetScrollItem)
...
function Season123_2_0CelebrityCardGetView:isItemID()
	return self.viewParam.is_item_id
end

function Season123_2_0CelebrityCardGetView:onClose()
	return
end

return Season123_2_0CelebrityCardGetView
