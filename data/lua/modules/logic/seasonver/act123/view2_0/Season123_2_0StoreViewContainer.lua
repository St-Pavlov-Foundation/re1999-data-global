...
slot0 = class("Season123_2_0StoreViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	table.insert(slot1, Season123_2_0StoreView.New())
...
function slot0.buildTabViews(slot0, slot1)
	...
	if slot1 == 2 then
		slot4 = CurrencyView.New({
			Season123Config.instance:getSeasonConstNum(Season123Model.instance:getCurSeasonId() or VersionActivity2_0Enum.ActivityId.Season, Activity123Enum.Const.StoreCoinId)
		})
...
function slot0.buildScrollViews(slot0)
	...
	slot1.cellClass = Season123_2_0StoreItem
