...
slot0 = class("Season123_2_0CardPackageViewContainer", BaseViewContainer)
...
function slot0.buildTabViews(slot0, slot1)
	if slot1 == 1 then
		...
		slot2:setHelpId(HelpEnum.HelpId.Season2_0CardGetViewHelp)
		slot2:hideHelpIcon()
...
function slot0.buildScrollViews(slot0)
	...
	slot1.cellClass = Season123_2_0CardPackageItem
