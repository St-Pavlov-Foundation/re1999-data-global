...
local var_0_0 = class("Season123_2_0DecomposeItem", ListScrollCellExtend)
...
function var_0_0.checkCreateIcon(arg_9_0)
	if not arg_9_0.icon then
		...
		arg_9_0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_9_1, Season123_2_0CelebrityCardEquip)
