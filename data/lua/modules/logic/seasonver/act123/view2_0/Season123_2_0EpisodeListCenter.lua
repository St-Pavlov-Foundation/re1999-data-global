-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EpisodeListCenter.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EpisodeListCenter", package.seeall)

local Season123_2_0EpisodeListCenter = class("Season123_2_0EpisodeListCenter", UserDataDispose)

function Season123_2_0EpisodeListCenter:ctor()
	self:__onInit()
end

function Season123_2_0EpisodeListCenter:dispose()
	self:__onDispose()
end

function Season123_2_0EpisodeListCenter:init(viewGO)
	self.viewGO = viewGO

	self:initComponent()
end

function Season123_2_0EpisodeListCenter:initComponent()
...
function Season123_2_0EpisodeListCenter:initData(actId, stage)
	self._actId = actId
	self._stageId = stage
end

function Season123_2_0EpisodeListCenter:refreshUI()
...
function Season123_2_0EpisodeListCenter:refreshRound()
...
Season123_2_0EpisodeListCenter.NoStarTimeAnchorY = -176
Season123_2_0EpisodeListCenter.WithStarTimeAnchorY = -86

function Season123_2_0EpisodeListCenter:refreshProgress()
	...
	if isShowStar then
		recthelper.setAnchorY(self._tftime, Season123_2_0EpisodeListCenter.WithStarTimeAnchorY)
	else
		recthelper.setAnchorY(self._tftime, Season123_2_0EpisodeListCenter.NoStarTimeAnchorY)
	end
end

return Season123_2_0EpisodeListCenter
