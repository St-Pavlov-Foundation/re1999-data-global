...
local var_0_0 = class("Season123_2_0TaskItem", ListScrollCell)

var_0_0.BlockKey = "Season123_2_0TaskItemAni"
...
function var_0_0.refreshRewardItem(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_2.equipId then
		...
		if not arg_13_1.equipIcon then
			arg_13_1.equipIcon = Season123_2_0CelebrityCardItem.New()
