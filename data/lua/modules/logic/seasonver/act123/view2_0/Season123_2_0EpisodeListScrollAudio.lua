...
slot0 = class("Season123_2_0EpisodeListScrollAudio", LuaCompBase)

function slot0.ctor(slot0, slot1)
	slot0.scroll = slot1
	slot0._contentWidth = recthelper.getHeight(slot0.scroll.content)
...
function slot0.onUpdate(slot0)
	if slot0.scroll and not slot0._isDisposed then
		slot1 = nil
		slot1 = recthelper.getAnchorY(slot0.scroll.content) * slot0._pixelOffsetMoveFactor
...
function slot0._onValueChangeForStartOrStop(slot0, slot1)
	if slot0._scrollingPlayY and slot0._scrollAudioStopTime then
		if slot0._intervalSampleStop < Time.realtimeSinceStartup - slot0._scrollAudioStopTime then
			slot3 = math.abs(slot1 - slot0._scrollingPlayY)
