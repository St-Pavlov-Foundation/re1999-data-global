-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0PickHeroItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0PickHeroItem", package.seeall)

local Season123_2_0PickHeroItem = class("Season123_2_0PickHeroItem", ListScrollCell)

function Season123_2_0PickHeroItem:init(go)
...
function Season123_2_0PickHeroItem:initHeroItem(go)
...
function Season123_2_0PickHeroItem:addEventListeners()
	return
end

function Season123_2_0PickHeroItem:removeEventListeners()
	return
end

function Season123_2_0PickHeroItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_0PickHeroItem:onItemClick()
...
function Season123_2_0PickHeroItem:onDestroy()
...
function Season123_2_0PickHeroItem:getAnimator()
	return self._animator
end

return Season123_2_0PickHeroItem
