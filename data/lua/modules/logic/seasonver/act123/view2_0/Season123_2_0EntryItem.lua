-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EntryItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EntryItem", package.seeall)

local Season123_2_0EntryItem = class("Season123_2_0EntryItem", UserDataDispose)

function Season123_2_0EntryItem:ctor()
	self:__onInit()
end

function Season123_2_0EntryItem:dispose()
	TaskDispatcher.cancelTask(self._enterEpiosdeList, self)
	self:removeEvents()
	self:__onDispose()
end

function Season123_2_0EntryItem:init(viewGO, animator)
	self.viewGO = viewGO
	self.anim = animator
...
function Season123_2_0EntryItem:initComponent()
...
function Season123_2_0EntryItem:removeEvents()
...
function Season123_2_0EntryItem:initData(actId)
	self._actId = actId

	self:refreshUI()
end

function Season123_2_0EntryItem:refreshUI()
...
function Season123_2_0EntryItem:refreshRound()
...
function Season123_2_0EntryItem:refreshLock()
...
function Season123_2_0EntryItem:refreshProgress()
...
function Season123_2_0EntryItem:refreshNew()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_0EntryItem:refreshRecordBtn()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_0EntryItem:refreshLockRepeat()
	self:refreshLock()
	self:refreshProgress()
end

function Season123_2_0EntryItem:_btnentranceOnClick()
...
function Season123_2_0EntryItem:_enterEpiosdeList()
...
function Season123_2_0EntryItem:_btnrecordsOnClick()
	Season123EntryController.instance:openStageRecords(self._stageId)
end

return Season123_2_0EntryItem
