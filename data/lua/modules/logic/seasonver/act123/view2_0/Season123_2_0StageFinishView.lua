-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0StageFinishView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0StageFinishView", package.seeall)

local Season123_2_0StageFinishView = class("Season123_2_0StageFinishView", BaseView)

function Season123_2_0StageFinishView:onInitView()
...
function Season123_2_0StageFinishView:addEvents()
	return
end

function Season123_2_0StageFinishView:removeEvents()
	return
end

function Season123_2_0StageFinishView:_editableInitView()
...
function Season123_2_0StageFinishView:onDestroyView()
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_2_0StageFinishView:onOpen()
...
function Season123_2_0StageFinishView:onClose()
	TaskDispatcher.cancelTask(self.lightStar, self)
	TaskDispatcher.cancelTask(self.light, self)
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_2_0StageFinishView:refreshUI()
...
function Season123_2_0StageFinishView:handleDelayAnimTransition()
...
function Season123_2_0StageFinishView:lightStar()
...
function Season123_2_0StageFinishView:light()
...
function Season123_2_0StageFinishView:firstPassStage(actId, stage)
...
function Season123_2_0StageFinishView:setAlreadyPass(actId, stage)
	local key = self:getPassKey(actId, stage)
...
function Season123_2_0StageFinishView:getPassKey(actId, stage)
	return "FirstPassStage" .. tostring(self.userId) .. "#" .. tostring(actId) .. tostring(stage)
end

return Season123_2_0StageFinishView
