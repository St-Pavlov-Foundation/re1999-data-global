-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0AdditionRuleTipView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0AdditionRuleTipView", package.seeall)

local Season123_2_0AdditionRuleTipView = class("Season123_2_0AdditionRuleTipView", BaseView)

function Season123_2_0AdditionRuleTipView:onInitView()
...
function Season123_2_0AdditionRuleTipView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_0AdditionRuleTipView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_0AdditionRuleTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_0AdditionRuleTipView:onOpen()
...
function Season123_2_0AdditionRuleTipView:getOrCreateItem(index)
...
function Season123_2_0AdditionRuleTipView:updateItem(item, ruleId)
	if not ruleId then
...
function Season123_2_0AdditionRuleTipView:onClose()
	return
end

return Season123_2_0AdditionRuleTipView
