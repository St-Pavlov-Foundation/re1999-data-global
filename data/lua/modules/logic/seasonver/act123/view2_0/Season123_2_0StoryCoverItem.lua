-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0StoryCoverItem.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0StoryCoverItem", package.seeall)

local Season123_2_0StoryCoverItem = class("Season123_2_0StoryCoverItem", LuaCompBase)

function Season123_2_0StoryCoverItem:ctor(param)
	self.param = param
end

function Season123_2_0StoryCoverItem:init(go)
	self:__onInit()
...
function Season123_2_0StoryCoverItem:addEventListeners()
	self.btnClick:AddClickListener(self.onClickCoverItem, self)
end

function Season123_2_0StoryCoverItem:removeEventListeners()
	self.btnClick:RemoveClickListener()
end

Season123_2_0StoryCoverItem.unlockDelayTime = 1.16

function Season123_2_0StoryCoverItem:refreshItem()
...
function Season123_2_0StoryCoverItem:onClickCoverItem()
...
function Season123_2_0StoryCoverItem:refreshUnlockState(unlockState)
	if self.isUnlock and self.isUnlock ~= unlockState then
		...
		TaskDispatcher.runDelay(self.playUnlockAnim, self, Season123_2_0StoryCoverItem.unlockDelayTime)
...
function Season123_2_0StoryCoverItem:playUnlockAnim()
...
function Season123_2_0StoryCoverItem:onUnlockAnimDone()
	gohelper.setActive(self.goLocked, not self.isUnlock)
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
end

function Season123_2_0StoryCoverItem:destroy()
	self:__onDispose()
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
	TaskDispatcher.cancelTask(self.playUnlockAnim, self)
end

return Season123_2_0StoryCoverItem
