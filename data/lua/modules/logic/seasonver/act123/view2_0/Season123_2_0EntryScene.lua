...
slot0 = class("Season123_2_0EntryScene", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._cameraHelper = Season123_2_0EntryCamera.New()

	slot0._cameraHelper:init()

	slot0._loadHelper = Season123_2_0EntryLoadScene.New()
...
function slot0.onSceneResLoaded(slot0, slot1)
	...
	slot0._dragHelper = Season123_2_0EntryDrag.New()
