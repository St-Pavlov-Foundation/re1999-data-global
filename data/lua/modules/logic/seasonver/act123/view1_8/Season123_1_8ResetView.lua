...
slot0 = class("Season123_1_8ResetView", BaseView)
...
function slot0.delayInitScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollchapter, Season123_1_8ResetViewAudio, slot0._scrollchapter)
