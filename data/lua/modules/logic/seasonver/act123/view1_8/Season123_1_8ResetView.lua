...
local var_0_0 = class("Season123_1_8ResetView", BaseView)
...
function var_0_0.refreshSingleItemFinished(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	if var_13_1 then
		local var_13_3 = Season123Controller.instance:isReduceRound(arg_13_0.viewParam.actId, arg_13_0.viewParam.stage, arg_13_3.cfg.layer) and "<color=#eecd8c>%s</color>" or "%s"

		arg_13_2.txttime.text = string.format(var_13_3, tostring(arg_13_3.round))
	end
...
function var_0_0.delayInitScrollAudio(arg_20_0)
	arg_20_0._audioScroll = MonoHelper.addLuaComOnceToGo(arg_20_0._goscrollchapter, Season123_1_8ResetViewAudio, arg_20_0._scrollchapter)
