-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8CelebrityCardItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8CelebrityCardItem", package.seeall)

local Season123_1_8CelebrityCardItem = class("Season123_1_8CelebrityCardItem", LuaCompBase)

Season123_1_8CelebrityCardItem.AssetPath = "ui/viewres/seasonver/v1a8_act123/season123celebritycarditem.prefab"

function Season123_1_8CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season123_1_8CelebrityCardItem.AssetPath
...
function Season123_1_8CelebrityCardItem:handleCardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season123_1_8CelebrityCardEquip)
...
function Season123_1_8CelebrityCardItem:showTag(enable)
...
function Season123_1_8CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season123_1_8CelebrityCardItem:showNewFlag(enable)
...
function Season123_1_8CelebrityCardItem:showNewFlag2(enable)
...
function Season123_1_8CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season123_1_8CelebrityCardItem:setColorDark(enable)
...
function Season123_1_8CelebrityCardItem:destroy()
	if self._icon then
...
return Season123_1_8CelebrityCardItem
