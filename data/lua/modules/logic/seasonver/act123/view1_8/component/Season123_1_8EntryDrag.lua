...
local var_0_0 = class("Season123_1_8EntryDrag", UserDataDispose)
...
function var_0_0.initBound(arg_3_0)
	arg_3_0._mapSize = gohelper.findChild(arg_3_0._sceneGo, "root/m_s15_size"):GetComponentInChildren(typeof(UnityEngine.BoxCollider)).size
