...
slot0 = class("Season123_1_8EntryCamera", UserDataDispose)
...
function slot0.dispose(slot0)
	slot0:killTween()
	slot0:__onDispose()
	MainCameraMgr.instance:addView(ViewName.Season123_1_8EntryView, nil, , )
end
...
function slot0.initCamera(slot0)
	...
	MainCameraMgr.instance:addView(ViewName.Season123_1_8EntryView, slot0.onScreenResize, slot0.resetCamera, slot0)
