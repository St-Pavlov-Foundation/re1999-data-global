-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EntryItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EntryItem", package.seeall)

local Season123_1_8EntryItem = class("Season123_1_8EntryItem", UserDataDispose)

function Season123_1_8EntryItem:ctor()
	self:__onInit()
end

function Season123_1_8EntryItem:dispose()
	TaskDispatcher.cancelTask(self._enterEpiosdeList, self)
	self:removeEvents()
	self:__onDispose()
end

function Season123_1_8EntryItem:init(viewGO, animator)
	self.viewGO = viewGO
	self.anim = animator
...
function Season123_1_8EntryItem:initComponent()
...
function Season123_1_8EntryItem:removeEvents()
...
function Season123_1_8EntryItem:initData(actId)
	self._actId = actId

	self:refreshUI()
end

function Season123_1_8EntryItem:refreshUI()
...
function Season123_1_8EntryItem:refreshRound()
...
function Season123_1_8EntryItem:refreshLock()
...
function Season123_1_8EntryItem:refreshProgress()
...
function Season123_1_8EntryItem:refreshNew()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_1_8EntryItem:refreshRecordBtn()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_1_8EntryItem:refreshLockRepeat()
	self:refreshLock()
	self:refreshProgress()
end

function Season123_1_8EntryItem:_btnentranceOnClick()
...
function Season123_1_8EntryItem:_enterEpiosdeList()
...
function Season123_1_8EntryItem:_btnrecordsOnClick()
	Season123EntryController.instance:openStageRecords(self._stageId)
end

return Season123_1_8EntryItem
