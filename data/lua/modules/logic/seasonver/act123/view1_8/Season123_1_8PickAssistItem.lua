-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8PickAssistItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8PickAssistItem", package.seeall)

local Season123_1_8PickAssistItem = class("Season123_1_8PickAssistItem", ListScrollCellExtend)

function Season123_1_8PickAssistItem:onInitView()
...
function Season123_1_8PickAssistItem:addEvents()
	self._btnHeroDetail:AddClickListener(self._onHeroDetailClick, self)
end

function Season123_1_8PickAssistItem:removeEvents()
	self._btnHeroDetail:RemoveClickListener()
end

function Season123_1_8PickAssistItem:_onHeroItemClick()
...
function Season123_1_8PickAssistItem:initHeroItem()
...
function Season123_1_8PickAssistItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_1_8PickAssistItem:setSelected(isSelected)
	gohelper.setActive(self.goSelected, isSelected)
end

function Season123_1_8PickAssistItem:onDestroy()
...
function Season123_1_8PickAssistItem:getAnimator()
	return self._animator
end

return Season123_1_8PickAssistItem
