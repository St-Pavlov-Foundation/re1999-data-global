...
local var_0_0 = class("Season123_1_8RecordWindow", BaseView)
local var_0_1 = 5
local var_0_2 = 0.06
local var_0_3 = 0.2
...
function var_0_0.onOpen(arg_7_0)
	...
	if var_7_0 and #var_7_0 > 0 then
		MonoHelper.addNoUpdateLuaComOnceToGo(arg_7_0._gobestrecorditem, Season123_1_8RecordWindowItem):onUpdateMO(var_7_0[1])
	...
	if var_7_1 and #var_7_1 > 0 then
		...
		gohelper.CreateObjList(arg_7_0, arg_7_0._onRecordItemLoad, var_7_1, arg_7_0._goContent, arg_7_0._gorecorditem, Season123_1_8RecordWindowItem)
