-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8RecordWindow.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8RecordWindow", package.seeall)

local Season123_1_8RecordWindow = class("Season123_1_8RecordWindow", BaseView)
local CAN_DISPLAY_ITEM_COUNT = 5
local ITEM_DELAY_ACTIVE_INTERVAL_TIME = 0.06
local BLOCK_TIME_EXTEND = 0.2

function Season123_1_8RecordWindow:onInitView()
...
function Season123_1_8RecordWindow:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_1_8RecordWindow:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_1_8RecordWindow:_btncloseOnClick()
	self:onClickModalMask()
end

function Season123_1_8RecordWindow:onClickModalMask()
	self:closeThis()
end

function Season123_1_8RecordWindow:_editableInitView()
	gohelper.setActive(self._gorecorditem, false)
end

function Season123_1_8RecordWindow:onOpen()
	...
	if bestRecordDataList and #bestRecordDataList > 0 then
		local bestRecordItem = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobestrecorditem, Season123_1_8RecordWindowItem)
	...
	if normalRecordDataList and #normalRecordDataList > 0 then
		...
		gohelper.CreateObjList(self, self._onRecordItemLoad, normalRecordDataList, self._goContent, self._gorecorditem, Season123_1_8RecordWindowItem)
...
function Season123_1_8RecordWindow:_onRecordItemLoad(cellComponent, data, index)
	if not data then
		return
	end
...
function Season123_1_8RecordWindow:_onItemPlayAnimFinish()
	UIBlockMgr.instance:endBlock(self.viewName .. "itemPlayAnim")
end

function Season123_1_8RecordWindow:onClose()
	TaskDispatcher.cancelTask(self._onItemPlayAnimFinish, self)
	self:_onItemPlayAnimFinish()
end

function Season123_1_8RecordWindow:onDestroyView()
	return
end

return Season123_1_8RecordWindow
