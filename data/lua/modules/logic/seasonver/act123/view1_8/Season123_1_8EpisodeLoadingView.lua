-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeLoadingView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeLoadingView", package.seeall)

local Season123_1_8EpisodeLoadingView = class("Season123_1_8EpisodeLoadingView", BaseView)

function Season123_1_8EpisodeLoadingView:onInitView()
...
function Season123_1_8EpisodeLoadingView:addEvents()
	return
end

function Season123_1_8EpisodeLoadingView:removeEvents()
	return
end

function Season123_1_8EpisodeLoadingView:_editableInitView()
	self._stageItems = {}
end

function Season123_1_8EpisodeLoadingView:onDestroyView()
...
function Season123_1_8EpisodeLoadingView:onOpen()
	local actId = self.viewParam.actId
	local stage = self.viewParam.stage
	local layer = self.viewParam.layer

	logNormal(string.format("Season123_1_8EpisodeLoadingView actId=%s, stage=%s", actId, stage))
...
function Season123_1_8EpisodeLoadingView:onClose()
	return
end

function Season123_1_8EpisodeLoadingView:refreshUI()
	self:refreshStageList()
end

function Season123_1_8EpisodeLoadingView:refreshStageList()
...
function Season123_1_8EpisodeLoadingView:getOrCreateStageItem(index)
...
function Season123_1_8EpisodeLoadingView:refreshSingleItem(index, item, data)
...
function Season123_1_8EpisodeLoadingView:refreshSingleItemLock(index, item, data)
	if data.emptyIndex then
...
function Season123_1_8EpisodeLoadingView:refreshSingleItemFinished(index, item, data)
	if data.emptyIndex then
