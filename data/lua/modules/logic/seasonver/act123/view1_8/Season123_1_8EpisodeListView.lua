...
slot0 = class("Season123_1_8EpisodeListView", BaseView)
...
function slot0.initCenter(slot0)
	slot0._centerItem = Season123_1_8EpisodeListCenter.New()
...
slot0.SCROLL_ANIM_BLOCK_KEY = "Season123_1_8EpisodeListView_scrollanim"
...
function slot0.onCloseView(slot0, slot1)
	if slot1 == ViewName.Season123_1_8EpisodeDetailView then
		slot0:refreshStageList()
...
function slot0.delayAddScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollstory, Season123_1_8EpisodeListScrollAudio, slot0._scrollStory)
