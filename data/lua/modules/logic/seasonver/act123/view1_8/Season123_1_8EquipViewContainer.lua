...
local var_0_0 = class("Season123_1_8EquipViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	local var_1_0 = arg_1_0:createEquipItemsParam()
	local var_1_1 = Season123_1_8EquipTagSelect.New()

	var_1_1:init(Season123EquipController.instance, "right/#drop_filter")

	return {
		Season123_1_8EquipView.New(),
		Season123_1_8EquipSpineView.New(),
		var_1_1,
		LuaListScrollView.New(Season123EquipItemListModel.instance, var_1_0),
...
function var_0_0.createEquipItemsParam(arg_2_0)
	...
	var_2_0.cellClass = Season123_1_8EquipItem
	var_2_0.scrollDir = ScrollEnum.ScrollDirV
	var_2_0.lineCount = Season123_1_8EquipItem.ColumnCount
	var_2_0.cellWidth = 170
	var_2_0.cellHeight = 235
	var_2_0.cellSpaceH = 8.4
	var_2_0.cellSpaceV = 0
	var_2_0.frameUpdateMs = 100
	var_2_0.minUpdateCountInFrame = Season123_1_8EquipItem.ColumnCount
