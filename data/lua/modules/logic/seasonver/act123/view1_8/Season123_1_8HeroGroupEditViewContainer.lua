...
slot0 = class("Season123_1_8HeroGroupEditViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = Season123_1_8HeroGroupEditItem
...
function slot0.getQuickEditScroll(slot0)
	...
	slot1.cellClass = Season123_1_8HeroGroupQuickEditItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = 5
	slot1.cellWidth = 200
	slot1.cellHeight = 472
