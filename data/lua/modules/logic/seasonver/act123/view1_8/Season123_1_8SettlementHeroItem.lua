...
slot0 = class("Season123_1_8SettlementHeroItem", BaseViewExtended)
...
function slot0._showHeroIcon(slot0, slot1, slot2)
	...
	elseif (FightEntityModel.instance:getById(slot1) or FightEntityModel.instance:getDeadById(slot1)) and lua_monster.configDict[slot5.modelId] then
...
function slot0._showEquip123(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, slot3 <= 1 and slot0._gosingle or slot0["_gocard" .. slot1], slot2, nil, slot4)
end
