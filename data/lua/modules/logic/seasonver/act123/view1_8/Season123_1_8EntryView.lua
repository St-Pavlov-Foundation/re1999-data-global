...
local var_0_0 = class("Season123_1_8EntryView", BaseView)
...
function var_0_0.checkSceneLoaded(arg_22_0)
	...
	if gohelper.findChild(var_22_0, "Season123_1_8EntryScene/scene") then
		gohelper.setActive(arg_22_0._goentranceitem, true)

		arg_22_0._centerItem = Season123_1_8EntryItem.New()
...
function var_0_0.onCloseView(arg_34_0, arg_34_1)
	if arg_34_1 == ViewName.Season123_1_8EpisodeListView then
		arg_34_0._anim:Play(var_0_0.Anim.Switch1, 0, 0)
	end

	if arg_34_1 == ViewName.Season123_1_8RetailView then
		arg_34_0._anim:Play(var_0_0.Anim.Switch, 0, 0)
	end

	if arg_34_1 == ViewName.Season123_1_8StoryPagePopView then
		arg_34_0._anim:Play(var_0_0.Anim.Switch, 0, 0)
