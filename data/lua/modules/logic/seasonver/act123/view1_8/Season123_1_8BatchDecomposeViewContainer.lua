-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8BatchDecomposeViewContainer.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8BatchDecomposeViewContainer", package.seeall)

local Season123_1_8BatchDecomposeViewContainer = class("Season123_1_8BatchDecomposeViewContainer", BaseViewContainer)

function Season123_1_8BatchDecomposeViewContainer:buildViews()
	self:createEquipItemsParam()

	return {
		Season123_1_8BatchDecomposeView.New(),
		self.scrollView,
...
function Season123_1_8BatchDecomposeViewContainer:createEquipItemsParam()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "left_container/#go_scrollcontainer/#scroll_equip"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_1_8DecomposeItem
...
function Season123_1_8BatchDecomposeViewContainer:buildTabViews(tabContainerId)
...
function Season123_1_8BatchDecomposeViewContainer:getLineCount()
...
function Season123_1_8BatchDecomposeViewContainer:playCloseTransition()
...
function Season123_1_8BatchDecomposeViewContainer:onCloseAnimDone()
	self:onPlayCloseTransitionFinish()
end

return Season123_1_8BatchDecomposeViewContainer
