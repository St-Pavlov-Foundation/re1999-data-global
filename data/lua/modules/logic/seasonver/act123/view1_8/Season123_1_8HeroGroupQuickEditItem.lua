-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupQuickEditItem", package.seeall)

local Season123_1_8HeroGroupQuickEditItem = class("Season123_1_8HeroGroupQuickEditItem", Season123_1_8HeroGroupEditItem)

function Season123_1_8HeroGroupQuickEditItem:init(go)
	Season123_1_8HeroGroupQuickEditItem.super.init(self, go)
...
function Season123_1_8HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_1_8HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123_1_8HeroGroupQuickEditItem:_onItemClick()
...
function Season123_1_8HeroGroupQuickEditItem:onSelect(select)
...
function Season123_1_8HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123_1_8HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123_1_8HeroGroupQuickEditItem
