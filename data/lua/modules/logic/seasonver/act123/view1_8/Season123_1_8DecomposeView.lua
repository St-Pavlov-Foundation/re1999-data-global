-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8DecomposeView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8DecomposeView", package.seeall)

local Season123_1_8DecomposeView = class("Season123_1_8DecomposeView", BaseView)

function Season123_1_8DecomposeView:onInitView()
...
function Season123_1_8DecomposeView:addEvents()
...
function Season123_1_8DecomposeView:removeEvents()
...
function Season123_1_8DecomposeView:_btnminOnClick()
	self.curCount = self.minDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_1_8DecomposeView:_btnsubOnClick()
...
function Season123_1_8DecomposeView:_btnaddOnClick()
...
function Season123_1_8DecomposeView:_btnmaxOnClick()
	self.curCount = self.maxDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_1_8DecomposeView:_btndecomposeOnClick()
...
function Season123_1_8DecomposeView:sendDecomposeEquipRequest()
	local list = {}
...
function Season123_1_8DecomposeView:_onEndEdit()
...
function Season123_1_8DecomposeView:_editableInitView()
	return
end

function Season123_1_8DecomposeView:onOpen()
...
function Season123_1_8DecomposeView:refreshUI()
...
function Season123_1_8DecomposeView:refreshInfoBySelectCount()
	self._inputvalue:SetText(self.curCount)

	self._txtgetCoin.text = luaLang("multiple") .. self.curCount * self.itemConfig.decomposeGet
end

function Season123_1_8DecomposeView:CreateCardIcon()
	if not self.cardIcon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocardpos, "icon")

		self.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_1_8CelebrityCardEquip)
	end
...
function Season123_1_8DecomposeView:showMaterialInfoTip()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self.itemId)
end

function Season123_1_8DecomposeView:onClose()
	return
end

function Season123_1_8DecomposeView:onDestroyView()
	if self.cardIcon then
		self.cardIcon:disposeUI()
	end
end

return Season123_1_8DecomposeView
