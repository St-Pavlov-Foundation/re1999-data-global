-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8FightRuleTipView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8FightRuleTipView", package.seeall)

local Season123_1_8FightRuleTipView = class("Season123_1_8FightRuleTipView", BaseView)

function Season123_1_8FightRuleTipView:onInitView()
...
function Season123_1_8FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season123_1_8FightRuleTipView:_closeView()
	self:closeThis()
end

function Season123_1_8FightRuleTipView:onOpen()
...
function Season123_1_8FightRuleTipView:createTab(go, tabType)
...
function Season123_1_8FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season123_1_8FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season123_1_8FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season123_1_8FightRuleTipView:switchTab(type)
...
function Season123_1_8FightRuleTipView:getTabActive(tabType)
...
function Season123_1_8FightRuleTipView:onClose()
	return
end

function Season123_1_8FightRuleTipView:onDestroyView()
...
return Season123_1_8FightRuleTipView
