-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EpisodeListCenter.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EpisodeListCenter", package.seeall)

local Season123_1_8EpisodeListCenter = class("Season123_1_8EpisodeListCenter", UserDataDispose)

function Season123_1_8EpisodeListCenter:ctor()
	self:__onInit()
end

function Season123_1_8EpisodeListCenter:dispose()
	self:__onDispose()
end

function Season123_1_8EpisodeListCenter:init(viewGO)
	self.viewGO = viewGO

	self:initComponent()
end

function Season123_1_8EpisodeListCenter:initComponent()
...
function Season123_1_8EpisodeListCenter:initData(actId, stage)
	self._actId = actId
	self._stageId = stage
end

function Season123_1_8EpisodeListCenter:refreshUI()
...
function Season123_1_8EpisodeListCenter:refreshRound()
...
Season123_1_8EpisodeListCenter.NoStarTimeAnchorY = -176
Season123_1_8EpisodeListCenter.WithStarTimeAnchorY = -86

function Season123_1_8EpisodeListCenter:refreshProgress()
	...
	if isShowStar then
		recthelper.setAnchorY(self._tftime, Season123_1_8EpisodeListCenter.WithStarTimeAnchorY)
	else
		recthelper.setAnchorY(self._tftime, Season123_1_8EpisodeListCenter.NoStarTimeAnchorY)
	end
end

return Season123_1_8EpisodeListCenter
