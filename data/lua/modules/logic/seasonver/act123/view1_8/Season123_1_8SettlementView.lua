...
local var_0_0 = class("Season123_1_8SettlementView", BaseViewExtended)
...
function var_0_0._showGetCardView(arg_9_0)
	if arg_9_0.equip_cards then
		...
		arg_9_0._showTipsFlow:addWork(Season123_1_8SettlementTipsWork.New())
...
function var_0_0._onRewardItemShow(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if arg_24_2.materilType == MaterialEnum.MaterialType.Season123EquipCard then
		local var_24_2 = Season123_1_8CelebrityCardItem.New()
		...
		for iter_27_11 = 1, 4 do
			if var_27_7[iter_27_11] then
				...
				if var_27_12 then
					...
					local var_27_16 = arg_27_0:openSubView(Season123_1_8SettlementHeroItem, arg_27_0._hero_obj_list[iter_27_11], nil, var_27_6, nil, var_27_14, var_27_15, nil, var_27_7[iter_27_11])
				...
				local var_27_20 = arg_27_0:openSubView(Season123_1_8SettlementHeroItem, arg_27_0._hero_obj_list[iter_27_11], nil, var_27_6, var_27_17, var_27_18, var_27_19)
...
function var_0_0.setMainPosCardItemByUid(arg_28_0, arg_28_1, arg_28_2)
	...
	if not var_28_2.unlockIndexSet[var_28_3] then
		...
		if arg_28_2 and arg_28_2 ~= "0" then
			...
			arg_28_0:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, var_28_5, arg_28_2, true)
		else
...
function var_0_0._onGetFightRecordGroupReply(arg_30_0, arg_30_1)
	for iter_30_0 = 1, 4 do
		...
		local var_30_5 = arg_30_0:openSubView(Season123_1_8SettlementHeroItem, var_30_0, nil, true, var_30_1, var_30_2, var_30_3, var_30_4)
...
function var_0_0.setMainPosCardItemById(arg_31_0, arg_31_1, arg_31_2)
	...
	if not var_31_3.unlockIndexSet[var_31_4] then
		...
		if var_31_0 and var_31_0 ~= 0 then
			...
			arg_31_0:openSubView(Season123_1_8CelebrityCardGetItem, Season123_1_8CelebrityCardItem.AssetPath, var_31_6, nil, nil, var_31_0)
		else
