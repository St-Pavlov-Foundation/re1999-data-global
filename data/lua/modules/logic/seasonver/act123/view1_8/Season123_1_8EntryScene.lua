...
slot0 = class("Season123_1_8EntryScene", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._cameraHelper = Season123_1_8EntryCamera.New()

	slot0._cameraHelper:init()

	slot0._loadHelper = Season123_1_8EntryLoadScene.New()
...
function slot0.onSceneResLoaded(slot0, slot1)
	...
	slot0._dragHelper = Season123_1_8EntryDrag.New()
