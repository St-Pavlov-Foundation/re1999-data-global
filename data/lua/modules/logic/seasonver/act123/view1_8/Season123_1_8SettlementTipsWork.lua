-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8SettlementTipsWork.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8SettlementTipsWork", package.seeall)

local Season123_1_8SettlementTipsWork = class("Season123_1_8SettlementTipsWork", BaseWork)

function Season123_1_8SettlementTipsWork:onStart(context)
...
function Season123_1_8SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season123_1_8SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season123_1_8SettlementTipsWork:_showGetCardView()
...
function Season123_1_8SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season123_1_8SettlementTipsWork
