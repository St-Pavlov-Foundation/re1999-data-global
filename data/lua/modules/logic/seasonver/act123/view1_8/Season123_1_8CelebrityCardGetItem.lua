-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8CelebrityCardGetItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8CelebrityCardGetItem", package.seeall)

local Season123_1_8CelebrityCardGetItem = class("Season123_1_8CelebrityCardGetItem", BaseViewExtended)

function Season123_1_8CelebrityCardGetItem:onInitView()
...
function Season123_1_8CelebrityCardGetItem:addEvents()
	return
end

function Season123_1_8CelebrityCardGetItem:removeEvents()
	return
end

function Season123_1_8CelebrityCardGetItem:onRefreshViewParam(uid, noClick, equipId)
	self._uid = uid
	self._noClick = noClick
	self._equipId = equipId
end

function Season123_1_8CelebrityCardGetItem:onOpen()
	self:refreshData(self._uid)
end

function Season123_1_8CelebrityCardGetItem:refreshData(uid)
...
function Season123_1_8CelebrityCardGetItem:_checkCreateIcon()
	if not self._icon then
		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self.viewGO, Season123_1_8CelebrityCardEquip)
...
function Season123_1_8CelebrityCardGetItem:onBtnClick()
	if self._noClick then
		return
	end
...
function Season123_1_8CelebrityCardGetItem:_getItemID(uid)
	local item_id
...
function Season123_1_8CelebrityCardGetItem:onClose()
	return
end

function Season123_1_8CelebrityCardGetItem:onDestroyView()
	if self._icon then
...
return Season123_1_8CelebrityCardGetItem
