...
slot0 = class("Season123_1_8FightCardView", BaseView)
...
function slot0.createItem(slot0, slot1)
	slot3 = Season123_1_8FightCardItem.New(gohelper.cloneInPlace(slot0._goCardItem, string.format("card%s", slot1)))
