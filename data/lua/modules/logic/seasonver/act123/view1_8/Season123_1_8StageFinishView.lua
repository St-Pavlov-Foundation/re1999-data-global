-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8StageFinishView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8StageFinishView", package.seeall)

local Season123_1_8StageFinishView = class("Season123_1_8StageFinishView", BaseView)

function Season123_1_8StageFinishView:onInitView()
...
function Season123_1_8StageFinishView:addEvents()
	return
end

function Season123_1_8StageFinishView:removeEvents()
	return
end

function Season123_1_8StageFinishView:_editableInitView()
...
function Season123_1_8StageFinishView:onDestroyView()
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_1_8StageFinishView:onOpen()
...
function Season123_1_8StageFinishView:onClose()
	TaskDispatcher.cancelTask(self.lightStar, self)
	TaskDispatcher.cancelTask(self.light, self)
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_1_8StageFinishView:refreshUI()
...
function Season123_1_8StageFinishView:handleDelayAnimTransition()
...
function Season123_1_8StageFinishView:lightStar()
...
function Season123_1_8StageFinishView:light()
...
function Season123_1_8StageFinishView:firstPassStage(actId, stage)
...
function Season123_1_8StageFinishView:setAlreadyPass(actId, stage)
	local key = self:getPassKey(actId, stage)
...
function Season123_1_8StageFinishView:getPassKey(actId, stage)
	return "FirstPassStage" .. tostring(self.userId) .. "#" .. tostring(actId) .. tostring(stage)
end

return Season123_1_8StageFinishView
