-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8EquipHeroItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8EquipHeroItem", package.seeall)

local Season123_1_8EquipHeroItem = class("Season123_1_8EquipHeroItem", ListScrollCellExtend)

function Season123_1_8EquipHeroItem:init(go)
	Season123_1_8EquipHeroItem.super.init(self, go)
...
function Season123_1_8EquipHeroItem:addEvents()
	return
end

function Season123_1_8EquipHeroItem:removeEvents()
	return
end

function Season123_1_8EquipHeroItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_1_8EquipHeroItem.ColumnCount = 6
Season123_1_8EquipHeroItem.AnimRowCount = 4
Season123_1_8EquipHeroItem.OpenAnimTime = 0.06
Season123_1_8EquipHeroItem.OpenAnimStartTime = 0.05

function Season123_1_8EquipHeroItem:checkPlayAnim()
...
function Season123_1_8EquipHeroItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_8EquipHeroItem:refreshUI()
...
function Season123_1_8EquipHeroItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_1_8EquipHeroItem:refreshEquipedHero(heroUid)
...
function Season123_1_8EquipHeroItem:refreshIcon(itemId, itemUid)
...
function Season123_1_8EquipHeroItem:checkCreateIcon()
...
function Season123_1_8EquipHeroItem:setRoleIconDark(value)
	if value then
...
function Season123_1_8EquipHeroItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_1_8EquipHeroItem:checkClickNew(itemUid)
...
Season123_1_8EquipHeroItem.Toast_Same_Card = 2851
Season123_1_8EquipHeroItem.Toast_Wrong_Type = 2852
Season123_1_8EquipHeroItem.Toast_MainRole_Wrong_Type = 2854
Season123_1_8EquipHeroItem.Toast_Other_Hero_Equiped = 2853
Season123_1_8EquipHeroItem.Toast_Career_Wrong = 2859
Season123_1_8EquipHeroItem.Toast_Slot_Lock = 67

function Season123_1_8EquipHeroItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipHeroItemListModel.instance:slotIsLock(Season123EquipHeroItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_1_8EquipHeroItem.Toast_Slot_Lock)
	...
	if isSameCard then
		GameFacade.showToast(Season123_1_8EquipHeroItem.Toast_Same_Card)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipHeroItemListModel.instance.curPos == Season123EquipHeroItemListModel.MainCharPos then
				GameFacade.showToast(Season123_1_8EquipHeroItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_1_8EquipHeroItem.Toast_Wrong_Type)
			end
...
function Season123_1_8EquipHeroItem:onDestroyView()
	if self.icon then
...
return Season123_1_8EquipHeroItem
