-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8FightFailView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8FightFailView", package.seeall)

local Season123_1_8FightFailView = class("Season123_1_8FightFailView", FightFailView)

function Season123_1_8FightFailView:onInitView()
...
function Season123_1_8FightFailView:addEvents()
	self._click:AddClickListener(self._onClickClose, self)
	self._btndata:AddClickListener(self._onClickData, self)
end

function Season123_1_8FightFailView:removeEvents()
	self._click:RemoveClickListener()
	self._btndata:RemoveClickListener()
end

function Season123_1_8FightFailView:_editableInitView()
...
function Season123_1_8FightFailView:onOpen()
...
function Season123_1_8FightFailView:refreshTips()
...
function Season123_1_8FightFailView:onClose()
	Season123_1_8FightFailView.super.onClose(self)
end

function Season123_1_8FightFailView:onDestroyView()
	Season123_1_8FightFailView.super.onDestroyView(self)
end

return Season123_1_8FightFailView
