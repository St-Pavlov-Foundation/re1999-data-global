-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8StoryCoverItem.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8StoryCoverItem", package.seeall)

local Season123_1_8StoryCoverItem = class("Season123_1_8StoryCoverItem", LuaCompBase)

function Season123_1_8StoryCoverItem:ctor(param)
	self.param = param
end

function Season123_1_8StoryCoverItem:init(go)
	self:__onInit()
...
function Season123_1_8StoryCoverItem:addEventListeners()
	self.btnClick:AddClickListener(self.onClickCoverItem, self)
end

function Season123_1_8StoryCoverItem:removeEventListeners()
	self.btnClick:RemoveClickListener()
end

Season123_1_8StoryCoverItem.unlockDelayTime = 1.16

function Season123_1_8StoryCoverItem:refreshItem()
...
function Season123_1_8StoryCoverItem:onClickCoverItem()
...
function Season123_1_8StoryCoverItem:refreshUnlockState(unlockState)
	if self.isUnlock and self.isUnlock ~= unlockState then
		...
		TaskDispatcher.runDelay(self.playUnlockAnim, self, Season123_1_8StoryCoverItem.unlockDelayTime)
...
function Season123_1_8StoryCoverItem:playUnlockAnim()
...
function Season123_1_8StoryCoverItem:onUnlockAnimDone()
	gohelper.setActive(self.goLocked, not self.isUnlock)
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
end

function Season123_1_8StoryCoverItem:destroy()
	self:__onDispose()
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
	TaskDispatcher.cancelTask(self.playUnlockAnim, self)
end

return Season123_1_8StoryCoverItem
