...
slot0 = class("Season123_1_8EquipSpineView", BaseView)
...
function slot0.refreshHeroSkin(slot0)
	if not Season123EquipItemListModel.instance:getPosHeroUid(Season123EquipItemListModel.instance.curPos) or slot2 == Season123EquipItemListModel.EmptyUid then
		gohelper.setActive(slot0._gospine, false)

		return nil
	end

	slot3 = HeroModel.instance:getById(tostring(slot2)) or HeroGroupTrialModel.instance:getById(slot2)

	if Season123EquipItemListModel.instance.stage ~= nil then
		slot3 = Season123HeroUtils.getHeroMO(Season123EquipItemListModel.instance.activityId, slot2, Season123EquipItemListModel.instance.stage)
	end
