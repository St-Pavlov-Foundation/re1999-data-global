-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3BatchDecomposeViewContainer.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3BatchDecomposeViewContainer", package.seeall)

local Season123_2_3BatchDecomposeViewContainer = class("Season123_2_3BatchDecomposeViewContainer", BaseViewContainer)

function Season123_2_3BatchDecomposeViewContainer:buildViews()
	self:createEquipItemsParam()

	return {
		Season123_2_3BatchDecomposeView.New(),
		self.scrollView,
...
function Season123_2_3BatchDecomposeViewContainer:createEquipItemsParam()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "left_container/#go_scrollcontainer/#scroll_equip"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_2_3DecomposeItem
...
function Season123_2_3BatchDecomposeViewContainer:buildTabViews(tabContainerId)
...
function Season123_2_3BatchDecomposeViewContainer:getLineCount()
...
function Season123_2_3BatchDecomposeViewContainer:playCloseTransition()
...
function Season123_2_3BatchDecomposeViewContainer:onCloseAnimDone()
	self:onPlayCloseTransitionFinish()
end

return Season123_2_3BatchDecomposeViewContainer
