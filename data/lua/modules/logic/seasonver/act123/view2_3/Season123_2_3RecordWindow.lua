-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3RecordWindow.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3RecordWindow", package.seeall)

local Season123_2_3RecordWindow = class("Season123_2_3RecordWindow", BaseView)
local CAN_DISPLAY_ITEM_COUNT = 5
local ITEM_DELAY_ACTIVE_INTERVAL_TIME = 0.06
local BLOCK_TIME_EXTEND = 0.2

function Season123_2_3RecordWindow:onInitView()
...
function Season123_2_3RecordWindow:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_3RecordWindow:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_3RecordWindow:_btncloseOnClick()
	self:onClickModalMask()
end

function Season123_2_3RecordWindow:onClickModalMask()
	self:closeThis()
end

function Season123_2_3RecordWindow:_editableInitView()
	gohelper.setActive(self._gorecorditem, false)
end

function Season123_2_3RecordWindow:onOpen()
	...
	if bestRecordDataList and #bestRecordDataList > 0 then
		local bestRecordItem = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobestrecorditem, Season123_2_3RecordWindowItem)
	...
	if normalRecordDataList and #normalRecordDataList > 0 then
		...
		gohelper.CreateObjList(self, self._onRecordItemLoad, normalRecordDataList, self._goContent, self._gorecorditem, Season123_2_3RecordWindowItem)
...
function Season123_2_3RecordWindow:_onRecordItemLoad(cellComponent, data, index)
	if not data then
		return
	end
...
function Season123_2_3RecordWindow:_onItemPlayAnimFinish()
	UIBlockMgr.instance:endBlock(self.viewName .. "itemPlayAnim")
end

function Season123_2_3RecordWindow:onClose()
	TaskDispatcher.cancelTask(self._onItemPlayAnimFinish, self)
	self:_onItemPlayAnimFinish()
end

function Season123_2_3RecordWindow:onDestroyView()
	return
end

return Season123_2_3RecordWindow
