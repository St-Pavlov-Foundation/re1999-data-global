-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3PickHeroItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3PickHeroItem", package.seeall)

local Season123_2_3PickHeroItem = class("Season123_2_3PickHeroItem", ListScrollCell)

function Season123_2_3PickHeroItem:init(go)
...
function Season123_2_3PickHeroItem:initHeroItem(go)
...
function Season123_2_3PickHeroItem:addEventListeners()
	return
end

function Season123_2_3PickHeroItem:removeEventListeners()
	return
end

function Season123_2_3PickHeroItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_3PickHeroItem:onItemClick()
...
function Season123_2_3PickHeroItem:onDestroy()
...
function Season123_2_3PickHeroItem:getAnimator()
	return self._animator
end

return Season123_2_3PickHeroItem
