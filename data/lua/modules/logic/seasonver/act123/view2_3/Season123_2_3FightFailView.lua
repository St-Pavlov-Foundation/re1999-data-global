-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3FightFailView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3FightFailView", package.seeall)

local Season123_2_3FightFailView = class("Season123_2_3FightFailView", FightFailView)

function Season123_2_3FightFailView:onInitView()
...
function Season123_2_3FightFailView:addEvents()
	self._click:AddClickListener(self._onClickClose, self)
	self._btndata:AddClickListener(self._onClickData, self)
end

function Season123_2_3FightFailView:removeEvents()
	self._click:RemoveClickListener()
	self._btndata:RemoveClickListener()
end

function Season123_2_3FightFailView:_editableInitView()
...
function Season123_2_3FightFailView:onOpen()
...
function Season123_2_3FightFailView:refreshTips()
...
function Season123_2_3FightFailView:onClose()
	Season123_2_3FightFailView.super.onClose(self)
end

function Season123_2_3FightFailView:onDestroyView()
	Season123_2_3FightFailView.super.onDestroyView(self)
end

return Season123_2_3FightFailView
