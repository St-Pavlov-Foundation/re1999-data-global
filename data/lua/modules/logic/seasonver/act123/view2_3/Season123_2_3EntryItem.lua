-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EntryItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EntryItem", package.seeall)

local Season123_2_3EntryItem = class("Season123_2_3EntryItem", UserDataDispose)

function Season123_2_3EntryItem:ctor()
	self:__onInit()
end

function Season123_2_3EntryItem:dispose()
	TaskDispatcher.cancelTask(self._enterEpiosdeList, self)
	self:removeEvents()
	self:__onDispose()
end

function Season123_2_3EntryItem:init(viewGO, animator)
	self.viewGO = viewGO
	self.anim = animator
...
function Season123_2_3EntryItem:initComponent()
...
function Season123_2_3EntryItem:removeEvents()
...
function Season123_2_3EntryItem:initData(actId)
	self._actId = actId

	self:refreshUI()
end

function Season123_2_3EntryItem:refreshUI()
...
function Season123_2_3EntryItem:refreshRound()
...
function Season123_2_3EntryItem:refreshLock()
...
function Season123_2_3EntryItem:refreshProgress()
...
function Season123_2_3EntryItem:refreshNew()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_3EntryItem:refreshRecordBtn()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_3EntryItem:refreshLockRepeat()
	self:refreshLock()
	self:refreshProgress()
end

function Season123_2_3EntryItem:_btnentranceOnClick()
...
function Season123_2_3EntryItem:_enterEpiosdeList()
...
function Season123_2_3EntryItem:_btnrecordsOnClick()
	Season123EntryController.instance:openStageRecords(self._stageId)
end

return Season123_2_3EntryItem
