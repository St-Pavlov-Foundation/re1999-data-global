...
slot0 = class("Season123_2_3EquipBookView", BaseView)
...
function slot0._btndecomposeOnClick(slot0)
	...
	ViewMgr.instance:openView(ViewName.Season123_2_3DecomposeView, {
		actId = slot0.actId,
		itemId = slot0.itemId
	})
end
...
function slot0.refreshIcon(slot0)
	if not slot0._icon then
		slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._gocarditem, Season123_2_3CelebrityCardEquip)
	end
