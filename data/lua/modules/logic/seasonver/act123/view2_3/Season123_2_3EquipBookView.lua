...
local var_0_0 = class("Season123_2_3EquipBookView", BaseView)
...
function var_0_0._btndecomposeOnClick(arg_6_0)
	...
	ViewMgr.instance:openView(ViewName.Season123_2_3DecomposeView, var_6_0)
end
...
function var_0_0.refreshIcon(arg_18_0)
	if not arg_18_0._icon then
		...
		arg_18_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_18_0, Season123_2_3CelebrityCardEquip)
	end
