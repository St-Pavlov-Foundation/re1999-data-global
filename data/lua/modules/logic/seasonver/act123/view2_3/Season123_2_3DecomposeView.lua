...
slot0 = class("Season123_2_3DecomposeView", BaseView)
...
function slot0.CreateCardIcon(slot0)
	if not slot0.cardIcon then
		slot0.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._gocardpos, "icon"), Season123_2_3CelebrityCardEquip)
	end
