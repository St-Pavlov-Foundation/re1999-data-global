-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3DecomposeView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3DecomposeView", package.seeall)

local Season123_2_3DecomposeView = class("Season123_2_3DecomposeView", BaseView)

function Season123_2_3DecomposeView:onInitView()
...
function Season123_2_3DecomposeView:addEvents()
...
function Season123_2_3DecomposeView:removeEvents()
...
function Season123_2_3DecomposeView:_btnminOnClick()
	self.curCount = self.minDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_2_3DecomposeView:_btnsubOnClick()
...
function Season123_2_3DecomposeView:_btnaddOnClick()
...
function Season123_2_3DecomposeView:_btnmaxOnClick()
	self.curCount = self.maxDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_2_3DecomposeView:_btndecomposeOnClick()
...
function Season123_2_3DecomposeView:sendDecomposeEquipRequest()
	local list = {}
...
function Season123_2_3DecomposeView:_onEndEdit()
...
function Season123_2_3DecomposeView:_editableInitView()
	return
end

function Season123_2_3DecomposeView:onOpen()
...
function Season123_2_3DecomposeView:refreshUI()
...
function Season123_2_3DecomposeView:refreshInfoBySelectCount()
	self._inputvalue:SetText(self.curCount)

	self._txtgetCoin.text = luaLang("multiple") .. self.curCount * self.itemConfig.decomposeGet
end

function Season123_2_3DecomposeView:CreateCardIcon()
	if not self.cardIcon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocardpos, "icon")

		self.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_2_3CelebrityCardEquip)
	end
...
function Season123_2_3DecomposeView:showMaterialInfoTip()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self.itemId)
end

function Season123_2_3DecomposeView:onClose()
	return
end

function Season123_2_3DecomposeView:onDestroyView()
	if self.cardIcon then
		self.cardIcon:disposeUI()
	end
end

return Season123_2_3DecomposeView
