-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupQuickEditItem", package.seeall)

local Season123_2_3HeroGroupQuickEditItem = class("Season123_2_3HeroGroupQuickEditItem", Season123_2_3HeroGroupEditItem)

function Season123_2_3HeroGroupQuickEditItem:init(go)
	Season123_2_3HeroGroupQuickEditItem.super.init(self, go)
...
function Season123_2_3HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_3HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123_2_3HeroGroupQuickEditItem:_onItemClick()
...
function Season123_2_3HeroGroupQuickEditItem:onSelect(select)
...
function Season123_2_3HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123_2_3HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123_2_3HeroGroupQuickEditItem
