...
local var_0_0 = class("Season123_2_3CelebrityCardTipView", BaseView)
...
function var_0_0.onOpen(arg_10_0)
	...
	arg_10_0._activityId = arg_10_0.viewParam.actId or Season123Model.instance:getCurSeasonId()
...
function var_0_0.refreshUI(arg_12_0)
	...
	arg_12_0._icon:setIndexLimitShowState(true)
...
function var_0_0.refreshQuantity(arg_13_0)
	if arg_13_0.viewParam.needQuantity then
		...
		elseif arg_13_0._activityId then
			var_13_0 = tostring(GameUtil.numberDisplay(Season123EquipMetaUtils.getEquipCount(arg_13_0._activityId, arg_13_0._itemId)))
		else
			var_13_0 = tostring(Season123EquipMetaUtils.getCurSeasonEquipCount(arg_13_0._itemId))
		end
...
function var_0_0.refreshProps(arg_14_0)
	...
	local var_14_1 = Season123EquipMetaUtils.getEquipPropsStrList(arg_14_0._itemCfg.attrId, true)
	local var_14_2 = Season123EquipMetaUtils.getCareerColorBrightBg(arg_14_0._itemId)
	local var_14_3 = {}
...
function var_0_0.refreshSkills(arg_15_0)
	local var_15_0 = Season123EquipMetaUtils.getSkillEffectStrList(arg_15_0._itemCfg)
	local var_15_1 = Season123EquipMetaUtils.getCareerColorBrightBg(arg_15_0._itemId)
...
function var_0_0.checkCreateIcon(arg_16_0)
	if not arg_16_0._icon then
		...
		arg_16_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_16_1, Season123_2_3CelebrityCardEquip)
	end
end
