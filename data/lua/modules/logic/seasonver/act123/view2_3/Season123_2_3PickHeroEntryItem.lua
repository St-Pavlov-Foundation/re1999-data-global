...
local var_0_0 = class("Season123_2_3PickHeroEntryItem", UserDataDispose)
	...
	if var_7_0 then
		...
		if not var_7_1 then
			...
			if var_7_0.heroMO then
				...
				if not var_7_2 then
					logError("Season123_2_3PickHeroEntryItem.refreshUI error, skinCfg is nil, id:" .. tostring(var_7_0.skinId))
