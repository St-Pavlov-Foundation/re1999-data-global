...
slot0 = class("Season123_2_3PickHeroEntryItem", UserDataDispose)
		...
		if not slot2 then
			...
			if slot1.heroMO then
				if not SkinConfig.instance:getSkinCo(slot1.heroMO.skin) then
					logError("Season123_2_3PickHeroEntryItem.refreshUI error, skinCfg is nil, id:" .. tostring(slot1.skinId))
