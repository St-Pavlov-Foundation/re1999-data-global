-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3StageFinishView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3StageFinishView", package.seeall)

local Season123_2_3StageFinishView = class("Season123_2_3StageFinishView", BaseView)

function Season123_2_3StageFinishView:onInitView()
...
function Season123_2_3StageFinishView:addEvents()
	return
end

function Season123_2_3StageFinishView:removeEvents()
	return
end

function Season123_2_3StageFinishView:_editableInitView()
...
function Season123_2_3StageFinishView:onDestroyView()
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_2_3StageFinishView:onOpen()
...
function Season123_2_3StageFinishView:onClose()
	TaskDispatcher.cancelTask(self.lightStar, self)
	TaskDispatcher.cancelTask(self.light, self)
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_2_3StageFinishView:refreshUI()
...
function Season123_2_3StageFinishView:handleDelayAnimTransition()
...
function Season123_2_3StageFinishView:lightStar()
...
function Season123_2_3StageFinishView:light()
...
function Season123_2_3StageFinishView:firstPassStage(actId, stage)
...
function Season123_2_3StageFinishView:setAlreadyPass(actId, stage)
	local key = self:getPassKey(actId, stage)
...
function Season123_2_3StageFinishView:getPassKey(actId, stage)
	return "FirstPassStage" .. tostring(self.userId) .. "#" .. tostring(actId) .. tostring(stage)
end

return Season123_2_3StageFinishView
