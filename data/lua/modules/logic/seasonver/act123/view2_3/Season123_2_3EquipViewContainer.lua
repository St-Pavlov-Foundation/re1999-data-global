...
slot0 = class("Season123_2_3EquipViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot2 = Season123_2_3EquipTagSelect.New()
...
function slot0.createEquipItemsParam(slot0)
	...
	slot1.cellClass = Season123_2_3EquipItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = Season123_2_3EquipItem.ColumnCount
	slot1.cellWidth = 170
	slot1.cellHeight = 235
	slot1.cellSpaceH = 8.4
	slot1.cellSpaceV = 0
	slot1.frameUpdateMs = 100
	slot1.minUpdateCountInFrame = Season123_2_3EquipItem.ColumnCount
