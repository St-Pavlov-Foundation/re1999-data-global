-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EpisodeLoadingView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EpisodeLoadingView", package.seeall)

local Season123_2_3EpisodeLoadingView = class("Season123_2_3EpisodeLoadingView", BaseView)

function Season123_2_3EpisodeLoadingView:onInitView()
...
function Season123_2_3EpisodeLoadingView:addEvents()
	self._btnskipAnim:AddClickListener(self._btnSkilAnimOnClick, self)
end

function Season123_2_3EpisodeLoadingView:removeEvents()
	self._btnskipAnim:RemoveClickListener()
end

function Season123_2_3EpisodeLoadingView:_btnSkilAnimOnClick()
...
function Season123_2_3EpisodeLoadingView:_editableInitView()
	self._stageItems = {}
end

function Season123_2_3EpisodeLoadingView:onDestroyView()
...
function Season123_2_3EpisodeLoadingView:onOpen()
	local actId = self.viewParam.actId
	local stage = self.viewParam.stage
	local layer = self.viewParam.layer

	logNormal(string.format("Season123_2_3EpisodeLoadingView actId=%s, stage=%s", actId, stage))
...
function Season123_2_3EpisodeLoadingView:onClose()
	return
end

function Season123_2_3EpisodeLoadingView:refreshUI()
	self:refreshStageList()
end

function Season123_2_3EpisodeLoadingView:refreshStageList()
...
function Season123_2_3EpisodeLoadingView:getOrCreateStageItem(index)
...
function Season123_2_3EpisodeLoadingView:refreshSingleItem(index, item, data)
...
function Season123_2_3EpisodeLoadingView:refreshSingleItemLock(index, item, data)
	if data.emptyIndex then
...
function Season123_2_3EpisodeLoadingView:refreshSingleItemFinished(index, item, data)
	if data.emptyIndex then
