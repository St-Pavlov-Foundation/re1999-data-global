-- chunkname: @modules/logic/seasonver/act123/view2_3/component/Season123_2_3MarketShowLevelItem.lua

module("modules.logic.seasonver.act123.view2_3.component.Season123_2_3MarketShowLevelItem", package.seeall)

local Season123_2_3MarketShowLevelItem = class("Season123_2_3MarketShowLevelItem", UserDataDispose)

function Season123_2_3MarketShowLevelItem:init(go, index, targetIndex, maxIndex)
	self:__onInit()
...
function Season123_2_3MarketShowLevelItem:show()
...
function Season123_2_3MarketShowLevelItem:destroy()
	self:__onDispose()
end

return Season123_2_3MarketShowLevelItem
