-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3CelebrityCardItem.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3CelebrityCardItem", package.seeall)

local Season123_2_3CelebrityCardItem = class("Season123_2_3CelebrityCardItem", LuaCompBase)

Season123_2_3CelebrityCardItem.AssetPath = "ui/viewres/seasonver/v2a3_act123/season123celebritycarditem.prefab"

function Season123_2_3CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season123_2_3CelebrityCardItem.AssetPath
...
function Season123_2_3CelebrityCardItem:handleCardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season123_2_3CelebrityCardEquip)
...
function Season123_2_3CelebrityCardItem:showTag(enable)
...
function Season123_2_3CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season123_2_3CelebrityCardItem:showNewFlag(enable)
...
function Season123_2_3CelebrityCardItem:showNewFlag2(enable)
...
function Season123_2_3CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season123_2_3CelebrityCardItem:setColorDark(enable)
...
function Season123_2_3CelebrityCardItem:destroy()
	if self._icon then
...
return Season123_2_3CelebrityCardItem
