...
slot0 = class("Season123_2_3EntryScene", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._cameraHelper = Season123_2_3EntryCamera.New()

	slot0._cameraHelper:init()

	slot0._loadHelper = Season123_2_3EntryLoadScene.New()
...
function slot0.onSceneResLoaded(slot0, slot1)
	...
	slot0._dragHelper = Season123_2_3EntryDrag.New()
...
function slot0.refreshStage(slot0, slot1)
	...
	slot0._loadHelper:showStageRes(slot2, slot1, slot0.viewParam)
end
