-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3EpisodeListCenter.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3EpisodeListCenter", package.seeall)

local Season123_2_3EpisodeListCenter = class("Season123_2_3EpisodeListCenter", UserDataDispose)

function Season123_2_3EpisodeListCenter:ctor()
	self:__onInit()
end

function Season123_2_3EpisodeListCenter:dispose()
	self:__onDispose()
end

function Season123_2_3EpisodeListCenter:init(viewGO)
	self.viewGO = viewGO

	self:initComponent()
end

function Season123_2_3EpisodeListCenter:initComponent()
...
function Season123_2_3EpisodeListCenter:initData(actId, stage)
	self._actId = actId
	self._stageId = stage
end

function Season123_2_3EpisodeListCenter:refreshUI()
...
function Season123_2_3EpisodeListCenter:refreshRound()
...
Season123_2_3EpisodeListCenter.NoStarTimeAnchorY = -176
Season123_2_3EpisodeListCenter.WithStarTimeAnchorY = -86

function Season123_2_3EpisodeListCenter:refreshProgress()
	...
	if isShowStar then
		recthelper.setAnchorY(self._tftime, Season123_2_3EpisodeListCenter.WithStarTimeAnchorY)
	else
		recthelper.setAnchorY(self._tftime, Season123_2_3EpisodeListCenter.NoStarTimeAnchorY)
	end
end

return Season123_2_3EpisodeListCenter
