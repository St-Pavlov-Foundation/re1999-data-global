-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3FightRuleTipView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3FightRuleTipView", package.seeall)

local Season123_2_3FightRuleTipView = class("Season123_2_3FightRuleTipView", BaseView)

function Season123_2_3FightRuleTipView:onInitView()
...
function Season123_2_3FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season123_2_3FightRuleTipView:_closeView()
	self:closeThis()
end

function Season123_2_3FightRuleTipView:onOpen()
...
function Season123_2_3FightRuleTipView:createTab(go, tabType)
...
function Season123_2_3FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season123_2_3FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season123_2_3FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season123_2_3FightRuleTipView:switchTab(type)
...
function Season123_2_3FightRuleTipView:getTabActive(tabType)
...
function Season123_2_3FightRuleTipView:onClose()
	return
end

function Season123_2_3FightRuleTipView:onDestroyView()
...
return Season123_2_3FightRuleTipView
