...
slot0 = class("Season123_2_3EpisodeListViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}
	slot0.episodeListView = Season123_2_3EpisodeListView.New()

	table.insert(slot1, Season123_2_3CheckCloseView.New())
