...
slot0 = class("Season123_2_3HeroGroupFightViewContainer", BaseViewContainer)
...
function slot0.buildTabViews(slot0, slot1)
	if slot1 == 1 then
		slot0._navigateButtonsView = NavigateButtonsView.New({
			...
			false,
			true
		}, HelpEnum.HelpId.Season2_3HerogroupHelp, slot0._closeCallback, nil, , slot0)

		slot0._navigateButtonsView:setHelpId(HelpEnum.HelpId.Season2_3HerogroupHelp)
