-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3CelebrityCardGetView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3CelebrityCardGetView", package.seeall)

local Season123_2_3CelebrityCardGetView = class("Season123_2_3CelebrityCardGetView", BaseViewExtended)

Season123_2_3CelebrityCardGetView.OpenType = {
	Get = 1
}

function Season123_2_3CelebrityCardGetView:onInitView()
...
function Season123_2_3CelebrityCardGetView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_3CelebrityCardGetView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_3CelebrityCardGetView:_btncloseOnClick()
	self:closeThis()
end

function Season123_2_3CelebrityCardGetView:onOpen()
...
function Season123_2_3CelebrityCardGetView:_showGetCard()
	self:com_loadAsset(Season123_2_3CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season123_2_3CelebrityCardGetView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season123_2_3CelebrityCardGetScrollItem)
...
function Season123_2_3CelebrityCardGetView:isItemID()
	return self.viewParam.is_item_id
end

function Season123_2_3CelebrityCardGetView:onClose()
	return
end

return Season123_2_3CelebrityCardGetView
