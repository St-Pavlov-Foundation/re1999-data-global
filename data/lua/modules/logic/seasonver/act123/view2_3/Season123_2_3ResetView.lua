...
slot0 = class("Season123_2_3ResetView", BaseView)
...
function slot0.delayInitScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollchapter, Season123_2_3ResetViewAudio, slot0._scrollchapter)
