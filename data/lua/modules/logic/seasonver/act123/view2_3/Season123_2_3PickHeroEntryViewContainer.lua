...
local var_0_0 = class("Season123_2_3PickHeroEntryViewContainer", BaseViewContainer)
...
function var_0_0.buildTabViews(arg_2_0, arg_2_1)
	if arg_2_1 == 1 then
		...
		arg_2_0._navigateButtonView:setHelpId(HelpEnum.HelpId.Season2_3SelectHeroHelp)
