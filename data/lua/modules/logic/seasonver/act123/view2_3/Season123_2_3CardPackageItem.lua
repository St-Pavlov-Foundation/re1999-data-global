...
local var_0_0 = class("Season123_2_3CardPackageItem", ListScrollCellExtend)
...
function var_0_0.checkCreateIcon(arg_6_0)
	if not arg_6_0.icon then
		...
		arg_6_0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_6_1, Season123_2_3CelebrityCardEquip)
