...
slot0 = class("Season123_2_3EpisodeListView", BaseView)
...
function slot0.initCenter(slot0)
	slot0._centerItem = Season123_2_3EpisodeListCenter.New()
...
slot0.SCROLL_ANIM_BLOCK_KEY = "Season123_2_3EpisodeListView_scrollanim"
...
function slot0.onCloseView(slot0, slot1)
	if slot1 == ViewName.Season123_2_3EpisodeDetailView then
		slot0:refreshStageList()
...
function slot0.delayAddScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollstory, Season123_2_3EpisodeListScrollAudio, slot0._scrollStory)
