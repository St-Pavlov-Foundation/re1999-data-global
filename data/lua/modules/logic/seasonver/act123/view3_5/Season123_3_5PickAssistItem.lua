-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5PickAssistItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5PickAssistItem", package.seeall)

local Season123_3_5PickAssistItem = class("Season123_3_5PickAssistItem", ListScrollCellExtend)

function Season123_3_5PickAssistItem:onInitView()
...
function Season123_3_5PickAssistItem:addEvents()
	self._btnHeroDetail:AddClickListener(self._onHeroDetailClick, self)
end

function Season123_3_5PickAssistItem:removeEvents()
	self._btnHeroDetail:RemoveClickListener()
end

function Season123_3_5PickAssistItem:_onHeroItemClick()
...
function Season123_3_5PickAssistItem:initHeroItem()
...
function Season123_3_5PickAssistItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_3_5PickAssistItem:setSelected(isSelected)
	gohelper.setActive(self.goSelected, isSelected)
end

function Season123_3_5PickAssistItem:onDestroy()
...
function Season123_3_5PickAssistItem:getAnimator()
	return self._animator
end

return Season123_3_5PickAssistItem
