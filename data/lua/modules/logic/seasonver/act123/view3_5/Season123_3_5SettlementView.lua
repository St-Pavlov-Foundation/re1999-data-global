...
function Season123_3_5SettlementView:_refreshRound()
	...
	if self._battleContext.stage and self._battleContext.layer then
		...
		if episodeMO and episodeMO.round then
			...
			self._txtindex.text = totalTimeStr
		end
	end
end
		...
		for i = 1, 4 do
			if trailDict[i] then
				...
				if trialCo then
					...
					local equip_104 = equip123_dic[hero_uid] and equip123_dic[hero_uid].equipId
				...
				local equip_104 = hero_uid ~= "0" and equip123_dic[hero_uid] and equip123_dic[hero_uid].equipId
...
function Season123_3_5SettlementView:refreshStar()
	...
	local episodeMO = curStageMO and curStageMO:getEpisodeMo(self._battleContext.layer or 1)
	local totalStar = Season123Config.instance:getSeasonEpisodeTotalStar(self._episode_config.id)
	local curStar = episodeMO and episodeMO.star or 0
