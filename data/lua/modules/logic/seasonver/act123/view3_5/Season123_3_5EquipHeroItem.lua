-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EquipHeroItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EquipHeroItem", package.seeall)

local Season123_3_5EquipHeroItem = class("Season123_3_5EquipHeroItem", ListScrollCellExtend)

function Season123_3_5EquipHeroItem:init(go)
	Season123_3_5EquipHeroItem.super.init(self, go)
...
function Season123_3_5EquipHeroItem:addEvents()
	return
end

function Season123_3_5EquipHeroItem:removeEvents()
	return
end

function Season123_3_5EquipHeroItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_3_5EquipHeroItem.ColumnCount = 6
Season123_3_5EquipHeroItem.AnimRowCount = 4
Season123_3_5EquipHeroItem.OpenAnimTime = 0.06
Season123_3_5EquipHeroItem.OpenAnimStartTime = 0.05

function Season123_3_5EquipHeroItem:checkPlayAnim()
...
function Season123_3_5EquipHeroItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_3_5EquipHeroItem:refreshUI()
...
function Season123_3_5EquipHeroItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_3_5EquipHeroItem:refreshEquipedHero(heroUid)
...
function Season123_3_5EquipHeroItem:refreshIcon(itemId, itemUid)
...
function Season123_3_5EquipHeroItem:checkCreateIcon()
...
function Season123_3_5EquipHeroItem:setRoleIconDark(value)
	if value then
...
function Season123_3_5EquipHeroItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_3_5EquipHeroItem:checkClickNew(itemUid)
...
Season123_3_5EquipHeroItem.Toast_Same_Card = 2851
Season123_3_5EquipHeroItem.Toast_Wrong_Type = 2852
Season123_3_5EquipHeroItem.Toast_MainRole_Wrong_Type = 2854
Season123_3_5EquipHeroItem.Toast_Other_Hero_Equiped = 2853
Season123_3_5EquipHeroItem.Toast_Career_Wrong = 2859
Season123_3_5EquipHeroItem.Toast_Slot_Lock = 67

function Season123_3_5EquipHeroItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipHeroItemListModel.instance:slotIsLock(Season123EquipHeroItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_3_5EquipHeroItem.Toast_Slot_Lock)
	...
	if isSameCard then
		GameFacade.showToast(Season123_3_5EquipHeroItem.Toast_Same_Card)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipHeroItemListModel.instance.curPos == Season123EquipHeroItemListModel.MainCharPos then
				GameFacade.showToast(Season123_3_5EquipHeroItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_3_5EquipHeroItem.Toast_Wrong_Type)
			end
...
function Season123_3_5EquipHeroItem:onDestroyView()
	if self.icon then
...
return Season123_3_5EquipHeroItem
