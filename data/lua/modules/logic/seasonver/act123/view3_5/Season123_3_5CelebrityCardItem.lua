-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5CelebrityCardItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5CelebrityCardItem", package.seeall)

local Season123_3_5CelebrityCardItem = class("Season123_3_5CelebrityCardItem", LuaCompBase)

Season123_3_5CelebrityCardItem.AssetPath = "ui/viewres/seasonver/v3a5_act123/season123celebritycarditem.prefab"

function Season123_3_5CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season123_3_5CelebrityCardItem.AssetPath
...
function Season123_3_5CelebrityCardItem:handleCardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season123_3_5CelebrityCardEquip)
...
function Season123_3_5CelebrityCardItem:showTag(enable)
...
function Season123_3_5CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season123_3_5CelebrityCardItem:showNewFlag(enable)
...
function Season123_3_5CelebrityCardItem:showNewFlag2(enable)
...
function Season123_3_5CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season123_3_5CelebrityCardItem:setColorDark(enable)
...
function Season123_3_5CelebrityCardItem:destroy()
	if self._icon then
...
return Season123_3_5CelebrityCardItem
