-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5ShowSkillEffectTip.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5ShowSkillEffectTip", package.seeall)

local Season123_3_5ShowSkillEffectTip = class("Season123_3_5ShowSkillEffectTip", LuaCompBase)

function Season123_3_5ShowSkillEffectTip:init(go)
...
function Season123_3_5ShowSkillEffectTip:_btnclosebuffOnClick()
	gohelper.setActive(self._goBuffContainer, false)
...
function Season123_3_5ShowSkillEffectTip:addHyperLinkClick(txtDesc)
...
function Season123_3_5ShowSkillEffectTip:onHyperLinkClick(id, clickPosition)
...
function Season123_3_5ShowSkillEffectTip:createAndGetBufferItem(effectId)
...
function Season123_3_5ShowSkillEffectTip:addChildHyperLinkClick(txtDesc)
	local hyperLinkClick = gohelper.onceAddComponent(txtDesc, typeof(ZProj.TMPHyperLinkClick))

	hyperLinkClick:SetClickListener(self.onChildHyperLinkClick, self)
end

function Season123_3_5ShowSkillEffectTip:onChildHyperLinkClick(id, clickPosition)
	local effectId = tonumber(id)

	self:createAndGetBufferItem(effectId)
end

function Season123_3_5ShowSkillEffectTip:onDestroy()
	self._btnclosebuff:RemoveClickListener()
end

return Season123_3_5ShowSkillEffectTip
