-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5HeroGroupQuickEditItem", package.seeall)

local Season123_3_5HeroGroupQuickEditItem = class("Season123_3_5HeroGroupQuickEditItem", Season123_3_5HeroGroupEditItem)

function Season123_3_5HeroGroupQuickEditItem:init(go)
	Season123_3_5HeroGroupQuickEditItem.super.init(self, go)
...
function Season123_3_5HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_3_5HeroGroupQuickEditItem:updateTrialRepeat(mo)
	if mo and (mo.heroId ~= self._mo.heroId or mo == self._mo) then
		return
	end

	local isRepeat = Season123HeroGroupQuickEditModel.instance:isRepeatHero(self._mo.heroId, self._mo.uid)

	self._heroItem:setTrialRepeat(isRepeat)
end

function Season123_3_5HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123_3_5HeroGroupQuickEditItem:_onItemClick()
	...
	if self._mo:isTrial() and not Season123HeroGroupQuickEditModel.instance:inInTeam(self._mo.uid) and Season123HeroGroupQuickEditModel.instance:isTrialLimit() then
...
function Season123_3_5HeroGroupQuickEditItem:onSelect(select)
...
function Season123_3_5HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123_3_5HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123_3_5HeroGroupQuickEditItem
