-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5DecomposeView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5DecomposeView", package.seeall)

local Season123_3_5DecomposeView = class("Season123_3_5DecomposeView", BaseView)

function Season123_3_5DecomposeView:onInitView()
...
function Season123_3_5DecomposeView:addEvents()
...
function Season123_3_5DecomposeView:removeEvents()
...
function Season123_3_5DecomposeView:_btnminOnClick()
	self.curCount = self.minDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_3_5DecomposeView:_btnsubOnClick()
...
function Season123_3_5DecomposeView:_btnaddOnClick()
...
function Season123_3_5DecomposeView:_btnmaxOnClick()
	self.curCount = self.maxDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_3_5DecomposeView:_btndecomposeOnClick()
...
function Season123_3_5DecomposeView:sendDecomposeEquipRequest()
	local list = {}
...
function Season123_3_5DecomposeView:_onEndEdit()
...
function Season123_3_5DecomposeView:_editableInitView()
	return
end

function Season123_3_5DecomposeView:onOpen()
...
function Season123_3_5DecomposeView:refreshUI()
...
function Season123_3_5DecomposeView:refreshInfoBySelectCount()
	self._inputvalue:SetText(self.curCount)

	self._txtgetCoin.text = luaLang("multiple") .. self.curCount * self.itemConfig.decomposeGet
end

function Season123_3_5DecomposeView:CreateCardIcon()
	if not self.cardIcon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocardpos, "icon")

		self.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_3_5CelebrityCardEquip)
	end
...
function Season123_3_5DecomposeView:showMaterialInfoTip()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self.itemId)
end

function Season123_3_5DecomposeView:onClose()
	return
end

function Season123_3_5DecomposeView:onDestroyView()
	if self.cardIcon then
		self.cardIcon:disposeUI()
	end
end

return Season123_3_5DecomposeView
