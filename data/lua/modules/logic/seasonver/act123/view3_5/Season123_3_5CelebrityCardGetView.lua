-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5CelebrityCardGetView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5CelebrityCardGetView", package.seeall)

local Season123_3_5CelebrityCardGetView = class("Season123_3_5CelebrityCardGetView", BaseViewExtended)

Season123_3_5CelebrityCardGetView.OpenType = {
	Get = 1
}

function Season123_3_5CelebrityCardGetView:onInitView()
...
function Season123_3_5CelebrityCardGetView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_3_5CelebrityCardGetView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_3_5CelebrityCardGetView:_btncloseOnClick()
	self:closeThis()
end

function Season123_3_5CelebrityCardGetView:onOpen()
...
function Season123_3_5CelebrityCardGetView:_showGetCard()
	self:com_loadAsset(Season123_3_5CelebrityCardItem.AssetPath, self._onCardItemLoaded)
end

function Season123_3_5CelebrityCardGetView:_onCardItemLoaded(loader)
	...
	self._scroll_view:setClass(Season123_3_5CelebrityCardGetScrollItem)
...
function Season123_3_5CelebrityCardGetView:isItemID()
	return self.viewParam.is_item_id
end

function Season123_3_5CelebrityCardGetView:onClose()
	return
end

return Season123_3_5CelebrityCardGetView
