-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5RecordWindow.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5RecordWindow", package.seeall)

local Season123_3_5RecordWindow = class("Season123_3_5RecordWindow", BaseView)
local CAN_DISPLAY_ITEM_COUNT = 5
local ITEM_DELAY_ACTIVE_INTERVAL_TIME = 0.06
local BLOCK_TIME_EXTEND = 0.2

function Season123_3_5RecordWindow:onInitView()
...
function Season123_3_5RecordWindow:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_3_5RecordWindow:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_3_5RecordWindow:_btncloseOnClick()
	self:onClickModalMask()
end

function Season123_3_5RecordWindow:onClickModalMask()
	self:closeThis()
end

function Season123_3_5RecordWindow:_editableInitView()
	gohelper.setActive(self._gorecorditem, false)
end

function Season123_3_5RecordWindow:onOpen()
	...
	if bestRecordDataList and #bestRecordDataList > 0 then
		local bestRecordItem = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobestrecorditem, Season123_3_5RecordWindowItem)
	...
	if normalRecordDataList and #normalRecordDataList > 0 then
		...
		gohelper.CreateObjList(self, self._onRecordItemLoad, normalRecordDataList, self._goContent, self._gorecorditem, Season123_3_5RecordWindowItem)
...
function Season123_3_5RecordWindow:_onRecordItemLoad(cellComponent, data, index)
	if not data then
		return
	end
...
function Season123_3_5RecordWindow:_onItemPlayAnimFinish()
	UIBlockMgr.instance:endBlock(self.viewName .. "itemPlayAnim")
end

function Season123_3_5RecordWindow:onClose()
	TaskDispatcher.cancelTask(self._onItemPlayAnimFinish, self)
	self:_onItemPlayAnimFinish()
end

function Season123_3_5RecordWindow:onDestroyView()
	return
end

return Season123_3_5RecordWindow
