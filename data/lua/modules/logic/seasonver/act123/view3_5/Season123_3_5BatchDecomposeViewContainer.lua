-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5BatchDecomposeViewContainer.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5BatchDecomposeViewContainer", package.seeall)

local Season123_3_5BatchDecomposeViewContainer = class("Season123_3_5BatchDecomposeViewContainer", BaseViewContainer)

function Season123_3_5BatchDecomposeViewContainer:buildViews()
	self:createEquipItemsParam()

	return {
		Season123_3_5BatchDecomposeView.New(),
		self.scrollView,
...
function Season123_3_5BatchDecomposeViewContainer:createEquipItemsParam()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "left_container/#go_scrollcontainer/#scroll_equip"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_3_5DecomposeItem
...
function Season123_3_5BatchDecomposeViewContainer:buildTabViews(tabContainerId)
...
function Season123_3_5BatchDecomposeViewContainer:getLineCount()
...
function Season123_3_5BatchDecomposeViewContainer:playCloseTransition()
...
function Season123_3_5BatchDecomposeViewContainer:onCloseAnimDone()
	self:onPlayCloseTransitionFinish()
end

return Season123_3_5BatchDecomposeViewContainer
