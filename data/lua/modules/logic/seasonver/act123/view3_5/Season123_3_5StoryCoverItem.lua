-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5StoryCoverItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5StoryCoverItem", package.seeall)

local Season123_3_5StoryCoverItem = class("Season123_3_5StoryCoverItem", LuaCompBase)

function Season123_3_5StoryCoverItem:ctor(param)
	self.param = param
end

function Season123_3_5StoryCoverItem:init(go)
	self:__onInit()
...
function Season123_3_5StoryCoverItem:addEventListeners()
	self.btnClick:AddClickListener(self.onClickCoverItem, self)
end

function Season123_3_5StoryCoverItem:removeEventListeners()
	self.btnClick:RemoveClickListener()
end

Season123_3_5StoryCoverItem.unlockDelayTime = 1.16

function Season123_3_5StoryCoverItem:refreshItem()
...
function Season123_3_5StoryCoverItem:onClickCoverItem()
...
function Season123_3_5StoryCoverItem:refreshUnlockState(unlockState)
	if self.isUnlock and self.isUnlock ~= unlockState then
		...
		TaskDispatcher.runDelay(self.playUnlockAnim, self, Season123_3_5StoryCoverItem.unlockDelayTime)
...
function Season123_3_5StoryCoverItem:playUnlockAnim()
...
function Season123_3_5StoryCoverItem:onUnlockAnimDone()
	gohelper.setActive(self.goLocked, not self.isUnlock)
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
end

function Season123_3_5StoryCoverItem:destroy()
	self:__onDispose()
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
	TaskDispatcher.cancelTask(self.playUnlockAnim, self)
end

return Season123_3_5StoryCoverItem
