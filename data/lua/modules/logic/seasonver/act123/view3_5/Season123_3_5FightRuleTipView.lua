-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5FightRuleTipView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5FightRuleTipView", package.seeall)

local Season123_3_5FightRuleTipView = class("Season123_3_5FightRuleTipView", BaseView)

function Season123_3_5FightRuleTipView:onInitView()
...
function Season123_3_5FightRuleTipView:_btncloseOnClick()
	self:_closeView()
end

function Season123_3_5FightRuleTipView:_closeView()
	self:closeThis()
end

function Season123_3_5FightRuleTipView:onOpen()
...
function Season123_3_5FightRuleTipView:createTab(go, tabType)
...
function Season123_3_5FightRuleTipView:updateTab(tab, active, tabNum)
	if active then
...
function Season123_3_5FightRuleTipView:destroyTab(item)
	if item then
		item.btn:RemoveClickListener()
	end
end

function Season123_3_5FightRuleTipView:onClickTab(item)
	if not item then
		return
	end
...
function Season123_3_5FightRuleTipView:switchTab(type)
...
function Season123_3_5FightRuleTipView:getTabActive(tabType)
...
function Season123_3_5FightRuleTipView:onClose()
	return
end

function Season123_3_5FightRuleTipView:onDestroyView()
...
return Season123_3_5FightRuleTipView
