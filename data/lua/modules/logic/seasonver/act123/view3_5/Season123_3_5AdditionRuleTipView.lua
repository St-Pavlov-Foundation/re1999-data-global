-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5AdditionRuleTipView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5AdditionRuleTipView", package.seeall)

local Season123_3_5AdditionRuleTipView = class("Season123_3_5AdditionRuleTipView", BaseView)

function Season123_3_5AdditionRuleTipView:onInitView()
...
function Season123_3_5AdditionRuleTipView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_3_5AdditionRuleTipView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_3_5AdditionRuleTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_3_5AdditionRuleTipView:onOpen()
...
function Season123_3_5AdditionRuleTipView:getOrCreateItem(index)
...
function Season123_3_5AdditionRuleTipView:updateItem(item, ruleId)
	if not ruleId then
...
function Season123_3_5AdditionRuleTipView:onClose()
	return
end

return Season123_3_5AdditionRuleTipView
