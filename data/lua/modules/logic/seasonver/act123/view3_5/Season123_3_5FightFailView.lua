-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5FightFailView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5FightFailView", package.seeall)

local Season123_3_5FightFailView = class("Season123_3_5FightFailView", FightFailView)

function Season123_3_5FightFailView:onInitView()
...
function Season123_3_5FightFailView:addEvents()
	self._click:AddClickListener(self._onClickClose, self)
	self._btndata:AddClickListener(self._onClickData, self)
end

function Season123_3_5FightFailView:removeEvents()
	self._click:RemoveClickListener()
	self._btndata:RemoveClickListener()
end

function Season123_3_5FightFailView:_editableInitView()
...
function Season123_3_5FightFailView:onOpen()
...
function Season123_3_5FightFailView:refreshTips()
...
function Season123_3_5FightFailView:onClose()
	Season123_3_5FightFailView.super.onClose(self)
end

function Season123_3_5FightFailView:onDestroyView()
	Season123_3_5FightFailView.super.onDestroyView(self)
end

return Season123_3_5FightFailView
