...
slot0 = class("Season123ShowHeroItem", UserDataDispose)
...
function slot0.initComponent(slot0)
	...
	slot5 = "rare"
	slot0._gorare = gohelper.findChild(slot0._gohero, slot5)
...
function slot0.refreshUI(slot0)
	...
	if slot1 then
		...
		if not SkinConfig.instance:getSkinCo(slot1.skin) then
			logError("Season123ShowHeroItem.refreshUI error, skinCfg is nil, id:" .. tostring(slot1.skin))
