-- chunkname: @modules/logic/seasonver/act123/view/Season123EpisodeLoadingView.lua

module("modules.logic.seasonver.act123.view.Season123EpisodeLoadingView", package.seeall)

local Season123EpisodeLoadingView = class("Season123EpisodeLoadingView", BaseView)

function Season123EpisodeLoadingView:onInitView()
...
function Season123EpisodeLoadingView:addEvents()
	return
end

function Season123EpisodeLoadingView:removeEvents()
	return
end

function Season123EpisodeLoadingView:_editableInitView()
	self._stageItems = {}
end

function Season123EpisodeLoadingView:onDestroyView()
...
function Season123EpisodeLoadingView:onOpen()
	local actId = self.viewParam.actId
	local stage = self.viewParam.stage
	local layer = self.viewParam.layer

	logNormal(string.format("Season123EpisodeLoadingView actId=%s, stage=%s", actId, stage))
...
function Season123EpisodeLoadingView:onClose()
	return
end

function Season123EpisodeLoadingView:refreshUI()
	self:refreshStageList()
end

function Season123EpisodeLoadingView:refreshStageList()
...
function Season123EpisodeLoadingView:getOrCreateStageItem(index)
...
function Season123EpisodeLoadingView:refreshSingleItem(index, item, data)
...
function Season123EpisodeLoadingView:refreshSingleItemLock(index, item, data)
	if data.emptyIndex then
...
function Season123EpisodeLoadingView:refreshSingleItemFinished(index, item, data)
	if data.emptyIndex then
