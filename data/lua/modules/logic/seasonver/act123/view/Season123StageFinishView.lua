-- chunkname: @modules/logic/seasonver/act123/view/Season123StageFinishView.lua

module("modules.logic.seasonver.act123.view.Season123StageFinishView", package.seeall)

local Season123StageFinishView = class("Season123StageFinishView", BaseView)

function Season123StageFinishView:onInitView()
...
function Season123StageFinishView:addEvents()
	return
end

function Season123StageFinishView:removeEvents()
	return
end

function Season123StageFinishView:_editableInitView()
...
function Season123StageFinishView:onDestroyView()
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123StageFinishView:onOpen()
...
function Season123StageFinishView:handleDelayAnimTransition()
...
function Season123StageFinishView:lightStar()
...
function Season123StageFinishView:light()
...
function Season123StageFinishView:firstPassStage(actId, stage)
...
function Season123StageFinishView:setAlreadyPass(actId, stage)
	local key = self:getPassKey(actId, stage)
...
function Season123StageFinishView:getPassKey(actId, stage)
	return "FirstPassStage" .. tostring(self.userId) .. "#" .. tostring(actId) .. tostring(stage)
end

return Season123StageFinishView
