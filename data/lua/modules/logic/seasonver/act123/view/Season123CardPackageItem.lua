-- chunkname: @modules/logic/seasonver/act123/view/Season123CardPackageItem.lua

module("modules.logic.seasonver.act123.view.Season123CardPackageItem", package.seeall)

local Season123CardPackageItem = class("Season123CardPackageItem", ListScrollCellExtend)

function Season123CardPackageItem:init(go)
	Season123CardPackageItem.super.init(self, go)
...
function Season123CardPackageItem:addEventListeners()
	return
end

function Season123CardPackageItem:removeEventListeners()
	return
end

function Season123CardPackageItem:onUpdateMO(mo)
	self._mo = mo

	self:refreshUI()
end

function Season123CardPackageItem:refreshUI()
...
function Season123CardPackageItem:checkCreateIcon()
...
function Season123CardPackageItem:onClickSelf()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self._mo.itemId)
end

function Season123CardPackageItem:getAnimator()
	self._animator.enabled = true

	return self._animator
end

function Season123CardPackageItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
end

return Season123CardPackageItem
