...
slot0 = class("Season123EntryCamera", UserDataDispose)
...
function slot0.dispose(slot0)
	slot0:killTween()
	slot0:__onDispose()
	MainCameraMgr.instance:addView(ViewName.Season123EntryView, nil, , )
end
...
function slot0.initCamera(slot0)
	...
	MainCameraMgr.instance:addView(ViewName.Season123EntryView, slot0.onScreenResize, slot0.resetCamera, slot0)
