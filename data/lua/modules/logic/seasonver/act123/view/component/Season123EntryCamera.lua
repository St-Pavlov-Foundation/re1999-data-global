...
local var_0_0 = class("Season123EntryCamera", UserDataDispose)
...
function var_0_0.initCamera(arg_3_0)
	...
	MainCameraMgr.instance:addView(ViewName.Season123EntryView, arg_3_0.onScreenResize, arg_3_0.resetCamera, arg_3_0)
