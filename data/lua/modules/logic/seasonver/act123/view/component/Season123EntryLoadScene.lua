...
local var_0_0 = class("Season123EntryLoadScene", UserDataDispose)
...
function var_0_0.createSceneRoot(arg_3_0)
	...
	arg_3_0._sceneRoot = UnityEngine.GameObject.New("Season123EntryScene")
...
var_0_0.BLOCK_LOAD_RES_KEY = "Season123EntrySceneLoadRes"
...
function var_0_0.getSceneFolderPath(arg_21_0)
	local var_21_0 = Season123EntryModel.instance.activityId
	local var_21_1 = Activity123Enum.SeasonResourcePrefix[var_21_0] or Season123Model.instance:getCurSeasonId()

	return (string.format("%s%s", var_21_1, Activity123Enum.SceneFolderPath))
end

function var_0_0.getDefaultBackgroundPrefab(arg_22_0)
	local var_22_0 = Season123EntryModel.instance.activityId
	local var_22_1 = Activity123Enum.SeasonResourcePrefix[var_22_0] or Season123Model.instance:getCurSeasonId()
