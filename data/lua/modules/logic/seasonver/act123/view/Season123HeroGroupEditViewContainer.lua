...
slot0 = class("Season123HeroGroupEditViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = Season123HeroGroupEditItem
...
function slot0.getQuickEditScroll(slot0)
	...
	slot1.cellClass = Season123HeroGroupQuickEditItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = 5
	slot1.cellWidth = 200
	slot1.cellHeight = 472
