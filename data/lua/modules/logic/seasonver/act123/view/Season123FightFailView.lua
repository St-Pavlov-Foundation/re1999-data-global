-- chunkname: @modules/logic/seasonver/act123/view/Season123FightFailView.lua

module("modules.logic.seasonver.act123.view.Season123FightFailView", package.seeall)

local Season123FightFailView = class("Season123FightFailView", FightFailView)

function Season123FightFailView:onInitView()
...
function Season123FightFailView:onOpen()
...
function Season123FightFailView:refreshTips()
...
function Season123FightFailView:onClose()
	Season123FightFailView.super.onClose(self)
end

function Season123FightFailView:onDestroyView()
	Season123FightFailView.super.onDestroyView(self)
end

return Season123FightFailView
