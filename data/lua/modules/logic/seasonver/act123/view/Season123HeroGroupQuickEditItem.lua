-- chunkname: @modules/logic/seasonver/act123/view/Season123HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view.Season123HeroGroupQuickEditItem", package.seeall)

local Season123HeroGroupQuickEditItem = class("Season123HeroGroupQuickEditItem", Season123HeroGroupEditItem)

function Season123HeroGroupQuickEditItem:init(go)
	Season123HeroGroupQuickEditItem.super.init(self, go)
...
function Season123HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123HeroGroupQuickEditItem:_onItemClick()
...
function Season123HeroGroupQuickEditItem:onSelect(select)
...
function Season123HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123HeroGroupQuickEditItem
