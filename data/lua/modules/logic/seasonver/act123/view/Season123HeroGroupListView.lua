...
local var_0_0 = class("Season123HeroGroupListView", BaseView)
...
function var_0_0._editableInitView(arg_2_0)
	...
	for iter_2_0 = 1, 4 do
		...
		local var_2_2 = MonoHelper.addNoUpdateLuaComOnceToGo(var_2_1, Season123HeroGroupHeroItem, arg_2_0)
	...
	for iter_2_2 = 1, 4 do
		local var_2_5 = gohelper.findChild(arg_2_0.viewGO, "herogroupcontain/hero/bg" .. iter_2_2 .. "/bg")

		table.insert(arg_2_0._bgList, var_2_5)
	end
...
function var_0_0._onEndDrag(arg_14_0, arg_14_1, arg_14_2)
	...
	if not var_14_11 or not var_14_13 then
		...
		if not var_14_11 then
			GameFacade.showToast(Season123EquipItem.Toast_Pos_Wrong, var_14_12)
		end

		if not var_14_13 then
			GameFacade.showToast(Season123EquipItem.Toast_Pos_Wrong, var_14_14)
		end
...
function var_0_0._updateHeroList(arg_20_0)
	for iter_20_0, iter_20_1 in ipairs(arg_20_0._heroItemList) do
		if Season123HeroGroupModel.instance:isEpisodeSeason123() or Season123HeroGroupModel.instance:isEpisodeSeason123Retail() then
			...
			local var_20_1 = {}
			local var_20_2 = HeroSingleGroupMO.New()

			var_20_2.id = iter_20_0
			var_20_2.heroUid = var_20_0.heroList[iter_20_0]

			if var_20_0.isReplay then
				local var_20_3 = var_20_0.replay_hero_data[var_20_2.heroUid]

				iter_20_1:onUpdateMO(var_20_2, arg_20_0.viewParam, var_20_3)
			else
				iter_20_1:onUpdateMO(var_20_2, arg_20_0.viewParam)
			end
		else
			local var_20_4 = HeroSingleGroupModel.instance:getById(iter_20_0)

			iter_20_1:onUpdateMO(var_20_4, arg_20_0.viewParam)
		end
	end
end
