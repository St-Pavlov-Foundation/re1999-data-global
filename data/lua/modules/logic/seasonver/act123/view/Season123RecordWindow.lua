...
slot0 = class("Season123RecordWindow", BaseView)
slot1 = 5
slot2 = 0.06
slot3 = 0.2
...
function slot0.onOpen(slot0)
	if Season123RecordModel.instance:getRecordList(true) and #slot1 > 0 then
		MonoHelper.addNoUpdateLuaComOnceToGo(slot0._gobestrecorditem, Season123RecordWindowItem):onUpdateMO(slot1[1])
	...
	if Season123RecordModel.instance:getRecordList(false) and #slot2 > 0 then
		...
		gohelper.CreateObjList(slot0, slot0._onRecordItemLoad, slot2, slot0._goContent, slot0._gorecorditem, Season123RecordWindowItem)
