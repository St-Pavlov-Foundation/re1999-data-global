...
local var_0_0 = class("Season123CelebrityCardItem", LuaCompBase)

var_0_0.AssetPath = "ui/viewres/seasonver/act123/season123celebritycarditem.prefab"
...
function var_0_0.handleCardLoaded(arg_2_0)
	...
	arg_2_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(arg_2_0._cardGo, Season123CelebrityCardEquip)
