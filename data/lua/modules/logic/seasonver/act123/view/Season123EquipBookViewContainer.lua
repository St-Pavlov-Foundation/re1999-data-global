...
local var_0_0 = class("Season123EquipBookViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	arg_1_0:createEquipItemsParam()

	local var_1_0 = Season123EquipFloatTouch.New()
...
function var_0_0.createEquipItemsParam(arg_2_0)
	...
	var_2_0.cellClass = Season123EquipBookItem
	var_2_0.scrollDir = ScrollEnum.ScrollDirV
	var_2_0.lineCount = Season123EquipBookItem.ColumnCount
	var_2_0.cellWidth = 170
	var_2_0.cellHeight = 235
	var_2_0.cellSpaceH = 8.2
	var_2_0.cellSpaceV = 1.74
	var_2_0.frameUpdateMs = 100
	var_2_0.minUpdateCountInFrame = Season123EquipBookItem.ColumnCount
