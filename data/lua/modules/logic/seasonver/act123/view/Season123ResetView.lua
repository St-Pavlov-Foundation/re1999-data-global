...
slot0 = class("Season123ResetView", BaseView)
...
function slot0.refreshSingleItemFinished(slot0, slot1, slot2, slot3)
	...
	if slot5 then
		slot2.txttime.text = tostring(slot3.round)
	end
...
function slot0.delayInitScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollchapter, Season123ResetViewAudio, slot0._scrollchapter)
