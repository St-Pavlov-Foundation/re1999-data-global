-- chunkname: @modules/logic/seasonver/act123/view/Season123EquipHeroItem.lua

module("modules.logic.seasonver.act123.view.Season123EquipHeroItem", package.seeall)

local Season123EquipHeroItem = class("Season123EquipHeroItem", ListScrollCellExtend)

function Season123EquipHeroItem:init(go)
	Season123EquipHeroItem.super.init(self, go)
...
function Season123EquipHeroItem:addEvents()
	return
end

function Season123EquipHeroItem:removeEvents()
	return
end

function Season123EquipHeroItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123EquipHeroItem.ColumnCount = 6
Season123EquipHeroItem.AnimRowCount = 4
Season123EquipHeroItem.OpenAnimTime = 0.06
Season123EquipHeroItem.OpenAnimStartTime = 0.05

function Season123EquipHeroItem:checkPlayAnim()
...
function Season123EquipHeroItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123EquipHeroItem:refreshUI()
...
function Season123EquipHeroItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123EquipHeroItem:refreshEquipedHero(heroUid)
...
function Season123EquipHeroItem:refreshIcon(itemId, itemUid)
...
function Season123EquipHeroItem:checkCreateIcon()
...
function Season123EquipHeroItem:setRoleIconDark(value)
	if value then
...
function Season123EquipHeroItem:onClickSelf()
	local itemUid = self._uid
...
function Season123EquipHeroItem:checkClickNew(itemUid)
...
Season123EquipHeroItem.Toast_Same_Card = 2851
Season123EquipHeroItem.Toast_Wrong_Type = 2852
Season123EquipHeroItem.Toast_MainRole_Wrong_Type = 2854
Season123EquipHeroItem.Toast_Other_Hero_Equiped = 2853
Season123EquipHeroItem.Toast_Career_Wrong = 2859
Season123EquipHeroItem.Toast_Slot_Lock = 67

function Season123EquipHeroItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipHeroItemListModel.instance:slotIsLock(Season123EquipHeroItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123EquipHeroItem.Toast_Slot_Lock)
	...
	if isSameCard then
		GameFacade.showToast(Season123EquipHeroItem.Toast_Same_Card)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipHeroItemListModel.instance.curPos == Season123EquipHeroItemListModel.MainCharPos then
				GameFacade.showToast(Season123EquipHeroItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123EquipHeroItem.Toast_Wrong_Type)
			end
...
function Season123EquipHeroItem:onDestroyView()
	if self.icon then
