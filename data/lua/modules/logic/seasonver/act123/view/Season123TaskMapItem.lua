...
local var_0_0 = class("Season123TaskMapItem", LuaCompBase)
...
function var_0_0.refreshUI(arg_6_0)
	...
	local var_6_4 = Season123Model.instance:getSingleBgFolder()

	arg_6_0._simageicon:LoadImage(ResUrl.getSeason123Icon(var_6_4, "v1a7_season_pic_" .. arg_6_0.stage))
	...
	local var_6_5 = var_6_1.stageMap[arg_6_0.stage]

	if var_6_5 then
		local var_6_6 = var_6_5.minRound

		arg_6_0._txttime.text = tostring(var_6_6)

		gohelper.setActive(arg_6_0._gofinish, var_6_6 > 0)
	else
	...
	local var_6_7 = Season123TaskModel.instance.curStage == arg_6_0.stage and 1 or 0.7

	transformhelper.setLocalScale(arg_6_0._goroot.transform, var_6_7, var_6_7, var_6_7)
end
