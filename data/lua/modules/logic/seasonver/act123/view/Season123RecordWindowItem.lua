...
slot0 = class("Season123RecordWindowItem", LuaCompBase)
slot1 = 6
...
function slot0.init(slot0, slot1)
	...
	slot0._imgBestCircle = gohelper.findChildImage(slot0.go, "#go_normalrecord/totaltime/#go_bestcircle")
	slot0._goBlueTxtTime = gohelper.findChild(slot0.go, "#go_normalrecord/totaltime/#go_bestcircle/#txt_timeblue")
...
function slot0.onUpdateMO(slot0, slot1)
	...
	slot0._txttime.text = slot0.mo.round or 0

	gohelper.setActive(slot0._gobestrecord, slot3)
	gohelper.setActive(slot0._goBestBg, slot3)
	gohelper.setActive(slot0._goBlueTxtTime, slot3)

	slot0._imgBestCircle.enabled = slot3
