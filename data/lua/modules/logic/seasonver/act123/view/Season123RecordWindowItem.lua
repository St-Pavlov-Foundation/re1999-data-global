...
local var_0_0 = class("Season123RecordWindowItem", LuaCompBase)
local var_0_1 = 6
...
function var_0_0.init(arg_1_0, arg_1_1)
	...
	arg_1_0._imgBestCircle = gohelper.findChildImage(arg_1_0.go, "#go_normalrecord/totaltime/#go_bestcircle")
	arg_1_0._goBlueTxtTime = gohelper.findChild(arg_1_0.go, "#go_normalrecord/totaltime/#go_bestcircle/#txt_timeblue")
...
function var_0_0.onUpdateMO(arg_7_0, arg_7_1)
	...
	gohelper.setActive(arg_7_0._goBlueTxtTime, var_7_1)

	arg_7_0._imgBestCircle.enabled = var_7_1
