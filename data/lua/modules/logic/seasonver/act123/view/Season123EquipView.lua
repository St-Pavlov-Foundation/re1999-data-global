...
function var_0_0._editableInitView(arg_6_0)
	...
	arg_6_0._slotItems = {}
	arg_6_0._descItems = {}
	arg_6_0._skillContainer = MonoHelper.addNoUpdateLuaComOnceToGo(arg_6_0._gobuffContainer, Season123ShowSkillEffectTip)
end
...
function var_0_0.getOrCreateSlotIcon(arg_21_0, arg_21_1)
	...
	if not var_21_0 then
		...
		var_21_0 = MonoHelper.addNoUpdateLuaComOnceToGo(var_21_2, Season123CelebrityCardEquip)
