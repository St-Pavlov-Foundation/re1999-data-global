...
function Season123EquipView:_rebuildLayout_overseas(listItem)
...
function Season123EquipView:_editableInitView()
	...
	self._slotItems = {}
	self._descItems = {}
	self._skillContainer = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobuffContainer, Season123ShowSkillEffectTip)
end
