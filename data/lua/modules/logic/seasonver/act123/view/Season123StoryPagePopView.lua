-- chunkname: @modules/logic/seasonver/act123/view/Season123StoryPagePopView.lua

module("modules.logic.seasonver.act123.view.Season123StoryPagePopView", package.seeall)

local Season123StoryPagePopView = class("Season123StoryPagePopView", BaseView)

function Season123StoryPagePopView:onInitView()
...
function Season123StoryPagePopView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123StoryPagePopView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123StoryPagePopView:_btncloseOnClick()
	self:closeThis()
end

function Season123StoryPagePopView:_editableInitView()
	return
end

function Season123StoryPagePopView:onUpdateParam()
	return
end

function Season123StoryPagePopView:onOpen()
...
function Season123StoryPagePopView:refreshDetailPageUI()
...
function Season123StoryPagePopView:onClose()
	Season123Controller.instance:dispatchEvent(Season123Event.GuideEntryOtherViewClose)
end

function Season123StoryPagePopView:onDestroyView()
	self._simagePolaroid:UnLoadImage()
end

return Season123StoryPagePopView
