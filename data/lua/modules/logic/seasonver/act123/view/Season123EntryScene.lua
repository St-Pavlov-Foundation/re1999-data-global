...
local var_0_0 = class("Season123EntryScene", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0._cameraHelper = Season123EntryCamera.New()

	arg_4_0._cameraHelper:init()

	arg_4_0._loadHelper = Season123EntryLoadScene.New()
...
function var_0_0.onSceneResLoaded(arg_8_0, arg_8_1)
	...
	arg_8_0._dragHelper = Season123EntryDrag.New()
...
function var_0_0.refreshRetail(arg_11_0, arg_11_1)
	...
	arg_11_0._loadHelper:showRetailRes(arg_11_0._retailId)
end
...
function var_0_0.handleRetailObjLoaded(arg_17_0, arg_17_1)
	if arg_17_0._retailId and arg_17_0._retailFocusId == nil then
		local var_17_0, var_17_1 = Season123EntryModel.getRandomRetailRes(arg_17_0._retailId)
...
function var_0_0.tryFocusOnRetailObj(arg_18_0)
	if arg_18_0._retailId and arg_18_0._retailFocusId == nil then
		local var_18_0, var_18_1 = Season123EntryModel.getRandomRetailRes(arg_18_0._retailId)
