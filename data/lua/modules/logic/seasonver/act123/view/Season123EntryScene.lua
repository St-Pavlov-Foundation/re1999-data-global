...
slot0 = class("Season123EntryScene", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._cameraHelper = Season123EntryCamera.New()

	slot0._cameraHelper:init()

	slot0._loadHelper = Season123EntryLoadScene.New()
...
function slot0.onSceneResLoaded(slot0, slot1)
	...
	slot0._dragHelper = Season123EntryDrag.New()
...
function slot0.refreshRetail(slot0, slot1)
	...
	slot0._loadHelper:showRetailRes(slot0._retailId)
end
...
function slot0.handleRetailObjLoaded(slot0, slot1)
	if slot0._retailId and slot0._retailFocusId == nil then
		slot2, slot3 = Season123EntryModel.getRandomRetailRes(slot0._retailId)
...
function slot0.tryFocusOnRetailObj(slot0)
	if slot0._retailId and slot0._retailFocusId == nil then
		slot1, slot2 = Season123EntryModel.getRandomRetailRes(slot0._retailId)
