-- chunkname: @modules/logic/seasonver/act123/view/Season123PickAssistItem.lua

module("modules.logic.seasonver.act123.view.Season123PickAssistItem", package.seeall)

local Season123PickAssistItem = class("Season123PickAssistItem", ListScrollCellExtend)

function Season123PickAssistItem:onInitView()
...
function Season123PickAssistItem:addEvents()
	self._btnHeroDetail:AddClickListener(self._onHeroDetailClick, self)
end

function Season123PickAssistItem:removeEvents()
	self._btnHeroDetail:RemoveClickListener()
end

function Season123PickAssistItem:_onHeroItemClick()
...
function Season123PickAssistItem:initHeroItem()
...
function Season123PickAssistItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123PickAssistItem:setSelected(isSelected)
	gohelper.setActive(self.goSelected, isSelected)
end

function Season123PickAssistItem:onDestroy()
...
function Season123PickAssistItem:getAnimator()
	return self._animator
end

return Season123PickAssistItem
