-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9StageFinishView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9StageFinishView", package.seeall)

local Season123_1_9StageFinishView = class("Season123_1_9StageFinishView", BaseView)

function Season123_1_9StageFinishView:onInitView()
...
function Season123_1_9StageFinishView:addEvents()
	return
end

function Season123_1_9StageFinishView:removeEvents()
	return
end

function Season123_1_9StageFinishView:_editableInitView()
...
function Season123_1_9StageFinishView:onDestroyView()
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_1_9StageFinishView:onOpen()
...
function Season123_1_9StageFinishView:onClose()
	TaskDispatcher.cancelTask(self.lightStar, self)
	TaskDispatcher.cancelTask(self.light, self)
	TaskDispatcher.cancelTask(self.handleDelayAnimTransition, self)
end

function Season123_1_9StageFinishView:refreshUI()
...
function Season123_1_9StageFinishView:handleDelayAnimTransition()
...
function Season123_1_9StageFinishView:lightStar()
...
function Season123_1_9StageFinishView:light()
...
function Season123_1_9StageFinishView:firstPassStage(actId, stage)
...
function Season123_1_9StageFinishView:setAlreadyPass(actId, stage)
	local key = self:getPassKey(actId, stage)
...
function Season123_1_9StageFinishView:getPassKey(actId, stage)
	return "FirstPassStage" .. tostring(self.userId) .. "#" .. tostring(actId) .. tostring(stage)
end

return Season123_1_9StageFinishView
