...
local var_0_0 = class("Season123_1_9CardPackageViewContainer", BaseViewContainer)
...
function var_0_0.buildTabViews(arg_2_0, arg_2_1)
	if arg_2_1 == 1 then
		...
		var_2_0:setHelpId(HelpEnum.HelpId.Season1_9CardGetViewHelp)
...
function var_0_0.buildScrollViews(arg_3_0)
	...
	var_3_0.cellClass = Season123_1_9CardPackageItem
