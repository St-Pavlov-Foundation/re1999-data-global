-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9StoreViewContainer.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9StoreViewContainer", package.seeall)

local Season123_1_9StoreViewContainer = class("Season123_1_9StoreViewContainer", BaseViewContainer)

function Season123_1_9StoreViewContainer:buildViews()
	self:buildScrollViews()

	local views = {}

	table.insert(views, self.scrollView)
	table.insert(views, Season123_1_9StoreView.New())
...
function Season123_1_9StoreViewContainer:buildTabViews(tabContainerId)
...
function Season123_1_9StoreViewContainer:buildScrollViews()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "mask/#scroll_store"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_1_9StoreItem
...
return Season123_1_9StoreViewContainer
