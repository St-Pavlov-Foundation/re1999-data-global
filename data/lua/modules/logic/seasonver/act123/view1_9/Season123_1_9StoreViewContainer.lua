...
local var_0_0 = class("Season123_1_9StoreViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	table.insert(var_1_0, Season123_1_9StoreView.New())
...
function var_0_0.buildTabViews(arg_2_0, arg_2_1)
	...
	if arg_2_1 == 2 then
		local var_2_0 = Season123Model.instance:getCurSeasonId()
...
function var_0_0.buildScrollViews(arg_3_0)
	...
	var_3_0.cellClass = Season123_1_9StoreItem
