...
slot0 = class("Season123_1_9EntryLoadScene", UserDataDispose)
...
function slot0.createSceneRoot(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New("Season123_1_9EntryScene")
...
slot0.BLOCK_LOAD_RES_KEY = "Season123_1_9EntrySceneLoadRes"
