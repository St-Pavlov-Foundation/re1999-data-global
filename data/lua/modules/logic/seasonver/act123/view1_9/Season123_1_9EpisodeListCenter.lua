-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EpisodeListCenter.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EpisodeListCenter", package.seeall)

local Season123_1_9EpisodeListCenter = class("Season123_1_9EpisodeListCenter", UserDataDispose)

function Season123_1_9EpisodeListCenter:ctor()
	self:__onInit()
end

function Season123_1_9EpisodeListCenter:dispose()
	self:__onDispose()
end

function Season123_1_9EpisodeListCenter:init(viewGO)
	self.viewGO = viewGO

	self:initComponent()
end

function Season123_1_9EpisodeListCenter:initComponent()
...
function Season123_1_9EpisodeListCenter:initData(actId, stage)
	self._actId = actId
	self._stageId = stage
end

function Season123_1_9EpisodeListCenter:refreshUI()
...
function Season123_1_9EpisodeListCenter:refreshRound()
...
Season123_1_9EpisodeListCenter.NoStarTimeAnchorY = -176
Season123_1_9EpisodeListCenter.WithStarTimeAnchorY = -86

function Season123_1_9EpisodeListCenter:refreshProgress()
	...
	if isShowStar then
		recthelper.setAnchorY(self._tftime, Season123_1_9EpisodeListCenter.WithStarTimeAnchorY)
	else
		recthelper.setAnchorY(self._tftime, Season123_1_9EpisodeListCenter.NoStarTimeAnchorY)
	end
end

return Season123_1_9EpisodeListCenter
