-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9DecomposeView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9DecomposeView", package.seeall)

local Season123_1_9DecomposeView = class("Season123_1_9DecomposeView", BaseView)

function Season123_1_9DecomposeView:onInitView()
...
function Season123_1_9DecomposeView:addEvents()
...
function Season123_1_9DecomposeView:removeEvents()
...
function Season123_1_9DecomposeView:_btnminOnClick()
	self.curCount = self.minDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_1_9DecomposeView:_btnsubOnClick()
...
function Season123_1_9DecomposeView:_btnaddOnClick()
...
function Season123_1_9DecomposeView:_btnmaxOnClick()
	self.curCount = self.maxDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_1_9DecomposeView:_btndecomposeOnClick()
...
function Season123_1_9DecomposeView:sendDecomposeEquipRequest()
	local list = {}
...
function Season123_1_9DecomposeView:_onEndEdit()
...
function Season123_1_9DecomposeView:_editableInitView()
	return
end

function Season123_1_9DecomposeView:onOpen()
...
function Season123_1_9DecomposeView:refreshUI()
...
function Season123_1_9DecomposeView:refreshInfoBySelectCount()
	self._inputvalue:SetText(self.curCount)

	self._txtgetCoin.text = luaLang("multiple") .. self.curCount * self.itemConfig.decomposeGet
end

function Season123_1_9DecomposeView:CreateCardIcon()
	if not self.cardIcon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocardpos, "icon")

		self.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_1_9CelebrityCardEquip)
	end
...
function Season123_1_9DecomposeView:showMaterialInfoTip()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self.itemId)
end

function Season123_1_9DecomposeView:onClose()
	return
end

function Season123_1_9DecomposeView:onDestroyView()
	if self.cardIcon then
		self.cardIcon:disposeUI()
	end
end

return Season123_1_9DecomposeView
