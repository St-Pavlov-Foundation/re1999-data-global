...
local var_0_0 = class("Season123_1_9DecomposeView", BaseView)
...
function var_0_0.CreateCardIcon(arg_15_0)
	if not arg_15_0.cardIcon then
		...
		arg_15_0.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(var_15_1, Season123_1_9CelebrityCardEquip)
	end
