-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9SettlementTipsWork.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9SettlementTipsWork", package.seeall)

local Season123_1_9SettlementTipsWork = class("Season123_1_9SettlementTipsWork", BaseWork)

function Season123_1_9SettlementTipsWork:onStart(context)
...
function Season123_1_9SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season123_1_9SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season123_1_9SettlementTipsWork:_showGetCardView()
...
function Season123_1_9SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season123_1_9SettlementTipsWork
