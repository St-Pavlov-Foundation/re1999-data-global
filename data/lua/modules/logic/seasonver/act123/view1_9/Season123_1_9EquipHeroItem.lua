-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EquipHeroItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EquipHeroItem", package.seeall)

local Season123_1_9EquipHeroItem = class("Season123_1_9EquipHeroItem", ListScrollCellExtend)

function Season123_1_9EquipHeroItem:init(go)
	Season123_1_9EquipHeroItem.super.init(self, go)
...
function Season123_1_9EquipHeroItem:addEvents()
	return
end

function Season123_1_9EquipHeroItem:removeEvents()
	return
end

function Season123_1_9EquipHeroItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_1_9EquipHeroItem.ColumnCount = 6
Season123_1_9EquipHeroItem.AnimRowCount = 4
Season123_1_9EquipHeroItem.OpenAnimTime = 0.06
Season123_1_9EquipHeroItem.OpenAnimStartTime = 0.05

function Season123_1_9EquipHeroItem:checkPlayAnim()
...
function Season123_1_9EquipHeroItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_1_9EquipHeroItem:refreshUI()
...
function Season123_1_9EquipHeroItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_1_9EquipHeroItem:refreshEquipedHero(heroUid)
...
function Season123_1_9EquipHeroItem:refreshIcon(itemId, itemUid)
...
function Season123_1_9EquipHeroItem:checkCreateIcon()
...
function Season123_1_9EquipHeroItem:setRoleIconDark(value)
	if value then
...
function Season123_1_9EquipHeroItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_1_9EquipHeroItem:checkClickNew(itemUid)
...
Season123_1_9EquipHeroItem.Toast_Same_Card = 2851
Season123_1_9EquipHeroItem.Toast_Wrong_Type = 2852
Season123_1_9EquipHeroItem.Toast_MainRole_Wrong_Type = 2854
Season123_1_9EquipHeroItem.Toast_Other_Hero_Equiped = 2853
Season123_1_9EquipHeroItem.Toast_Career_Wrong = 2859
Season123_1_9EquipHeroItem.Toast_Slot_Lock = 67

function Season123_1_9EquipHeroItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipHeroItemListModel.instance:slotIsLock(Season123EquipHeroItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_1_9EquipHeroItem.Toast_Slot_Lock)
	...
	if isSameCard then
		GameFacade.showToast(Season123_1_9EquipHeroItem.Toast_Same_Card)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipHeroItemListModel.instance.curPos == Season123EquipHeroItemListModel.MainCharPos then
				GameFacade.showToast(Season123_1_9EquipHeroItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_1_9EquipHeroItem.Toast_Wrong_Type)
			end
...
function Season123_1_9EquipHeroItem:onDestroyView()
	if self.icon then
...
return Season123_1_9EquipHeroItem
