-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EntryItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EntryItem", package.seeall)

local Season123_1_9EntryItem = class("Season123_1_9EntryItem", UserDataDispose)

function Season123_1_9EntryItem:ctor()
	self:__onInit()
end

function Season123_1_9EntryItem:dispose()
	TaskDispatcher.cancelTask(self._enterEpiosdeList, self)
	self:removeEvents()
	self:__onDispose()
end

function Season123_1_9EntryItem:init(viewGO, animator)
	self.viewGO = viewGO
	self.anim = animator
...
function Season123_1_9EntryItem:initComponent()
...
function Season123_1_9EntryItem:removeEvents()
...
function Season123_1_9EntryItem:initData(actId)
	self._actId = actId

	self:refreshUI()
end

function Season123_1_9EntryItem:refreshUI()
...
function Season123_1_9EntryItem:refreshRound()
...
function Season123_1_9EntryItem:refreshLock()
...
function Season123_1_9EntryItem:refreshProgress()
...
function Season123_1_9EntryItem:refreshNew()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_1_9EntryItem:refreshRecordBtn()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_1_9EntryItem:refreshLockRepeat()
	self:refreshLock()
	self:refreshProgress()
end

function Season123_1_9EntryItem:_btnentranceOnClick()
...
function Season123_1_9EntryItem:_enterEpiosdeList()
...
function Season123_1_9EntryItem:_btnrecordsOnClick()
	Season123EntryController.instance:openStageRecords(self._stageId)
end

return Season123_1_9EntryItem
