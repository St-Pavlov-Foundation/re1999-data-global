...
slot0 = class("Season123_1_9StageLoadingView", BaseView)
...
function slot0.onOpen(slot0)
	...
	logNormal(string.format("Season123_1_9StageLoadingView actId=%s, stage=%s", slot0.viewParam.actId, slot0.viewParam.stage))
