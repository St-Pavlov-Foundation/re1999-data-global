-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9HeroGroupQuickEditItem", package.seeall)

local Season123_1_9HeroGroupQuickEditItem = class("Season123_1_9HeroGroupQuickEditItem", Season123_1_9HeroGroupEditItem)

function Season123_1_9HeroGroupQuickEditItem:init(go)
	Season123_1_9HeroGroupQuickEditItem.super.init(self, go)
...
function Season123_1_9HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_1_9HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123_1_9HeroGroupQuickEditItem:_onItemClick()
...
function Season123_1_9HeroGroupQuickEditItem:onSelect(select)
...
function Season123_1_9HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123_1_9HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123_1_9HeroGroupQuickEditItem
