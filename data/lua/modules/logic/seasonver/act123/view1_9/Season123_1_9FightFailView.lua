-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9FightFailView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9FightFailView", package.seeall)

local Season123_1_9FightFailView = class("Season123_1_9FightFailView", FightFailView)

function Season123_1_9FightFailView:onInitView()
...
function Season123_1_9FightFailView:addEvents()
	self._click:AddClickListener(self._onClickClose, self)
	self._btndata:AddClickListener(self._onClickData, self)
end

function Season123_1_9FightFailView:removeEvents()
	self._click:RemoveClickListener()
	self._btndata:RemoveClickListener()
end

function Season123_1_9FightFailView:_editableInitView()
...
function Season123_1_9FightFailView:onOpen()
...
function Season123_1_9FightFailView:refreshTips()
...
function Season123_1_9FightFailView:onClose()
	Season123_1_9FightFailView.super.onClose(self)
end

function Season123_1_9FightFailView:onDestroyView()
	Season123_1_9FightFailView.super.onDestroyView(self)
end

return Season123_1_9FightFailView
