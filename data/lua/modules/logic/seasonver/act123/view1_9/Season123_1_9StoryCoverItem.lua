-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9StoryCoverItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9StoryCoverItem", package.seeall)

local Season123_1_9StoryCoverItem = class("Season123_1_9StoryCoverItem", LuaCompBase)

function Season123_1_9StoryCoverItem:ctor(param)
	self.param = param
end

function Season123_1_9StoryCoverItem:init(go)
	self:__onInit()
...
function Season123_1_9StoryCoverItem:addEventListeners()
	self.btnClick:AddClickListener(self.onClickCoverItem, self)
end

function Season123_1_9StoryCoverItem:removeEventListeners()
	self.btnClick:RemoveClickListener()
end

Season123_1_9StoryCoverItem.unlockDelayTime = 1.16

function Season123_1_9StoryCoverItem:refreshItem()
...
function Season123_1_9StoryCoverItem:onClickCoverItem()
...
function Season123_1_9StoryCoverItem:refreshUnlockState(unlockState)
	if self.isUnlock and self.isUnlock ~= unlockState then
		...
		TaskDispatcher.runDelay(self.playUnlockAnim, self, Season123_1_9StoryCoverItem.unlockDelayTime)
...
function Season123_1_9StoryCoverItem:playUnlockAnim()
...
function Season123_1_9StoryCoverItem:onUnlockAnimDone()
	gohelper.setActive(self.goLocked, not self.isUnlock)
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
end

function Season123_1_9StoryCoverItem:destroy()
	self:__onDispose()
	UIBlockMgr.instance:endBlock("playCoverItemUnlockAnim")
	TaskDispatcher.cancelTask(self.playUnlockAnim, self)
end

return Season123_1_9StoryCoverItem
