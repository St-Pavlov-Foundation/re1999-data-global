-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9PickHeroEntryItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9PickHeroEntryItem", package.seeall)

local Season123_1_9PickHeroEntryItem = class("Season123_1_9PickHeroEntryItem", UserDataDispose)

function Season123_1_9PickHeroEntryItem:ctor()
	self:__onInit()
end

function Season123_1_9PickHeroEntryItem:dispose()
	self:removeEvents()
	self:__onDispose()
end

function Season123_1_9PickHeroEntryItem:init(viewGO)
	self.viewGO = gohelper.findChild(viewGO, "root")

	self:initComponent()
end

Season123_1_9PickHeroEntryItem.exSkillFillAmount = {
	0.2,
	0.4,
	0.6,
	0.79,
...
Season123_1_9PickHeroEntryItem.MaxRare = 5

function Season123_1_9PickHeroEntryItem:initComponent()
	...
	local maxRank = HeroConfig.instance:getMaxRank(Season123_1_9PickHeroEntryItem.MaxRare)
...
function Season123_1_9PickHeroEntryItem:removeEvents()
...
function Season123_1_9PickHeroEntryItem:initData(index)
	self._index = index
...
function Season123_1_9PickHeroEntryItem:refreshUI()
		...
		if not isEmpty then
			...
			if mo.heroMO then
				...
				if not skinConfig then
					logError("Season123_1_9PickHeroEntryItem.refreshUI error, skinCfg is nil, id:" .. tostring(mo.skinId))
...
function Season123_1_9PickHeroEntryItem:refreshRare(heroMO)
	for rare = 1, #self._rareList do
		gohelper.setActive(self._rareList[rare], rare <= heroMO.config.rare + 1)
	end
end

function Season123_1_9PickHeroEntryItem:refreshRank(heroMO)
...
function Season123_1_9PickHeroEntryItem:refreshExSkill(heroMO)
...
function Season123_1_9PickHeroEntryItem:onClickSelf()
...
function Season123_1_9PickHeroEntryItem:onClickSupport()
	if self._index == Activity123Enum.SupportPosIndex then
		local mo = Season123PickHeroEntryModel.instance:getByIndex(self._index)
...
function Season123_1_9PickHeroEntryItem:OpenAnim()
...
function Season123_1_9PickHeroEntryItem:playOpenAnim()
	gohelper.setActive(self.viewGO, true)
end

function Season123_1_9PickHeroEntryItem:cutHeroAnim(isCut)
	gohelper.setActive(self._gocuthero, isCut)
	self._animCuthero:Play("pickheroentryview_click", 0, 0)
end

return Season123_1_9PickHeroEntryItem
