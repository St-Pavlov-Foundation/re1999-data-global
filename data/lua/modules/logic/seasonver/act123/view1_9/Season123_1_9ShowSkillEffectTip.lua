-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9ShowSkillEffectTip.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9ShowSkillEffectTip", package.seeall)

local Season123_1_9ShowSkillEffectTip = class("Season123_1_9ShowSkillEffectTip", LuaCompBase)

function Season123_1_9ShowSkillEffectTip:init(go)
...
function Season123_1_9ShowSkillEffectTip:_btnclosebuffOnClick()
	gohelper.setActive(self._goBuffContainer, false)
...
function Season123_1_9ShowSkillEffectTip:addHyperLinkClick(txtDesc)
...
function Season123_1_9ShowSkillEffectTip:onHyperLinkClick(id, clickPosition)
...
function Season123_1_9ShowSkillEffectTip:createAndGetBufferItem(effectId)
...
function Season123_1_9ShowSkillEffectTip:addChildHyperLinkClick(txtDesc)
	local hyperLinkClick = gohelper.onceAddComponent(txtDesc, typeof(ZProj.TMPHyperLinkClick))

	hyperLinkClick:SetClickListener(self.onChildHyperLinkClick, self)
end

function Season123_1_9ShowSkillEffectTip:onChildHyperLinkClick(id, clickPosition)
	local effectId = tonumber(id)

	self:createAndGetBufferItem(effectId)
end

function Season123_1_9ShowSkillEffectTip:onDestroy()
	self._btnclosebuff:RemoveClickListener()
end

return Season123_1_9ShowSkillEffectTip
