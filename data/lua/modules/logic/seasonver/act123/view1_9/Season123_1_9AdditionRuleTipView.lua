-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9AdditionRuleTipView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9AdditionRuleTipView", package.seeall)

local Season123_1_9AdditionRuleTipView = class("Season123_1_9AdditionRuleTipView", BaseView)

function Season123_1_9AdditionRuleTipView:onInitView()
...
function Season123_1_9AdditionRuleTipView:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_1_9AdditionRuleTipView:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_1_9AdditionRuleTipView:_btncloseOnClick()
	self:closeThis()
end

function Season123_1_9AdditionRuleTipView:onOpen()
...
function Season123_1_9AdditionRuleTipView:getOrCreateItem(index)
...
function Season123_1_9AdditionRuleTipView:updateItem(item, ruleId)
	if not ruleId then
...
function Season123_1_9AdditionRuleTipView:onClose()
	return
end

return Season123_1_9AdditionRuleTipView
