...
slot0 = class("Season123_1_9EquipBookView", BaseView)
...
function slot0._btndecomposeOnClick(slot0)
	...
	ViewMgr.instance:openView(ViewName.Season123_1_9DecomposeView, {
		actId = slot0.actId,
		itemId = slot0.itemId
	})
end
...
function slot0.cardDescItemShow(slot0, slot1, slot2, slot3)
	...
	slot4.text = slot0._skillContainer:addLink(HeroSkillModel.instance:skillDesToSpot(slot2))
	...
	slot0._skillContainer:addHyperLinkClick(slot4)
end

function slot0.refreshIcon(slot0)
	if not slot0._icon then
		slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._gocarditem, Season123_1_9CelebrityCardEquip)
	end
