...
local var_0_0 = class("Season123_1_9EquipBookView", BaseView)
...
function var_0_0._btndecomposeOnClick(arg_6_0)
	...
	ViewMgr.instance:openView(ViewName.Season123_1_9DecomposeView, var_6_0)
end
...
function var_0_0._editableInitView(arg_9_0)
	...
	arg_9_0._skillContainer = MonoHelper.addNoUpdateLuaComOnceToGo(arg_9_0._gobuffContainer, Season123_1_9ShowSkillEffectTip)
end
...
function var_0_0.cardDescItemShow(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_16_0.text = arg_16_0._skillContainer:addLink(arg_16_2)

	var_16_1:refreshTmpContent(var_16_0)
	SLFramework.UGUI.GuiHelper.SetColor(var_16_0, arg_16_0.colorStr)
	arg_16_0._skillContainer:addHyperLinkClick(var_16_0)
end
...
function var_0_0.refreshIcon(arg_17_0)
	if not arg_17_0._icon then
		...
		arg_17_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_17_0, Season123_1_9CelebrityCardEquip)
	end

	if arg_17_0.itemId then
		arg_17_0._icon:updateData(arg_17_0.itemId)
		arg_17_0._icon:setIndexLimitShowState(true)
	end
end
