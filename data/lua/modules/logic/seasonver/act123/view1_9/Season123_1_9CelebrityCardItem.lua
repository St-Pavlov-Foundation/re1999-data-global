-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9CelebrityCardItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9CelebrityCardItem", package.seeall)

local Season123_1_9CelebrityCardItem = class("Season123_1_9CelebrityCardItem", LuaCompBase)

Season123_1_9CelebrityCardItem.AssetPath = "ui/viewres/seasonver/v1a9_act123/season123celebritycarditem.prefab"

function Season123_1_9CelebrityCardItem:init(go, equipId, params)
	self.go = go
	self._equipId = equipId

	local assetPath = Season123_1_9CelebrityCardItem.AssetPath
...
function Season123_1_9CelebrityCardItem:handleCardLoaded()
	self._cardGo = self._resLoader:getInstGO()
	self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self._cardGo, Season123_1_9CelebrityCardEquip)
...
function Season123_1_9CelebrityCardItem:showTag(enable)
...
function Season123_1_9CelebrityCardItem:showProbability(enable)
	self._showTag = enable
...
function Season123_1_9CelebrityCardItem:showNewFlag(enable)
...
function Season123_1_9CelebrityCardItem:showNewFlag2(enable)
...
function Season123_1_9CelebrityCardItem:reset(equipId)
	self._equipId = equipId
...
function Season123_1_9CelebrityCardItem:setColorDark(enable)
...
function Season123_1_9CelebrityCardItem:destroy()
	if self._icon then
...
return Season123_1_9CelebrityCardItem
