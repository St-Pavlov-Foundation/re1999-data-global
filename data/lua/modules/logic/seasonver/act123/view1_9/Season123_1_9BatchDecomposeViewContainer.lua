-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9BatchDecomposeViewContainer.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9BatchDecomposeViewContainer", package.seeall)

local Season123_1_9BatchDecomposeViewContainer = class("Season123_1_9BatchDecomposeViewContainer", BaseViewContainer)

function Season123_1_9BatchDecomposeViewContainer:buildViews()
	self:createEquipItemsParam()

	return {
		Season123_1_9BatchDecomposeView.New(),
		self.scrollView,
...
function Season123_1_9BatchDecomposeViewContainer:createEquipItemsParam()
	local scrollParam = ListScrollParam.New()

	scrollParam.scrollGOPath = "left_container/#go_scrollcontainer/#scroll_equip"
	scrollParam.prefabType = ScrollEnum.ScrollPrefabFromRes
	scrollParam.prefabUrl = self._viewSetting.otherRes[1]
	scrollParam.cellClass = Season123_1_9DecomposeItem
...
function Season123_1_9BatchDecomposeViewContainer:buildTabViews(tabContainerId)
...
function Season123_1_9BatchDecomposeViewContainer:getLineCount()
...
function Season123_1_9BatchDecomposeViewContainer:playCloseTransition()
...
function Season123_1_9BatchDecomposeViewContainer:onCloseAnimDone()
	self:onPlayCloseTransitionFinish()
end

return Season123_1_9BatchDecomposeViewContainer
