...
slot0 = class("Season123_1_9SettlementHeroItem", BaseViewExtended)
...
function slot0._showEquip123(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:openSubView(Season123_1_9CelebrityCardGetItem, Season123_1_9CelebrityCardItem.AssetPath, slot3 <= 1 and slot0._gosingle or slot0["_gocard" .. slot1], slot2, nil, slot4)
end
