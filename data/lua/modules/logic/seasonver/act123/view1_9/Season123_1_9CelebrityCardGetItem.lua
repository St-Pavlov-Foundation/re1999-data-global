...
slot0 = class("Season123_1_9CelebrityCardGetItem", BaseViewExtended)
...
function slot0._checkCreateIcon(slot0)
	if not slot0._icon then
		slot0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0.viewGO, Season123_1_9CelebrityCardEquip)
