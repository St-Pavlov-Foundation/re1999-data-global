...
local var_0_0 = class("Season123_1_9CelebrityCardGetItem", BaseViewExtended)
...
function var_0_0._checkCreateIcon(arg_7_0)
	if not arg_7_0._icon then
		arg_7_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(arg_7_0.viewGO, Season123_1_9CelebrityCardEquip)
