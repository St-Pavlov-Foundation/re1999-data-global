-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9PickAssistItem.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9PickAssistItem", package.seeall)

local Season123_1_9PickAssistItem = class("Season123_1_9PickAssistItem", ListScrollCellExtend)

function Season123_1_9PickAssistItem:onInitView()
...
function Season123_1_9PickAssistItem:addEvents()
	self._btnHeroDetail:AddClickListener(self._onHeroDetailClick, self)
end

function Season123_1_9PickAssistItem:removeEvents()
	self._btnHeroDetail:RemoveClickListener()
end

function Season123_1_9PickAssistItem:_onHeroItemClick()
...
function Season123_1_9PickAssistItem:initHeroItem()
...
function Season123_1_9PickAssistItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_1_9PickAssistItem:setSelected(isSelected)
	gohelper.setActive(self.goSelected, isSelected)
end

function Season123_1_9PickAssistItem:onDestroy()
...
function Season123_1_9PickAssistItem:getAnimator()
	return self._animator
end

return Season123_1_9PickAssistItem
