...
slot0 = class("Season123_2_1CelebrityCardGetView", BaseViewExtended)
slot0.OpenType = {
	Get = 1
}
...
function slot0._showGetCard(slot0)
	slot0:com_loadAsset(Season123_2_1CelebrityCardItem.AssetPath, slot0._onCardItemLoaded)
end
...
function slot0._onCardItemLoaded(slot0, slot1)
	...
	slot0._scroll_view:setClass(Season123_2_1CelebrityCardGetScrollItem)
