...
function Season123_2_1EpisodeDetailView:_setInfo()
	...
	local targetStageTagPos = isNewStage and Season123_2_1EpisodeDetailView.NewStageTagPos or Season123_2_1EpisodeDetailView.NomalStageTagPos
...
function Season123_2_1EpisodeDetailView:_showPartStarGroupItem(starGroup)
	if starGroup < 7 then
		...
		for i = 1, 6 do
			...
			self._partStageItems[i].canvasgroup.alpha = i <= starGroup and Season123_2_1EpisodeDetailView.UnLockStageItemAlpha or Season123_2_1EpisodeDetailView.LockStageItemAlpha
		end
	else
		for i = 1, 7 do
			if not self._partStageItems[i] then
