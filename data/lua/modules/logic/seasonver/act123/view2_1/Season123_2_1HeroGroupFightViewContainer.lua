...
local var_0_0 = class("Season123_2_1HeroGroupFightViewContainer", BaseViewContainer)
...
function var_0_0.buildTabViews(arg_3_0, arg_3_1)
	if arg_3_1 == 1 then
		arg_3_0._navigateButtonsView = NavigateButtonsView.New({
			...
			false,
			true
		}, HelpEnum.HelpId.Season2_1HerogroupHelp, arg_3_0._closeCallback, nil, nil, arg_3_0)

		arg_3_0._navigateButtonsView:setHelpId(HelpEnum.HelpId.Season2_1HerogroupHelp)
