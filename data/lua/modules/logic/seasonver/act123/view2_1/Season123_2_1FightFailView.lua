-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1FightFailView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1FightFailView", package.seeall)

local Season123_2_1FightFailView = class("Season123_2_1FightFailView", FightFailView)

function Season123_2_1FightFailView:onInitView()
...
function Season123_2_1FightFailView:addEvents()
	self._click:AddClickListener(self._onClickClose, self)
	self._btndata:AddClickListener(self._onClickData, self)
end

function Season123_2_1FightFailView:removeEvents()
	self._click:RemoveClickListener()
	self._btndata:RemoveClickListener()
end

function Season123_2_1FightFailView:_editableInitView()
...
function Season123_2_1FightFailView:onOpen()
...
function Season123_2_1FightFailView:refreshTips()
...
function Season123_2_1FightFailView:onClose()
	Season123_2_1FightFailView.super.onClose(self)
end

function Season123_2_1FightFailView:onDestroyView()
	Season123_2_1FightFailView.super.onDestroyView(self)
end

return Season123_2_1FightFailView
