...
local var_0_0 = class("Season123_2_1FightFailView", FightFailView)
...
function var_0_0.refreshTips(arg_6_0)
	...
	local var_6_4 = Season123Model.instance:getBattleContext()

	if var_6_4 then
		var_6_3 = Season123HeroGroupModel.filterRule(var_6_4.actId, var_6_3)

		if var_6_4.stage then
			var_6_3 = Season123Config.instance:filterRule(var_6_3, var_6_4.stage)
		end
	end

	if var_6_3 and #var_6_3 ~= 0 then
		arg_6_0:refreshConditionsContainer(var_6_3)
	else
