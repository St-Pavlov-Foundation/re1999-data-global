-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickAssistItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickAssistItem", package.seeall)

local Season123_2_1PickAssistItem = class("Season123_2_1PickAssistItem", ListScrollCellExtend)

function Season123_2_1PickAssistItem:onInitView()
...
function Season123_2_1PickAssistItem:addEvents()
	self._btnHeroDetail:AddClickListener(self._onHeroDetailClick, self)
end

function Season123_2_1PickAssistItem:removeEvents()
	self._btnHeroDetail:RemoveClickListener()
end

function Season123_2_1PickAssistItem:_onHeroItemClick()
...
function Season123_2_1PickAssistItem:initHeroItem()
...
function Season123_2_1PickAssistItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_1PickAssistItem:setSelected(isSelected)
	gohelper.setActive(self.goSelected, isSelected)
end

function Season123_2_1PickAssistItem:onDestroy()
...
function Season123_2_1PickAssistItem:getAnimator()
	return self._animator
end

return Season123_2_1PickAssistItem
