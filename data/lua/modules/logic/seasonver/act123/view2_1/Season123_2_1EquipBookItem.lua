...
local var_0_0 = class("Season123_2_1EquipBookItem", ListScrollCellExtend)
...
function var_0_0.checkCreateIcon(arg_8_0)
	if not arg_8_0.icon then
		...
		arg_8_0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_8_1, Season123_2_1CelebrityCardEquip)
