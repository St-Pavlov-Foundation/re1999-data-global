-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EpisodeLoadingView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EpisodeLoadingView", package.seeall)

local Season123_2_1EpisodeLoadingView = class("Season123_2_1EpisodeLoadingView", BaseView)

function Season123_2_1EpisodeLoadingView:onInitView()
...
function Season123_2_1EpisodeLoadingView:addEvents()
	return
end

function Season123_2_1EpisodeLoadingView:removeEvents()
	return
end

function Season123_2_1EpisodeLoadingView:_editableInitView()
	self._stageItems = {}
end

function Season123_2_1EpisodeLoadingView:onDestroyView()
...
function Season123_2_1EpisodeLoadingView:onOpen()
	local actId = self.viewParam.actId
	local stage = self.viewParam.stage
	local layer = self.viewParam.layer

	logNormal(string.format("Season123_2_1EpisodeLoadingView actId=%s, stage=%s", actId, stage))
...
function Season123_2_1EpisodeLoadingView:onClose()
	return
end

function Season123_2_1EpisodeLoadingView:refreshUI()
	self:refreshStageList()
end

function Season123_2_1EpisodeLoadingView:refreshStageList()
...
function Season123_2_1EpisodeLoadingView:getOrCreateStageItem(index)
...
function Season123_2_1EpisodeLoadingView:refreshSingleItem(index, item, data)
...
function Season123_2_1EpisodeLoadingView:refreshSingleItemLock(index, item, data)
	if data.emptyIndex then
...
function Season123_2_1EpisodeLoadingView:refreshSingleItemFinished(index, item, data)
	if data.emptyIndex then
