...
slot0 = class("Season123_2_1EntryLoadScene", UserDataDispose)
...
function slot0.createSceneRoot(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New("Season123_2_1EntryScene")
...
slot0.BLOCK_LOAD_RES_KEY = "Season123_2_1EntrySceneLoadRes"
