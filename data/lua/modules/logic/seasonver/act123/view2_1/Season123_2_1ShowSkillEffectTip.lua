-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1ShowSkillEffectTip.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1ShowSkillEffectTip", package.seeall)

local Season123_2_1ShowSkillEffectTip = class("Season123_2_1ShowSkillEffectTip", LuaCompBase)

function Season123_2_1ShowSkillEffectTip:init(go)
...
function Season123_2_1ShowSkillEffectTip:_btnclosebuffOnClick()
	gohelper.setActive(self._goBuffContainer, false)
...
function Season123_2_1ShowSkillEffectTip:addHyperLinkClick(txtDesc)
...
function Season123_2_1ShowSkillEffectTip:onHyperLinkClick(id, clickPosition)
...
function Season123_2_1ShowSkillEffectTip:createAndGetBufferItem(effectId)
...
function Season123_2_1ShowSkillEffectTip:addChildHyperLinkClick(txtDesc)
	local hyperLinkClick = gohelper.onceAddComponent(txtDesc, typeof(ZProj.TMPHyperLinkClick))

	hyperLinkClick:SetClickListener(self.onChildHyperLinkClick, self)
end

function Season123_2_1ShowSkillEffectTip:onChildHyperLinkClick(id, clickPosition)
	local effectId = tonumber(id)

	self:createAndGetBufferItem(effectId)
end

function Season123_2_1ShowSkillEffectTip:onDestroy()
	self._btnclosebuff:RemoveClickListener()
end

return Season123_2_1ShowSkillEffectTip
