-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EntryItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EntryItem", package.seeall)

local Season123_2_1EntryItem = class("Season123_2_1EntryItem", UserDataDispose)

function Season123_2_1EntryItem:ctor()
	self:__onInit()
end

function Season123_2_1EntryItem:dispose()
	TaskDispatcher.cancelTask(self._enterEpiosdeList, self)
	self:removeEvents()
	self:__onDispose()
end

function Season123_2_1EntryItem:init(viewGO, animator)
	self.viewGO = viewGO
	self.anim = animator
...
function Season123_2_1EntryItem:initComponent()
...
function Season123_2_1EntryItem:removeEvents()
...
function Season123_2_1EntryItem:initData(actId)
	self._actId = actId

	self:refreshUI()
end

function Season123_2_1EntryItem:refreshUI()
...
function Season123_2_1EntryItem:refreshRound()
...
function Season123_2_1EntryItem:refreshLock()
...
function Season123_2_1EntryItem:refreshProgress()
...
function Season123_2_1EntryItem:refreshNew()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_1EntryItem:refreshRecordBtn()
	local seasonMO = Season123Model.instance:getActInfo(self._actId)
...
function Season123_2_1EntryItem:refreshLockRepeat()
	self:refreshLock()
	self:refreshProgress()
end

function Season123_2_1EntryItem:_btnentranceOnClick()
...
function Season123_2_1EntryItem:_enterEpiosdeList()
...
function Season123_2_1EntryItem:_btnrecordsOnClick()
	Season123EntryController.instance:openStageRecords(self._stageId)
end

return Season123_2_1EntryItem
