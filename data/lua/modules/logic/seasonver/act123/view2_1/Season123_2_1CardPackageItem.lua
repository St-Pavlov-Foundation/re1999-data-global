-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1CardPackageItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1CardPackageItem", package.seeall)

local Season123_2_1CardPackageItem = class("Season123_2_1CardPackageItem", ListScrollCellExtend)

function Season123_2_1CardPackageItem:init(go)
	Season123_2_1CardPackageItem.super.init(self, go)
...
function Season123_2_1CardPackageItem:addEventListeners()
	return
end

function Season123_2_1CardPackageItem:removeEventListeners()
	return
end

function Season123_2_1CardPackageItem:onUpdateMO(mo)
	self._mo = mo

	self:refreshUI()
end

function Season123_2_1CardPackageItem:refreshUI()
...
function Season123_2_1CardPackageItem:checkCreateIcon()
...
function Season123_2_1CardPackageItem:onClickSelf()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self._mo.itemId)
end

function Season123_2_1CardPackageItem:getAnimator()
	self._animator.enabled = true

	return self._animator
end

function Season123_2_1CardPackageItem:onDestroyView()
	if self.icon then
		self.icon:disposeUI()
	end
end

return Season123_2_1CardPackageItem
