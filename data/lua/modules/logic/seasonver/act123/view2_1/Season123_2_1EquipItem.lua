-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipItem", package.seeall)

local Season123_2_1EquipItem = class("Season123_2_1EquipItem", ListScrollCellExtend)

function Season123_2_1EquipItem:init(go)
	Season123_2_1EquipItem.super.init(self, go)
...
function Season123_2_1EquipItem:addEvents()
	return
end

function Season123_2_1EquipItem:removeEvents()
	return
end

function Season123_2_1EquipItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_2_1EquipItem.ColumnCount = 6
Season123_2_1EquipItem.AnimRowCount = 4
Season123_2_1EquipItem.OpenAnimTime = 0.06
Season123_2_1EquipItem.OpenAnimStartTime = 0.05

function Season123_2_1EquipItem:checkPlayAnim()
...
function Season123_2_1EquipItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_1EquipItem:refreshUI()
...
function Season123_2_1EquipItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_2_1EquipItem:refreshEquipedHero(heroUid)
...
function Season123_2_1EquipItem:refreshIcon(itemId, itemUid)
...
function Season123_2_1EquipItem:checkCreateIcon()
...
function Season123_2_1EquipItem:setRoleIconDark(value)
	if value then
...
function Season123_2_1EquipItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_2_1EquipItem:checkClickNew(itemUid)
...
Season123_2_1EquipItem.Toast_Same_Card = 2851
Season123_2_1EquipItem.Toast_Wrong_Type = 2852
Season123_2_1EquipItem.Toast_MainRole_Wrong_Type = 2854
Season123_2_1EquipItem.Toast_Other_Hero_Equiped = 2853
Season123_2_1EquipItem.Toast_Career_Wrong = 2859
Season123_2_1EquipItem.Toast_Slot_Lock = 67
Season123_2_1EquipItem.Toast_Pos_Wrong = 70501

function Season123_2_1EquipItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipItemListModel.instance:slotIsLock(Season123EquipItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_2_1EquipItem.Toast_Slot_Lock)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipItemListModel.instance.curPos == Season123EquipItemListModel.MainCharPos then
				GameFacade.showToast(Season123_2_1EquipItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_2_1EquipItem.Toast_Wrong_Type)
			end
		...
		if isCareerWrong then
			GameFacade.showToast(Season123_2_1EquipItem.Toast_Career_Wrong)
		...
		if isPosWrong then
			GameFacade.showToast(Season123_2_1EquipItem.Toast_Pos_Wrong, tarPosStr)
...
function Season123_2_1EquipItem:onDestroyView()
	if self.icon then
