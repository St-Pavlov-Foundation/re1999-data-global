...
local var_0_0 = class("Season123_2_1EquipItem", ListScrollCellExtend)
...
function var_0_0.refreshIcon(arg_10_0, arg_10_1, arg_10_2)
	...
	if arg_10_1 then
		...
		arg_10_0.icon:setIndexLimitShowState(true)
...
function var_0_0.checkCreateIcon(arg_11_0)
	if not arg_11_0.icon then
		...
		arg_11_0.icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_11_1, Season123_2_1CelebrityCardEquip)
