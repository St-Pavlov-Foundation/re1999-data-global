...
local var_0_0 = class("Season123_2_1EquipViewContainer", BaseViewContainer)
...
function var_0_0.createEquipItemsParam(arg_2_0)
	...
	var_2_0.cellClass = Season123_2_1EquipItem
	var_2_0.scrollDir = ScrollEnum.ScrollDirV
	var_2_0.lineCount = Season123_2_1EquipItem.ColumnCount
	var_2_0.cellWidth = 170
	var_2_0.cellHeight = 235
	var_2_0.cellSpaceH = 8.4
	var_2_0.cellSpaceV = 0
	var_2_0.frameUpdateMs = 100
	var_2_0.minUpdateCountInFrame = Season123_2_1EquipItem.ColumnCount
