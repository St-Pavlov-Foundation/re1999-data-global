...
local var_0_0 = class("Season123_2_1CelebrityCardTipView", BaseView)
...
function var_0_0.checkCreateIcon(arg_16_0)
	if not arg_16_0._icon then
		...
		arg_16_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_16_1, Season123_2_1CelebrityCardEquip)
	end
end
