...
slot0 = class("Season123_2_1EquipBookViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot0:createEquipItemsParam()

	slot1 = Season123_2_1EquipFloatTouch.New()

	slot1:init("left/#go_target/#go_ctrl", "left/#go_target/#go_touch")

	slot2 = Season123_2_1EquipTagSelect.New()
...
function slot0.createEquipItemsParam(slot0)
	...
	slot1.cellClass = Season123_2_1EquipBookItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = Season123_2_1EquipBookItem.ColumnCount
	slot1.cellWidth = 170
	slot1.cellHeight = 235
	slot1.cellSpaceH = 8.2
	slot1.cellSpaceV = 1.74
	slot1.frameUpdateMs = 100
	slot1.minUpdateCountInFrame = Season123_2_1EquipBookItem.ColumnCount
