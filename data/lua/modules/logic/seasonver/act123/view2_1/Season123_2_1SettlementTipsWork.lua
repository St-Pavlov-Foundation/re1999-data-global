-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1SettlementTipsWork.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1SettlementTipsWork", package.seeall)

local Season123_2_1SettlementTipsWork = class("Season123_2_1SettlementTipsWork", BaseWork)

function Season123_2_1SettlementTipsWork:onStart(context)
...
function Season123_2_1SettlementTipsWork:_showEquipGet()
	PopupController.instance:setPause("fightsuccess", false)
...
function Season123_2_1SettlementTipsWork:_onCloseViewFinish(viewName)
...
function Season123_2_1SettlementTipsWork:_showGetCardView()
...
function Season123_2_1SettlementTipsWork:clearWork()
	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
end

return Season123_2_1SettlementTipsWork
