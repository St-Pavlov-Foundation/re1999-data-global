-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1DecomposeView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1DecomposeView", package.seeall)

local Season123_2_1DecomposeView = class("Season123_2_1DecomposeView", BaseView)

function Season123_2_1DecomposeView:onInitView()
...
function Season123_2_1DecomposeView:addEvents()
...
function Season123_2_1DecomposeView:removeEvents()
...
function Season123_2_1DecomposeView:_btnminOnClick()
	self.curCount = self.minDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_2_1DecomposeView:_btnsubOnClick()
...
function Season123_2_1DecomposeView:_btnaddOnClick()
...
function Season123_2_1DecomposeView:_btnmaxOnClick()
	self.curCount = self.maxDecomposeCount

	self:refreshInfoBySelectCount()
end

function Season123_2_1DecomposeView:_btndecomposeOnClick()
...
function Season123_2_1DecomposeView:sendDecomposeEquipRequest()
	local list = {}
...
function Season123_2_1DecomposeView:_onEndEdit()
...
function Season123_2_1DecomposeView:_editableInitView()
	return
end

function Season123_2_1DecomposeView:onOpen()
...
function Season123_2_1DecomposeView:refreshUI()
...
function Season123_2_1DecomposeView:refreshInfoBySelectCount()
	self._inputvalue:SetText(self.curCount)

	self._txtgetCoin.text = luaLang("multiple") .. self.curCount * self.itemConfig.decomposeGet
end

function Season123_2_1DecomposeView:CreateCardIcon()
	if not self.cardIcon then
		local path = self.viewContainer:getSetting().otherRes[1]
		local go = self:getResInst(path, self._gocardpos, "icon")

		self.cardIcon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_2_1CelebrityCardEquip)
	end
...
function Season123_2_1DecomposeView:showMaterialInfoTip()
	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.Season123EquipCard, self.itemId)
end

function Season123_2_1DecomposeView:onClose()
	return
end

function Season123_2_1DecomposeView:onDestroyView()
	if self.cardIcon then
		self.cardIcon:disposeUI()
	end
end

return Season123_2_1DecomposeView
