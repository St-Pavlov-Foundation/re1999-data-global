-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EquipHeroItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EquipHeroItem", package.seeall)

local Season123_2_1EquipHeroItem = class("Season123_2_1EquipHeroItem", ListScrollCellExtend)

function Season123_2_1EquipHeroItem:init(go)
	Season123_2_1EquipHeroItem.super.init(self, go)
...
function Season123_2_1EquipHeroItem:addEvents()
	return
end

function Season123_2_1EquipHeroItem:removeEvents()
	return
end

function Season123_2_1EquipHeroItem:onUpdateMO(mo)
	self._mo = mo
	self._uid = mo.id
...
Season123_2_1EquipHeroItem.ColumnCount = 6
Season123_2_1EquipHeroItem.AnimRowCount = 4
Season123_2_1EquipHeroItem.OpenAnimTime = 0.06
Season123_2_1EquipHeroItem.OpenAnimStartTime = 0.05

function Season123_2_1EquipHeroItem:checkPlayAnim()
...
function Season123_2_1EquipHeroItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_2_1EquipHeroItem:refreshUI()
...
function Season123_2_1EquipHeroItem:refreshDeckCount()
	local itemUid = self._uid
...
function Season123_2_1EquipHeroItem:refreshEquipedHero(heroUid)
...
function Season123_2_1EquipHeroItem:refreshIcon(itemId, itemUid)
...
function Season123_2_1EquipHeroItem:checkCreateIcon()
...
function Season123_2_1EquipHeroItem:setRoleIconDark(value)
	if value then
...
function Season123_2_1EquipHeroItem:onClickSelf()
	local itemUid = self._uid
...
function Season123_2_1EquipHeroItem:checkClickNew(itemUid)
...
Season123_2_1EquipHeroItem.Toast_Same_Card = 2851
Season123_2_1EquipHeroItem.Toast_Wrong_Type = 2852
Season123_2_1EquipHeroItem.Toast_MainRole_Wrong_Type = 2854
Season123_2_1EquipHeroItem.Toast_Other_Hero_Equiped = 2853
Season123_2_1EquipHeroItem.Toast_Career_Wrong = 2859
Season123_2_1EquipHeroItem.Toast_Slot_Lock = 67

function Season123_2_1EquipHeroItem:checkCanNotEquipWithToast(itemUid)
	if Season123EquipHeroItemListModel.instance:slotIsLock(Season123EquipHeroItemListModel.instance.curSelectSlot) then
		GameFacade.showToast(Season123_2_1EquipHeroItem.Toast_Slot_Lock)
	...
	if isSameCard then
		GameFacade.showToast(Season123_2_1EquipHeroItem.Toast_Same_Card)
	...
	if itemMO then
		...
		if isTypeWrong then
			if Season123EquipHeroItemListModel.instance.curPos == Season123EquipHeroItemListModel.MainCharPos then
				GameFacade.showToast(Season123_2_1EquipHeroItem.Toast_MainRole_Wrong_Type)
			else
				GameFacade.showToast(Season123_2_1EquipHeroItem.Toast_Wrong_Type)
			end
...
function Season123_2_1EquipHeroItem:onDestroyView()
	if self.icon then
...
return Season123_2_1EquipHeroItem
