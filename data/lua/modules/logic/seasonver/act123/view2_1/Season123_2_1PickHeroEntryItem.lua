-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickHeroEntryItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickHeroEntryItem", package.seeall)

local Season123_2_1PickHeroEntryItem = class("Season123_2_1PickHeroEntryItem", UserDataDispose)

function Season123_2_1PickHeroEntryItem:ctor()
	self:__onInit()
end

function Season123_2_1PickHeroEntryItem:dispose()
	self:removeEvents()
	self:__onDispose()
end

function Season123_2_1PickHeroEntryItem:init(viewGO)
	self.viewGO = gohelper.findChild(viewGO, "root")

	self:initComponent()
end

Season123_2_1PickHeroEntryItem.exSkillFillAmount = {
	0.2,
	0.4,
	0.6,
	0.79,
...
Season123_2_1PickHeroEntryItem.MaxRare = 5

function Season123_2_1PickHeroEntryItem:initComponent()
	...
	local maxRank = HeroConfig.instance:getMaxRank(Season123_2_1PickHeroEntryItem.MaxRare)
...
function Season123_2_1PickHeroEntryItem:removeEvents()
...
function Season123_2_1PickHeroEntryItem:initData(index)
	self._index = index
...
function Season123_2_1PickHeroEntryItem:refreshUI()
		...
		if not isEmpty then
			...
			if mo.heroMO then
				...
				if not skinConfig then
					logError("Season123_2_1PickHeroEntryItem.refreshUI error, skinCfg is nil, id:" .. tostring(mo.skinId))
...
function Season123_2_1PickHeroEntryItem:refreshRare(heroMO)
	for rare = 1, #self._rareList do
		gohelper.setActive(self._rareList[rare], rare <= heroMO.config.rare + 1)
	end
end

function Season123_2_1PickHeroEntryItem:refreshRank(heroMO)
...
function Season123_2_1PickHeroEntryItem:refreshExSkill(heroMO)
...
function Season123_2_1PickHeroEntryItem:onClickSelf()
...
function Season123_2_1PickHeroEntryItem:onClickSupport()
	if self._index == Activity123Enum.SupportPosIndex then
		local mo = Season123PickHeroEntryModel.instance:getByIndex(self._index)
...
function Season123_2_1PickHeroEntryItem:OpenAnim()
...
function Season123_2_1PickHeroEntryItem:playOpenAnim()
	gohelper.setActive(self.viewGO, true)
end

function Season123_2_1PickHeroEntryItem:cutHeroAnim(isCut)
	gohelper.setActive(self._gocuthero, isCut)
	self._animCuthero:Play("pickheroentryview_click", 0, 0)
end

return Season123_2_1PickHeroEntryItem
