...
slot0 = class("Season123_2_1EpisodeListView", BaseView)
...
function slot0.initCenter(slot0)
	slot0._centerItem = Season123_2_1EpisodeListCenter.New()
...
slot0.SCROLL_ANIM_BLOCK_KEY = "Season123_2_1EpisodeListView_scrollanim"
...
function slot0.onCloseView(slot0, slot1)
	if slot1 == ViewName.Season123_2_1EpisodeDetailView then
		slot0:refreshStageList()
...
function slot0.delayAddScrollAudio(slot0)
	slot0._audioScroll = MonoHelper.addLuaComOnceToGo(slot0._goscrollstory, Season123_2_1EpisodeListScrollAudio, slot0._scrollStory)
