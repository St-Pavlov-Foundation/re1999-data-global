-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1CelebrityCardGetItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1CelebrityCardGetItem", package.seeall)

local Season123_2_1CelebrityCardGetItem = class("Season123_2_1CelebrityCardGetItem", BaseViewExtended)

function Season123_2_1CelebrityCardGetItem:onInitView()
...
function Season123_2_1CelebrityCardGetItem:addEvents()
	return
end

function Season123_2_1CelebrityCardGetItem:removeEvents()
	return
end

function Season123_2_1CelebrityCardGetItem:onRefreshViewParam(uid, noClick, equipId)
	self._uid = uid
	self._noClick = noClick
	self._equipId = equipId
end

function Season123_2_1CelebrityCardGetItem:onOpen()
	self:refreshData(self._uid)
end

function Season123_2_1CelebrityCardGetItem:refreshData(uid)
...
function Season123_2_1CelebrityCardGetItem:_checkCreateIcon()
	if not self._icon then
		self._icon = MonoHelper.addNoUpdateLuaComOnceToGo(self.viewGO, Season123_2_1CelebrityCardEquip)
...
function Season123_2_1CelebrityCardGetItem:onBtnClick()
	if self._noClick then
		return
	end
...
function Season123_2_1CelebrityCardGetItem:_getItemID(uid)
	local item_id
...
function Season123_2_1CelebrityCardGetItem:onClose()
	return
end

function Season123_2_1CelebrityCardGetItem:onDestroyView()
	if self._icon then
...
return Season123_2_1CelebrityCardGetItem
