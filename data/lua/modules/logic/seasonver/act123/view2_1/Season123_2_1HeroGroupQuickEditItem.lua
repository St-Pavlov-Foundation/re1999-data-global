-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1HeroGroupQuickEditItem.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1HeroGroupQuickEditItem", package.seeall)

local Season123_2_1HeroGroupQuickEditItem = class("Season123_2_1HeroGroupQuickEditItem", Season123_2_1HeroGroupEditItem)

function Season123_2_1HeroGroupQuickEditItem:init(go)
	Season123_2_1HeroGroupQuickEditItem.super.init(self, go)
...
function Season123_2_1HeroGroupQuickEditItem:onUpdateMO(mo)
	self._mo = mo
...
function Season123_2_1HeroGroupQuickEditItem:_show_goorderbg()
...
function Season123_2_1HeroGroupQuickEditItem:_onItemClick()
...
function Season123_2_1HeroGroupQuickEditItem:onSelect(select)
...
function Season123_2_1HeroGroupQuickEditItem:onDestroy()
	TaskDispatcher.cancelTask(self._show_goorderbg, self)
	Season123_2_1HeroGroupQuickEditItem.super.onDestroy(self)
end

return Season123_2_1HeroGroupQuickEditItem
