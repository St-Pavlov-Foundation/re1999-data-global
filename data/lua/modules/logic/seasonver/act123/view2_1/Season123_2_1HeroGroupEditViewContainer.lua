...
slot0 = class("Season123_2_1HeroGroupEditViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = Season123_2_1HeroGroupEditItem
...
function slot0.getQuickEditScroll(slot0)
	...
	slot1.cellClass = Season123_2_1HeroGroupQuickEditItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = 5
	slot1.cellWidth = 200
	slot1.cellHeight = 472
