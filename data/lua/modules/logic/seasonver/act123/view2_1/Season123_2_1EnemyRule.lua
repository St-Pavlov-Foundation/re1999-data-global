...
function slot0._setRuleDescItem(slot0, slot1, slot2)
	...
	gohelper.findChildText(slot4, "desc").text = SkillConfig.instance:fmtTagDescColor(luaLang("dungeon_add_rule_target_" .. slot2), string.gsub(slot1.desc, "%【(.-)%】", "<color=#6680bd>[%1]</color>") .. ("\n" .. HeroSkillModel.instance:getEffectTagDescFromDescRecursion(slot1.desc, slot3[1])), slot3[slot2])
end
