-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1RecordWindow.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1RecordWindow", package.seeall)

local Season123_2_1RecordWindow = class("Season123_2_1RecordWindow", BaseView)
local CAN_DISPLAY_ITEM_COUNT = 5
local ITEM_DELAY_ACTIVE_INTERVAL_TIME = 0.06
local BLOCK_TIME_EXTEND = 0.2

function Season123_2_1RecordWindow:onInitView()
...
function Season123_2_1RecordWindow:addEvents()
	self._btnclose:AddClickListener(self._btncloseOnClick, self)
end

function Season123_2_1RecordWindow:removeEvents()
	self._btnclose:RemoveClickListener()
end

function Season123_2_1RecordWindow:_btncloseOnClick()
	self:onClickModalMask()
end

function Season123_2_1RecordWindow:onClickModalMask()
	self:closeThis()
end

function Season123_2_1RecordWindow:_editableInitView()
	gohelper.setActive(self._gorecorditem, false)
end

function Season123_2_1RecordWindow:onOpen()
	...
	if bestRecordDataList and #bestRecordDataList > 0 then
		local bestRecordItem = MonoHelper.addNoUpdateLuaComOnceToGo(self._gobestrecorditem, Season123_2_1RecordWindowItem)
	...
	if normalRecordDataList and #normalRecordDataList > 0 then
		...
		gohelper.CreateObjList(self, self._onRecordItemLoad, normalRecordDataList, self._goContent, self._gorecorditem, Season123_2_1RecordWindowItem)
...
function Season123_2_1RecordWindow:_onRecordItemLoad(cellComponent, data, index)
	if not data then
		return
	end
...
function Season123_2_1RecordWindow:_onItemPlayAnimFinish()
	UIBlockMgr.instance:endBlock(self.viewName .. "itemPlayAnim")
end

function Season123_2_1RecordWindow:onClose()
	TaskDispatcher.cancelTask(self._onItemPlayAnimFinish, self)
	self:_onItemPlayAnimFinish()
end

function Season123_2_1RecordWindow:onDestroyView()
	return
end

return Season123_2_1RecordWindow
