...
slot0 = class("VersionActivity1_2TaskItem", ListScrollCell)
...
function slot0.init(slot0, slot1)
	...
	slot0._simageclickbg = gohelper.findChildSingleImage(slot0.viewGO, "#go_normal/click/bg")
	...
	slot0._simageallfinishbg = gohelper.findChildSingleImage(slot0.viewGO, "#go_normal/#go_allfinish/bg")
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivity1_2Enum.ActivityId.Dungeon)
	else
...
function slot0._editableInitView(slot0)
	...
	slot0._simageallfinishbg:LoadImage(ResUrl.getVersionActivity1_2TaskImage("renwu_diehei"))
end
...
function slot0.refreshNormalUI(slot0)
	slot0._simagenormalbg:LoadImage(ResUrl.getVersionActivity1_2TaskImage("renwu_putong"))
...
function slot0.refreshGetAllUI(slot0)
	slot0._simagegetallbg:LoadImage(ResUrl.getVersionActivity1_2TaskImage("renwu_lingqu"))
end
...
function slot0.onDestroyView(slot0)
	...
	slot0._simageallfinishbg:UnLoadImage()
end
