...
function slot0.setInputKey(slot0)
	MessageBoxController.instance:showMsgBox(MessageBoxIdDefine.PCInputKeyChange, MsgBoxEnum.BoxType.NO, slot0._btnconfirmOnClick, slot0._btncancelOnClick, nil, slot0, slot0, nil, slot0._mo.description)
	slot0:listenInputKey()
end

function slot0.setKey(slot0, slot1)
	ViewMgr.instance:closeView(ViewName.MessageBoxView)
	MessageBoxController.instance:showMsgBox(MessageBoxIdDefine.PCInputKeyConfirm, MsgBoxEnum.BoxType.Yes_No, slot0._btnconfirmOnClick, slot0._btncancelOnClick, nil, slot0, slot0, nil, slot0._mo.description, PCInputController.instance:KeyNameToDescName(slot1))
...
function slot0.setCantModify(slot0, slot1)
	...
	ToastController.instance:showToast(ToastEnum.PCKeyCantModify, PCInputController.instance:KeyNameToDescName(slot1))
end
...
function slot0.setKeyOccupied(slot0, slot1, slot2)
	...
	MessageBoxController.instance:showMsgBox(MessageBoxIdDefine.PCInputKeySwap, MsgBoxEnum.BoxType.Yes_No, function ()
		uv0:swapKey(uv1, uv2)
	end, slot0._btncancelOnClick, nil, , , , PCInputController.instance:KeyNameToDescName(slot2), slot1.description)
end
