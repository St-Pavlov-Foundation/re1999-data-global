...
slot0 = class("RougeHeroGroupFightView", BaseView)
slot1 = 4

function slot0.onInitView(slot0)
	slot0._btnstart = gohelper.findChildButtonWithAudio(slot0.viewGO, "rouge/#btn_start")
...
function slot0.onOpen(slot0)
	...
	NavigateMgr.instance:addEscape(ViewName.RougeHeroGroupFightView, slot0._onEscapeBtnClick, slot0)
	slot0:isShowHelpBtnIcon()
...
function slot0._refreshPowerShow(slot0)
	...
	if DungeonConfig.instance:getChapterCO(DungeonConfig.instance:getEpisodeCO(RougeHeroGroupModel.instance.episodeId).chapterId) and slot4.enterAfterFreeLimit > 0 and slot0._multiplication <= DungeonModel.instance:getChapterRemainingNum(slot4.type) then
		slot1 = false
	end
...
function slot0._groupDropValueChanged(slot0, slot1)
	slot2 = nil
	slot2 = RougeHeroGroupModel.instance:getGroupTypeName() and slot1 or slot1 + 1

	gohelper.setActive(slot0._btnmodifyname, slot2 ~= 0)

	if RougeHeroGroupModel.instance:setHeroGroupSelectIndex(slot2) then
		slot0:_checkEquipClothSkill()
...
function slot0._initFightGroupDrop(slot0)
	...
	slot1 = {
		[slot5] = RougeHeroGroupModel.instance:getCommonGroupName(slot5)
	}

	for slot5 = 1, 4 do
	end

	gohelper.setActive(slot0._btnmodifyname, RougeHeroGroupModel.instance.curGroupSelectIndex ~= 0)
...
function slot0._refreshUI(slot0)
	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, RougeHeroGroupModel.instance:getCurGroupId())

	slot0._episodeId = RougeHeroGroupModel.instance.episodeId
...
function slot0._dispatchNoEquipEvent(slot0)
	for slot5 = 1, 4 do
		if EquipModel.instance:getEquip(RougeHeroGroupModel.instance:getCurGroupMO():getPosEquips(slot5 - 1).equipUid[1]) then
			return
		end
	end
...
function slot0._dispatchRecordEvent(slot0)
	if OpenModel.instance:isFuncBtnShow(OpenEnum.UnlockFunc.FightReplay) and (DungeonModel.instance:getEpisodeInfo(RougeHeroGroupModel.instance.episodeId) and slot2.hasRecord) then
...
function slot0._refreshReplay(slot0)
	if slot0._chapterConfig.type == DungeonEnum.ChapterType.WeekWalk then
		...
		slot4 = DungeonModel.instance:getEpisodeInfo(RougeHeroGroupModel.instance.episodeId) and slot3.hasRecord
...
function slot0._refreshCloth(slot0)
	...
	slot4 = PlayerClothModel.instance:getById(PlayerClothModel.instance:getSpEpisodeClothID() or RougeHeroGroupModel.instance:getCurGroupMO().clothId)
	...
	gohelper.setActive(slot0._btncloth.gameObject, false)
end
...
function slot0._checkEquipClothSkill(slot0)
	...
	if PlayerClothModel.instance:getById(RougeHeroGroupModel.instance:getCurGroupMO().clothId) then
		return
	end

	for slot6, slot7 in ipairs(PlayerClothModel.instance:getList()) do
		if PlayerClothModel.instance:hasCloth(slot7.id) then
			RougeHeroGroupModel.instance:replaceCloth(slot7.id)
			HeroGroupController.instance:dispatchEvent(HeroGroupEvent.OnModifyHeroGroup)
...
function slot0._getEpisodeConfigAndBattleConfig()
	...
	return DungeonConfig.instance:getEpisodeCO(RougeHeroGroupModel.instance.episodeId), (not RougeHeroGroupModel.instance.battleId or RougeHeroGroupModel.instance.battleId <= 0 or lua_battle.configDict[RougeHeroGroupModel.instance.battleId]) and DungeonConfig.instance:getBattleCo(RougeHeroGroupModel.instance.episodeId)
end
...
function slot0.showCloth()
	...
	slot4 = PlayerClothModel.instance:getById(RougeHeroGroupModel.instance:getCurGroupMO().clothId)
	slot6 = false
...
function slot0._onClickHeroGroupItem(slot0, slot1)
	slot0._param = {
		...
		adventure = RougeHeroGroupModel.instance:isAdventureOrWeekWalk(),
		equips = RougeHeroGroupModel.instance:getCurGroupMO():getPosEquips(slot1 - 1).equipUid,
		heroGroupEditType = RougeEnum.HeroGroupEditType.Fight
	}
...
function slot0.openHeroGroupEditView(slot0)
	ViewMgr.instance:openView(ViewName.RougeHeroGroupEditView, slot0._param)
end

function slot0._checkFirstPosHasEquip(slot0)
	slot3 = RougeHeroGroupModel.instance:getCurGroupMO():getPosEquips(0).equipUid and slot2[1]
...
function slot0._onClickStart(slot0)
	...
	if RougeHeroGroupModel.instance.episodeId == 10104 and not DungeonModel.instance:hasPassLevel(slot6) then
...
function slot0._onClickReplay(slot0)
	...
	slot1 = DungeonConfig.instance:getEpisodeCO(RougeHeroGroupModel.instance.episodeId)

	if not (DungeonModel.instance:getEpisodeInfo(RougeHeroGroupModel.instance.episodeId) and slot2.hasRecord) and (slot2 and slot2.star == DungeonEnum.StarType.Advanced) and (slot1 and slot1.firstBattleId > 0) then
...
function slot0._switchReplayGroup(slot0, slot1)
	...
	if slot0._replayMode then
		...
		RougeHeroGroupModel.instance:setParam(RougeHeroGroupModel.instance.battleId, RougeHeroGroupModel.instance.episodeId, RougeHeroGroupModel.instance.adventure)
		HeroGroupController.instance:dispatchEvent(HeroGroupEvent.SelectHeroGroup, RougeHeroGroupModel.instance:getCurGroupMO().id)
		slot0:_refreshCloth()
		gohelper.setActive(slot0._goherogroupcontain, false)
		gohelper.setActive(slot0._goherogroupcontain, true)
	end
...
function slot0._haveRecord(slot0)
	...
	if DungeonModel.instance:getEpisodeInfo(RougeHeroGroupModel.instance.episodeId) and slot1.star == DungeonEnum.StarType.Advanced and not slot1.hasRecord then
		return false
	end
...
function slot0._noAidHero(slot0)
	if not lua_battle.configDict[RougeHeroGroupModel.instance.battleId] then
		return
	end
...
function slot0._updateReplayHeroGorupList(slot0)
	RougeHeroGroupModel.instance:setReplayParam(slot0._replayFightGroupMO)
