...
slot0 = class("RougePickAssistViewContainer", BaseViewContainer)
...
function slot0.instantiateListScrollView(slot0)
	...
	slot1.cellClass = RougePickAssistItem
	...
	return LuaListScrollViewWithAnimator.New(PickAssistListModel.instance, slot1, {
