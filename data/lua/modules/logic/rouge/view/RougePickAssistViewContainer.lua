...
local var_0_0 = class("RougePickAssistViewContainer", BaseViewContainer)
...
function var_0_0.instantiateListScrollView(arg_2_0)
	...
	var_2_0.cellClass = RougePickAssistItem
	...
	return LuaListScrollViewWithAnimator.New(PickAssistListModel.instance, var_2_0, var_2_1)
end
