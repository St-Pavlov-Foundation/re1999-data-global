...
function slot0.onInitView(slot0)
	...
	slot0._scrollextra = gohelper.findChildScrollRect(slot0.viewGO, "container/Scroll View/Viewport/layoutgroup/#go_extra/#scroll_extra")
	slot0._goextraContainer = gohelper.findChild(slot0.viewGO, "container/Scroll View/Viewport/layoutgroup/#go_extra/#scroll_extra/Viewport/#go_extraContainer")
	slot0._goextraItem = gohelper.findChild(slot0.viewGO, "container/Scroll View/Viewport/layoutgroup/#go_extra/#scroll_extra/Viewport/#go_extraContainer/#go_extraItem")
