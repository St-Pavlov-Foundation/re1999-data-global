...
slot0 = class("RougeTalentTreeBranchPool", BaseView)
...
function slot0.createIconInternal(slot0)
	slot1 = RougeTalentTreeBranchItem.New()
	slot0._iconIndex = slot0._iconIndex + 1

	slot1:init(slot0:getResInst(slot0._resPath, slot0._gopool, "branchitem" .. tostring(slot0._iconIndex)))
