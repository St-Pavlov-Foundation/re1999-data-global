...
local var_0_0 = pureTable("RougeHeroGroupMO")
...
function var_0_0.ctor(arg_1_0)
	...
	arg_1_0.exInfos = {}
	arg_1_0._maxHeroCount = ModuleEnum.MaxHeroCountInGroup
end
...
function var_0_0.initByFightGroup(arg_4_0, arg_4_1)
	...
	arg_4_0.recordRound = arg_4_1.recordRound
	arg_4_0.heroList = {}
	...
	arg_4_0.trialDict = {}
	arg_4_0.exInfos = {}
	arg_4_0.replayAssistHeroUid = arg_4_1.assistHeroUid
	arg_4_0.replayAssistUserId = arg_4_1.assistUserId

	local var_4_1 = HeroGroupModel.instance.battleId
	local var_4_2 = var_4_1 and lua_battle.configDict[var_4_1]
	local var_4_3 = var_4_2 and var_4_2.playerMax or ModuleEnum.HeroCountInGroup
	...
	for iter_4_10, iter_4_11 in ipairs(arg_4_1.activity104Equips) do
		...
		arg_4_0.activity104Equips[var_4_19]:setLimitNum(arg_4_0._seasonCardMainNum, arg_4_0._seasonCardNormalNum)
...
function var_0_0.setTrials(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in pairs(var_6_2) do
		if iter_6_1[3] then
			...
			if var_6_4 < 0 then
				var_6_4 = arg_6_0._playerMax - var_6_4
			end

			arg_6_0.trialDict[var_6_4] = iter_6_1

			local var_6_5 = lua_hero_trial.configDict[iter_6_1[1]][iter_6_1[2] or 0]

			arg_6_0.heroList[var_6_4] = tostring(var_6_5.heroId - 1099511627776)
			var_6_3[var_6_5.heroId] = true

			if not arg_6_1 and (var_6_5.act104EquipId1 > 0 or var_6_5.act104EquipId2 > 0) then
	...
	for iter_6_2, iter_6_3 in pairs(arg_6_0.heroList) do
		if tonumber(iter_6_3) > 0 then
			local var_6_6 = HeroModel.instance:getById(iter_6_3)

			if var_6_6 and var_6_3[var_6_6.heroId] then
				arg_6_0.heroList[iter_6_2] = "0"
			end
		end
	end
	...
	if not arg_6_1 and not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Equip) and not string.nilorempty(var_6_1.trialEquips) then
		local var_6_7 = string.splitToNumber(var_6_1.trialEquips, "|")

		for iter_6_4 = 1, math.min(#var_6_7, arg_6_0._maxHeroCount) do
			arg_6_0:updatePosEquips({
				index = iter_6_4 - 1,
				equipUid = {
					tostring(-var_6_7[iter_6_4])
				}
			})
		end
	end
...
function var_0_0.saveData(arg_7_0)
	...
	if Activity104Model.instance:isSeasonChapter() then
		var_7_3 = Activity104Model.instance:getSeasonTrialPrefsKey()
	else
...
function var_0_0.getSubList(arg_26_0)
	...
	if arg_26_0._playerMax then
		...
		for iter_26_1 = (var_26_4 and var_26_4.playerMax or ModuleEnum.HeroCountInGroup) + 1, arg_26_0._maxHeroCount do
