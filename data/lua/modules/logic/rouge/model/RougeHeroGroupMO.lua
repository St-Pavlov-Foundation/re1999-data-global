...
slot0 = pureTable("RougeHeroGroupMO")
...
function slot0.ctor(slot0)
	...
	slot0.exInfos = {}
	slot0._maxHeroCount = ModuleEnum.MaxHeroCountInGroup
end
...
function slot0.initByFightGroup(slot0, slot1)
	...
	for slot9, slot10 in ipairs(slot1.activity104Equips) do
		slot11 = slot10.heroUid == "-100000" and 4 or slot2[slot10.heroUid] - 1
		slot0.activity104Equips[slot11] = HeroGroupActivity104EquipMo.New()

		slot0.activity104Equips[slot11]:setLimitNum(slot0._seasonCardMainNum, slot0._seasonCardNormalNum)
...
function slot0.setTrials(slot0, slot1)
	...
	if not slot1 and not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Equip) and not string.nilorempty(slot3.trialEquips) then
		...
		for slot10 = 1, math.min(slot10, slot0._maxHeroCount) do
...
function slot0.getSubList(slot0)
	...
	if slot0._playerMax then
		...
		for slot9 = (slot4 and slot4.playerMax or ModuleEnum.HeroCountInGroup) + 1, slot0._maxHeroCount do
			slot10 = slot0.heroList[slot9] or "0"
