...
local var_0_0 = class("RougeHeroGroupBalanceHelper")
...
function var_0_0.getIsBalanceMode()
	local var_5_0 = RougeModel.instance:getDifficulty()

	if not var_5_0 then
		return false
	end

	local var_5_1 = RougeConfig1.instance:getDifficultyCO(var_5_0)

	return var_5_1 and not string.nilorempty(var_5_1.balanceLevel) or false
end
...
function var_0_0.getBalanceLv()
	local var_6_0 = RougeModel.instance:getDifficulty()

	if not var_6_0 then
		return
	end

	local var_6_1 = RougeConfig1.instance:getDifficultyCO(var_6_0)

	if not var_6_1 then
		return
	end

	local var_6_2 = string.splitToNumber(var_6_1.balanceLevel, "#")
