...
slot0 = class("RougeMapCollectionExchangeView", BaseView)
...
function slot0._btnconfirmOnClick(slot0)
	...
	slot0.callbackId = RougeRpc.instance:sendRougeDisplaceRequest(RougeLossCollectionListModel.instance:getSelectMoList()[1].uid, slot0.onReceiveMsg, slot0)
end
...
function slot0.onOpen(slot0)
	...
	RougeLossCollectionListModel.instance:initList(slot0.lossCount, slot0.collections, slot0.baseFilterTagDict, slot0.extraFilterTagDict)
	slot0:refreshTitle()
	slot0:refreshLeft()
	slot0:refreshRight()
	slot0:refreshBtn()
...
function slot0.refreshTitle(slot0)
	slot0._txtdec.text = GameUtil.getSubPlaceholderLuaLangOneParam(luaLang("rouge_exchange_title"), slot0.lossCount)
end
