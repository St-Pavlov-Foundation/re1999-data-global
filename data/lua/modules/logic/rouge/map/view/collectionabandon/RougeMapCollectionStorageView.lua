...
local var_0_0 = class("RougeMapCollectionStorageView", BaseView)
...
function var_0_0.onOpen(arg_9_0)
	...
	arg_9_0.lossCount = arg_9_0.viewParam and arg_9_0.viewParam.lossCount or 1
	...
	RougeLossCollectionListModel.instance:initList(arg_9_0.lossCount, arg_9_0.collections, arg_9_0.baseFilterTagDict, arg_9_0.extraFilterTagDict, true)
...
function var_0_0.refreshTitle(arg_10_0)
	arg_10_0._txtdec.text = GameUtil.getSubPlaceholderLuaLangOneParam(luaLang("rouge_storage_title"), arg_10_0.lossCount)
end
