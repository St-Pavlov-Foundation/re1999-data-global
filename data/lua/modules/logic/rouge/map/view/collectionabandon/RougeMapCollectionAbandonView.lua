...
slot0 = class("RougeMapCollectionAbandonView", BaseView)
...
function slot0.onInitView(slot0)
	...
	slot0._gofilterselect = gohelper.findChild(slot0.viewGO, "Left/#btn_filter/#go_select")
	slot0._gofilterunselect = gohelper.findChild(slot0.viewGO, "Left/#btn_filter/#go_unselect")
	slot0._txtnum = gohelper.findChildText(slot0.viewGO, "Right/#txt_num")
	slot0._gorightempty = gohelper.findChild(slot0.viewGO, "Right/#go_rightempty")
