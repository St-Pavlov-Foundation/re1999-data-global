-- chunkname: @modules/logic/rouge/map/view/collectionabandon/RougeMapCollectionStorageViewContainer.lua

module("modules.logic.rouge.map.view.collectionabandon.RougeMapCollectionStorageViewContainer", package.seeall)

local RougeMapCollectionStorageViewContainer = class("RougeMapCollectionStorageViewContainer", BaseViewContainer)

function RougeMapCollectionStorageViewContainer:buildViews()
	local views = {}

	table.insert(views, RougeMapCollectionStorageView.New())
...
function RougeMapCollectionStorageViewContainer:buildTabViews(tabContainerId)
...
function RougeMapCollectionStorageViewContainer:onContainerInit()
	self.listRemoveComp = ListScrollAnimRemoveItem.Get(self.scrollView)

	self.listRemoveComp:setMoveInterval(0)
end

function RougeMapCollectionStorageViewContainer:getListRemoveComp()
	return self.listRemoveComp
end

return RougeMapCollectionStorageViewContainer
