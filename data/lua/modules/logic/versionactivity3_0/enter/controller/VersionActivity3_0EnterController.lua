...
local var_0_0 = class("VersionActivity3_0EnterController", BaseController)
...
function var_0_0.openVersionActivityEnterView(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	local var_6_0 = VersionActivity3_0Enum.ActivityId.EnterView
	local var_6_1 = VersionActivityEnterHelper.getActIdList(VersionActivity3_0Enum.EnterViewActSetting)
	local var_6_2 = {
		actId = var_6_0,
		jumpActId = arg_6_3,
	...
	if arg_6_4 then
		...
		if TimeUtil.getDayFirstLoginRed(VersionActivity3_0Enum.EnterVideoDayKey) then
			var_6_2.playVideo = true
		end
	end

	local var_6_4 = ViewName.VersionActivity3_0EnterView
