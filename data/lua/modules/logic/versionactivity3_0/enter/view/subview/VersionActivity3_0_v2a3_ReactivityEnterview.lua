-- chunkname: @modules/logic/versionactivity3_0/enter/view/subview/VersionActivity3_0_v2a3_ReactivityEnterview.lua

module("modules.logic.versionactivity3_0.enter.view.subview.VersionActivity3_0_v2a3_ReactivityEnterview", package.seeall)

local VersionActivity3_0_v2a3_ReactivityEnterview = class("VersionActivity3_0_v2a3_ReactivityEnterview", ReactivityEnterview)

function VersionActivity3_0_v2a3_ReactivityEnterview:onInitView()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:addEvents()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:removeEvents()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:_editableInitView()
	self.rewardItems = {}

	VersionActivity3_0_v2a3_ReactivityEnterview.super._editableInitView(self)
end

function VersionActivity3_0_v2a3_ReactivityEnterview:onOpen()
	self.actId = VersionActivity2_9Enum.ActivityId.Reactivity
	...
	VersionActivity3_0_v2a3_ReactivityEnterview.super.onOpen(self)
end

function VersionActivity3_0_v2a3_ReactivityEnterview:_onClickEnter()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:initRedDot()
	return
end

function VersionActivity3_0_v2a3_ReactivityEnterview:_btntaskOnClick()
	if not self:_isOpenOrThrowToast() then
		return
	end
...
function VersionActivity3_0_v2a3_ReactivityEnterview:_onClickStoreBtn()
	VersionActivity2_3DungeonController.instance:openStoreView()
end

function VersionActivity3_0_v2a3_ReactivityEnterview:_isOpenOrThrowToast()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:refreshStoreTime()
...
function VersionActivity3_0_v2a3_ReactivityEnterview:onDestroyView()
	if self.animComp then
		self.animComp:destroy()
	end
end

return VersionActivity3_0_v2a3_ReactivityEnterview
