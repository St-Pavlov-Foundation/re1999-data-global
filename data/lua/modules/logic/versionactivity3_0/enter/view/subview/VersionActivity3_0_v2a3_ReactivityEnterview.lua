...
local var_0_0 = class("VersionActivity3_0_v2a3_ReactivityEnterview", ReactivityEnterview)
...
function var_0_0.onOpen(arg_5_0)
	arg_5_0.actId = VersionActivity2_9Enum.ActivityId.Reactivity
...
function var_0_0.onDestroyView(arg_12_0)
	if arg_12_0.animComp then
		arg_12_0.animComp:destroy()
	end
end
