...
local var_0_0 = class("KaRongTalkView", BaseView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(KaRongDrawController.instance, KaRongDrawEvent.OnStartDialog, arg_2_0._onStartDialog, arg_2_0)
end
