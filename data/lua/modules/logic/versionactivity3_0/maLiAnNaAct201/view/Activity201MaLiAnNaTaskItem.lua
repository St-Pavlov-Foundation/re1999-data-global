...
local var_0_0 = class("Activity201MaLiAnNaTaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._act203TaskMO.config.jumpId > 0 then
		GameFacade.jump(arg_4_0._act203TaskMO.config.jumpId)
	end
end

function var_0_0._btnfinishbgOnClick(arg_5_0)
	arg_5_0:_onOneClickClaimReward(arg_5_0._act203TaskMO.activityId)
...
function var_0_0._btngetallOnClick(arg_6_0)
	Activity201MaLiAnNaController.instance:dispatchEvent(Activity201MaLiAnNaEvent.OneClickClaimReward, arg_6_0._act203TaskMO.activityId, true)
	UIBlockHelper.instance:startBlock("Activity201MaLiAnNaTaskItem_finishAnim", 0.5)
	TaskDispatcher.runDelay(arg_6_0._delayFinishAll, arg_6_0, 0.5)
end

function var_0_0._delayFinish(arg_7_0)
	TaskRpc.instance:sendFinishTaskRequest(arg_7_0._act203TaskMO.config.id)
end
...
function var_0_0._editableAddEvents(arg_10_0)
	Activity201MaLiAnNaController.instance:registerCallback(Activity201MaLiAnNaEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	Activity201MaLiAnNaController.instance:unregisterCallback(Activity201MaLiAnNaEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end

function var_0_0._onOneClickClaimReward(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_0._act203TaskMO and arg_12_0._act203TaskMO.activityId == arg_12_1 and (arg_12_0._act203TaskMO:alreadyGotReward() or arg_12_0._act203TaskMO.id == -99999 and arg_12_2) then
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	arg_14_0._act203TaskMO = arg_14_1

	local var_14_0 = Activity201MaLiAnNaTaskListModel.instance:getRankDiff(arg_14_1)
...
function var_0_0._refreshUI(arg_17_0)
	local var_17_0 = arg_17_0._act203TaskMO
