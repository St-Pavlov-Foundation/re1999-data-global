...
function slot0.onInitView(slot0)
	...
	slot0._txtlvlimit = gohelper.findChildText(slot0.viewGO, "go_levellimit/bg/txt")
...
function slot0.refreshNextRefreshTime(slot0, slot1)
	...
	if slot2 then
		if slot0:getEndTimeStamp(slot1) - ServerTime.now() > 0 then
...
function slot0.refreshActGoods(slot0)
	...
	slot0._txtremain.text = formatLuaLang("store_buylimit_day", FurnaceTreasureModel.instance:getGoodsRemainCount(slot2, slot3))
