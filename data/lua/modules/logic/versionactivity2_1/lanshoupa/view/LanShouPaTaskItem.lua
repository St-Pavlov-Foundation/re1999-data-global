...
local var_0_0 = class("LanShouPaTaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._act164TaskMO.config.jumpId > 0 then
		GameFacade.jump(arg_4_0._act164TaskMO.config.jumpId)
	end
end

function var_0_0._btnfinishbgOnClick(arg_5_0)
	arg_5_0:_onOneClickClaimReward(arg_5_0._act164TaskMO.activityId)
...
function var_0_0._btngetallOnClick(arg_6_0)
	LanShouPaController.instance:dispatchEvent(LanShouPaEvent.OneClickClaimReward, arg_6_0._act164TaskMO.activityId)
	UIBlockHelper.instance:startBlock("LanShouPaTaskItem_finishAnim", 0.5)
	TaskDispatcher.runDelay(arg_6_0._delayFinishAll, arg_6_0, 0.5)
end

function var_0_0._delayFinish(arg_7_0)
	TaskRpc.instance:sendFinishTaskRequest(arg_7_0._act164TaskMO.config.id)
end
...
function var_0_0._editableInitView(arg_9_0)
	arg_9_0._animator = arg_9_0.viewGO:GetComponent(LanShouPaEnum.ComponentType.Animator)
...
function var_0_0._editableAddEvents(arg_10_0)
	LanShouPaController.instance:registerCallback(LanShouPaEvent.OneClickClaimReward, arg_10_0._onOneClickClaimReward, arg_10_0)
end

function var_0_0._editableRemoveEvents(arg_11_0)
	LanShouPaController.instance:unregisterCallback(LanShouPaEvent.OneClickClaimReward, arg_11_0._onOneClickClaimReward, arg_11_0)
end

function var_0_0._onOneClickClaimReward(arg_12_0, arg_12_1)
	if arg_12_0._act164TaskMO and arg_12_0._act164TaskMO.activityId == arg_12_1 and arg_12_0._act164TaskMO:alreadyGotReward() then
...
function var_0_0.onUpdateMO(arg_14_0, arg_14_1)
	arg_14_0._act164TaskMO = arg_14_1

	local var_14_0 = Activity164TaskListModel.instance:getRankDiff(arg_14_1)
...
function var_0_0._moveByRankDiff(arg_15_0, arg_15_1)
	if arg_15_1 and arg_15_1 ~= 0 then
		...
		arg_15_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_15_0.viewTrs, 0, LanShouPaEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function var_0_0._refreshUI(arg_17_0)
	local var_17_0 = arg_17_0._act164TaskMO

	if not var_17_0 then
		return
	end

	local var_17_1 = var_17_0.id ~= LanShouPaEnum.TaskMOAllFinishId
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_1/v2a1_tuesday/v2a1_tuesday_taskitem.prefab"
