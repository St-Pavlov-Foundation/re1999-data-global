...
local var_0_0 = class("AergusiTaskItem", ListScrollCellExtend)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._goquan = gohelper.findChild(arg_1_0.viewGO, "#go_normal/#btn_notfinishbg/quan")
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._taskMO then
		local var_4_0 = arg_4_0._taskMO.config.jumpId
...
function var_0_0._btnfinishbgOnClick(arg_5_0)
	if AergusiController.instance:delayReward(AergusiEnum.AnimatorTime.TaskReward, arg_5_0._taskMO) then
		arg_5_0:_onOneClickClaimReward(arg_5_0._taskMO.activityId)
	end
end

function var_0_0._btngetallOnClick(arg_6_0)
	if AergusiController.instance:delayReward(AergusiEnum.AnimatorTime.TaskReward, arg_6_0._taskMO) then
		Activity131Controller.instance:dispatchEvent(Activity131Event.OneClickClaimReward, arg_6_0._taskMO.activityId)
	end
end
...
function var_0_0._editableAddEvents(arg_8_0)
	AergusiController.instance:registerCallback(AergusiEvent.OneClickClaimReward, arg_8_0._onOneClickClaimReward, arg_8_0)
end

function var_0_0._editableRemoveEvents(arg_9_0)
	AergusiController.instance:unregisterCallback(AergusiEvent.OneClickClaimReward, arg_9_0._onOneClickClaimReward, arg_9_0)
end

function var_0_0._onOneClickClaimReward(arg_10_0, arg_10_1)
	if arg_10_0._taskMO and arg_10_0._taskMO.activityId == arg_10_1 and arg_10_0._taskMO:alreadyGotReward() then
...
function var_0_0.onUpdateMO(arg_12_0, arg_12_1)
	arg_12_0._taskMO = arg_12_1

	local var_12_0 = AergusiTaskListModel.instance:getRankDiff(arg_12_1)
...
function var_0_0._moveByRankDiff(arg_13_0, arg_13_1)
	if arg_13_1 and arg_13_1 ~= 0 then
		...
		arg_13_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_13_0.viewTrs, 0, AergusiEnum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function var_0_0._refreshUI(arg_15_0)
	local var_15_0 = arg_15_0._taskMO

	if not var_15_0 then
		return
	end

	local var_15_1 = var_15_0.id ~= AergusiEnum.TaskMOAllFinishId
	...
	if var_15_1 then
		...
		elseif AergusiTaskListModel.instance:getAniDisableState() then
			arg_15_0._animator:Play("open", 1, 0)
			gohelper.setActive(arg_15_0._goquan, false)
		end
		...
		gohelper.setActive(arg_15_0._gonojump, false)
		...
		elseif var_15_0:alreadyGotReward() then
			...
			local var_15_2 = arg_15_0._taskMO.config.jumpId

			gohelper.setActive(arg_15_0._btnnotfinishbg.gameObject, var_15_2 > 0)
			gohelper.setActive(arg_15_0._gonojump, var_15_2 <= 0)
		end
		...
		local var_15_3 = DungeonConfig.instance:getRewardItems(tonumber(var_15_0.config.bonus))
		local var_15_4 = {}

		for iter_15_0, iter_15_1 in ipairs(var_15_3) do
			var_15_4[iter_15_0] = {
				isIcon = true,
				materilType = iter_15_1[1],
				materilId = iter_15_1[2],
				quantity = iter_15_1[3]
			}
		end

		arg_15_0.item_list = var_15_4

		IconMgr.instance:getCommonPropItemIconList(arg_15_0, arg_15_0._onItemShow, var_15_4, arg_15_0._gorewards)
	end
...
var_0_0.prefabPath = "ui/viewres/versionactivity_2_1/v2a1_aergusi/v2a1_aergusi_taskitem.prefab"
