...
local var_0_0 = class("VersionActivity2_1EnterController", BaseController)
...
function var_0_0.openVersionActivityEnterView(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	local var_6_0 = VersionActivity2_1Enum.ActivityId.EnterView
	local var_6_1 = VersionActivityEnterHelper.getActIdList(VersionActivity2_1Enum.EnterViewActSetting)
	local var_6_2 = {
		actId = var_6_0,
		jumpActId = arg_6_3,
	...
	local var_6_4 = ViewName.VersionActivity2_1EnterView
