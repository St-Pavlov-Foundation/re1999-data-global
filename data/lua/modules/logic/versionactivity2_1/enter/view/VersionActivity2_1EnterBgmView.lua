...
slot0 = class("VersionActivity2_1EnterBgmView", BaseView)
...
function slot0.onOpen(slot0)
	...
	slot0._isFirstOpenMainAct = VersionActivityEnterHelper.getActId(slot1[VersionActivityEnterHelper.getTabIndex(slot1, slot0.viewParam.jumpActId)]) == VersionActivity2_1Enum.ActivityId.Dungeon
...
function slot0.modifyBgm(slot0, slot1)
	slot0._isMainAct = slot1 == VersionActivity2_1Enum.ActivityId.Dungeon
	slot2 = 0
...
function slot0.defaultBgmHandle(slot0, slot1)
	...
	if ActivityConfig.instance:getActivityEnterViewBgm(slot1) == 0 then
		...
		slot2 = AudioEnum.Bgm.Act2_1DungeonBgm
	end
	...
	AudioBgmManager.instance:modifyBgmAudioId(AudioBgmEnum.Layer.VersionActivity2_1Main, slot2)
end
