...
local var_0_0 = class("VersionActivity2_1EnterView", VersionActivityEnterBaseViewWithListNew)
local var_0_1 = 2.1
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.First, arg_1_0._gotabitem1, VersionActivity2_1EnterViewTabItem1)
	arg_1_0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.Second, arg_1_0._gotabitem2, VersionActivity2_1EnterViewTabItem2)
...
function var_0_0.onOpen(arg_5_0)
	...
	if arg_5_0.curActId == VersionActivity2_1Enum.ActivityId.Dungeon then
		arg_5_0.viewAnim:Play("open1", 0, 0)
	else
		arg_5_0.viewAnim:Play(UIAnimationName.Open, 0, 0)
		arg_5_0.viewContainer:markPlayedSubViewAnim()
	end
end
...
function var_0_0._onTabScrollChange(arg_7_0)
	local var_7_0 = recthelper.getAnchorY(arg_7_0.rectTrContent)

	for iter_7_0, iter_7_1 in ipairs(arg_7_0.activityTabItemList) do
		if iter_7_1:isShowRedDot() and -iter_7_1:getAnchorY() + VersionActivity2_1Enum.RedDotOffsetY - var_7_0 > arg_7_0.viewPortHeight then
			gohelper.setActive(arg_7_0.goArrowRedDot, true)

			return
		end
	end

	gohelper.setActive(arg_7_0.goArrowRedDot, false)
end

function var_0_0.refreshRedDot(arg_8_0)
	arg_8_0:_onTabScrollChange()
end

function var_0_0.refreshBtnVisible(arg_9_0, arg_9_1)
	local var_9_0 = VersionActivity2_1EnterHelper.GetIsShowReplayBtn(arg_9_0.curActId)
	local var_9_1 = VersionActivity2_1EnterHelper.GetIsShowAchievementBtn(arg_9_0.curActId)

	gohelper.setActive(arg_9_0.goReplayBtn, var_9_0)
	gohelper.setActive(arg_9_0.goAchievementBtn, var_9_1)
