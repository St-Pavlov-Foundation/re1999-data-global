...
local var_0_0 = class("V2a1_DungeonEnterView", BaseView)
...
function var_0_0.onOpen(arg_12_0)
	...
	if arg_12_0.viewParam.isDirectOpen then
...
function var_0_0.refreshRemainTime(arg_15_0)
	...
	local var_15_2 = ActivityModel.instance:getActivityInfo()[VersionActivity2_1Enum.ActivityId.DungeonStore]
...
function var_0_0.refreshActivityState(arg_16_0)
	...
	local var_16_3 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_1Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal
