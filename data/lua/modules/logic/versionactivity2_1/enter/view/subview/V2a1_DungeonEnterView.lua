...
slot0 = class("V2a1_DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_1Enum.ActivityId.Dungeon
	slot0.animComp = VersionActivity2_1SubAnimatorComp.get(slot0.viewGO, slot0)
	...
	slot0:_setDesc()
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a1DungeonEnter)
...
function slot0.onOpen(slot0)
	...
	if slot0.viewParam.isDirectOpen then
...
function slot0.refreshRemainTime(slot0)
	if ActivityModel.instance:getActivityInfo()[slot0.actId]:getRealEndTimeStamp() - ServerTime.now() > 0 then
		slot0._txttime.text = slot1:getRemainTimeStr3(false, false)
	...
	slot3 = ActivityModel.instance:getActivityInfo()[VersionActivity2_1Enum.ActivityId.DungeonStore]
...
function slot0.refreshActivityState(slot0)
	...
	gohelper.setActive(slot0.goStore, ActivityHelper.getActivityStatusAndToast(VersionActivity2_1Enum.ActivityId.DungeonStore) == ActivityEnum.ActivityStatus.Normal)
end
