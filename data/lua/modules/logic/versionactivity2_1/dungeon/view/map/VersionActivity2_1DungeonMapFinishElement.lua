-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/map/VersionActivity2_1DungeonMapFinishElement.lua

module("modules.logic.versionactivity2_1.dungeon.view.map.VersionActivity2_1DungeonMapFinishElement", package.seeall)

local VersionActivity2_1DungeonMapFinishElement = class("VersionActivity2_1DungeonMapFinishElement", DungeonMapFinishElement)

function VersionActivity2_1DungeonMapFinishElement:init(go)
	self._go = go
...
function VersionActivity2_1DungeonMapFinishElement:_onResLoaded()
	if not string.nilorempty(self.resPath) then
...
function VersionActivity2_1DungeonMapFinishElement:onDown()
	self:_onDown()
end

function VersionActivity2_1DungeonMapFinishElement:_onDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivity2_1DungeonMapFinishElement:onClick()
...
return VersionActivity2_1DungeonMapFinishElement
