...
slot0 = class("VersionActivity2_1DungeonMapEpisodeItem", BaseChildView)
...
function slot0.onClick(slot0)
	...
	if ViewMgr.instance:getContainer(ViewName.VersionActivity2_1DungeonMapLevelView) then
...
function slot0._showEye(slot0)
	...
	slot2 = slot0._config.chapterId == VersionActivity2_1DungeonEnum.DungeonChapterId.Hard
...
function slot0.getMapAllElementList(slot0)
	return VersionActivity2_1DungeonModel.instance:getElementCoList(slot0._map.id)
end

function slot0._showAllElementTipView(slot0)
	if not slot0._map or slot0._config.chapterId == VersionActivity2_1DungeonEnum.DungeonChapterId.Hard then
	...
	slot1, slot2 = VersionActivity2_1DungeonModel.instance:getElementCoListWithFinish(slot0._map.id)
...
function slot0.refresh(slot0, slot1, slot2)
	...
	slot0._map = VersionActivity2_1DungeonConfig.instance:getEpisodeMapConfig(slot0._config.id)
...
function slot0.calculatePosInContent(slot0)
	slot0._maxWidth = math.max(math.max(recthelper.getAnchorX(slot0._txtsectionname.transform) + slot0._txtsectionname.preferredWidth, recthelper.getAnchorX(slot0._txtnameen.transform) + slot0._txtsectionname.preferredWidth) * 2, VersionActivity2_1DungeonEnum.EpisodeItemMinWidth) + 30
...
function slot0.setImage(slot0, slot1, slot2, slot3)
	slot5 = VersionActivity2_1DungeonEnum.EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId]

	UISpriteSetMgr.instance:setV2a1DungeonSprite(slot1, slot2 and slot5.light or slot5.empty)
end
