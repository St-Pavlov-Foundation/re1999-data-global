...
local var_0_0 = class("VersionActivity2_1DungeonMapScene", BaseView)
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.FocusElement, arg_2_0.onFocusElement, arg_2_0)
	arg_2_0:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.ManualClickElement, arg_2_0.manualClickElement, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.FocusElement, arg_3_0.onFocusElement, arg_3_0)
	arg_3_0:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.ManualClickElement, arg_3_0.manualClickElement, arg_3_0)
...
function var_0_0._onScreenResize(arg_6_0)
	if arg_6_0._sceneGo then
		...
		var_6_0.orthographicSize = VersionActivity2_1DungeonEnum.DungeonMapCameraSize * var_6_1
...
function var_0_0.onActivityDungeonMoChange(arg_8_0)
	local var_8_0 = VersionActivity2_1DungeonModel.instance:getMapNeedTweenState()
...
function var_0_0._initMapRootNode(arg_19_0)
	arg_19_0._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_1DungeonEnum.SceneRootName)
...
function var_0_0._initCamera(arg_22_0)
	...
	var_22_0.orthographicSize = VersionActivity2_1DungeonEnum.DungeonMapCameraSize * var_22_1
end

function var_0_0.refreshMap(arg_23_0, arg_23_1, arg_23_2)
	arg_23_0._mapCfg = arg_23_2 or VersionActivity2_1DungeonConfig.instance:getEpisodeMapConfig(arg_23_0.activityDungeonMo.episodeId)
...
function var_0_0._initScene(arg_28_0)
	...
	local var_28_9 = VersionActivity2_1DungeonEnum.DungeonMapCameraSize / var_28_8
...
function var_0_0._focusUnfinishStoryElement(arg_32_0)
	local var_32_0 = VersionActivity2_1DungeonModel.instance:checkAndGetUnfinishStoryElementCo(arg_32_0._mapCfg.id)

	if var_32_0 then
		VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, var_32_0.id)
	end
end
...
function var_0_0.directSetScenePos(arg_37_0, arg_37_1)
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnMapPosChanged, arg_37_0._scenePos, arg_37_0.needTween)
