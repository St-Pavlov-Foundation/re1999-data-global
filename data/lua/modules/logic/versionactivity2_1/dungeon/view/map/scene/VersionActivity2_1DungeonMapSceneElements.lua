...
function VersionActivity2_1DungeonMapSceneElements:addEvents()
	...
	self:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
...
function VersionActivity2_1DungeonMapSceneElements:removeEvents()
	...
	self:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.onHideInteractUI, self)
