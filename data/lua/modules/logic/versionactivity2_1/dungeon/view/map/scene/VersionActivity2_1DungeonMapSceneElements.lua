...
slot0 = class("VersionActivity2_1DungeonMapSceneElements", BaseView)
slot1 = 0.5
slot2 = 0.5
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, slot0.onHideInteractUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, slot0.onHideInteractUI, slot0)
...
function slot0.onGamepadKeyDown(slot0, slot1)
	...
	for slot9 = 0, UnityEngine.Physics2D.RaycastAll(slot3.origin, slot3.direction).Length - 1 do
		if MonoHelper.getLuaComFromGo(slot4[slot9].transform.parent.gameObject, VersionActivity2_1DungeonMapElement) then
			slot11:_onClickDown()
		end
	end
end
...
function slot0._removeElement(slot0, slot1)
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnRemoveElement, slot2)
end
...
function slot0.showNewElements(slot0)
	...
	for slot6, slot7 in ipairs(slot1) do
		if VersionActivity2_1DungeonConfig.instance:checkElementBelongMapId(DungeonConfig.instance:getChapterMapElement(slot7), slot0._mapCfg.id) and slot8.showCamera == 1 then
			slot2[#slot2 + 1] = slot7
		end
	end
...
function slot0._doFocusElement(slot0)
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, slot0[2], true)
end
...
function slot0._addElement(slot0, slot1)
	...
	if slot0._elementCompPoolDict[slot1.id] then
		...
		slot2 = MonoHelper.addLuaComOnceToGo(slot3, VersionActivity2_1DungeonMapElement, {
			slot1,
			slot0
		})
	end
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnAddOneElement, slot2)
end
...
function slot0.showElements(slot0)
	...
	for slot8, slot9 in ipairs(VersionActivity2_1DungeonModel.instance:getElementCoList(slot0._mapCfg.id)) do
...
function slot0._arrowClick(slot0, slot1)
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, slot1)
end
