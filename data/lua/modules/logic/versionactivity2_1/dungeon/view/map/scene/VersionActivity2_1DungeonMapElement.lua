...
slot0 = class("VersionActivity2_1DungeonMapElement", LuaCompBase)
slot1 = 1.6
...
function slot0.onClick(slot0)
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnClickElement, slot0)
end
