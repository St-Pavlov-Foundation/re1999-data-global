-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/map/scene/VersionActivity2_1DungeonMapElement.lua

module("modules.logic.versionactivity2_1.dungeon.view.map.scene.VersionActivity2_1DungeonMapElement", package.seeall)

local VersionActivity2_1DungeonMapElement = class("VersionActivity2_1DungeonMapElement", LuaCompBase)
local FINISH_ANIM_TIME = 1.6
local BOX_COLLIDER_SIZE = Vector2(1.5, 1.5)

function VersionActivity2_1DungeonMapElement:ctor(param)
	self._config = param[1]
	self._sceneElements = param[2]
end

function VersionActivity2_1DungeonMapElement:getElementId()
	return self._config.id
end

function VersionActivity2_1DungeonMapElement:hide()
	gohelper.setActive(self._go, false)
end

function VersionActivity2_1DungeonMapElement:show()
	gohelper.setActive(self._go, true)
end

function VersionActivity2_1DungeonMapElement:init(go)
	self._go = go
...
function VersionActivity2_1DungeonMapElement:_onResLoaded()
...
function VersionActivity2_1DungeonMapElement:createMainPrefab()
...
function VersionActivity2_1DungeonMapElement.addBoxColliderListener(go, callback, callbackTarget)
...
function VersionActivity2_1DungeonMapElement:createEffectPrefab()
...
function VersionActivity2_1DungeonMapElement:autoPopInteractView()
...
function VersionActivity2_1DungeonMapElement:tryHideSelf()
	if VersionActivity2_1DungeonModel.instance:checkIsShowInteractView() then
		self:hideElement()
	end
end

function VersionActivity2_1DungeonMapElement:hideElement()
	self:playEffectAnim("wenhao_a_001_out")
end

function VersionActivity2_1DungeonMapElement:showElement()
	self:playEffectAnim("wenhao_a_001_in")
end

function VersionActivity2_1DungeonMapElement:setFinish()
...
function VersionActivity2_1DungeonMapElement:onFinishAnimDone()
	self:onDestroy()
end

function VersionActivity2_1DungeonMapElement:playEffectAnim(name)
...
function VersionActivity2_1DungeonMapElement:_effectAnimDone()
	return
end

function VersionActivity2_1DungeonMapElement:updatePos()
...
function VersionActivity2_1DungeonMapElement:getTransform()
	return self._transform
end

function VersionActivity2_1DungeonMapElement:getElementPos()
...
function VersionActivity2_1DungeonMapElement:getConfig()
	return self._config
end

function VersionActivity2_1DungeonMapElement:_onClickDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivity2_1DungeonMapElement:onClick()
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnClickElement, self)
end

function VersionActivity2_1DungeonMapElement:isValid()
	return not gohelper.isNil(self._go)
end

function VersionActivity2_1DungeonMapElement:isConfigShowArrow()
	return self._config.showArrow == 1
end

function VersionActivity2_1DungeonMapElement:onDestroy()
	gohelper.setActive(self._go, true)
...
return VersionActivity2_1DungeonMapElement
