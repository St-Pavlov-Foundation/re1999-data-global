...
local k_VersionActivity2_1Dungeon = 2110111

function VersionActivity2_1DungeonMapLevelView:_buildEpisodeName_overseas(firstName, remainName, txtColor, episodeCo, nameLen)
	local isJp = LangSettings.instance:isJp()
	local isjpth11 = self.showEpisodeCo.id == k_VersionActivity2_1Dungeon and isJp
	...
	if isjpth11 then
		...
		return self:buildColorText(string.format("%s<size=112>%s</size>%s", firstName, secondName, remainName), txtColor)
	else
