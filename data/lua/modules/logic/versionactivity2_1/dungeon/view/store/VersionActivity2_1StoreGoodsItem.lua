...
slot0 = class("VersionActivity2_1StoreGoodsItem", UserDataDispose)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_1Enum.ActivityId.DungeonStore, slot0.storeGoodsCo.id)
