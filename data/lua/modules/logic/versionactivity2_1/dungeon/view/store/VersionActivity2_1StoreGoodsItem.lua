-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/store/VersionActivity2_1StoreGoodsItem.lua

module("modules.logic.versionactivity2_1.dungeon.view.store.VersionActivity2_1StoreGoodsItem", package.seeall)

local VersionActivity2_1StoreGoodsItem = class("VersionActivity2_1StoreGoodsItem", UserDataDispose)

function VersionActivity2_1StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_1StoreGoodsItem:onClick()
...
function VersionActivity2_1StoreGoodsItem:updateInfo(storeGoodsCo)
...
function VersionActivity2_1StoreGoodsItem:refreshRemainBuyCount()
...
function VersionActivity2_1StoreGoodsItem:setImageIconNative()
	self.imageIcon:SetNativeSize()
end

function VersionActivity2_1StoreGoodsItem:refreshTag()
...
function VersionActivity2_1StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity2_1StoreGoodsItem:onDestroy()
...
return VersionActivity2_1StoreGoodsItem
