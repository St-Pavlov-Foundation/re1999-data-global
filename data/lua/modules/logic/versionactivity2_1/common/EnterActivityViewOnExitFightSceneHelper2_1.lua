...
function slot0.enterActivity12113(slot0, slot1)
...
function slot0.enterActivity12105(slot0, slot1)
	DungeonModel.instance.curSendEpisodeId = nil

	MainController.instance:enterMainScene(slot0)
	SceneHelper.instance:waitSceneDone(SceneType.Main, function ()
		VersionActivity2_1EnterController.instance:openVersionActivityEnterViewIfNotOpened(nil, , VersionActivity2_1Enum.ActivityId.Aergusi, true)
	end)
end

function slot0.enterActivity12114(slot0, slot1)
	DungeonModel.instance.curSendEpisodeId = nil

	MainController.instance:enterMainScene(slot0)
	SceneHelper.instance:waitSceneDone(SceneType.Main, function ()
		VersionActivity2_1EnterController.instance:openVersionActivityEnterViewIfNotOpened(nil, , VersionActivity2_1Enum.ActivityId.LanShouPa, true)
	end)
end

function slot0.enterActivity12115(slot0, slot1)
...
function slot0.enterActivity12102(slot0, slot1)
	uv0.enterVersionActivityDungeonCommon(uv0._enterActivity12102, slot0, slot1)
end

function slot0._enterActivity12102(slot0, slot1)
	...
	if slot3.chapterId == VersionActivity2_1DungeonEnum.DungeonChapterId.ElementFight then
		DungeonMapModel.instance.lastElementBattleId = slot2

		if VersionActivity2_1DungeonModel.instance:getLastEpisodeId() then
			VersionActivity2_1DungeonModel.instance:setLastEpisodeId(nil)
		else
			slot2 = DungeonConfig.instance:getActivityElementFightEpisodeToNormalEpisodeId(slot3, VersionActivity2_1DungeonEnum.DungeonChapterId.Story)
		end
	...
	slot5:registerDoneListener(function ()
		if uv0 then
			VersionActivity2_1DungeonController.instance:openVersionActivityDungeonMapView(nil, uv1, function ()
				ViewMgr.instance:openView(ViewName.VersionActivity2_1DungeonMapLevelView, {
					episodeId = uv0
				})
			end, nil)
		else
			VersionActivity2_1DungeonController.instance:openVersionActivityDungeonMapView(nil, uv1)
		end
	end)
	slot5:start()
