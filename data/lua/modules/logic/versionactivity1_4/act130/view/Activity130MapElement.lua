...
slot0 = class("Activity130MapElement", LuaCompBase)

function slot0.ctor(slot0, slot1)
	slot0._info = slot1[1]
	slot0._config = Activity130Config.instance:getActivity130ElementCo(VersionActivity1_4Enum.ActivityId.Role37, slot0._info.elementId)
...
function slot0.onClick(slot0)
	slot0._info = Activity130Model.instance:getCurMapElementInfo(slot0._info.elementId)

	Activity130Controller.instance:dispatchEvent(Activity130Event.OnClickElement, slot0)
end
