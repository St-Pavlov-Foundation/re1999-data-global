...
local var_0_0 = class("Activity131TaskItem", ListScrollCellExtend)
...
function var_0_0._btnnotfinishbgOnClick(arg_4_0)
	if arg_4_0._act131TaskMO then
		local var_4_0 = arg_4_0._act131TaskMO.config.jumpId
...
function var_0_0._btnfinishbgOnClick(arg_5_0)
	if Activity131Controller.instance:delayReward(Activity131Enum.AnimatorTime.TaskReward, arg_5_0._act131TaskMO) then
		arg_5_0:_onOneClickClaimReward(arg_5_0._act131TaskMO.activityId)
	end
end

function var_0_0._btngetallOnClick(arg_6_0)
	if Activity131Controller.instance:delayReward(Activity131Enum.AnimatorTime.TaskReward, arg_6_0._act131TaskMO) then
		Activity131Controller.instance:dispatchEvent(Activity131Event.OneClickClaimReward, arg_6_0._act131TaskMO.activityId)
	end
end
...
function var_0_0._editableAddEvents(arg_8_0)
	Activity131Controller.instance:registerCallback(Activity131Event.OneClickClaimReward, arg_8_0._onOneClickClaimReward, arg_8_0)
end

function var_0_0._editableRemoveEvents(arg_9_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.OneClickClaimReward, arg_9_0._onOneClickClaimReward, arg_9_0)
end

function var_0_0._onOneClickClaimReward(arg_10_0, arg_10_1)
	if arg_10_0._act131TaskMO and arg_10_0._act131TaskMO.activityId == arg_10_1 and arg_10_0._act131TaskMO:alreadyGotReward() then
...
function var_0_0.onUpdateMO(arg_12_0, arg_12_1)
	...
	arg_12_0._act131TaskMO = arg_12_1

	local var_12_0 = Activity131TaskListModel.instance:getRankDiff(arg_12_1)
...
function var_0_0._moveByRankDiff(arg_13_0, arg_13_1)
	if arg_13_1 and arg_13_1 ~= 0 then
		...
		arg_13_0._rankDiffMoveId = ZProj.TweenHelper.DOAnchorPosY(arg_13_0.viewTrs, 0, Activity131Enum.AnimatorTime.TaskRewardMoveUp)
	end
end
...
function var_0_0._refreshUI(arg_15_0)
	local var_15_0 = arg_15_0._act131TaskMO

	if not var_15_0 then
		return
	end

	local var_15_1 = var_15_0.id ~= Activity131Enum.TaskMOAllFinishId
...
var_0_0.prefabPath = "ui/viewres/versionactivity_1_4/v1a4_6role/v1a4_role6_taskitem.prefab"
