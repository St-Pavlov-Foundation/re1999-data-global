...
slot0 = pureTable("Activity131ElementMo")
...
function slot0.init(slot0, slot1)
	...
	slot0.config = Activity131Config.instance:getActivity131ElementCo(VersionActivity1_4Enum.ActivityId.Role6, slot0.elementId)

	if not slot0.config then
		logError(string.format("Activity131ElementMo no config id:%s", slot0.elementId))
