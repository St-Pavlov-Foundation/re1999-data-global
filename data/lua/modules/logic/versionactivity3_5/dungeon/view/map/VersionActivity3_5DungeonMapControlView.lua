...
function VersionActivity3_5DungeonMapControlView:_updateTimeline(isOpenMapLevelView)
	...
	VersionActivity3_5DungeonEnum.DungeonMapCameraSize = showMapEpisodeList and zoomInCameraSize or normalCameraSize
...
function VersionActivity3_5DungeonMapControlView:_tweenCameraSize()
	...
	if ViewMgr.instance:isOpen(ViewName.VersionActivity3_5DungeonMapLevelView) then
		time = fastTweenTime
	end
