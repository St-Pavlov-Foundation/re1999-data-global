-- chunkname: @modules/logic/versionactivity3_5/dungeon/view/map/scene/VersionActivity3_5DungeonMapHoleView.lua

module("modules.logic.versionactivity3_5.dungeon.view.map.scene.VersionActivity3_5DungeonMapHoleView", package.seeall)

local VersionActivity3_5DungeonMapHoleView = class("VersionActivity3_5DungeonMapHoleView", VersionActivityFixedDungeonMapHoleView)

function VersionActivity3_5DungeonMapHoleView:refreshHoles()
...
return VersionActivity3_5DungeonMapHoleView
