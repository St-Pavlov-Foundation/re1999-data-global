...
function VersionActivity3_5DungeonMapSceneElements:showElements()
	...
	local elementCoList = self._showMap and VersionActivity3_5DungeonMapSceneElements.getAllElementCoList() or VersionActivityFixedDungeonModel.instance:getElementCoList(self._mapCfg.id)
