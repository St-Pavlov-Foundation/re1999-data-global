...
local var_0_0 = class("VersionActivity2_4EnterViewTabItem2", VersionActivity2_4EnterViewTabItemBase)
...
function var_0_0.childRefreshSelect(arg_3_0, arg_3_1)
	...
	local var_3_0 = VersionActivity2_4Enum.TabSetting.unselect

	if arg_3_0.isSelect then
		var_3_0 = VersionActivity2_4Enum.TabSetting.select
	end
