...
slot0 = class("VersionActivity2_4EnterViewTabItem2", VersionActivity2_4EnterViewTabItemBase)
...
function slot0.childRefreshSelect(slot0, slot1)
	...
	slot2 = VersionActivity2_4Enum.TabSetting.unselect

	if slot0.isSelect then
		slot2 = VersionActivity2_4Enum.TabSetting.select
	end
