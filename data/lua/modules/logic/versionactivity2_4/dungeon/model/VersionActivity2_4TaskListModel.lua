...
local var_0_0 = class("VersionActivity2_4TaskListModel", ListScrollModel)
...
function var_0_0.initTask(arg_3_0)
	arg_3_0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_4Enum.ActivityId.Dungeon)
end
...
function var_0_0.getFinishedTaskIdxList(arg_8_0)
	local var_8_0 = {}
...
function var_0_0.getFinishTaskActivityCount(arg_9_0)
	local var_9_0 = 0

	for iter_9_0, iter_9_1 in ipairs(arg_9_0.taskMoList) do
		if iter_9_1.hasFinished and iter_9_1.finishCount < iter_9_1.config.maxFinishCount then
			var_9_0 = var_9_0 + iter_9_1.config.activity
		end
	end
...
function var_0_0.getGetRewardTaskCount(arg_10_0)
	local var_10_0 = 0

	if not arg_10_0.taskMoList then
		return 0
	end

	for iter_10_0, iter_10_1 in ipairs(arg_10_0.taskMoList) do
		if iter_10_1.finishCount >= iter_10_1.config.maxFinishCount then
			var_10_0 = var_10_0 + 1
		end
	end
