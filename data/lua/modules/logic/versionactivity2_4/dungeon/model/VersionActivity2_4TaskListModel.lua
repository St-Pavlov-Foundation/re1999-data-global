...
slot0 = class("VersionActivity2_4TaskListModel", ListScrollModel)
...
function slot0.initTask(slot0)
	slot0.taskMoList = TaskModel.instance:getTaskMoList(TaskEnum.TaskType.ActivityDungeon, VersionActivity2_4Enum.ActivityId.Dungeon)
end
...
function slot0.getFinishedTaskIdxList(slot0)
	slot1 = {}
