...
slot0 = class("VersionActivity2_4DungeonMapEpisodeView", BaseView)
slot1 = 0.5
slot2 = -240
slot3 = 0.41
slot4 = 1.7
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, slot0.hideUI, slot0)
	slot0:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnHideInteractUI, slot0.showUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, slot0.hideUI, slot0)
	slot0:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnHideInteractUI, slot0.showUI, slot0)
...
function slot0.refreshModeLockText(slot0)
	if ServerTime.now() < VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity2_4DungeonEnum.DungeonChapterId.Hard) then
		slot3 = slot1 - slot2
		...
		if Mathf.Floor(slot3 / TimeUtil.OneDaySecond) > 0 then
			if slot6 > 0 then
				slot8 = GameUtil.getSubPlaceholderLuaLang(luaLang("hournum"), {
					ActivityModel.instance:getActivityInfo()[VersionActivity2_4Enum.ActivityId.Dungeon]:getRemainTimeStr2(slot3),
					slot6
				})
			end
...
function slot0.checkHardModeIsOpen(slot0)
	return VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapterAndGetToast(VersionActivity2_4Enum.ActivityId.Dungeon)
end
...
function slot0.playUnlockAnimation(slot0, slot1)
	...
	if slot0:IsNeedPlayHardModeUnlockAnimation() then
		VersionActivity2_4DungeonController.instance:savePlayerPrefs(VersionActivity2_4DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim, uv0)
...
function slot0.IsNeedPlayHardModeUnlockAnimation(slot0)
	...
	if VersionActivity2_4DungeonController.instance:getPlayerPrefs(VersionActivity2_4DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim, uv0) ~= uv1 and VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(VersionActivity2_4Enum.ActivityId.Dungeon) then
		slot1 = true
	end
...
function slot0._unlockAniDone(slot0)
	if not VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(VersionActivity2_4Enum.ActivityId.Dungeon) then
		return
	end
