...
slot0 = class("VersionActivity2_4DungeonMapElement", LuaCompBase)
slot1 = 1.6
...
function slot0.onClick(slot0)
	VersionActivity2_4DungeonController.instance:dispatchEvent(VersionActivity2_4DungeonEvent.OnClickElement, slot0)
end
