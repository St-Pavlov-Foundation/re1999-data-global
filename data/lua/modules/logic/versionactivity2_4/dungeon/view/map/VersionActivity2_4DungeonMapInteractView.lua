...
slot0 = class("VersionActivity2_4DungeonMapInteractView", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, slot0.showInteractUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, slot0.showInteractUI, slot0)
...
function slot0._onClickFightBtn(slot0)
	...
	VersionActivity2_4DungeonModel.instance:setLastEpisodeId(slot0.activityDungeonMo.episodeId)
