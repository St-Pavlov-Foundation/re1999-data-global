...
local var_0_0 = class("VersionActivity2_4DungeonMapViewContainer", BaseViewContainer)

function var_0_0.buildViews(arg_1_0)
	arg_1_0.mapScene = VersionActivity2_4DungeonMapScene.New()
	arg_1_0.mapSceneElements = VersionActivity2_4DungeonMapSceneElements.New()
	arg_1_0.mapView = VersionActivity2_4DungeonMapView.New()
	arg_1_0.mapEpisodeView = VersionActivity2_4DungeonMapEpisodeView.New()
	arg_1_0.interactView = VersionActivity2_4DungeonMapInteractView.New()
...
function var_0_0.onContainerInit(arg_5_0)
	arg_5_0.versionActivityDungeonBaseMo = VersionActivity2_4DungeonMo.New()

	arg_5_0.versionActivityDungeonBaseMo:init(VersionActivity2_4Enum.ActivityId.Dungeon, arg_5_0.viewParam.chapterId, arg_5_0.viewParam.episodeId)
	arg_5_0.versionActivityDungeonBaseMo:setLayoutClass(VersionActivity2_4DungeonMapChapterLayout)
	arg_5_0.versionActivityDungeonBaseMo:setMapEpisodeItemClass(VersionActivity2_4DungeonMapEpisodeItem)

	for iter_5_0, iter_5_1 in ipairs(arg_5_0._views) do
		iter_5_1.activityDungeonMo = arg_5_0.versionActivityDungeonBaseMo
	end

	VersionActivity2_4DungeonModel.instance:setDungeonBaseMo(arg_5_0.versionActivityDungeonBaseMo)
