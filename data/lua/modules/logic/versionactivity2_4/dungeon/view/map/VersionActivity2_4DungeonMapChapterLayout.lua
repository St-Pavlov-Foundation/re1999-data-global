...
function VersionActivity2_4DungeonMapChapterLayout:addEvents()
	...
	self:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.GuideShowElement, self._GuideShowElement, self)
...
function VersionActivity2_4DungeonMapChapterLayout:removeEvents()
	...
	self:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.GuideShowElement, self._GuideShowElement, self)
end
