...
local var_0_0 = class("VersionActivity2_4DungeonMapEpisodeItem", BaseChildView)
...
function var_0_0.onClick(arg_4_0)
	...
	local var_4_0 = ViewMgr.instance:getContainer(ViewName.VersionActivity2_4DungeonMapLevelView)
...
function var_0_0._showEye(arg_6_0)
	...
	local var_6_1 = arg_6_0._config.chapterId == VersionActivity2_4DungeonEnum.DungeonChapterId.Hard
...
function var_0_0.getMapAllElementList(arg_10_0)
	return (VersionActivity2_4DungeonModel.instance:getElementCoList(arg_10_0._map.id))
end

function var_0_0._showAllElementTipView(arg_11_0)
	if not arg_11_0._map or arg_11_0._config.chapterId == VersionActivity2_4DungeonEnum.DungeonChapterId.Hard then
	...
	local var_11_0, var_11_1 = VersionActivity2_4DungeonModel.instance:getElementCoListWithFinish(arg_11_0._map.id)
...
function var_0_0.refresh(arg_13_0, arg_13_1, arg_13_2)
	...
	arg_13_0._map = VersionActivity2_4DungeonConfig.instance:getEpisodeMapConfig(arg_13_0._config.id)
...
function var_0_0.calculatePosInContent(arg_28_0)
	...
	arg_28_0._maxWidth = math.max(var_28_4 * 2, VersionActivity2_4DungeonEnum.EpisodeItemMinWidth) + 30
...
function var_0_0.setImage(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	local var_29_1 = VersionActivity2_4DungeonEnum.EpisodeStarType[var_29_0.chapterId]
	local var_29_2 = arg_29_2 and var_29_1.light or var_29_1.empty

	UISpriteSetMgr.instance:setV2a4DungeonSprite(arg_29_1, var_29_2)
end
