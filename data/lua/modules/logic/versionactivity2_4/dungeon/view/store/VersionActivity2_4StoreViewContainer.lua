-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/store/VersionActivity2_4StoreViewContainer.lua

module("modules.logic.versionactivity2_4.dungeon.view.store.VersionActivity2_4StoreViewContainer", package.seeall)

local VersionActivity2_4StoreViewContainer = class("VersionActivity2_4StoreViewContainer", BaseViewContainer)

function VersionActivity2_4StoreViewContainer:buildViews()
	return {
...
function VersionActivity2_4StoreViewContainer:buildTabViews(tabContainerId)
...
function VersionActivity2_4StoreViewContainer:_onCurrencyOpen()
...
function VersionActivity2_4StoreViewContainer:playOpenTransition()
...
function VersionActivity2_4StoreViewContainer:playCloseTransition()
...
return VersionActivity2_4StoreViewContainer
