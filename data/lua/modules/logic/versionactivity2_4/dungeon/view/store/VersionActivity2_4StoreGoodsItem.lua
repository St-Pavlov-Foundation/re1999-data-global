-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/store/VersionActivity2_4StoreGoodsItem.lua

module("modules.logic.versionactivity2_4.dungeon.view.store.VersionActivity2_4StoreGoodsItem", package.seeall)

local VersionActivity2_4StoreGoodsItem = class("VersionActivity2_4StoreGoodsItem", UserDataDispose)

function VersionActivity2_4StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function VersionActivity2_4StoreGoodsItem:onClick()
...
function VersionActivity2_4StoreGoodsItem:updateInfo(storeGoodsCo)
	self.storeGoodsCo = storeGoodsCo

	self:refreshRemainBuyCount()

	local productItemType, productItemId, productItemQuantity = VersionActivity2_4EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setV2a1MainActivitySprite(self.imageRare, "v2a1_store_quality_" .. rare)
	...
	self.costItemType, self.costItemId, self.costItemQuantity = VersionActivity2_4EnterHelper.getItemTypeIdQuantity(self.storeGoodsCo.cost)
...
function VersionActivity2_4StoreGoodsItem:refreshRemainBuyCount()
...
function VersionActivity2_4StoreGoodsItem:setImageIconNative()
	self.imageIcon:SetNativeSize()
end

function VersionActivity2_4StoreGoodsItem:refreshTag()
...
function VersionActivity2_4StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function VersionActivity2_4StoreGoodsItem:onDestroy()
...
return VersionActivity2_4StoreGoodsItem
