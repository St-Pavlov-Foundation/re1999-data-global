...
slot0 = class("VersionActivity2_4DungeonController", BaseController)
...
function slot0.openStoreView(slot0)
	if not VersionActivityEnterHelper.checkCanOpen(VersionActivity2_4Enum.ActivityId.DungeonStore) then
		return
	end
...
function slot0._internalOpenVersionActivityDungeonMapView(slot0)
	...
	if not slot0.dungeonMapViewParam.episodeId then
		slot1 = VersionActivity2_4DungeonModel.instance:getUnFinishElementEpisodeId()
		slot3 = nil

		if VersionActivity2_4DungeonModel.instance:getUnFinishStoryElements() and #slot2 > 0 then
			slot3 = DungeonConfig.instance:getEpisodeByElement(slot2[1])
		end
	...
	ViewMgr.instance:openView(ViewName.VersionActivity2_4DungeonMapView, slot0.dungeonMapViewParam)
end
...
function slot1(slot0)
	...
	return string.format("2_0Dungeon_%s_%s", VersionActivity2_4Enum.ActivityId.Dungeon, slot0)
end
