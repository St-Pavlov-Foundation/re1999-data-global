...
local var_0_0 = class("VersionActivity2_4DungeonController", BaseController)
...
function var_0_0.openStoreView(arg_5_0)
	local var_5_0 = VersionActivity2_4Enum.ActivityId.DungeonStore
...
function var_0_0._internalOpenVersionActivityDungeonMapView(arg_9_0)
	...
	ViewMgr.instance:openView(ViewName.VersionActivity2_4DungeonMapView, arg_9_0.dungeonMapViewParam)
end
...
local function var_0_1(arg_11_0)
	...
	return (string.format("2_0Dungeon_%s_%s", VersionActivity2_4Enum.ActivityId.Dungeon, arg_11_0))
end
