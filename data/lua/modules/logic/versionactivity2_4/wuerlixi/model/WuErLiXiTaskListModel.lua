...
local var_0_0 = class("WuErLiXiTaskListModel", ListScrollModel)
...
function var_0_0.init(arg_1_0, arg_1_1)
	...
	if var_1_0 ~= nil then
		local var_1_3 = WuErLiXiConfig.instance:getTaskByActId(arg_1_1)

		for iter_1_0, iter_1_1 in ipairs(var_1_3) do
			local var_1_4 = WuErLiXiTaskMo.New()
	...
	if var_1_2 > 1 then
		local var_1_5 = WuErLiXiTaskMo.New()
