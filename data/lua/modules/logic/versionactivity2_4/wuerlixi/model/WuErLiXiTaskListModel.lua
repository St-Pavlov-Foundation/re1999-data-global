...
slot0 = class("WuErLiXiTaskListModel", ListScrollModel)

function slot0.init(slot0, slot1)
	slot3 = {}
	slot4 = 0

	if TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.Activity180) ~= nil then
		for slot9, slot10 in ipairs(WuErLiXiConfig.instance:getTaskByActId(slot1)) do
			slot11 = WuErLiXiTaskMo.New()
