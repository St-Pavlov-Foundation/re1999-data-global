module("modules.logic.versionactivity2_4.newinsight.view.ActivityInsightShowTaskItem_2_4", package.seeall)

slot0 = class("ActivityInsightShowTaskItem_2_4", LuaCompBase)
...
function slot0._refreshBtns(slot0)
	...
	if slot0._taskMO.finishCount >= 1 then
		if not ActivityType172Model.instance:isTaskHasUsed(ActivityEnum.Activity.V2a4_NewInsight, slot0._taskId) and slot0._config.itemId ~= 0 then
