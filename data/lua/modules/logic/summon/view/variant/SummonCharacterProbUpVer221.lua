...
local var_0_0 = class("SummonCharacterProbUpVer221", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagedec1 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/node1/#simage_dec1")
	...
	arg_1_0._simagedec2 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/node1/#simage_dec2")
