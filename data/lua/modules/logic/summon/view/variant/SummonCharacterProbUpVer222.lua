module("modules.logic.summon.view.variant.SummonCharacterProbUpVer222", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer222", SummonMainCharacterProbUp)
