module("modules.logic.summon.view.variant.SummonCharacterProbUpVer201", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer201", SummonMainCharacterProbUp)
