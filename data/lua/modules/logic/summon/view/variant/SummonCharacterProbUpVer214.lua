module("modules.logic.summon.view.variant.SummonCharacterProbUpVer214", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer214", SummonMainCharacterProbUp)
