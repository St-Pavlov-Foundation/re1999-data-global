...
slot0 = class("SummonCharacterProbUpVer154", SummonMainCharacterProbUp)
slot0.preloadList = {
...
function slot0._editableInitView(slot0)
	...
	slot0._simagefont = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/#simage_font")
