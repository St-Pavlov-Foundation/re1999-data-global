module("modules.logic.summon.view.variant.SummonCharacterProbUpVer175", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer175", SummonMainCharacterProbUp)
