...
slot0 = class("SummonCharacterProbUpVer189", SummonMainCharacterProbUp)
slot0.preloadList = {
...
function slot0._editableInitView(slot0)
	...
	slot0._simagefulldec = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/#simage_fulldec")
...
function slot0.unloadSingleImage(slot0)
	...
	slot0._simagefulldec:UnLoadImage()
	slot0._simageline:UnLoadImage()
	slot0._simagecurrency1:UnLoadImage()
	slot0._simagecurrency10:UnLoadImage()
end

function slot0._parseCost(slot0)
...
function slot0._checkIsEnough(slot0, slot1, slot2)
	return slot2 <= ItemModel.instance:getItemQuantity(slot0, slot1)
end
...
function slot0._refreshView(slot0, ...)
	...
	slot0._currentCostInfo = uv0._getCostInfo(slot1.id)

	uv0.super._refreshView(slot0, ...)
end

function slot0._getCostInfo(slot0)
	if not slot0 then
		return {
			cost_num = 0,
			cost_num_before = 0,
	...
	slot3, slot4, slot5 = uv0._parseCost(slot2.cost10)
