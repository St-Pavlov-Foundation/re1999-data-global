-- chunkname: @modules/logic/summon/view/variant/SummonCharacterProbUpVer189.lua

module("modules.logic.summon.view.variant.SummonCharacterProbUpVer189", package.seeall)

local SummonCharacterProbUpVer189 = class("SummonCharacterProbUpVer189", SummonMainCharacterProbUp)

SummonCharacterProbUpVer189.preloadList = {
	"singlebg/summon/heroversion_1_8/v1a8_lake/v1a8_lake_fullbg.png",
	"singlebg/summon/heroversion_1_8/v1a8_lake/v1a8_lake_ad1.png",
	"singlebg/summon/heroversion_1_8/v1a8_lake/v1a8_lake_ad2.png",
	"singlebg/summon/heroversion_1_8/v1a8_lake/v1a8_lake_fulldec.png"
}

function SummonCharacterProbUpVer189:_editableInitView()
	...
	self._simagefulldec = gohelper.findChildSingleImage(self.viewGO, "#go_ui/current/#simage_fulldec")
	...
	SummonCharacterProbUpVer189.super._editableInitView(self)
end

function SummonCharacterProbUpVer189:refreshSingleImage()
	self._simageline:LoadImage(ResUrl.getSummonHeroIcon("title_img_deco"))
end

function SummonCharacterProbUpVer189:unloadSingleImage()
	self._simagebg:UnLoadImage()
	self._simagead1:UnLoadImage()
	self._simagead2:UnLoadImage()
	self._simagefulldec:UnLoadImage()
	self._simageline:UnLoadImage()
	self._simagecurrency1:UnLoadImage()
	self._simagecurrency10:UnLoadImage()
end

function SummonCharacterProbUpVer189._parseCost(cost)
...
function SummonCharacterProbUpVer189._checkIsEnough(itemType, itemId, need)
	local has = ItemModel.instance:getItemQuantity(itemType, itemId)

	return need <= has
end

function SummonCharacterProbUpVer189:_refreshView(...)
	...
	self._currentCostInfo = SummonCharacterProbUpVer189._getCostInfo(poolId)

	SummonCharacterProbUpVer189.super._refreshView(self, ...)
end

function SummonCharacterProbUpVer189._getCostInfo(poolId)
	local res = {
		cost_num = 0,
		cost_num_before = 0,
		discountPercent01 = 0,
	...
	local cost_type, cost_id, cost_num = SummonCharacterProbUpVer189._parseCost(co.cost10)
...
function SummonCharacterProbUpVer189:_btnsummon10OnClick()
...
function SummonCharacterProbUpVer189:_refreshCost()
	local curPool = SummonMainModel.instance:getCurPool()
...
function SummonCharacterProbUpVer189:_refreshCost10()
	local curPool = SummonMainModel.instance:getCurPool()
...
return SummonCharacterProbUpVer189
