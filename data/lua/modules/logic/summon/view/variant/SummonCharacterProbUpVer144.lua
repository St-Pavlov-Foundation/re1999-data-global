module("modules.logic.summon.view.variant.SummonCharacterProbUpVer144", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer144", SummonMainCharacterProbUp)
