...
local var_0_0 = class("SummonCharacterProbUpVer141", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagerole4 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/#simage_role4")
	arg_1_0._simagebottom = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/#simage_bottom")
	arg_1_0._charaterItemCount = 4
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._simagerole4:UnLoadImage()
