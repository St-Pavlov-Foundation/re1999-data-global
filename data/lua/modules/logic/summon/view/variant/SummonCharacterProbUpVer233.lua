module("modules.logic.summon.view.variant.SummonCharacterProbUpVer233", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer233", SummonMainCharacterProbUp)
