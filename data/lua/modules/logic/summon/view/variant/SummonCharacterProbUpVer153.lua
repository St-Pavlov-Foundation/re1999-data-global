module("modules.logic.summon.view.variant.SummonCharacterProbUpVer153", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer153", SummonMainCharacterProbUp)
