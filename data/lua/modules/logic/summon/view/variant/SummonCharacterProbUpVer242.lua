module("modules.logic.summon.view.variant.SummonCharacterProbUpVer242", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer242", SummonMainCharacterProbUp)
