...
local var_0_0 = class("SummonCharacterProbUpVer113", SummonMainCharacterProbUp)
...
function var_0_0.refreshSingleImage(arg_2_0)
	arg_2_0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/full/bg_hnj"))
	arg_2_0._simagead1:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/hongnujian/img_role_hongnujian"))
	arg_2_0._simagead2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/hongnujian/img_role_5seyue"))
	arg_2_0._simagead3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/hongnujian/img_role_tannante"))
