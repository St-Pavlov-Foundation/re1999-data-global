module("modules.logic.summon.view.variant.SummonCharacterProbUpVer173", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer173", SummonMainCharacterProbUp)
