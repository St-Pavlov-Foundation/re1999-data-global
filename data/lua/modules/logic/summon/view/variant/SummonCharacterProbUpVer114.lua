...
slot0 = class("SummonCharacterProbUpVer114", SummonMainCharacterProbUp)
...
function slot0.refreshSingleImage(slot0)
	slot0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/full/bg_bfz"))
	slot0._simagead1:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/baifuzhang/img_role_baifuzhang"))
	slot0._simagead2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/baifuzhang/img_role_x"))
	slot0._simagead3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/baifuzhang/img_role_xiali"))
