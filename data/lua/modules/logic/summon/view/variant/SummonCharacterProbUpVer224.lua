module("modules.logic.summon.view.variant.SummonCharacterProbUpVer224", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer224", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagebottom2 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/#simage_bottom2")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._simagebottom2:UnLoadImage()
