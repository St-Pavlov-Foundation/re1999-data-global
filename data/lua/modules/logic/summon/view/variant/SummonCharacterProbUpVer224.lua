...
slot0 = class("SummonCharacterProbUpVer224", SummonMainCharacterProbUp)
slot0.preloadList = {
...
function slot0._editableInitView(slot0)
	...
	slot0._simagebottom2 = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/#simage_bottom2")
...
function slot0.unloadSingleImage(slot0)
	...
	slot0._simagebottom2:UnLoadImage()
