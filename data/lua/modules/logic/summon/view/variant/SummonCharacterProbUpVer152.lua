module("modules.logic.summon.view.variant.SummonCharacterProbUpVer152", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer152", SummonMainCharacterProbUp)
