module("modules.logic.summon.view.variant.SummonCharacterProbUpVer223", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer223", SummonMainCharacterProbUp)
