module("modules.logic.summon.view.variant.SummonCharacterProbUpVer215", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer215", SummonMainCharacterProbUp)
