module("modules.logic.summon.view.variant.SummonCharacterProbUpVer243", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer243", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagefrontbg2 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/#simage_frontbg1/#simage_frontbg2")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._simagefrontbg2:UnLoadImage()
