module("modules.logic.summon.view.variant.SummonCharacterProbUpVer155", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer155", SummonMainCharacterProbUp)
