...
local var_0_0 = class("SummonCharacterProbUpVer115", SummonMainCharacterProbUp)
...
function var_0_0.refreshSingleImage(arg_2_0)
	arg_2_0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/full/bg_xt"))
	arg_2_0._simagead1:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/xingti/img_role_xingti"))
	arg_2_0._simagead2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/xingti/img_role_pamiai"))
	arg_2_0._simagead3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/xingti/img_role_qiqiupaidui"))
	arg_2_0._simagefrontbg:LoadImage(ResUrl.getSummonHeroIcon("bg_1"))
