module("modules.logic.summon.view.variant.SummonCharacterProbUpVer205", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer205", SummonMainCharacterProbUp)
