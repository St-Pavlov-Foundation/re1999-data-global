module("modules.logic.summon.view.variant.SummonCharacterProbUpVer182", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer182", SummonMainCharacterProbUp)
