-- chunkname: @modules/logic/summon/view/variant/SummonCharacterProbUpVer246.lua

module("modules.logic.summon.view.variant.SummonCharacterProbUpVer246", package.seeall)

local SummonCharacterProbUpVer246 = class("SummonCharacterProbUpVer246", SummonMainCharacterProbUp)

SummonCharacterProbUpVer246.preloadList = {
...
function SummonCharacterProbUpVer246:_editableInitView()
	...
	SummonCharacterProbUpVer246.super._editableInitView(self)
end

function SummonCharacterProbUpVer246:refreshSingleImage()
	self._simageline:LoadImage(ResUrl.getSummonHeroIcon("title_img_deco"))
end

function SummonCharacterProbUpVer246:unloadSingleImage()
...
return SummonCharacterProbUpVer246
