...
local var_0_0 = class("SummonCharacterProbUpVer121", SummonMainCharacterProbUp)
...
function var_0_0.refreshSingleImage(arg_2_0)
	arg_2_0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_2/wenni/full/img_bg"))
	arg_2_0._simagead1:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_2/wenni/img_chara_wn"))
	arg_2_0._simagead2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_2/wenni/img_wx_kckc"))
	arg_2_0._simagead3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_2/wenni/img_wx_yel"))
	arg_2_0._simagefrontbg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_2/wenni/mask"))
