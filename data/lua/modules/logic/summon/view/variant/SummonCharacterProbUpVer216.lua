...
local var_0_0 = class("SummonCharacterProbUpVer216", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._magedec6 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/Dec/image_dec6")
	arg_1_0._magedec10 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/Dec/image_dec10")
	arg_1_0._magedec20 = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/Dec/image_dec20")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._magedec6:UnLoadImage()
	arg_3_0._magedec10:UnLoadImage()
	arg_3_0._magedec20:UnLoadImage()
