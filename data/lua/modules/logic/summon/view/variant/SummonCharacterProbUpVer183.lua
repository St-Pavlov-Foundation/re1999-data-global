module("modules.logic.summon.view.variant.SummonCharacterProbUpVer183", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer183", SummonMainCharacterProbUp)
