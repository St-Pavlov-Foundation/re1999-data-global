...
local var_0_0 = class("SummonCharacterProbUpVer251", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagefontbg = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/node1/#simage_fontbg")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._simagefontbg:UnLoadImage()
