module("modules.logic.summon.view.variant.SummonCharacterProbUpVer143", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer143", SummonMainCharacterProbUp)
