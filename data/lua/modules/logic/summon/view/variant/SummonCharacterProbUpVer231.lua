module("modules.logic.summon.view.variant.SummonCharacterProbUpVer231", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer231", SummonMainCharacterProbUp)
