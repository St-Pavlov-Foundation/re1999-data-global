module("modules.logic.summon.view.variant.SummonCharacterProbUpVer184", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer184", SummonMainCharacterProbUp)
