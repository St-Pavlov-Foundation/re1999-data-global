module("modules.logic.summon.view.variant.SummonCharacterProbUpVer203", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer203", SummonMainCharacterProbUp)
