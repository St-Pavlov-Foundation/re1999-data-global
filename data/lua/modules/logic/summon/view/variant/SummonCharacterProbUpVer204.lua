module("modules.logic.summon.view.variant.SummonCharacterProbUpVer204", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer204", SummonMainCharacterProbUp)
