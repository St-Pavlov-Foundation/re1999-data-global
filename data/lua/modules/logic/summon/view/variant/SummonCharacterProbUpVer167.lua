...
slot0 = class("SummonCharacterProbUpVer167", SummonMainCharacterProbUp)
slot0.preloadList = {
...
function slot0._editableInitView(slot0)
	...
	slot0._simagerole2 = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/node2/pos/#simage_role2")
	slot0._simagerole1 = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/node2/pos/#simage_role1")
	...
	slot0._rrow = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/tip/tip/arrow")
