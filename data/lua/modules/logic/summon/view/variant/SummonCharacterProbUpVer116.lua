...
local var_0_0 = class("SummonCharacterProbUpVer116", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	for iter_1_0 = 2, var_0_0.SIMAGE_COUNT do
...
function var_0_0.refreshSingleImage(arg_2_0)
	arg_2_0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/full/bg_fjs"))
	arg_2_0._simagead2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/fujishen/img_x"))
	arg_2_0._simagead3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/fujishen/img_kaca"))
	arg_2_0._simagefrontbg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_1/fujishen/img_zhuangshi"))
	arg_2_0._simageline:LoadImage(ResUrl.getSummonHeroIcon("title_img_deco"))
end

function var_0_0.unloadSingleImage(arg_3_0)
	for iter_3_0 = 2, var_0_0.SIMAGE_COUNT do
