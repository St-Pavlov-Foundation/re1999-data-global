module("modules.logic.summon.view.variant.SummonCharacterProbUpVer174", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer174", SummonMainCharacterProbUp)
