module("modules.logic.summon.view.variant.SummonCharacterProbUpVer202", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer202", SummonMainCharacterProbUp)
