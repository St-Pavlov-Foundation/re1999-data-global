module("modules.logic.summon.view.variant.SummonCharacterProbUpVer185", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer185", SummonMainCharacterProbUp)
