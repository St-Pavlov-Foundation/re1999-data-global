module("modules.logic.summon.view.variant.SummonCharacterProbUpVer212", package.seeall)

local var_0_0 = class("SummonCharacterProbUpVer212", SummonMainCharacterProbUp)
