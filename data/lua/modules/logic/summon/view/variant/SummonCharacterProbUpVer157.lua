...
local var_0_0 = class("SummonCharacterProbUpVer157", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._imagemiddledec = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/simage_middledec")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._imagemiddledec:UnLoadImage()
