...
local var_0_0 = class("SummonCharacterProbUpVer142", SummonMainCharacterProbUp)
...
function var_0_0.refreshSingleImage(arg_2_0)
	arg_2_0._simagebg:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_4/role37/full/v1a4_role37_summon_bg"))
	arg_2_0._simagerole1:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_4/role37/v1a4_role37_summon_37"))
	arg_2_0._simagerole2:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_4/role37/v1a4_role37_summon_role2"))
	arg_2_0._simagerole3:LoadImage(ResUrl.getSummonCoverBg("heroversion_1_4/role37/v1a4_role37_summon_role1"))
