...
local var_0_0 = class("SummonCharacterProbUpVer164", SummonMainCharacterProbUp)
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0._simagecaidai = gohelper.findChildSingleImage(arg_1_0.viewGO, "#go_ui/current/#simage_caidai")
...
function var_0_0.unloadSingleImage(arg_3_0)
	...
	arg_3_0._simagecaidai:UnLoadImage()
