module("modules.logic.summon.view.variant.SummonCharacterProbUpVer193", package.seeall)

slot0 = class("SummonCharacterProbUpVer193", SummonMainCharacterProbUp)
slot0.preloadList = {
...
function slot0._editableInitView(slot0)
	...
	slot0._simagelight = gohelper.findChildSingleImage(slot0.viewGO, "#go_ui/current/node1/#simage_light")
