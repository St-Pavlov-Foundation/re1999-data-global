...
local var_0_0 = class("SummonCustomPickChoiceItem", LuaCompBase)
...
function var_0_0.onClickSelf(arg_5_0)
	...
	SummonCustomPickChoiceController.instance:setSelect(arg_5_0._mo.id)
end
...
function var_0_0.refreshUI(arg_7_0)
	...
	if not var_7_0 then
		logError("SummonCustomPickChoiceItem.onUpdateMO error, heroConfig is nil, id:" .. tostring(arg_7_0._mo.id))
...
function var_0_0.refreshBaseInfo(arg_8_0, arg_8_1)
	...
	if not var_8_0 then
		logError("SummonCustomPickChoiceItem.onUpdateMO error, skinCfg is nil, id:" .. tostring(arg_8_1.skinId))
...
function var_0_0.refreshSelect(arg_10_0)
	local var_10_0 = SummonCustomPickChoiceListModel.instance:isHeroIdSelected(arg_10_0._mo.id)
