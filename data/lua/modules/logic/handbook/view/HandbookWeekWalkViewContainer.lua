...
slot0 = class("HandbookWeekWalkViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}

	table.insert(slot1, HandbookWeekWalkView.New())
	table.insert(slot1, HandbookWeekWalkSceneView.New())
