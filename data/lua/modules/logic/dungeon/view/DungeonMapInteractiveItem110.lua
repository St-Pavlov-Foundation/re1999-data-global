...
local DungeonMapInteractiveItem110 = class("DungeonMapInteractiveItem110", AergusiDialogRoleItemBase)

function DungeonMapInteractiveItem110:ctor(...)
	DungeonMapInteractiveItem110.super.ctor(self, ...)
end

function DungeonMapInteractiveItem110:onDestroyView()
	self:onDestroy()
end
...
function DungeonMapInteractiveItem110:_showDialog(type, text, speaker, audio)
	...
	local txtContentMarkTopIndex = self:createMarktopCmp(infoText)

	self:setTopOffset(txtContentMarkTopIndex, 0, -3)
	self:setLineSpacing(txtContentMarkTopIndex, 32)
	self:setTextWithMarktopByIndex(txtContentMarkTopIndex, text)
...
function DungeonMapInteractiveItem110:_onDissolveStart()
	local txtContentMarkTopIndex = self._dissolveInfo[4]
...
function DungeonMapInteractiveItem110:onDestroy()
	...
	DungeonMapInteractiveItem110.destroy(self)
end
