...
local var_0_0 = class("RoleStoryActivityItem", ListScrollCellExtend)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0.simagePhoto = gohelper.findChildSingleImage(arg_1_0.root, "mask/#simage_Photo")
...
function var_0_0.refreshName(arg_7_0)
	local var_7_0 = arg_7_0._mo.cfg.heroName

	arg_7_0.txtName.text = GameUtil.setFirstStrSize(var_7_0, 70)
end
...
function var_0_0.refreshUnlock(arg_12_0, arg_12_1)
	...
	if not arg_12_1 then
		local var_12_0 = arg_12_0._mo.costItemType
		local var_12_1 = arg_12_0._mo.costItemId
		local var_12_2 = CurrencyConfig.instance:getCurrencyCo(var_12_1)
		local var_12_3 = string.format("%s_1", var_12_2 and var_12_2.icon)

		UISpriteSetMgr.instance:setCurrencyItemSprite(arg_12_0.imgPropItem, var_12_3)

		local var_12_4 = ItemModel.instance:getItemQuantity(var_12_0, var_12_1)
		local var_12_5 = arg_12_0._mo.costItemCount

		if var_12_4 < var_12_5 then
			arg_12_0.txtPropNum.text = string.format(string.format("<color=#d97373>%s</color>/%s", var_12_4, var_12_5))
		else
			arg_12_0.txtPropNum.text = string.format(string.format("%s/%s", var_12_4, var_12_5))
		end
	end
	...
	elseif not arg_12_0._isOpen then
...
function var_0_0.onClickItem(arg_14_0)
	...
	if arg_14_0._mo.hasUnlock then
		...
		local var_14_0 = arg_14_0._mo.costItemCount
		local var_14_1 = arg_14_0._mo.cfg.heroName
		local var_14_2 = ItemModel.instance:getItemConfig(arg_14_0._mo.costItemType, arg_14_0._mo.costItemId)
		local var_14_3 = var_14_2 and var_14_2.name

		GameFacade.showMessageBox(MessageBoxIdDefine.RoleStoryUnlockTips, MsgBoxEnum.BoxType.Yes_No, arg_14_0._unlockCallback, nil, nil, arg_14_0, nil, nil, var_14_0, var_14_3, var_14_1)
	end
end
...
function var_0_0._unlockCallback(arg_15_0)
	...
	table.insert(var_15_0, {
		type = arg_15_0._mo.costItemType,
		id = arg_15_0._mo.costItemId,
		quantity = arg_15_0._mo.costItemCount
	})

	local var_15_1, var_15_2, var_15_3 = ItemModel.instance:hasEnoughItems(var_15_0)

	if not var_15_2 then
		GameFacade.showToastWithIcon(ToastEnum.NotEnoughId, var_15_3, var_15_1)
