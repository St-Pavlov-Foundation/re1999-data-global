...
local var_0_0 = class("PlayerCardAchievementNamePlateSelectItem", ListScrollCellExtend)
...
function var_0_0._onClickBtn(arg_4_0)
	if arg_4_0._id then
		PlayerCardAchievementSelectController.instance:changeNamePlateSelect(arg_4_0._id)

		local var_4_0 = PlayerCardAchievementSelectListModel.instance:isSingleSelected(arg_4_0._id)
...
function var_0_0.refreshUI(arg_9_0)
	if not PlayerCardAchievementSelectListModel.instance:checkIsNamePlate() then
		return
	end

	local var_9_0 = PlayerCardAchievementSelectListModel.instance:isSingleSelected(arg_9_0._id)
