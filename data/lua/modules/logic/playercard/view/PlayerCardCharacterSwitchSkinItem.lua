...
slot0 = class("PlayerCardCharacterSwitchSkinItem", LuaCompBase)
...
function slot0.addEventListeners(slot0)
	...
	PlayerCardController.instance:registerCallback(PlayerCardEvent.SwitchHeroSkin, slot0._switchHeroSkin, slot0)
end

function slot0.removeEventListeners(slot0)
	PlayerCardController.instance:unregisterCallback(PlayerCardEvent.SwitchHeroSkin, slot0._switchHeroSkin, slot0)
...
function slot0._onClick(slot0)
	...
	PlayerCardController.instance:dispatchEvent(PlayerCardEvent.SwitchHeroSkin, slot0._heroId, slot0._skinId)
end
