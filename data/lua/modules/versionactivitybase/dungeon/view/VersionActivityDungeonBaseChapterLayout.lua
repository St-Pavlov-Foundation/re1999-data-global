...
function var_0_0.refreshEpisodeNodes(arg_8_0)
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_0) do
		...
		if var_8_4 then
			...
			var_8_3 = arg_8_0:getEpisodeContainerItem(var_8_1)
			arg_8_0._episodeItemDict[iter_8_1.id] = var_8_3.episodeItem
			var_8_3.containerTr.name = iter_8_1.id

			var_8_3.episodeItem:refresh(iter_8_1, var_8_4)

			if var_8_5 then
				local var_8_6 = recthelper.getAnchorX(var_8_5.containerTr) or 0
				local var_8_7 = var_8_5.episodeItem

				recthelper.setAnchorX(var_8_3.containerTr, var_8_6 + var_8_7:getMaxWidth() + arg_8_0._constDungeonNormalDeltaX)
			else
				recthelper.setAnchorX(var_8_3.containerTr, arg_8_0._constDungeonNormalPosX)
			end
		end
	end

	local var_8_8 = arg_8_0._episodeContainerItemList[var_8_1]
	local var_8_9 = recthelper.rectToRelativeAnchorPos(var_8_8.containerTr.position, arg_8_0.rectTransform).x + arg_8_0._offsetX

	recthelper.setSize(arg_8_0.contentTransform, var_8_9, arg_8_0._rawHeight)

	arg_8_0._contentWidth = var_8_9
