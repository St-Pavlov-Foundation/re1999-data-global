...
function var_0_0._editableInitView(arg_29_0)
	arg_29_0._simagegorare1 = gohelper.findChildSingleImage(arg_29_0.viewGO, "anim/versionactivity/right/#go_rewards/rewardList/#go_activityrewarditem/rare/#go_rare1")

	arg_29_0._simagegorare1:LoadImage("singlebg_lang/txt_tag/bg_biaoqian5.png")
...
function var_0_0.onDestroyView(arg_60_0)
	...
	arg_60_0._simagegorare1:UnLoadImage()
end
