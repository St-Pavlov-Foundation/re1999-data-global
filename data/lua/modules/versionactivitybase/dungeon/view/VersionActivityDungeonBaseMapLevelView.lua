...
function slot0._editableInitView(slot0)
	slot0._simagegorare1 = gohelper.findChildSingleImage(slot0.viewGO, "anim/versionactivity/right/#go_rewards/rewardList/#go_activityrewarditem/rare/#go_rare1")

	slot0._simagegorare1:LoadImage("singlebg_lang/txt_tag/bg_biaoqian5.png")
...
function slot0.onDestroyView(slot0)
	...
	slot0._simagegorare1:UnLoadImage()
end
