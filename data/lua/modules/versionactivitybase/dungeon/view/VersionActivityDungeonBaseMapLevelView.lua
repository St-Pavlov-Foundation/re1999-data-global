...
function VersionActivityDungeonBaseMapLevelView:_editableInitView()
	self._simagegorare1 = gohelper.findChildSingleImage(self.viewGO, "anim/versionactivity/right/#go_rewards/rewardList/#go_activityrewarditem/rare/#go_rare1")

	self._simagegorare1:LoadImage("singlebg_lang/txt_tag/bg_biaoqian5.png")
...
function VersionActivityDungeonBaseMapLevelView:onDestroyView()
	...
	self._simagegorare1:UnLoadImage()
end
