...
local var_0_0 = class("VersionActivityFixedDungeonMapScene", BaseView)
...
function var_0_0.onActivityDungeonMoChange(arg_8_0)
	local var_8_0 = VersionActivityFixedDungeonModel.instance:getMapNeedTweenState()
...
function var_0_0.refreshMap(arg_23_0, arg_23_1, arg_23_2)
	arg_23_0._mapCfg = arg_23_2 or VersionActivityFixedDungeonConfig.instance:getEpisodeMapConfig(arg_23_0.activityDungeonMo.episodeId)
...
function var_0_0.tweenSetScenePos(arg_32_0, arg_32_1, arg_32_2)
	arg_32_0._tweenTargetPosX, arg_32_0._tweenTargetPosY = arg_32_0:getTargetPos(arg_32_1)
	arg_32_0._tweenStartPosX, arg_32_0._tweenStartPosY = arg_32_0:getTargetPos(arg_32_2 or arg_32_0._scenePos)

	arg_32_0:killTween()

	arg_32_0.tweenId = ZProj.TweenHelper.DOTweenFloat(0, 1, DungeonEnum.DefaultTweenMapTime, arg_32_0.tweenFrameCallback, arg_32_0.tweenFinishCallback, arg_32_0)

	arg_32_0:tweenFrameCallback(0)
end

function var_0_0.getTargetPos(arg_33_0, arg_33_1)
	local var_33_0 = arg_33_1.x
	local var_33_1 = arg_33_1.y

	if not arg_33_0._mapMinX or not arg_33_0._mapMaxX or not arg_33_0._mapMinY or not arg_33_0._mapMaxY then
		local var_33_2 = arg_33_0._mapCfg and arg_33_0._mapCfg.initPos
		local var_33_3 = string.splitToNumber(var_33_2, "#")

		var_33_0 = var_33_3[1] or 0
		var_33_1 = var_33_3[2] or 0
	else
		if var_33_0 < arg_33_0._mapMinX then
			var_33_0 = arg_33_0._mapMinX
		elseif var_33_0 > arg_33_0._mapMaxX then
			var_33_0 = arg_33_0._mapMaxX
		end

		if var_33_1 < arg_33_0._mapMinY then
			var_33_1 = arg_33_0._mapMinY
		elseif var_33_1 > arg_33_0._mapMaxY then
			var_33_1 = arg_33_0._mapMaxY
		end
	end
...
function var_0_0.tweenFrameCallback(arg_34_0, arg_34_1)
	local var_34_0 = Mathf.Lerp(arg_34_0._tweenStartPosX, arg_34_0._tweenTargetPosX, arg_34_1)
	local var_34_1 = Mathf.Lerp(arg_34_0._tweenStartPosY, arg_34_0._tweenTargetPosY, arg_34_1)

	arg_34_0._tempVector:Set(var_34_0, var_34_1, 0)
	arg_34_0:directSetScenePos(arg_34_0._tempVector)
end

function var_0_0.tweenFinishCallback(arg_35_0)
	arg_35_0._tempVector:Set(arg_35_0._tweenTargetPosX, arg_35_0._tweenTargetPosY, 0)
	arg_35_0:directSetScenePos(arg_35_0._tempVector)
end

function var_0_0.directSetScenePos(arg_36_0, arg_36_1)
	local var_36_0, var_36_1 = arg_36_0:getTargetPos(arg_36_1)

	arg_36_0._scenePos.x = var_36_0
	arg_36_0._scenePos.y = var_36_1

	if not arg_36_0._sceneTrans or gohelper.isNil(arg_36_0._sceneTrans) then
		return
	end
...
function var_0_0._updateElementArrow(arg_37_0)
...
function var_0_0.setVisible(arg_38_0, arg_38_1)
	gohelper.setActive(arg_38_0._sceneRoot, arg_38_1)

	if arg_38_1 then
		arg_38_0:_initCamera()
	end
end

function var_0_0.getSceneGo(arg_39_0)
	return arg_39_0._sceneGo
end

function var_0_0.onClose(arg_40_0)
	arg_40_0:killTween()
	arg_40_0:_resetCamera()
end

function var_0_0.killTween(arg_41_0)
	if arg_41_0.tweenId then
		ZProj.TweenHelper.KillById(arg_41_0.tweenId)
	end
end

function var_0_0._resetCamera(arg_42_0)
	local var_42_0 = CameraMgr.instance:getMainCamera()

	var_42_0.orthographicSize = 5
	var_42_0.orthographic = false
end

function var_0_0.onDestroyView(arg_43_0)
	gohelper.destroy(arg_43_0._sceneRoot)
	arg_43_0:disposeOldMap()
	arg_43_0:_disposeScene()

	if arg_43_0._mapLoader then
		arg_43_0._mapLoader:dispose()
	end
end

function var_0_0.disposeOldMap(arg_44_0)
	if arg_44_0._sceneTrans then
		arg_44_0._oldScenePos = arg_44_0._scenePos
	else
	...
	if arg_44_0._mapAudioGo then
		arg_44_0._mapAudioGo = nil
...
function var_0_0._disposeScene(arg_45_0)
	...
	if arg_45_0._sceneGo then
		gohelper.destroy(arg_45_0._sceneGo)

		arg_45_0._sceneGo = nil
	end

	arg_45_0._sceneTrans = nil
	arg_45_0._elementRoot = nil

	if arg_45_0._mapLoader then
		arg_45_0._mapLoader:dispose()

		arg_45_0._mapLoader = nil
	end
