-- chunkname: @modules/versionactivitybase/fixed/dungeon/view/map/VersionActivityFixedDungeonMapFinishElement.lua

module("modules.versionactivitybase.fixed.dungeon.view.map.VersionActivityFixedDungeonMapFinishElement", package.seeall)

local VersionActivityFixedDungeonMapFinishElement = class("VersionActivityFixedDungeonMapFinishElement", DungeonMapFinishElement)

function VersionActivityFixedDungeonMapFinishElement:init(go)
	self._go = go
...
function VersionActivityFixedDungeonMapFinishElement:_onResLoaded()
	if not string.nilorempty(self.resPath) then
...
function VersionActivityFixedDungeonMapFinishElement:onDown()
	self:_onDown()
end

function VersionActivityFixedDungeonMapFinishElement:_onDown()
	self._sceneElements:setMouseElementDown(self)
end

function VersionActivityFixedDungeonMapFinishElement:onClick()
...
return VersionActivityFixedDungeonMapFinishElement
