...
local var_0_0 = class("VersionActivityFixedDungeonMapEpisodeItem", BaseChildView)
...
function var_0_0.getMapAllElementList(arg_10_0)
	return (VersionActivityFixedDungeonModel.instance:getElementCoList(arg_10_0._map.id))
end
...
function var_0_0._showAllElementTipView(arg_11_0)
	...
	local var_11_0, var_11_1 = VersionActivityFixedDungeonModel.instance:getElementCoListWithFinish(arg_11_0._map.id)
...
function var_0_0.refresh(arg_13_0, arg_13_1, arg_13_2)
	...
	arg_13_0._map = VersionActivityFixedDungeonConfig.instance:getEpisodeMapConfig(arg_13_0._config.id)
...
function var_0_0.calculatePosInContent(arg_28_0)
	...
	local var_28_2 = arg_28_0._txtsectionname.preferredWidth
	local var_28_3 = arg_28_0._txtnameen.preferredWidth
	local var_28_4 = arg_28_0.elementItemList and #arg_28_0.elementItemList * 20 or 0
	local var_28_5 = var_28_0 + var_28_2 + var_28_4
	local var_28_6 = var_28_1 + var_28_3 - var_28_2 * 0.5 - var_28_4
