...
local var_0_0 = class("VersionActivityFixedDungeonMapSceneElements", BaseView)
local var_0_1 = 0.5
local var_0_2 = 0.5
...
function var_0_0.showNewElements(arg_22_0)
	...
	for iter_22_0, iter_22_1 in ipairs(var_22_0) do
		...
		if VersionActivityFixedDungeonConfig.instance:checkElementBelongMapId(var_22_2, arg_22_0._mapCfg.id) and var_22_2.showCamera == 1 then
...
function var_0_0._addElement(arg_28_0, arg_28_1)
	...
	if var_28_0:isConfigShowArrow() then
		...
		local var_28_4 = arg_28_0:getResInst(var_28_3, arg_28_0._goarrow)
		local var_28_5 = gohelper.findChild(var_28_4, "mesh")
		local var_28_6, var_28_7, var_28_8 = transformhelper.getLocalRotation(var_28_5.transform)
		local var_28_9 = gohelper.getClick(gohelper.findChild(var_28_4, "click"))

		var_28_9:AddClickListener(arg_28_0._arrowClick, arg_28_0, arg_28_1.id)

		local var_28_10 = arg_28_0:getUserDataTb_()

		var_28_10.go = var_28_4
		var_28_10.rotationTrans = var_28_5.transform
		var_28_10.initRotation = {
			var_28_6,
			var_28_7,
			var_28_8
		}
		var_28_10.arrowClick = var_28_9
		arg_28_0._arrowList[arg_28_1.id] = var_28_10
...
function var_0_0.showElements(arg_29_0)
	...
	local var_29_3 = VersionActivityFixedDungeonModel.instance:getElementCoList(arg_29_0._mapCfg.id)
