...
function var_0_0.buildEpisodeName(arg_35_0, arg_35_1)
	...
	local var_35_5 = arg_35_0.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard and "#cfccc9" or "#cfccc9"

	return arg_35_0:buildColorText(string.format("<size=%s>%s</size>%s", var_35_4, var_35_1, var_35_2), var_35_5)
end
