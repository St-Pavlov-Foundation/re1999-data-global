...
local var_0_0 = class("VersionActivityFixedEnterBgmView", BaseView)
...
function var_0_0.modifyBgm(arg_8_0, arg_8_1)
	local var_8_0 = VersionActivityFixedHelper.getVersionActivityEnum()

	arg_8_0._isMainAct = arg_8_1 == var_8_0.ActivityId.Dungeon
	...
	if arg_8_0._isMainAct then
		...
		if arg_8_0._isFirstOpenMainAct then
			...
			if var_8_0.Audio and var_8_0.Audio.FirstOpenDungeonTab then
				AudioMgr.instance:trigger(var_8_0.Audio.FirstOpenDungeonTab)
			end
		else
			var_8_1 = 1

			if var_8_0.Audio and var_8_0.Audio.ReturnDungeonTab then
				AudioMgr.instance:trigger(var_8_0.Audio.ReturnDungeonTab)
			end
		end
	end
	...
	TaskDispatcher.runDelay(arg_8_0._doModifyBgm, arg_8_0, var_8_1)
end
...
function var_0_0.defaultBgmHandle(arg_10_0, arg_10_1)
	...
	if var_10_0 == 0 then
		...
		var_10_0 = AudioEnum.Bgm.Act2_3DungeonBgm
	end
	...
	AudioBgmManager.instance:modifyBgmAudioId(VersionActivityFixedHelper.getVersionActivityAudioBgmLayer(), var_10_0)
end
...
function var_0_0._bossrushBgmHandle(arg_12_0, arg_12_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(VersionActivityFixedHelper.getVersionActivityAudioBgmLayer(), var_12_0)
end

function var_0_0._reactivityBgmHandle(arg_13_0, arg_13_1)
	...
	AudioBgmManager.instance:modifyBgmAudioId(VersionActivityFixedHelper.getVersionActivityAudioBgmLayer(), var_13_0)
end
