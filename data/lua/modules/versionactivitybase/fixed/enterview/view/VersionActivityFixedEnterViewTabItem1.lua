...
local var_0_0 = class("VersionActivityFixedEnterViewTabItem1", VersionActivityFixedEnterViewTabItemBase)
...
function var_0_0.afterSetData(arg_3_0)
	...
	local var_3_0 = VersionActivityFixedHelper.getVersionActivityEnum().TabSetting
