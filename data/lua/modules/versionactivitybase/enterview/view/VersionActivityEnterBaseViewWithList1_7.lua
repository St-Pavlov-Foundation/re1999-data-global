...
slot0 = class("VersionActivityEnterBaseViewWithList1_7", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actLevel2GoItem[VersionActivity1_7Enum.ActLevel.First] = slot0._goActivityItem1
	slot0.actLevel2GoItem[VersionActivity1_7Enum.ActLevel.Second] = slot0._goActivityItem2
	slot0.actLevel2Cls = {
...
function slot0.checkCanRemove(slot0, slot1)
	if slot1.actType == VersionActivity1_7Enum.ActType.Single then
