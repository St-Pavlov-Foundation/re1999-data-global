...
function slot0.ctor(slot0)
	...
	if VersionUtil.isVersionLargeEqual("2.4.0") or SLFramework.FrameworkSettings.IsEditor then
		slot0._callbackList[slot0.csharpInst.dataPropertiesChangeCallbackType] = slot0._dataPropertiesChangeCallBack
...
function slot0._callback(slot0, slot1, ...)
	...
	elseif not VersionUtil.isVersionLess("2.4.0") or slot1 ~= slot0.csharpInst.readNfcCallbackType then
